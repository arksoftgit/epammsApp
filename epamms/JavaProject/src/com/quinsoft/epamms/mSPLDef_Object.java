...
omSPLDef_GeneratePDF_Label( View     mSPLDef )
{
   ...
   if ( szWriteBuffer == null )
      ...
      ZeidonStringCopy( sb_szWriteBuffer, 1, 0, "c:\\lplr\\epamms\\xsl\\TestLabel.xsl", 1, 0, 32001 );
   ...
   if ( szPageHeight == null )
      ...
      sb_szPageHeight = new StringBuilder( szPageHeight );
       GetVariableFromAttribute( sb_szPageHeight, mi_lTempInteger_0, 'S', 11, mSPLDef, "LLD_Page", "Height", "", 0 );
   ...
   if ( szPageWidth == null )
      ...
      sb_szPageWidth = new StringBuilder( szPageWidth );
       GetVariableFromAttribute( sb_szPageWidth, mi_lTempInteger_1, 'S', 11, mSPLDef, "LLD_Page", "Width", "", 0 );
   ...
   { 
      ...
      if ( szTop == null )
         ...
         sb_szTop = new StringBuilder( szTop );
             GetVariableFromAttribute( sb_szTop, mi_lTempInteger_2, 'S', 11, mSPLDef, "LLD_Panel", "Top", "", 0 );
      ...
      if ( szLeft == null )
         ...
         sb_szLeft = new StringBuilder( szLeft );
             GetVariableFromAttribute( sb_szLeft, mi_lTempInteger_3, 'S', 11, mSPLDef, "LLD_Panel", "Left", "", 0 );
      ...
      if ( szHeight == null )
         ...
         sb_szHeight = new StringBuilder( szHeight );
             GetVariableFromAttribute( sb_szHeight, mi_lTempInteger_4, 'S', 11, mSPLDef, "LLD_Panel", "Height", "", 0 );
      ...
      if ( szWidth == null )
         ...
         sb_szWidth = new StringBuilder( szWidth );
             GetVariableFromAttribute( sb_szWidth, mi_lTempInteger_5, 'S', 11, mSPLDef, "LLD_Panel", "Width", "", 0 );
   ...
   if ( szWriteBuffer == null )
      ...
      sb_szWriteBuffer = new StringBuilder( szWriteBuffer );
      ZeidonStringCopy( sb_szWriteBuffer, 1, 0, "c:\\lplr\\epamms\\xsl\\TestLabel.xml", 1, 0, 32001 );
   szWriteBuffer = sb_szWriteBuffer.toString( );}
   //://CommitOI_ToXML_File( mSPLDef, szWriteBuffer, 0 )
   //:GenerateXML_File( mSPLDef, "SubregPhysicalLabelDef", szWriteBuffer )
   omSPLDef_GenerateXML_File( mSPLDef, "SubregPhysicalLabelDef", szWriteBuffer );
   return( 0 );
// END
} 
...
omSPLDef_BuildCompositeEntries( View     mSPLDef )
{
   ...
   if ( szTempString_7 == null )
      ...
      sb_szTempString_7 = new StringBuilder( szTempString_7 );
       GetVariableFromAttribute( sb_szTempString_7, mi_lTempInteger_6, 'S', 255, mSPLDef, "SPLD_HumanHazardSection", "Location1", "", 0 );
   lTempInteger_6 = mi_lTempInteger_6.intValue( );
   ...
   if ( CompareAttributeToString( mSPLDef, "SPLD_HumanHazardSection", "Location2", "" ) != 0 )
   { 
      ...
      if ( szTempString_8 == null )
         ...
         sb_szTempString_8 = new StringBuilder( szTempString_8 );
             GetVariableFromAttribute( sb_szTempString_8, mi_lTempInteger_7, 'S', 255, mSPLDef, "SPLD_HumanHazardSection", "Location2", "", 0 );
      lTempInteger_7 = mi_lTempInteger_7.intValue( );
   ...
   if ( CompareAttributeToString( mSPLDef, "SPLD_HumanHazardSection", "Location3", "" ) != 0 )
   { 
      ...
      if ( szTempString_9 == null )
         ...
         sb_szTempString_9 = new StringBuilder( szTempString_9 );
             GetVariableFromAttribute( sb_szTempString_9, mi_lTempInteger_8, 'S', 255, mSPLDef, "SPLD_HumanHazardSection", "Location3", "", 0 );
      lTempInteger_8 = mi_lTempInteger_8.intValue( );
   ...
   if ( CompareAttributeToString( mSPLDef, "SPLD_HumanHazardSection", "Location4", "" ) != 0 )
   { 
      ...
      if ( szTempString_10 == null )
         ...
         sb_szTempString_10 = new StringBuilder( szTempString_10 );
             GetVariableFromAttribute( sb_szTempString_10, mi_lTempInteger_9, 'S', 255, mSPLDef, "SPLD_HumanHazardSection", "Location4", "", 0 );
      lTempInteger_9 = mi_lTempInteger_9.intValue( );
   ...
   if ( CompareAttributeToString( mSPLDef, "SPLD_HumanHazardSection", "Location5", "" ) != 0 )
   { 
      ...
      if ( szTempString_11 == null )
         ...
         sb_szTempString_11 = new StringBuilder( szTempString_11 );
             GetVariableFromAttribute( sb_szTempString_11, mi_lTempInteger_10, 'S', 255, mSPLDef, "SPLD_HumanHazardSection", "Location5", "", 0 );
      lTempInteger_10 = mi_lTempInteger_10.intValue( );
...
//:TRANSFORMATION OPERATION
public int 
omSPLDef_SetUpFormattingSelect( View     mSPLDef,
                                String   szSectionType )
{
   int      RESULT = 0;
   ...
   { 
      ...
      RESULT = DeleteEntity( mSPLDef, "SpecialFormattingSelectEntry", zREPOS_NONE );
      RESULT = SetCursorNextEntity( mSPLDef, "SpecialFormattingSelectEntry", "" );
   } 
   ...
   { 
      ...
      RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
      //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Hazards Warning"
      SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Hazards Warning" );
      //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
      RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
      //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Hazards Signal Word"
      SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Hazards Signal Word" );
      //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
      RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
      //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Hazards Precautionary"
      SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Hazards Precautionary" );
      //:ELSE
   } 
   else
   { 
      ...
      { 
         ...
         SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Ingredients Title" );
         //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
         RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
         //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Ingredients Items" 
         SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Ingredients Items" );
         //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
         RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
         //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Ingredients Inert" 
         SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Ingredients Inert" );
         //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
         RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
         //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Ingredients Total" 
         SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Ingredients Total" );
         //:ELSE
      } 
      else
      { 
         ...
         { 
            ...
            SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Title" );
            //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
            RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
            //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "Text" 
            SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Text" );
            //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
            RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
            //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "DIRECTIONS Header" 
            SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "DIRECTIONS Header" );
            //:ELSE
         } 
         else
         { 
            ...
            { 
               ...
               SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "Column List" );
               //:CREATE ENTITY mSPLDef.SpecialFormattingSelectEntry 
               RESULT = CreateEntity( mSPLDef, "SpecialFormattingSelectEntry", zPOS_AFTER );
               //:mSPLDef.SpecialFormattingSelectEntry.KeywordName = "MARKETING Header" 
               SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "MARKETING Header" );
               //:ELSE
            } 
            else
            { 
               ...
               { 
                  ...
                  SetAttributeFromString( mSPLDef, "SpecialFormattingSelectEntry", "KeywordName", "FIRST AID Header" );
                  //:ELSE
               } 
               else
               { 
