...
public class qPrimReg_Object extends VmlObjectOperations
{
   public qPrimReg_Object( View view )
   {
      super( view );
   }
...
public int 
oqPrimReg_dRegistrantNameID( View     qPrimReg,
                             ...
                             Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         lTempInteger_0 = CheckExistenceOfEntity( qPrimReg, "Organization" );
         if ( lTempInteger_0 == 0 )
         { 
            ...
            if ( szString == null )
               ...
               sb_szString = new StringBuilder( szString );
                         GetVariableFromAttribute( sb_szString, mi_lTempInteger_1, 'S', 1001, qPrimReg, "Organization", "Name", "", 0 );
            lTempInteger_1 = mi_lTempInteger_1.intValue( );
            szString = sb_szString.toString( );}
            //:IF qPrimReg.PrimaryRegistrant.EPA_CompanyNumber = ""
            if ( CompareAttributeToString( qPrimReg, "PrimaryRegistrant", "EPA_CompanyNumber", "" ) == 0 )
            { 
         ...
         StoreStringInRecord( qPrimReg, InternalEntityStructure, InternalAttribStructure, szString );
         //:RETURN 0
         if(8==8)return( 0 );
         //:/* end zDERIVED_GET */
         //:OF   zDERIVED_SET:
   ...
   //:DERIVED ATTRIBUTE OPERATION
public int 
oqPrimReg_dFullNameLFM( View     qPrimReg,
                        String InternalEntityStructure,
                        String InternalAttribStructure,
                        Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( qPrimReg );
          m_ZGlobal1_Operation.PersonName_LastFirstMiddle( qPrimReg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
...
//:DERIVED ATTRIBUTE OPERATION
public int 
oqPrimReg_dFullNameFML( View     qPrimReg,
                        String InternalEntityStructure,
                        String InternalAttribStructure,
                        Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( qPrimReg );
          m_ZGlobal1_Operation.PersonName_FirstMiddleLast( qPrimReg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
          // m_ZGlobal1_Operation = null;  // permit gc  (unnecessary)
         }
         break ;
      //:  /* end zDERIVED_GET */
