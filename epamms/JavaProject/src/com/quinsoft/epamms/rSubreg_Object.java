...
public class rSubreg_Object extends VmlObjectOperations
{
   public rSubreg_Object( View view )
   {
      super( view );
   }
...
public int 
orSubreg_dRegistrantNameID( View     rSubreg,
                            ...
                            Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         lTempInteger_0 = CheckExistenceOfEntity( rSubreg, "SubregOrganization" );
         if ( lTempInteger_0 == 0 )
         { 
            ...
            if ( szString == null )
               ...
               sb_szString = new StringBuilder( szString );
                         GetVariableFromAttribute( sb_szString, mi_lTempInteger_1, 'S', 1001, rSubreg, "SubregOrganization", "Name", "", 0 );
            lTempInteger_1 = mi_lTempInteger_1.intValue( );
            szString = sb_szString.toString( );}
            //:IF rSubreg.Subregistrant.EPA_CompanyNumber = ""
            if ( CompareAttributeToString( rSubreg, "Subregistrant", "EPA_CompanyNumber", "" ) == 0 )
            { 
            ...
            { 
               ...
               if ( szTempString_0 == null )
                  ...
                  sb_szTempString_0 = new StringBuilder( szTempString_0 );
                               GetVariableFromAttribute( sb_szTempString_0, mi_lTempInteger_2, 'S', 129, rSubreg, "Subregistrant", "EPA_CompanyNumber", "", 0 );
         ...
         StoreStringInRecord( rSubreg, InternalEntityStructure, InternalAttribStructure, szString );
         //:RETURN 0
         if(8==8)return( 0 );
         //:/* end zDERIVED_GET */
         //:OF   zDERIVED_SET:
   ...
   //:DERIVED ATTRIBUTE OPERATION
public int 
orSubreg_dFullNameLFM( View     rSubreg,
                       String InternalEntityStructure,
                       String InternalAttribStructure,
                       Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( rSubreg );
          m_ZGlobal1_Operation.PersonName_LastFirstMiddle( rSubreg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
...
//:DERIVED ATTRIBUTE OPERATION
public int 
orSubreg_dFullNameFML( View     rSubreg,
                       String InternalEntityStructure,
                       String InternalAttribStructure,
                       Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( rSubreg );
          m_ZGlobal1_Operation.PersonName_FirstMiddleLast( rSubreg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
          // m_ZGlobal1_Operation = null;  // permit gc  (unnecessary)
         }
         break ;
      //:  /* end zDERIVED_GET */
