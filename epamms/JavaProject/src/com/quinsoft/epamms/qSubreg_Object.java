...
public class qSubreg_Object extends VmlObjectOperations
{
   public qSubreg_Object( View view )
   {
      super( view );
   }
...
public int 
oqSubreg_dRegistrantNameID( View     qSubreg,
                            ...
                            Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         lTempInteger_0 = CheckExistenceOfEntity( qSubreg, "SubregOrganization" );
         if ( lTempInteger_0 == 0 )
         { 
            ...
            if ( szString == null )
               ...
               sb_szString = new StringBuilder( szString );
                         GetVariableFromAttribute( sb_szString, mi_lTempInteger_1, 'S', 1001, qSubreg, "SubregOrganization", "Name", "", 0 );
            lTempInteger_1 = mi_lTempInteger_1.intValue( );
            szString = sb_szString.toString( );}
            //:IF qSubreg.Subregistrant.EPA_CompanyNumber = ""
            if ( CompareAttributeToString( qSubreg, "Subregistrant", "EPA_CompanyNumber", "" ) == 0 )
            { 
            ...
            { 
               ...
               if ( szTempString_0 == null )
                  ...
                  sb_szTempString_0 = new StringBuilder( szTempString_0 );
                               GetVariableFromAttribute( sb_szTempString_0, mi_lTempInteger_2, 'S', 129, qSubreg, "Subregistrant", "EPA_CompanyNumber", "", 0 );
         ...
         StoreStringInRecord( qSubreg, InternalEntityStructure, InternalAttribStructure, szString );
         //:RETURN 0
         if(8==8)return( 0 );
         //:/* end zDERIVED_GET */
         //:OF   zDERIVED_SET:
   ...
   //:DERIVED ATTRIBUTE OPERATION
public int 
oqSubreg_dFullNameLFM( View     qSubreg,
                       String InternalEntityStructure,
                       String InternalAttribStructure,
                       Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( qSubreg );
          m_ZGlobal1_Operation.PersonName_LastFirstMiddle( qSubreg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
...
//:DERIVED ATTRIBUTE OPERATION
public int 
oqSubreg_dFullNameFML( View     qSubreg,
                       String InternalEntityStructure,
                       String InternalAttribStructure,
                       Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( qSubreg );
          m_ZGlobal1_Operation.PersonName_FirstMiddleLast( qSubreg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
          // m_ZGlobal1_Operation = null;  // permit gc  (unnecessary)
         }
         break ;
      //:  /* end zDERIVED_GET */
