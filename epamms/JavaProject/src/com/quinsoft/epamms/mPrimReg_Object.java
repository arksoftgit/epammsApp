...
public class mPrimReg_Object extends VmlObjectOperations
{
   public mPrimReg_Object( View view )
   {
      super( view );
   }
...
public int 
omPrimReg_dFullNameLFM( View     mPrimReg,
                        ...
                        Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( mPrimReg );
          m_ZGlobal1_Operation.PersonName_LastFirstMiddle( mPrimReg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
...
//:DERIVED ATTRIBUTE OPERATION
public int 
omPrimReg_dFullNameFML( View     mPrimReg,
                        String InternalEntityStructure,
                        String InternalAttribStructure,
                        Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         {
          ZGlobal1_Operation m_ZGlobal1_Operation = new ZGlobal1_Operation( mPrimReg );
          m_ZGlobal1_Operation.PersonName_FirstMiddleLast( mPrimReg, InternalEntityStructure, InternalAttribStructure, GetOrSetFlag );
          // m_ZGlobal1_Operation = null;  // permit gc  (unnecessary)
         }
         break ;
      //:  /* end zDERIVED_GET */
...
public int 
omPrimReg_dRegistrantNameID( View     mPrimReg,
                             String InternalEntityStructure,
                             String InternalAttribStructure,
                             Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         lTempInteger_0 = CheckExistenceOfEntity( mPrimReg, "Organization" );
         if ( lTempInteger_0 == 0 )
         { 
            ...
            if ( szString == null )
               ...
               sb_szString = new StringBuilder( szString );
                         GetVariableFromAttribute( sb_szString, mi_lTempInteger_1, 'S', 1001, mPrimReg, "Organization", "Name", "", 0 );
            lTempInteger_1 = mi_lTempInteger_1.intValue( );
            szString = sb_szString.toString( );}
            //:IF mPrimReg.PrimaryRegistrant.EPA_CompanyNumber = ""
            if ( CompareAttributeToString( mPrimReg, "PrimaryRegistrant", "EPA_CompanyNumber", "" ) == 0 )
            { 
         ...
         StoreStringInRecord( mPrimReg, InternalEntityStructure, InternalAttribStructure, szString );
         //:RETURN 0
         if(8==8)return( 0 );
         //:/* end zDERIVED_GET */
         //:OF   zDERIVED_SET:
   ...
   //:STRING ( 1000 ) szString
public int 
omPrimReg_dMasterProductNameNbr( View     mPrimReg,
                                 String InternalEntityStructure,
                                 String InternalAttribStructure,
                                 Integer   GetOrSetFlag )
{
   ...
   { 
      ...
      case zDERIVED_GET :
         ...
         lTempInteger_0 = CheckExistenceOfEntity( mPrimReg, "MasterProduct" );
         if ( lTempInteger_0 == 0 )
         { 
            ...
            if ( szString == null )
               ...
               sb_szString = new StringBuilder( szString );
                         GetStringFromAttribute( sb_szString, mPrimReg, "MasterProduct", "Name" );
            szString = sb_szString.toString( );}
             {StringBuilder sb_szString;
            if ( szString == null )
               sb_szString = new StringBuilder( 32 );
