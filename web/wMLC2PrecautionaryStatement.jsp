...
if ( strLastWindow.equals("wMLC2PrecautionaryStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2PrecautionaryStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2PrecautionaryStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2PrecautionaryStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2PrecautionaryStatement", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2PrecautionaryStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2PrecautionaryStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2PrecautionaryStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2PrecautionaryStatement.js"></script>
...
<form name="wMLC2PrecautionaryStatement" id="wMLC2PrecautionaryStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "PrecautionaryStatement" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2PrecautionaryStatement" );
