...
if ( strLastWindow.equals("wSPLD2SubregProductsList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2SubregProductsList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2SubregProductsList LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2SubregProductsList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2SubregProductsList", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD", "DeleteSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DeleteLLD" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD2", "DeleteLLD" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SubregProductsList.jsp", "wSPLD2.GOTO_UpdateSubregProduct" );
      try
      {
         nOptRC = wSPLD2.GOTO_UpdateSubregProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_UpdateSubregProduct: " + e.getMessage();
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD2", "SubregProductUpdate" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewSubregProduct" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD", "NewSubregProduct" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2SubregProductsList" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2SubregProductsList.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2SubregProductsList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SubregProductsList.jsp", "wSPLD2.InitListSubregProducts" );
   nOptRC = wSPLD2.InitListSubregProducts( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLD2SubregProductsList.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD2" +
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SubregProductsList" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2SubregProductsList.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="ExitDialog( )">Exit</a></li>
<%
   }
%>
...
<form name="wSPLD2SubregProductsList" id="wSPLD2SubregProductsList" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "SubregProductsList" );
...
try
{
   ...
   if ( VmlOperation.isValid( mLLD_LST ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGridLLD.cursor( "LLD" ).getStringFromAttribute( "Name", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2SubregProductsList" );
