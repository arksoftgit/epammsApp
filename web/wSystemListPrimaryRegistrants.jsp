...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "ListPrimaryRegistrants", strFeedback );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminDeletePrimaryRegistrant" ) )
   {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SelectDeletePrimaryRegistrant: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminNewPrimaryRegistrant" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation InitPrimaryRegistrantForInsert: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminUpdatePrimaryRegistrant" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SelectUpdatePrimaryRegistrant: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
