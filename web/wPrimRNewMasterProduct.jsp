...
<%-- wPrimRNewMasterProduct   Generate Timestamp: 20160317151013567 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wPrimR.AcceptNewMasterProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wPrimR.CancelNewMasterProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wStartUp.GOTO_UserList" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProduct", "wPrimR.InitMasterProductForInsert" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for ProductDescription: " + "mMasProd.MasterProduct" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for EPARegistrationNumber: " + "mMasProd.MasterProduct" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for ESL_Date: " + "mMasProd.MasterProduct" );
      }
   }
%>
