...
<%-- wSPLDSPLD_EnvironmentalHazards --%>
                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC = vGridTmp.cursor( "SPLD_GeneralSubSection" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SPLD_GeneralSubSection" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "SPLD_GeneralSubSection" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLDSPLD_EnvironmentalHazards") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSPLD_EnvironmentalHazards strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSPLD_EnvironmentalHazards LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSPLD_EnvironmentalHazards LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSPLD_EnvironmentalHazards", strActionToProcess );
      ...
      if ( VmlOperation.isValid( mSPLDef ) )
      {
         ...
         csrRC = mSPLDef.cursor( "SPLD_GeneralSubSection" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mSPLDef.cursor( "SPLD_GeneralSubSection" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mSPLDef.cursor( "SPLD_GeneralSubSection" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mSPLDef.cursor( "SPLD_GeneralSubSection" ).setNextContinue( );
            } // Grid
         }
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.SaveSPLD_AndReturn" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.CancelSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.SaveSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHumanHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smFirstAid" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smStorageDisposal" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.ExecuteJOE_Test1" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smPrecautionary" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGENERATE_SPLD_Label" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.GENERATE_SPLD_Label" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGenerateLabelDottedBorders" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.GENERATE_SPLD_LabelDottedBorders" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCLEAN_SPLD_Data" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.CLEAN_SPLD_Data" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSPLD_EnvironmentalHazards" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSPLD_EnvironmentalHazards.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSPLD_EnvironmentalHazards.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SPLD_EnvironmentalHazards", "" );
   }
...
<title>SPLD Environmental Hazards</title>

<%@ include file="./include/head.inc" %>
<!-- Timeout.inc has a value for nTimeout which is used to determine when to -->
<!-- log a user out.  Timeout.inc is not used if the dialog or window has a timeout value set. -->
<%@ include file="./include/timeout.inc" %>
<script language="JavaScript" type="text/javascript" src="./js/common.js?v=20170809192902074"></script>
<script language="JavaScript" type="text/javascript" src="./js/scw.js?v=20170809192902074"></script>
<script language="JavaScript" type="text/javascript" src="./js/animatedcollapse.js?v=20170809192902074"></script>
<script language="JavaScript" type="text/javascript" src="./js/jquery.blockUI.js?v=20170809192902074"></script>
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDSPLD_EnvironmentalHazards.js?v=20170809192902074"></script>
...
<%
   ...
   {
%>
       <li id="smEnvironmentalHazard" name="smEnvironmentalHazard"><a href="#"  class="sideselected"  onclick="smEnvironmentalHazard()">Environmental Hazard</a></li>
<%
   }
%>
...
<form name="wSPLDSPLD_EnvironmentalHazards" id="wSPLDSPLD_EnvironmentalHazards" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "SPLD_EnvironmentalHazards" );
...
<label class="listheader"  id="EnvironmentalHazardSections" name="EnvironmentalHazardSections" style="width:238px;height:16px;position:absolute;left:2px;top:12px;">Environmental Hazard Sections</label>
...
<table  cols=2 style="width:730px;"  name="GridEnvironmentalSections" id="GridEnvironmentalSections">
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      vGridEnvironmentalSections = mSPLDef.newView( );
      csrRC2 = vGridEnvironmentalSections.cursor( "SPLD_GeneralSubSection" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridEnvironmentalSections.cursor( "SPLD_GeneralSubSection" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGridEditEnvironmentalName = "";
         nRC = vGridEnvironmentalSections.cursor( "SPLD_GeneralSubSection" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditEnvironmentalName = vGridEnvironmentalSections.cursor( "SPLD_GeneralSubSection" ).getAttribute( "Name" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditEnvironmentalVolume = vGridEnvironmentalSections.cursor( "SPLD_GeneralSubSection" ).getAttribute( "ContainerVolumeEnvironmentHazard" ).getString( "" );
...
<%
         csrRC2 = vGridEnvironmentalSections.cursor( "SPLD_GeneralSubSection" ).setNextContinue( );
      }
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSPLD_EnvironmentalHazards" );
