...
<%-- wSPLDSPLD_EnvironmentalHazards   Generate Timestamp: 20170427124545220 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_EnvironmentalHazards", "wSPLD.DisplayPhysicalChemicalHazards" );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDSPLD_EnvironmentalHazards.js"></script>
