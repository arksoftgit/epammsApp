...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "RemoveSLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2UsageEntriesSelect", "wSLC2.RemoveSLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2UsageEntriesSelect", "wSLC2.SelectMLC_UsageEntries" );
      try
      {
