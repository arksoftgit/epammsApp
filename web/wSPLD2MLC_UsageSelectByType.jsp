      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "MasterLabelContent" ).setAttribute( "wSelectedUsageType", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wSPLD2MLC_UsageSelectByType") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2MLC_UsageSelectByType strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2MLC_UsageSelectByType LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2MLC_UsageSelectByType LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2MLC_UsageSelectByType", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.AcceptMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SELECT_MLC_UsageTypeForSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.SELECT_MLC_UsageTypeForSource" );
      try
      {
         nOptRC = wSPLD2.SELECT_MLC_UsageTypeForSource( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.CLEAR_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.SETALL_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.CLEAR_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "RemoveMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.RemoveMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.SelectMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_UsageSelectByType.jsp", "wSPLD2.SETALL_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2MLC_UsageSelectByType" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2MLC_UsageSelectByType.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2MLC_UsageSelectByType.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "MLC_UsageSelectByType" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2MLC_UsageSelectByType.js"></script>
...
<form name="wSPLD2MLC_UsageSelectByType" id="wSPLD2MLC_UsageSelectByType" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "MLC_UsageSelectByType" );
...
<%
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mMasLC , "MasterLabelContent", "wSelectedUsageType", "" );

      nRC = mMasLC.cursor( "MasterLabelContent" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mMasLC.cursor( "MasterLabelContent" ).getStringFromAttribute( "wSelectedUsageType", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2MLC_UsageSelectByType" );
