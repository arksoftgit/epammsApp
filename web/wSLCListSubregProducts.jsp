...
if ( strLastWindow.equals("wSLCListSubregProducts") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCListSubregProducts strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCListSubregProducts LastWindow *** " + strLastWindow );
task.log().info("*** wSLCListSubregProducts LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCListSubregProducts", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.DeleteSubregProduct" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GenerateNewSLC" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCListSubregProducts", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.GenerateNewSLC_FromMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GenerateNewSLC_Version" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.GenerateNewSLC_Version" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "", "" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveSubregProductDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.MoveSubregProductDown" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StayOnWindowWithRefresh, "wSLC", "ListSubregProducts" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveSubregProductUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.MoveSubregProductUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.NewSubregProduct" );
      try
      {
         nOptRC = wSLC.NewSubregProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "NewSubregProduct" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnSubregUserDetail" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_ReturnToParent, "wStartUp", "ePammsPortal" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.UpdateSubregProduct" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smReturnSubregUserDetail" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCListSubregProducts", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCListSubregProducts" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCListSubregProducts.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCListSubregProducts.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCListSubregProducts.jsp", "wSLC.InitListSubregProducts" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSLCListSubregProducts.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCListSubregProducts.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnSubregUserDetail( )">Return</a></li>
<%
   }
%>
...
<form name="wSLCListSubregProducts" id="wSLCListSubregProducts" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "ListSubregProducts" );
...
<% /* GBSubregProducts:GroupBox */ %>

<div id="GBSubregProducts" name="GBSubregProducts" class="listgroup" style="width:486px;height:40px;float:left;">  <!-- GBSubregProducts --> 
...
<span class="listheader"  id="SubregProducts" name="SubregProducts" style="width:154px;height:16px;">Subregistrant Products</span>
...
<button type="button" class="newbutton" name="PBNewSubregProduct" id="PBNewSubregProduct" value="" onclick="NewSubregProduct( )" style="width:78px;height:26px;">New</button>

</div>  <!-- End of a new line -->


</div>  <!--  GBSubregProducts --> 
</div>  <!-- End of a new line -->
...
<table  cols=9 style=""  name="GridSubregProducts" id="GridSubregProducts">
...
try
{
   ...
   if ( VmlOperation.isValid( mSubreg ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGESubregProductName = vGridSubregProducts.cursor( "SubregProduct" ).getStringFromAttribute( "Name", "" );
         ...
         strGridPrimaryRegistrant = "";
         nRC = vGridSubregProducts.cursor( "MasterProductPrimRegOrg" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridPrimaryRegistrant = vGridSubregProducts.cursor( "MasterProductPrimRegOrg" ).getStringFromAttribute( "Name", "" );

            if ( strGridPrimaryRegistrant == null )
               strGridPrimaryRegistrant = "";
         }

         if ( StringUtils.isBlank( strGridPrimaryRegistrant ) )
            strGridPrimaryRegistrant = "&nbsp";
         ...
         if ( nRC >= 0 )
         {
            strGridESL_Date = vGridSubregProducts.cursor( "SubregProduct" ).getStringFromAttribute( "ESL_Date", "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="UpdateSubregProduct( this.id )" id="GESubregProductName::<%=strEntityKey%>"><%=strGESubregProductName%></a></td>
   <td><a href="#" onclick="UpdateSubregProduct( this.id )" id="GridPrimaryRegistrant::<%=strEntityKey%>"><%=strGridPrimaryRegistrant%></a></td>
   <td><a href="#" onclick="UpdateSubregProduct( this.id )" id="GEPrimRegProductName::<%=strEntityKey%>"><%=strGEPrimRegProductName%></a></td>
   <td><a href="#" onclick="UpdateSubregProduct( this.id )" id="GridESL_Date::<%=strEntityKey%>"><%=strGridESL_Date%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateSubregProduct" onclick="UpdateSubregProduct( this.id )" id="BMBUpdateSubregProduct::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveSubregProductUp" onclick="MoveSubregProductUp( this.id )" id="BMBMoveSubregProductUp::<%=strEntityKey%>"><img src="./images/ePammsUp.jpg" alt="Move Up"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveSubregProductDown" onclick="MoveSubregProductDown( this.id )" id="BMBMoveSubregProductDown::<%=strEntityKey%>"><img src="./images/ePammsDown.jpg" alt="Move Down"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBNewSLC" onclick="GenerateNewSLC( this.id )" id="BMBNewSLC::<%=strEntityKey%>"><img src="./images/ePammsNewVersion.jpg" alt="New SLC"></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCListSubregProducts" );
