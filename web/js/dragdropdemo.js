...
// bMouseDown represents the current mouse button state: up or down
/*
lMouseState represents the previous mouse button state so that we can
check for button clicks and button releases:
if ( bMouseDown && !lMouseState ) // button just clicked!
if ( !bMouseDown && lMouseState ) // button just released!
*/
var mouseOffset = null;
...
function mouseMove( ev ) {
   ...
   */
   ...
   if ( curTarget ) {
      ...
      dragHelper.style.left = mousePos.x - mouseOffset.xadjusted;
