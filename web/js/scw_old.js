...
//******************************************************************************
    ...
    var scwDateDisplayFormat = 'M/D/YYYY';     // e.g. 'MMM-DD-YYYY' for the US

    // Output date format

    var scwDateOutputFormat  = 'M/D/YYYY'; // e.g. 'MMM-DD-YYYY' for the US
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSourceEle)
        {scwTriggerEle = scwSourceEle;
         ...
         //scwDateDisplayFormat = document.getElementById('zCalendarFormat');
         //alert( scwDateDisplayFormat );
