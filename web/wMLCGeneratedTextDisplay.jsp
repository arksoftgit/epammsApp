...
<%-- wMLCGeneratedTextDisplay   Generate Timestamp: 20160328163908278 --%>
...
if ( strLastWindow.equals("wMLCGeneratedTextDisplay") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCGeneratedTextDisplay strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCGeneratedTextDisplay LastWindow *** " + strLastWindow );
task.log().info("*** wMLCGeneratedTextDisplay LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCGeneratedTextDisplay" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCGeneratedTextDisplay.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCGeneratedTextDisplay.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCGeneratedTextDisplay.js"></script>
...
<form name="wMLCGeneratedTextDisplay" id="wMLCGeneratedTextDisplay" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "GeneratedTextDisplay" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCGeneratedTextDisplay" );
