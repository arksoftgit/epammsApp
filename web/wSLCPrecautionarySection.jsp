...
<%-- wSLCPrecautionarySection   Generate Timestamp: 20160317151020491 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCPrecautionarySection", "wSLC.DisplayAreasOfUseSection" );
