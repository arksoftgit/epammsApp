...
if ( strLastWindow.equals("wMLC2DeleteMasterLabelContent") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2DeleteMasterLabelContent strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2DeleteMasterLabelContent LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2DeleteMasterLabelContent LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2DeleteMasterLabelContent", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteMasterLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DeleteMasterLabelContent.jsp", "wMLC2.ConfirmDeleteMasterLabelContent" );
      try
      {
         nOptRC = wMLC2.ConfirmDeleteMasterLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2DeleteMasterLabelContent" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2DeleteMasterLabelContent.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2DeleteMasterLabelContent.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2DeleteMasterLabelContent.js"></script>
...
<form name="wMLC2DeleteMasterLabelContent" id="wMLC2DeleteMasterLabelContent" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "DeleteMasterLabelContent" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2DeleteMasterLabelContent" );
