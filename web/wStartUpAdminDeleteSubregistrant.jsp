...
<%-- wStartUpAdminDeleteSubregistrant --%>
...
if ( strLastWindow.equals("wStartUpAdminDeleteSubregistrant") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminDeleteSubregistrant strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminDeleteSubregistrant LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminDeleteSubregistrant LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminConfirmDeleteSubreg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregistrant", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.DeleteSubregistrant" );
      try
      {
         nOptRC = wStartUp.DeleteSubregistrant( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation DeleteSubregistrant: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelDeleteSubreg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminConfirmDeleteSubreg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminCancelDeleteSubreg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminDeleteSubregistrant" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminDeleteSubregistrant.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregistrant.jsp", "wStartUp.InitSubregistrantForDelete" );
   nOptRC = wStartUp.InitSubregistrantForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wStartUpAdminDeleteSubregistrant.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitSubregistrantForDelete";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminDeleteSubregistrant" );
   }
...
<title>Delete Subregistrant</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminDeleteSubregistrant.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminConfirmDeleteSubreg( )">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminCancelDeleteSubreg( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminDeleteSubregistrant" id="wStartUpAdminDeleteSubregistrant" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminDeleteSubregistrant" );
...
<span  id="OrganizationName:" name="OrganizationName:" style="width:134px;height:16px;">Primary Registrant:</span>
...
<div id="Subregistrant" name="Subregistrant" class="noborder" style="width:682px;height:140px;float:left;">  <!-- Subregistrant --> 
...
<span  id="LoginName:" name="LoginName:" style="width:150px;height:16px;">Login Name:</span>

<span style="height:16px;">&nbsp&nbsp</span>
<% /* TXOrganizationName:Text */ %>
<% strTextDisplayValue = "";
   mSubreg = task.getViewByName( "mSubreg" );
   if ( VmlOperation.isValid( mSubreg ) == false )
      task.log( ).debug( "Invalid View: " + "TXOrganizationName" );
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSubreg.cursor( "SubregOrganization" ).getStringFromAttribute( "LoginName", "" );
      }
      catch (Exception e)
      {
         out.println("There is an error on TXOrganizationName: " + e.getMessage());
         task.log().info( "*** Error on ctrl TXOrganizationName" + e.getMessage() );
      }
         if ( strTextDisplayValue == null )
            strTextDisplayValue = "";
      }
...
<span  id="TXOrganizationName" name="TXOrganizationName" style="width:226px;height:16px;"><%=strTextDisplayValue%></span>

<span style="height:16px;">&nbsp&nbsp&nbsp&nbsp</span>
<% /* Password::Text */ %>

<span  id="Password:" name="Password:" style="width:74px;height:16px;">Password:</span>
...
<span class="text10"  id="SubregistrantName:" name="SubregistrantName:" style="width:150px;height:16px;">Subregistrant Name:</span>
...
<span class="text10"  id="SubregistrantName" name="SubregistrantName" style="width:490px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="Text" name="Text" style="width:416px;height:16px;">Are you sure you want to delete this Subregistrant?</span>
