...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "AdminDeleteSubregistrant", "" );
   }
...
<%
   ...
   {
%>
       <li id="smDeleteAndReturn" name="smDeleteAndReturn"><a href="#"  onclick="smAdminConfirmDeleteSubreg()">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smAdminCancelDeleteSubreg()">Cancel Delete and Return</a></li>
<%
   }
%>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSubreg.cursor( "SubregOrganization" ).getAttribute( "LoginName" ).getString( "" );
      }
      catch (Exception e)
      {
