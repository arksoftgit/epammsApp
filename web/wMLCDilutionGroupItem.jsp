...
<%-- wMLCDilutionGroupItem   Generate Timestamp: 20160328163907622 --%>
...
<input class="text12" name="EditBox3" id="EditBox3" style="width:426px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
