...
<%-- wMLCDilutionGroupItem   Generate Timestamp: 20160623085854837 --%>
                           ...
                           boolean webMapping )
{
   ...
   {
      // EditBox: EditBox3
      nRC = mMasLC.cursor( "M_DilutionGroupItem" ).checkExistenceOfEntity( ).toInt();
...
if ( strLastWindow.equals("wMLCDilutionGroupItem") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCDilutionGroupItem strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCDilutionGroupItem LastWindow *** " + strLastWindow );
task.log().info("*** wMLCDilutionGroupItem LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCDilutionGroupItem" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCDilutionGroupItem.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCDilutionGroupItem.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<form name="wMLCDilutionGroupItem" id="wMLCDilutionGroupItem" method="post">
...
<input class="text12" name="EditBox3" id="EditBox3" maxlength="4" style="width:426px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
