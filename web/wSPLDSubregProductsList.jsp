...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductsList", "wSPLD.DeleteSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductsList", "wSPLD.GOTO_UpdateSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductsList", "wSPLD.GOTO_NewSubregProduct" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductsList", "wSPLD.InitListSubregProducts" );
