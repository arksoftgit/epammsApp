...
if ( strLastWindow.equals("wMLC2UpdateMasterProduct") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2UpdateMasterProduct strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2UpdateMasterProduct LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2UpdateMasterProduct LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2UpdateMasterProduct", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2UpdateMasterProduct.jsp", "wMLC2.CANCEL_MasterProduct" );
      try
      {
         nOptRC = wMLC2.CANCEL_MasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation CANCEL_MasterProduct: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CompareToPreviousMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2UpdateMasterProduct.jsp", "wMLC2.CompareToPreviousMLC" );
      try
      {
         nOptRC = wMLC2.CompareToPreviousMLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wSystem", "AnalysisDifferences" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMasterLabelContent" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "DeleteMasterLabelContent" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GenerateNewMLC_Version" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2UpdateMasterProduct.jsp", "wMLC2.GenerateNewMLC_Version" );
      try
      {
         nOptRC = wMLC2.GenerateNewMLC_Version( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "VersionData" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2UpdateMasterProduct.jsp", "wMLC2.GOTO_UpdateMLC" );
      try
      {
         nOptRC = wMLC2.GOTO_UpdateMLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_UpdateMLC: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NEW_MLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2UpdateMasterProduct.jsp", "wMLC2.NEW_MLC" );
      try
      {
         nOptRC = wMLC2.NEW_MLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation NEW_MLC: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SAVE_MasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2UpdateMasterProduct.jsp", "wMLC2.SAVE_MasterProduct" );
      try
      {
         nOptRC = wMLC2.SAVE_MasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SAVE_MasterProduct: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2UpdateMasterProduct" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2UpdateMasterProduct.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2UpdateMasterProduct.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2UpdateMasterProduct.js"></script>
...
<form name="wMLC2UpdateMasterProduct" id="wMLC2UpdateMasterProduct" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "UpdateMasterProduct" );
...
<button type="button" class="newbutton" name="PBNewMasterLabelContent" id="PBNewMasterLabelContent" value="" onclick="NEW_MLC( )" style="width:78px;height:26px;">New</button>
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateMasterLabelContent" onclick="GOTO_UpdateMLC( this.id )" id="BMBUpdateMasterLabelContent::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2UpdateMasterProduct" );
