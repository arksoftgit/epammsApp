...
if ( strLastWindow.equals("wTemplDDeleteTemplate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wTemplDDeleteTemplate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wTemplDDeleteTemplate LastWindow *** " + strLastWindow );
task.log().info("*** wTemplDDeleteTemplate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wTemplDDeleteTemplate", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteClaimsStatement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wTemplD.DeleteTemplate" );
      try
      {
         nOptRC = wTemplD.DeleteTemplate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation DeleteTemplate: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDDeleteTemplate.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wTemplDDeleteTemplate" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wTemplDDeleteTemplate.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wTemplDDeleteTemplate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DeleteTemplate" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wTemplDDeleteTemplate.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="ConfirmDeleteClaimsStatement( )">Confirm Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelDeleteClaimsStatement( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wTemplDDeleteTemplate" id="wTemplDDeleteTemplate" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wTemplD", "DeleteTemplate" );
...
<span class="PageTitle"  id="Text3" name="Text3" style="width:382px;height:16px;">Delete Template Confirmation</span>
...
<span  id="Text2" name="Text2" style="width:116px;height:16px;">Template Name:</span>

<% /* Text1:Text */ %>
<% strTextDisplayValue = "";
   lTemplLST = task.getViewByName( "lTemplLST" );
   if ( VmlOperation.isValid( lTemplLST ) == false )
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = lTemplLST.cursor( "Template" ).getStringFromAttribute( "Name", "" );
      }
      catch (Exception e)
      {
...
<span  id="Text1" name="Text1" style="width:346px;height:16px;"><%=strTextDisplayValue%></span>
...
<%
   session.setAttribute( "ZeidonWindow", "wTemplDDeleteTemplate" );
