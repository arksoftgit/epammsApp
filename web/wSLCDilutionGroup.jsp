                           ...
                           boolean webMapping )
{
   ...
   {
      // EditBox: Title
      nRC = mSubLC.cursor( "S_DilutionGroup" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "Title" ).setValue( strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "Text" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "Ratio" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "UnitsNumerator" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "UnitsDenominator" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      csrRC = vGridTmp.cursor( "S_DilutionChartEntry" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "S_DilutionChartEntry" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "S_DilutionChartEntry" ).setNextContinue( );
      }
      ...
      // entity positions. 
      vGridTmp = mSubLC.newView( );
      csrRC = vGridTmp.cursor( "S_DilutionGroupItem" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "S_DilutionGroupItem" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "S_DilutionGroupItem" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSLCDilutionGroup") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCDilutionGroup strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCDilutionGroup LastWindow *** " + strLastWindow );
task.log().info("*** wSLCDilutionGroup LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DilutionGroupItemDisplay" ) )
   {
      ...
      if ( VmlOperation.isValid( mSubLC ) )
      {
         ...
         csrRC = mSubLC.cursor( "S_DilutionGroupItem" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mSubLC.cursor( "S_DilutionGroupItem" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mSubLC.cursor( "S_DilutionGroupItem" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mSubLC.cursor( "S_DilutionGroupItem" ).setNextContinue( );
            } // Grid
         }
      }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSLCDilutionGroup" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCDilutionGroup.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCDilutionGroup.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCDilutionGroup.js"></script>
...
<form name="wSLCDilutionGroup" id="wSLCDilutionGroup" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "DilutionGroup" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "Title" ).getString( "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_DilutionGroup.Title: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist for Title: " + "mSubLC.S_DilutionGroup" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "Text" ).getString( "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_DilutionGroup.Text: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist for Text: " + "mSubLC.S_DilutionGroup" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "Ratio" ).getString( "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_DilutionGroup.Ratio: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist for Ratio: " + "mSubLC.S_DilutionGroup" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "UnitsNumerator" ).getString( "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_DilutionGroup.UnitsNumerator: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist for UnitsNumerator: " + "mSubLC.S_DilutionGroup" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mSubLC.cursor( "S_DilutionGroup" ).getAttribute( "UnitsDenominator" ).getString( "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_DilutionGroup.UnitsDenominator: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist for UnitsDenominator: " + "mSubLC.S_DilutionGroup" );
      }
   }
%>
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      csrRC2 = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strUse = "";
         nRC = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strUse = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).getAttribute( "Use" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strProductAmount = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).getAttribute( "ProductAmountText" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strWaterAmount = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).getAttribute( "WaterAmountText" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strContactTime = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).getAttribute( "ContactTime" ).getString( "" );
...
<%
         csrRC2 = vGridDilutionGroupItems.cursor( "S_DilutionChartEntry" ).setNextContinue( );
      }
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      vGridGroupItems = mSubLC.newView( );
      csrRC2 = vGridGroupItems.cursor( "S_DilutionGroupItem" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridGroupItems.cursor( "S_DilutionGroupItem" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strItemText = "";
         nRC = vGridGroupItems.cursor( "S_DilutionGroupItem" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strItemText = vGridGroupItems.cursor( "S_DilutionGroupItem" ).getAttribute( "Text" ).getString( "" );
...
<%
         csrRC2 = vGridGroupItems.cursor( "S_DilutionGroupItem" ).setNextContinue( );
      }
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCDilutionGroup" );
