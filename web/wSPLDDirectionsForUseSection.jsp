                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      // entity positions. 
      vGridTmp = mSPLDef.newView( );
      csrRC = vGridTmp.cursor( "SPLD_ClaimsDrivingUsage" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SPLD_ClaimsDrivingUsage" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "SPLD_ClaimsDrivingUsage" ).setNextContinue( );
      }
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DirectionsForUseStatement" ) )
   {
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "GOTO_DirectionsForUseStatement", e.getMessage( ), "" );
         break;
      }
      // Next Window
...
<title>SPLD Directions For Use Section</title>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_DirectionsForUseSection" ).getAttribute( "Name" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_DirectionsForUseSection" ).getAttribute( "Title" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_DirectionsForUseSection" ).getAttribute( "HeadNote" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_DirectionsForUseSection" ).getAttribute( "Subtitle" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_DirectionsForUseSection" ).getAttribute( "TailNote" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   {
      nRC = mSPLDef.cursor( "SPLD_DirectionsForUseXORSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_DirectionsForUseXORSection" ).getAttribute( "Name" ).getString( "" );
      }
      catch (Exception e)
      {
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditDirectionsUse = vGridDirectionsUse.cursor( "SPLD_DirectionsForUseStatement" ).getAttribute( "dDU_StatementTitleTextKeyword" ).getString( "" );
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGrid1.cursor( "SPLD_ClaimsDrivingUsage" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid1.cursor( "SPLD_ClaimsDrivingUsage" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGridEditCtl1 = "";
         nRC = vGrid1.cursor( "SPLD_ClaimsDrivingUsage" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGrid1.cursor( "SPLD_ClaimsDrivingUsage" ).getAttribute( "ClaimsClassification" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl2 = vGrid1.cursor( "SPLD_ClaimsDrivingUsage" ).getAttribute( "dDisplayUsageName" ).getString( "" );
...
<%
         csrRC2 = vGrid1.cursor( "SPLD_ClaimsDrivingUsage" ).setNextContinue( );
      }
      vGrid1.drop( );
   }
}
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGrid2.cursor( "SPLD_ClaimsDrivingUsage" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid2.cursor( "SPLD_ClaimsDrivingUsage" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGridEditCtl3 = "";
         nRC = vGrid2.cursor( "SPLD_ClaimsDrivingUsage" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditCtl3 = vGrid2.cursor( "SPLD_ClaimsDrivingUsage" ).getAttribute( "ClaimsClassification" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl4 = vGrid2.cursor( "SPLD_ClaimsDrivingUsage" ).getAttribute( "dDisplayUsageName" ).getString( "" );
...
<%
         csrRC2 = vGrid2.cursor( "SPLD_ClaimsDrivingUsage" ).setNextContinue( );
      }
      vGrid2.drop( );
   }
}
