   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteDirectionsUseStmt" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCDeleteDirectionsForUseStatement" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCDeleteDirectionsForUseStatement.jsp";
...
<span style="height:288px;">&nbsp&nbsp</span>
...
<textarea name="StatementText" id="StatementText"style="width:566px;height:288px;border:solid;border-width:4px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
