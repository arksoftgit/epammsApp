...
if ( strLastWindow.equals("wSPLD2SLC_ComponentsUpdate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2SLC_ComponentsUpdate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2SLC_ComponentsUpdate LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2SLC_ComponentsUpdate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2SLC_ComponentsUpdate", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.CancelSubregistrantLabelContent" );
      try
      {
         nOptRC = wSPLD2.CancelSubregistrantLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAN_ClaimEntries" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2SLC_ComponentsUpdate", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.CLEAN_ClaimEntries" );
      try
      {
         nOptRC = wSPLD2.CLEAN_ClaimEntries( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation CLEAN_ClaimEntries: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_ComponentsDisplay" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wSPLD2", "SLC_Components" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMLC_ComponentsForSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.DeleteMLC_ComponentsForSLC" );
      try
      {
         nOptRC = wSPLD2.DeleteMLC_ComponentsForSLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.SaveSubregistrantLabelContent" );
      try
      {
         nOptRC = wSPLD2.SaveSubregistrantLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "REFRESH_SLC_FromMLC" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2SLC_ComponentsUpdate", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.REFRESH_SLC_FromMLC" );
      try
      {
         nOptRC = wSPLD2.REFRESH_SLC_FromMLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation REFRESH_SLC_FromMLC: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_ComponentsForSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.SelectMLC_ComponentsForSLC" );
      try
      {
         nOptRC = wSPLD2.SelectMLC_ComponentsForSLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2SLC_ComponentsUpdate" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2SLC_ComponentsUpdate.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2SLC_ComponentsUpdate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SLC_ComponentsUpdate.jsp", "wSPLD2.PostbuildSLC_Update" );
   nOptRC = wSPLD2.PostbuildSLC_Update( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLD2SLC_ComponentsUpdate.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD2" +
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SLC_ComponentsUpdate" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2SLC_ComponentsUpdate.js"></script>
...
<form name="wSPLD2SLC_ComponentsUpdate" id="wSPLD2SLC_ComponentsUpdate" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "SLC_ComponentsUpdate" );
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGrid2.cursor( "CompositeComponentList" ).getStringFromAttribute( "DisplayTypeIndent", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2SLC_ComponentsUpdate" );
