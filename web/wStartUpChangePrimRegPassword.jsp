      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               wWebXfer.cursor( "Root" ).setAttribute( "CurrentPassword", strMapValue, "" );
         }
...
if ( strLastWindow.equals("wStartUpChangePrimRegPassword") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpChangePrimRegPassword strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpChangePrimRegPassword LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpChangePrimRegPassword LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelChangePrimRegPassword" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegPassword", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.CancelChangePrimRegPassword" );
      try
      {
         nOptRC = wStartUp.CancelChangePrimRegPassword( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelChangePrimRegPassword: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmChangePrimRegPassword" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegPassword", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.ConfirmChangePrimRegPassword" );
      try
      {
         nOptRC = wStartUp.ConfirmChangePrimRegPassword( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation ConfirmChangePrimRegPassword: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmChangePrimRegPassword" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegPassword", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelChangePrimRegPassword" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegPassword", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegPassword.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpChangePrimRegPassword" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpChangePrimRegPassword.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wStartUpChangePrimRegPassword.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitChangePrimRegPassword";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ChangePrimRegPassword" );
   }
...
<title>Change Primary Registrant Password</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpChangePrimRegPassword.js"></script>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ConfirmChangePrimRegPassword" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smConfirmChangePrimRegPassword( )">Change Password and Return</a></li>
<%
   }
%>

<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "CancelChangePassword" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smCancelChangePrimRegPassword( )">Cancel Password and Return</a></li>
<%
   }
%>
...
<form name="wStartUpChangePrimRegPassword" id="wStartUpChangePrimRegPassword" method="post">
...
<% /* GroupBox:GroupBox */ %>
<div id="GroupBox" name="GroupBox" style="float:left;width:642px;"  class="withborder">

<table cols=2 style="width:642px;"  class="grouptable">

<tr>
<td valign="top" style="width:154px;">
<% /* PrimaryRegistrantName::Text */ %>

<span  id="PrimaryRegistrantName:" name="PrimaryRegistrantName:" style="width:142px;height:16px;">Primary Registrant:</span>

</td>
<td valign="top" style="width:458px;">
<% /* PrimaryRegistrantName:Text */ %>
<% strTextDisplayValue = "";
   mPrimReg = task.getViewByName( "mPrimReg" );
   if ( VmlOperation.isValid( mPrimReg ) == false )
      task.log( ).debug( "Invalid View: " + "PrimaryRegistrantName" );
   else
   {
      ...
      {
         out.println("There is an error on PrimaryRegistrantName: " + e.getMessage());
         task.log().info( "*** Error on ctrl PrimaryRegistrantName" + e.getMessage() );
      }
...
<span  id="PrimaryRegistrantName" name="PrimaryRegistrantName" style="width:458px;height:16px;"><%=strTextDisplayValue%></span>
...
<span  id="CurrentPassword:" name="CurrentPassword:" style="width:142px;height:16px;">Current Password:</span>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = wWebXfer.cursor( "Root" ).getStringFromAttribute( "CurrentPassword", "" );
            }
            catch (Exception e)
            {
...
<span  id="TXNewPassword:" name="TXNewPassword:" style="width:142px;height:16px;">New Password:</span>
...
<span  id="ConfirmPassword:" name="ConfirmPassword:" style="width:142px;height:16px;">Confirm Password:</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wStartUpChangePrimRegPassword" );
