...
if ( strLastWindow.equals("wMLCFirstAidSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCFirstAidSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCFirstAidSection LastWindow *** " + strLastWindow );
task.log().info("*** wMLCFirstAidSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_AddFirstAidStatement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAidSection", "wMLC.GOTO_AddFirstAidStatements" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAidSection", "wMLC.EditLocationsSection" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCFirstAidSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCFirstAidSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCFirstAidSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCFirstAidSection.js"></script>
...
<%
   ...
   {
%>
       <li id="smFirstAid" name="smFirstAid"><a href="#"  class="sideselected"  onclick="smEditFirstAidSect()">First Aid</a></li>
<%
   }
%>
...
<form name="wMLCFirstAidSection" id="wMLCFirstAidSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "FirstAidSection" );
...
<div id="GBFirstAidSection" name="GBFirstAidSection" class="withborder"   style="float:left;position:relative; width:730px; height:126px;">  <!-- GBFirstAidSection --> 

<% /* FirstAidTitle::Text */ %>

<label  id="FirstAidTitle:" name="FirstAidTitle:" style="width:106px;height:16px;position:absolute;left:14px;top:18px;">Title:</label>
...
<input class="text12"  name="FirstAidTitle" id="FirstAidTitle" maxlength="4096" style="width:582px;position:absolute;left:126px;top:18px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* ReviewerNote::Text */ %>

<label  id="ReviewerNote:" name="ReviewerNote:" style="width:106px;height:16px;position:absolute;left:14px;top:40px;">Reviewer Note:</label>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).info( "Entity does not exist for ReviewerNote: " + "mMasLC.M_GeneralSection" );
      }
   }
%>

<textarea name="ReviewerNote" id="ReviewerNote" maxlength="4096" style="width:582px;height:52px;position:absolute;left:126px;top:40px;border:solid;border-width:4px;border-style:groove;" class="text12" wrap="wrap"><%=strErrorMapValue%></textarea>

<% /* GBFirstAidStatements:GroupBox */ %>

<div id="GBFirstAidStatements" name="GBFirstAidStatements" class="listgroup" style="width:708px;height:28px;position:absolute;left:8px;top:108px;">  <!-- GBFirstAidStatements --> 
