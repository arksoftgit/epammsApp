...
if ( strLastWindow.equals("wMLC2FirstAidSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2FirstAidSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2FirstAidSection LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2FirstAidSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2FirstAidSection", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "PrecautionaryStatement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_FirstAidStmtDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.GOTO_FirstAidStmtDelete" );
      try
      {
         nOptRC = wMLC2.GOTO_FirstAidStmtDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_FirstAidStmtDelete: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateFirstAidStmt" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "FirstAidStatement" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.SaveAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.SaveMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.CancelAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditPrecautionarySection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditFirstAidSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditHazardsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditClaimsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditSurfacesSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditAreasOfUseSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2FirstAidSection.jsp", "wMLC2.EditApplicationTypesSection" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2FirstAidSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2FirstAidSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2FirstAidSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2FirstAidSection.js"></script>
...
<form name="wMLC2FirstAidSection" id="wMLC2FirstAidSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "FirstAidSection" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdatePrecautionaryStatement" onclick="GOTO_UpdateFirstAidStmt( this.id )" id="BMBUpdatePrecautionaryStatement::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeletePrecautionaryStatement" onclick="GOTO_FirstAidStmtDelete( this.id )" id="BMBDeletePrecautionaryStatement::<%=strEntityKey%>"><img src="./images/ePammsDelete.jpg" alt="Delete"></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2FirstAidSection" );
