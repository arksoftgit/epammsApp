...
<%-- wMLCDirsForUseSelectByType   Generate Timestamp: 20160407171235967 --%>
...
if ( strLastWindow.equals("wMLCDirsForUseSelectByType") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCDirsForUseSelectByType strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCDirsForUseSelectByType LastWindow *** " + strLastWindow );
task.log().info("*** wMLCDirsForUseSelectByType LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCDirsForUseSelectByType" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCDirsForUseSelectByType.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCDirsForUseSelectByType.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<form name="wMLCDirsForUseSelectByType" id="wMLCDirsForUseSelectByType" method="post">
