...
if ( strLastWindow.equals("wSPLDSPLD_HumanHazard") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSPLD_HumanHazard strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSPLD_HumanHazard LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSPLD_HumanHazard LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSPLD_HumanHazard", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.SaveSPLD_AndReturn" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.CancelSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.SaveSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHumanHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smFirstAid" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smStorageDisposal" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.ExecuteJOE_Test1" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smPrecautionary" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGENERATE_SPLD_Label" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.GENERATE_SPLD_Label" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGenerateLabelDottedBorders" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.GENERATE_SPLD_LabelDottedBorders" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCLEAN_SPLD_Data" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_HumanHazard", "wSPLD.CLEAN_SPLD_Data" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSPLD_HumanHazard" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSPLD_HumanHazard.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSPLD_HumanHazard.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SPLD_HumanHazard", "" );
   }
...
<title>SPLD Human Hazard</title>

<%@ include file="./include/head.inc" %>
<!-- Timeout.inc has a value for nTimeout which is used to determine when to -->
<!-- log a user out.  Timeout.inc is not used if the dialog or window has a timeout value set. -->
<%@ include file="./include/timeout.inc" %>
<script language="JavaScript" type="text/javascript" src="./js/common.js?v=20170810173025360"></script>
<script language="JavaScript" type="text/javascript" src="./js/scw.js?v=20170810173025360"></script>
<script language="JavaScript" type="text/javascript" src="./js/animatedcollapse.js?v=20170810173025360"></script>
<script language="JavaScript" type="text/javascript" src="./js/jquery.blockUI.js?v=20170810173025360"></script>
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDSPLD_HumanHazard.js?v=20170810173025360"></script>
...
<%
   ...
   {
%>
       <li id="smHumanHazard" name="smHumanHazard"><a href="#"  class="sideselected"  onclick="smHumanHazard()">Human Hazard</a></li>
<%
   }
%>
...
<form name="wSPLDSPLD_HumanHazard" id="wSPLDSPLD_HumanHazard" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "SPLD_HumanHazard" );
...
<div id="GroupBox1" name="GroupBox1" class="listgroup"   style="float:left;position:relative; width:692px; height:390px;">  <!-- GroupBox1 --> 

<% /* Text2:Text */ %>

<label class="listheader"  id="Text2" name="Text2" style="width:250px;height:16px;position:absolute;left:0px;top:0px;">Human Hazard Attributes</label>

<% /* HazardText::Text */ %>

<label  id="HazardText:" name="HazardText:" style="width:114px;height:16px;position:absolute;left:26px;top:30px;">Hazard Text:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "EPA_ChildHazardWarning" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="Text3" name="Text3" style="width:544px;height:16px;position:absolute;left:142px;top:30px;"><%=strTextDisplayValue%></label>

<% /* SignalWord::Text */ %>

<label  id="SignalWord:" name="SignalWord:" style="width:114px;height:16px;position:absolute;left:26px;top:62px;">Signal Word:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "EPA_SignalWord" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="Text1" name="Text1" style="width:544px;height:16px;position:absolute;left:142px;top:62px;"><%=strTextDisplayValue%></label>

<% /* Statement::Text */ %>

<label  id="Statement:" name="Statement:" style="width:114px;height:16px;position:absolute;left:26px;top:100px;">Statement:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PrecautionaryStatement" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="Text4" name="Text4" style="width:542px;height:50px;position:absolute;left:146px;top:100px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation1::Text */ %>

<label  id="PanelLocation1:" name="PanelLocation1:" style="width:114px;height:16px;position:absolute;left:26px;top:160px;">Panel Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc1" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation1" name="PanelLocation1" style="width:178px;height:16px;position:absolute;left:146px;top:160px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation1::Text */ %>

<label  id="LabelLocation1:" name="LabelLocation1:" style="width:114px;height:16px;position:absolute;left:358px;top:160px;">Label Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc1" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation1" name="LabelLocation1" style="width:178px;height:16px;position:absolute;left:478px;top:160px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation2::Text */ %>

<label  id="PanelLocation2:" name="PanelLocation2:" style="width:114px;height:16px;position:absolute;left:26px;top:186px;">Panel Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc2" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation2" name="PanelLocation2" style="width:178px;height:16px;position:absolute;left:146px;top:186px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation2::Text */ %>

<label  id="LabelLocation2:" name="LabelLocation2:" style="width:114px;height:16px;position:absolute;left:358px;top:186px;">LabelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc2" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation2" name="LabelLocation2" style="width:178px;height:16px;position:absolute;left:478px;top:186px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation3::Text */ %>

<label  id="PanelLocation3:" name="PanelLocation3:" style="width:114px;height:16px;position:absolute;left:26px;top:212px;">PanelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc3" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation3" name="PanelLocation3" style="width:178px;height:16px;position:absolute;left:146px;top:212px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation3::Text */ %>

<label  id="LabelLocation3:" name="LabelLocation3:" style="width:114px;height:16px;position:absolute;left:358px;top:212px;">LabelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc3" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation3" name="LabelLocation3" style="width:178px;height:16px;position:absolute;left:478px;top:212px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation4::Text */ %>

<label  id="PanelLocation4:" name="PanelLocation4:" style="width:114px;height:16px;position:absolute;left:26px;top:238px;">Panel Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc4" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation4" name="PanelLocation4" style="width:178px;height:16px;position:absolute;left:146px;top:238px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation4::Text */ %>

<label  id="LabelLocation4:" name="LabelLocation4:" style="width:114px;height:16px;position:absolute;left:358px;top:238px;">Label Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc4" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation4" name="LabelLocation4" style="width:178px;height:16px;position:absolute;left:478px;top:238px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation5::Text */ %>

<label  id="PanelLocation5:" name="PanelLocation5:" style="width:114px;height:16px;position:absolute;left:26px;top:264px;">PanelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc5" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation5" name="PanelLocation5" style="width:178px;height:16px;position:absolute;left:146px;top:264px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation5::Text */ %>

<label  id="LabelLocation5:" name="LabelLocation5:" style="width:114px;height:16px;position:absolute;left:358px;top:264px;">LabelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc5" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation5" name="LabelLocation5" style="width:178px;height:16px;position:absolute;left:478px;top:264px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation6::Text */ %>

<label  id="PanelLocation6:" name="PanelLocation6:" style="width:114px;height:16px;position:absolute;left:26px;top:290px;">Panel Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc6" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation6" name="PanelLocation6" style="width:178px;height:16px;position:absolute;left:146px;top:290px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation6::Text */ %>

<label  id="LabelLocation6:" name="LabelLocation6:" style="width:114px;height:16px;position:absolute;left:358px;top:290px;">Label Location:</label>
...
<label  id="LabelLocation6" name="LabelLocation6" style="width:178px;height:16px;position:absolute;left:478px;top:290px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation7::Text */ %>

<label  id="PanelLocation7:" name="PanelLocation7:" style="width:114px;height:16px;position:absolute;left:26px;top:316px;">Panel Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc7" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation7" name="PanelLocation7" style="width:178px;height:16px;position:absolute;left:146px;top:316px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation7::Text */ %>

<label  id="LabelLocation7:" name="LabelLocation7:" style="width:114px;height:16px;position:absolute;left:358px;top:316px;">LabelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc7" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation7" name="LabelLocation7" style="width:178px;height:16px;position:absolute;left:478px;top:316px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation8::Text */ %>

<label  id="PanelLocation8:" name="PanelLocation8:" style="width:114px;height:16px;position:absolute;left:26px;top:342px;">PanelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc8" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation8" name="PanelLocation8" style="width:178px;height:16px;position:absolute;left:146px;top:342px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation8::Text */ %>

<label  id="LabelLocation8:" name="LabelLocation8:" style="width:114px;height:16px;position:absolute;left:358px;top:342px;">LabelLocation:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc8" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation8" name="LabelLocation8" style="width:178px;height:16px;position:absolute;left:478px;top:342px;"><%=strTextDisplayValue%></label>

<% /* PanelLocation9::Text */ %>

<label  id="PanelLocation9:" name="PanelLocation9:" style="width:114px;height:16px;position:absolute;left:26px;top:368px;">Panel Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "PanelLoc9" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="PanelLocation9" name="PanelLocation9" style="width:178px;height:16px;position:absolute;left:146px;top:368px;"><%=strTextDisplayValue%></label>

<% /* LabelLocation9::Text */ %>

<label  id="LabelLocation9:" name="LabelLocation9:" style="width:114px;height:16px;position:absolute;left:358px;top:368px;">Label Location:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "LabelLoc9" ).getString( "" );
      }
      catch (Exception e)
      {
...
<label  id="LabelLocation9" name="LabelLocation9" style="width:178px;height:16px;position:absolute;left:478px;top:368px;"><%=strTextDisplayValue%></label>
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mSPLDef.cursor( "SPLD_HumanHazardSection" ).getAttribute( "dFullStatement" ).getString( "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "SPLD_HumanHazardSection.dFullStatement: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist for MLEditFullStatement: " + "mSPLDef.SPLD_HumanHazardSection" );
      }
   }
%>
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSPLD_HumanHazard" );
