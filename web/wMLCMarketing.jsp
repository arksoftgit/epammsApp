...
<input class="text12"  name="MarketingTitle" id="MarketingTitle" maxlength="4096" style="width:634px;position:absolute;left:130px;top:26px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
