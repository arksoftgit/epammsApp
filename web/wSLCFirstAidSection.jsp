...
if ( strLastWindow.equals("wSLCFirstAidSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCFirstAidSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCFirstAidSection LastWindow *** " + strLastWindow );
task.log().info("*** wSLCFirstAidSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCFirstAidSection", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.SaveSLC_Return" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.SaveSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.CancelAndReturnSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayFirstAidSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplaySurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplaySurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplayLocationsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplayApplicationTypesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAidSection", "wSLC.DisplayClaimsSection" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSLCFirstAidSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCFirstAidSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCFirstAidSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "FirstAidSection", "" );
   }
...
<title>SLC First Aid</title>

<%@ include file="./include/head.inc" %>
<!-- Timeout.inc has a value for nTimeout which is used to determine when to -->
<!-- log a user out.  Timeout.inc is not used if the dialog or window has a timeout value set. -->
<%@ include file="./include/timeout.inc" %>
<script language="JavaScript" type="text/javascript" src="./js/common.js?v=20170809163729693"></script>
<script language="JavaScript" type="text/javascript" src="./js/scw.js?v=20170809163729693"></script>
<script language="JavaScript" type="text/javascript" src="./js/animatedcollapse.js?v=20170809163729693"></script>
<script language="JavaScript" type="text/javascript" src="./js/jquery.blockUI.js?v=20170809163729693"></script>
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCFirstAidSection.js?v=20170809163729693"></script>
...
<%
   ...
   {
%>
       <li id="smFirstAid" name="smFirstAid"><a href="#"  class="sideselected"  onclick="smDisplayFirstAidSection()">First Aid</a></li>
<%
   }
%>
...
<form name="wSLCFirstAidSection" id="wSLCFirstAidSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "FirstAidSection" );
...
<div id="GBFirstAidSection" name="GBFirstAidSection" class="listgroup"   style="float:left;position:relative; width:730px; height:46px;">  <!-- GBFirstAidSection --> 

<% /* FirstAidTitle::Text */ %>

<label class="groupbox"  id="FirstAidTitle:" name="FirstAidTitle:" style="width:118px;height:16px;position:absolute;left:14px;top:16px;">First Aid Title:</label>
...
<label class="text12"  id="FirstAidTitle" name="FirstAidTitle" style="width:550px;height:16px;position:absolute;left:146px;top:16px;"><%=strTextDisplayValue%></label>
...
<div id="GroupBox2" name="GroupBox2" style="width:730px;height:50px;float:left;">  <!-- GroupBox2 --> 
...
<div id="GBFirstAidStatements" name="GBFirstAidStatements" style="float:left;width:684px;"  class="listgroup">
...
<div style="height:1px;width:10px;float:left;"></div>   <!-- Width Spacer -->
<% /* GridFirstAid:Grid */ %>
<table  cols=1 style="width:728px;"  name="GridFirstAid" id="GridFirstAid">
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      csrRC2 = vGridFirstAid.cursor( "S_GeneralStatement" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridFirstAid.cursor( "S_GeneralStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGridEditFirstAid = "";
         nRC = vGridFirstAid.cursor( "S_GeneralStatement" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditFirstAid = vGridFirstAid.cursor( "S_GeneralStatement" ).getAttribute( "dGenStmtCombinedTitleText" ).getString( "" );
...
<%
         csrRC2 = vGridFirstAid.cursor( "S_GeneralStatement" ).setNextContinue( );
      }
      vGridFirstAid.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCFirstAidSection" );
