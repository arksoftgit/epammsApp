...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "HazardsStatement", "" );
   }
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wMLCHazardsStatement" );
