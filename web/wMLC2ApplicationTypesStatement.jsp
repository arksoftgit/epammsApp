...
<%-- wMLC2ApplicationTypesStatement --%>
...
if ( strLastWindow.equals("wMLC2ApplicationTypesStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2ApplicationTypesStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2ApplicationTypesStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2ApplicationTypesStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2ApplicationTypesStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAddNewUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypesStatement.jsp", "wMLC2.SaveAddNewUsage" );
      try
      {
         nOptRC = wMLC2.SaveAddNewUsage( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SaveAddNewUsage: " + e.getMessage();
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2ApplicationTypesStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2ApplicationTypesStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2ApplicationTypesStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ApplicationTypesStatement" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2ApplicationTypesStatement.js"></script>
...
<form name="wMLC2ApplicationTypesStatement" id="wMLC2ApplicationTypesStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "ApplicationTypesStatement" );
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl PrecautionarySubtitle1" + e.getMessage() );
            }
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2ApplicationTypesStatement" );
