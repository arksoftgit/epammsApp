...
<%-- wStartUpAdminDeletePrimRegUser --%>
...
if ( strLastWindow.equals("wStartUpAdminDeletePrimRegUser") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminDeletePrimRegUser strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminDeletePrimRegUser LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminDeletePrimRegUser LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelDeletePrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimRegUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminConfirmDeletePrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimRegUser", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.DeletePrimRegUser" );
      try
      {
         nOptRC = wStartUp.DeletePrimRegUser( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation DeletePrimRegUser: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminConfirmDeletePrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimRegUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminCancelDeletePrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimRegUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimRegUser.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminDeletePrimRegUser" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminDeletePrimRegUser.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminDeletePrimRegUser" );
   }
...
<title>Delete Primary Registrant User</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminDeletePrimRegUser.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminConfirmDeletePrimRegUser( )">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminCancelDeletePrimRegUser( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminDeletePrimRegUser" id="wStartUpAdminDeletePrimRegUser" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminDeletePrimRegUser" );
...
<div id="User" name="User" class="noborder" style="width:702px;height:140px;float:left;">  <!-- User --> 

<div  id="User" name="User" >Primary Registrant User</div>
...
<% strTextDisplayValue = "";
   ...
   {
      nRC = mCurrentUser.cursor( "PrimaryRegistrant" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mCurrentUser.cursor( "PrimaryRegistrant" ).getStringFromAttribute( "dRegistrantNameID", "" );
      }
      catch (Exception e)
      {
...
<span  id="TXName" name="TXName" style="width:466px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="UserName:" name="UserName:" style="width:142px;height:16px;">User Name:</span>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mCurrentUser.cursor( "User" ).getStringFromAttribute( "UserName", "" );
      }
      catch (Exception e)
      {
...
<span class="text10"  id="UserName" name="UserName" style="width:466px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="Text7" name="Text7" style="width:410px;height:16px;">Are you sure you want to delete this User?</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wStartUpAdminDeletePrimRegUser" );
