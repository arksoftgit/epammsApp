...
<%-- wMLCOrganismClaims   Generate Timestamp: 20160525203753591 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_AddUsageStatements" ) )
   {
      bDone = true;
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.GOTO_AddUsageStatements" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateClaimsStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCOrganismClaims", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.SaveAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.SaveMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.CancelAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazards" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditEnvironmentalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditSurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditLocationsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditApplicationTypesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCOrganismClaims", "wMLC.EditClaimsSection" );
...
<%
   ...
   {
%>
       <li id="smOrganismClaims" name="smOrganismClaims"><a href="#"  class="sideselected"  onclick="smEditClaimsSection()">Organism Claims</a></li>
<%
   }
%>
...
<% /* GroupBox2:GroupBox */ %>
<div id="GroupBox2" name="GroupBox2" style="float:left;width:662px;" >

<table cols=2 style="width:662px;"  class="grouptable">
...
<input name="Title" id="Title" maxlength="254" style="width:512px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="ReviewerNote" id="ReviewerNote" maxlength="254" style="width:512px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<% /* GBClaimsSections:GroupBox */ %>

<div id="GBClaimsSections" name="GBClaimsSections" class="listgroup"   style="float:left;position:relative; width:666px; height:40px;">  <!-- GBClaimsSections --> 

<% /* EnvironmentalHazardsSection:Text */ %>

<label class="groupbox"  id="EnvironmentalHazardsSection" name="EnvironmentalHazardsSection" style="width:198px;height:16px;position:absolute;left:6px;top:12px;">Organism Claims Statements</label>

<% /* PBDelete:PushBtn */ %>
<button type="button" name="PBDelete" id="PBDelete" value="" onclick="GOTO_DeleteSelectedEntries( )" style="width:166px;height:26px;position:absolute;left:222px;top:12px;">Delete Selected Claims</button>
...
<div id="GroupBox1" name="GroupBox1" style="width:662px;float:left;">  <!-- GroupBox1 --> 
...
<div style="height:1px;width:10px;float:left;"></div>   <!-- Width Spacer -->
<% /* GridClaims:Grid */ %>
<table class="sortable"  cols=4 style="width:638px;"  name="GridClaims" id="GridClaims">
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGEClassification = vGridClaims.cursor( "M_Usage" ).getAttribute( "ClaimsClassification" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGEPathogen = vGridClaims.cursor( "M_Usage" ).getAttribute( "dDisplayPathogenNameKeyword" ).getString( "" );
