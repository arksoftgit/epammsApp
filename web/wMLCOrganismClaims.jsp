...
<%-- wMLCOrganismClaims   Generate Timestamp: 20170608112959853 --%>
...
<title>MLC Organism Claims</title>
...
<input name="Title" id="Title" maxlength="4096" style="width:512px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="ReviewerNote" id="ReviewerNote" maxlength="4096" style="width:512px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
