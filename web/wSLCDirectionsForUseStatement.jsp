      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DirectionsForUseStatement" ).setAttribute( "ReviewerNote", strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DirectionsForUseStatement" ).setAttribute( "NotForUseText", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "S_DirectionsForUseStatement" ).setAttribute( "NotForUseType", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wSLCDirectionsForUseStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCDirectionsForUseStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCDirectionsForUseStatement LastWindow *** " + strLastWindow );
task.log().info("*** wSLCDirectionsForUseStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptDirectionsUseStmt" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wSLC.AcceptDirectionsUseStmt" );
      try
      {
         nOptRC = wSLC.AcceptDirectionsUseStmt( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_ReturnToParent, "wSLC", "DirectionsForUseSection" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ShowHideEditor" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDirectionsForUseStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDirectionsUseStmt" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wSLC.CancelDirectionsUseStmt" );
      try
      {
         nOptRC = wSLC.CancelDirectionsUseStmt( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAddNewDirectionsUseStmt" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wSLC.SaveAddNewDirectionsUseStmt" );
      try
      {
         nOptRC = wSLC.SaveAddNewDirectionsUseStmt( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StayOnWindowWithRefresh, "wSLC", "DirectionsForUseStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDirectionsForUseStatement.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCDirectionsForUseStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCDirectionsForUseStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCDirectionsForUseStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCDirectionsForUseStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelDirectionsUseStmt( )">Return</a></li>
<%
   }
%>
...
<form name="wSLCDirectionsForUseStatement" id="wSLCDirectionsForUseStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "DirectionsForUseStatement" );
...
<fieldset id="DirectionsForUseStatement" name="DirectionsForUseStatement"   style="size:absolute; width:738px; height:574px;">
<legend>Directions for Use Statement</legend>
<% /* DirectionsUseTitle::Text */ %>

<label  id="DirectionsUseTitle:" name="DirectionsUseTitle:" style="width:130px;height:16px;position:absolute;left:12px;top:28px;">Directions Title:</label>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSubLC.cursor( "S_DirectionsForUseSection" ).getStringFromAttribute( "Title", "" );
      }
      catch (Exception e)
      {
...
<label  id="DirectionsUseTitle" name="DirectionsUseTitle" style="width:566px;height:16px;position:absolute;left:152px;top:28px;"><%=strTextDisplayValue%></label>
...
<div id="GB3" name="GB3" style="width:584px;height:56px;position:absolute;left:152px;top:52px;">  <!-- GB3 --> 
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mSubLC.cursor( "S_DirectionsForUseStatement" ).getStringFromAttribute( "ReviewerNote", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "S_DirectionsForUseStatement.ReviewerNote: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mSubLC.S_DirectionsForUseStatement" );
      }
   }
%>
...
<label  id="StatementText:" name="StatementText:" style="width:130px;height:16px;position:absolute;left:12px;top:120px;">Statement Text:</label>
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mSubLC.cursor( "S_DirectionsForUseStatement" ).getStringFromAttribute( "Text", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "S_DirectionsForUseStatement.Text: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mSubLC.S_DirectionsForUseStatement" );
      }
...
<textarea name="StatementText" id="StatementText" class="mceSimple" style="width:566px;height:364px;position:absolute;left:152px;top:120px;border:solid;border-width:4px;border-style:groove;"><%=strErrorMapValue%></textarea>
...
<div id="GB5" name="GB5" style="width:566px;height:86px;position:absolute;left:152px;top:496px;">  <!-- GB5 --> 
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mSubLC.cursor( "S_DirectionsForUseStatement" ).getStringFromAttribute( "NotForUseText", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "S_DirectionsForUseStatement.NotForUseText: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mSubLC.S_DirectionsForUseStatement" );
      }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSubLC.cursor( "S_DirectionsForUseStatement" ).getStringFromAttribute( "NotForUseType", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_DirectionsForUseStatement.NotForUseType: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSubLC.S_DirectionsForUseStatement" );
      }
   }
%>
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCDirectionsForUseStatement" );
