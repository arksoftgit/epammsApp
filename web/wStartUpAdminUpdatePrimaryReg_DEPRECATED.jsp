...
<%
   ...
   {
%>
       <li><a href="#"  onclick="ChangePrimRegPassword( )">Change Password</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AdminAcceptUpdatePrimReg( )">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AdminCancelUpdatePrimReg( )">Cancel and Return</a></li>
<%
   }
%>
