...
<%-- wStartUpAdminUpdatePrimaryReg_DEPRECATED --%>
...
if ( strLastWindow.equals("wStartUpAdminUpdatePrimaryReg_DEPRECATED") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminUpdatePrimaryReg_DEPRECATED strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminUpdatePrimaryReg_DEPRECATED LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminUpdatePrimaryReg_DEPRECATED LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminUpdatePrimaryReg_DEPRECATED", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimaryReg_DEPRECATED", "wStartUp.GOTO_UserList" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wStartUpAdminUpdatePrimaryReg_DEPRECATED" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminUpdatePrimaryReg_DEPRECATED.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminUpdatePrimaryReg_DEPRECATED.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminUpdatePrimaryReg_DEPRECATED.js"></script>
...
<%
   ...
   {
%>
       <li id="CancelAndReturn" name="CancelAndReturn"><a href="#"  onclick="ChangePrimRegPassword()">Change Password</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="CancelAndReturn" name="CancelAndReturn"><a href="#"  onclick="AdminAcceptUpdatePrimReg()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="CancelAndReturn" name="CancelAndReturn"><a href="#"  onclick="AdminCancelUpdatePrimReg()">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminUpdatePrimaryReg_DEPRECATED" id="wStartUpAdminUpdatePrimaryReg_DEPRECATED" method="post">
...
<div id="GBPrimaryRegistrant" name="GBPrimaryRegistrant" style="float:left;width:506px;" >
...
<span  id="Description" name="Description" style="width:140px;height:16px;">Description:</span>
...
<input name="EBDescription" id="EBDescription" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="EPA_ID:" name="EPA_ID:" style="width:140px;height:16px;">EPA Company ID:</span>
...
<input name="EPA_ID" id="EPA_ID" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="Role:" name="Role:" style="width:140px;height:16px;">Role:</span>
...
<input name="LoginName" id="LoginName" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<div id="GBPhysicalAddress" name="GBPhysicalAddress" style="float:left;width:506px;" >

<table cols=4 style="width:506px;"  class="grouptable">
...
<td valign="top" style="width:154px;">
<% /* GroupBox2:GroupBox */ %>
<div id="GroupBox2" name="GroupBox2" style="width:140px;height:16px;float:left;">
</div>  <!-- GroupBox2 --> 
</td>
<td valign="top" style="width:318px;">
<% /* EBPAddress2:EditBox */ %>
...
<input name="EBPAddress2" id="EBPAddress2" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="TollFreeEmergencyPhone:" name="TollFreeEmergencyPhone:" style="width:208px;height:16px;">Toll Free Emergency Phone:</span>
...
<input name="EBPEmergencyPhone" id="EBPEmergencyPhone" style="width:250px;<%=strErrorColor%>" type="text" mask="###-###-####" onblur="return onBlurMask(this);" onfocus="return onFocusMask(this);" onkeydown="return doMask(this);" value="<%=strErrorMapValue%>" >
...
<div id="GroupBox1" name="GroupBox1" style="width:206px;height:36px;float:left;">  <!-- GroupBox1 --> 
...
<span style="width:202px;height:22px;">&nbsp Same As Physical Address</span>
...
<div id="GBMailingAddress" name="GBMailingAddress" style="float:left;width:506px;" >

<table cols=2 style="width:506px;"  class="grouptable">

<tr>
<td valign="top"  class="groupbox" style="width:126px;">
<% /* MailingAddress:Text */ %>

<span class="groupbox"  id="MailingAddress" name="MailingAddress" style="width:126px;height:24px;">Mailing Address</span>
...
<input name="EBStreetAddress" id="EBStreetAddress" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<td valign="top" style="width:154px;">
<% /* GroupBox3:GroupBox */ %>
<div id="GroupBox3" name="GroupBox3" style="width:140px;height:16px;float:left;">
</div>  <!-- GroupBox3 --> 
</td>
<td valign="top" style="width:318px;">
<% /* EBAddress2:EditBox */ %>
...
<input name="EBAddress2" id="EBAddress2" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBCity" id="EBCity" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<div style="height:1px;width:12px;float:left;"></div>   <!-- Width Spacer -->
<% /* GBContact:GroupBox */ %>
<div id="GBContact" name="GBContact" style="float:left;width:506px;" >
...
<input name="EBCPhone" id="EBCPhone" style="width:318px;<%=strErrorColor%>" type="text" mask="###-###-####" onblur="return onBlurMask(this);" onfocus="return onFocusMask(this);" onkeydown="return doMask(this);" value="<%=strErrorMapValue%>" >
...
<input name="EBFax" id="EBFax" style="width:318px;<%=strErrorColor%>" type="text" mask="###-###-####" onblur="return onBlurMask(this);" onfocus="return onFocusMask(this);" onkeydown="return doMask(this);" value="<%=strErrorMapValue%>" >
...
<div id="GroupBox" name="GroupBox" style="width:16px;height:36px;float:left;">  <!-- GroupBox --> 
