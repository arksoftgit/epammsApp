...
if ( strLastWindow.equals("wSystemExitHelpMessage") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemExitHelpMessage strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemExitHelpMessage LastWindow *** " + strLastWindow );
task.log().info("*** wSystemExitHelpMessage LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemExitHelpMessage", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ExitHelp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemExitHelpMessage", "wSystem.ExitHelp" );
      nOptRC = wSystem.ExitHelp( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSystemExitHelpMessage" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemExitHelpMessage.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemExitHelpMessage.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ExitHelpMessage", "" );
   }
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSystem", "ExitHelpMessage" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSystemExitHelpMessage" );
