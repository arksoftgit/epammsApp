...
if ( strLastWindow.equals("wStartUpAdminDeleteSubregUser") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminDeleteSubregUser strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminDeleteSubregUser LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminDeleteSubregUser LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminConfirmDeleteSubregUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregUser", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.DeleteSubregUser" );
      try
      {
         nOptRC = wStartUp.DeleteSubregUser( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelDeleteSubregUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminConfirmDeleteSubregUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminCancelDeleteSubregUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeleteSubregUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeleteSubregUser.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminDeleteSubregUser" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminDeleteSubregUser.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminDeleteSubregUser.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminDeleteSubregUser" );
   }
...
<title>Delete Subregistrant User</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminDeleteSubregUser.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminConfirmDeleteSubregUser( )">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminCancelDeleteSubregUser( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminDeleteSubregUser" id="wStartUpAdminDeleteSubregUser" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminDeleteSubregUser" );
...
<div id="User" name="User" class="noborder" style="width:682px;height:140px;float:left;">  <!-- User --> 

<div  id="User" name="User" >Subregistrant User</div>
...
<span  id="SubregistrantName:" name="SubregistrantName:" style="width:154px;height:16px;">Subregistrant Name:</span>
...
<% strTextDisplayValue = "";
   ...
   {
      nRC = mCurrentUser.cursor( "Subregistrant" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mCurrentUser.cursor( "Subregistrant" ).getStringFromAttribute( "dSubregistrantNameID", "" );
      }
      catch (Exception e)
      {
...
<span class="text10"  id="UserName:" name="UserName:" style="width:154px;height:16px;">User Name:</span>
...
<span class="text10"  id="Text7" name="Text7" style="width:416px;height:16px;">Are you sure you want to delete this User?</span>
