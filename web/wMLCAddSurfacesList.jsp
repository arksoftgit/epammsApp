      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "EPA_Surface" ).setAttribute( "wkSelected", strMapValue );
               else
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAddSurfacesStmts" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCAddSurfacesList" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCAddSurfacesList.jsp";
