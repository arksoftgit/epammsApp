...
<%
   ...
   {
%>
       <li><a href="#"  onclick="ConfirmAddSelectedSurfacesStmts( )">Add Selected Surfaces</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="ConfirmAddSurfacesStmtsAndReturn( )">Add and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelAddSurfacesStmts( )">Cancel and Return</a></li>
<%
   }
%>
