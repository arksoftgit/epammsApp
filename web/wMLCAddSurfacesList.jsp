...
<%-- wMLCAddSurfacesList   Generate Timestamp: 20160406142139090 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAddSurfacesStmts" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddSurfacesList", "wMLC.CancelAddSurfacesStmts" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmAddSelectedSurfacesStmts" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddSurfacesList", "wMLC.ConfirmAddSurfacesStmts" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddSurfacesList", "wMLC.InitSurfacesStmtsForInsert" );
