      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "Organization" ).setAttribute( "Name", strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "Organization" ).setAttribute( "Description", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PrimaryRegistrant" ).setAttribute( "EPA_CompanyNumber", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "Organization" ).setAttribute( "Role", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "Organization" ).setAttribute( "LoginName", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PhysicalAddress" ).setAttribute( "Address", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PhysicalAddress" ).setAttribute( "AddressLine2", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PhysicalAddress" ).setAttribute( "City", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PhysicalAddress" ).setAttribute( "State", strMapValue, "States - Full Name" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PhysicalAddress" ).setAttribute( "ZipCode", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "PhysicalAddress" ).setAttribute( "TollFreePhone", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "MailingAddress" ).setAttribute( "Address", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "MailingAddress" ).setAttribute( "AddressLine2", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "MailingAddress" ).setAttribute( "City", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "MailingAddress" ).setAttribute( "State", strMapValue, "States - Full Name" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "MailingAddress" ).setAttribute( "ZipCode", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "ContactPerson" ).setAttribute( "FirstName", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "ContactPerson" ).setAttribute( "LastName", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "ContactPerson" ).setAttribute( "Title", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "ContactPerson" ).setAttribute( "WorkPhone", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "ContactPerson" ).setAttribute( "Fax", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mPrimReg.cursor( "ContactPerson" ).setAttribute( "EmailAddress", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wStartUpAdminNewPrimaryRegistrant") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminNewPrimaryRegistrant strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminNewPrimaryRegistrant LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminNewPrimaryRegistrant LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminAcceptNewPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimaryRegistrant", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.AcceptNewPrimaryRegistrant" );
      try
      {
         nOptRC = wStartUp.AcceptNewPrimaryRegistrant( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation AcceptNewPrimaryRegistrant: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelNewPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimaryRegistrant", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.CancelNewPrimaryRegistrant" );
      try
      {
         nOptRC = wStartUp.CancelNewPrimaryRegistrant( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelNewPrimaryRegistrant: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminAcceptNewPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimaryRegistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminCancelNewPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimaryRegistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminNewPrimaryRegistrant" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminNewPrimaryRegistrant.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminNewPrimaryRegistrant.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimaryRegistrant.jsp", "wStartUp.AddNewPrimaryRegistrant" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wStartUpAdminNewPrimaryRegistrant.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "AddNewPrimaryRegistrant";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminNewPrimaryRegistrant" );
   }
...
<title>New Primary Registrant</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminNewPrimaryRegistrant.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminAcceptNewPrimReg( )">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminCancelNewPrimReg( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminNewPrimaryRegistrant" id="wStartUpAdminNewPrimaryRegistrant" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminNewPrimaryRegistrant" );
...
<div id="GBPrimaryRegistrant" name="GBPrimaryRegistrant" style="width:586px;height:146px;float:left;">  <!-- GBPrimaryRegistrant --> 
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "Organization" ).getStringFromAttribute( "Name", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "Organization" ).getStringFromAttribute( "Description", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "PrimaryRegistrant" ).getStringFromAttribute( "EPA_CompanyNumber", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on EPA_ID: " + e.getMessage());
               task.log().info( "*** Error on ctrl EPA_ID" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<%
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mPrimReg.cursor( "Organization" ).getStringFromAttribute( "Role", "" );
...
<div style="height:1px;width:26px;float:left;"></div>   <!-- Width Spacer -->
<% /* GroupBox12:GroupBox */ %>
<div id="GroupBox12" name="GroupBox12" style="float:left;width:546px;" >
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "PhysicalAddress" ).getStringFromAttribute( "Address", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "Entity does not exist: " + "mPrimReg.PhysicalAddress" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "PhysicalAddress" ).getStringFromAttribute( "AddressLine2", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "PhysicalAddress" ).getStringFromAttribute( "City", "" );
            }
            catch (Exception e)
            {
...
<%
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mPrimReg.cursor( "PhysicalAddress" ).getStringFromAttribute( "State", "States - Full Name" );
         if ( strComboCurrentValue == null )
            strComboCurrentValue = "";
      }
      else
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "PhysicalAddress" ).getStringFromAttribute( "ZipCode", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "PhysicalAddress" ).getStringFromAttribute( "TollFreePhone", "" );
            }
            catch (Exception e)
            {
...
<div id="GroupBox13" name="GroupBox13" style="width:248px;height:26px;float:left;">  <!-- GroupBox13 --> 
...
<span  id="Text2" name="Text2" style="width:196px;height:18px;">Same As Physical Address</span>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "MailingAddress" ).getStringFromAttribute( "Address", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "Entity does not exist: " + "mPrimReg.MailingAddress" );
      }
   }
%>
...
<td valign="top" style="width:154px;">
<% /* GroupBox6:GroupBox */ %>
<div id="GroupBox6" name="GroupBox6" style="width:118px;height:16px;float:left;">
</div>  <!-- GroupBox6 --> 
</td>
<td valign="top" style="width:350px;">
<% /* EBAddress:EditBox */ %>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "MailingAddress" ).getStringFromAttribute( "AddressLine2", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "MailingAddress" ).getStringFromAttribute( "City", "" );
            }
            catch (Exception e)
            {
...
<% /* GroupBox14:GroupBox */ %>
<div id="GroupBox14" name="GroupBox14" style="float:left;width:310px;" >
...
<%
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mPrimReg.cursor( "MailingAddress" ).getStringFromAttribute( "State", "States - Full Name" );
         if ( strComboCurrentValue == null )
            strComboCurrentValue = "";
      }
      else
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "MailingAddress" ).getStringFromAttribute( "ZipCode", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "ContactPerson" ).getStringFromAttribute( "FirstName", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "Entity does not exist: " + "mPrimReg.ContactPerson" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "ContactPerson" ).getStringFromAttribute( "LastName", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "ContactPerson" ).getStringFromAttribute( "Title", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "ContactPerson" ).getStringFromAttribute( "WorkPhone", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "ContactPerson" ).getStringFromAttribute( "Fax", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mPrimReg.cursor( "ContactPerson" ).getStringFromAttribute( "EmailAddress", "" );
            }
            catch (Exception e)
            {
...
<div id="GroupBox11" name="GroupBox11" style="width:16px;height:26px;float:left;">  <!-- GroupBox11 --> 
