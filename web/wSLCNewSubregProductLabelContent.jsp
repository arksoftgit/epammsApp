...
<%-- wSLCNewSubregProductLabelContent --%>
...
if ( strLastWindow.equals("wSLCNewSubregProductLabelContent") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSLC.SaveFeedback( "mOrganiz", "wSLC", "NewSubregProductLabelContent", strFeedback );
      }
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCNewSubregProductLabelContent", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wSLC.GenerateNewSLC_FromMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewProductLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wSLC.CancelNewProductLabelContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGenerateNewSLC_FromMLC" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCNewSubregProductLabelContent", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.ProcessLogin" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wStartUp.Template" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().debug( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCNewSubregProductLabelContent" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCNewSubregProductLabelContent.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProductLabelContent.jsp", "wSLC.InitProductLabelContentForInsert" );
   nOptRC = wSLC.InitProductLabelContentForInsert( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCNewSubregProductLabelContent.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
                         "&OperationName=" + "InitProductLabelContentForInsert";
...
if ( VmlOperation.isValid( wWebXA ) )
{
   ...
   wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewSubregProductLabelContent" );
}
...
<title>New Subregistrant Product Label Content</title>
...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSLCNewSubregProductLabelContent.zAction.value = "_OnResubmitPage";
         document.wSLCNewSubregProductLabelContent.submit( );
      }
      else
      {
         _OnTimeout( );
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "_OnTimeout";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSLCNewSubregProductLabelContent.zAction.value = "_OnUnload";
         document.wSLCNewSubregProductLabelContent.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSLCNewSubregProductLabelContent.zFocusCtrl.value;
   if ( szFocusCtrl != "" )
      eval( 'document.wSLCNewSubregProductLabelContent.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSLCNewSubregProductLabelContent.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSLCNewSubregProductLabelContent.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var keyRole = document.wSLCNewSubregProductLabelContent.zKeyRole.value;
...
// if ( keyRole == "S" ) // If we are here, we have to be a Subregistrant.
   ...
   document.wSLCNewSubregProductLabelContent.zError.value = "";
   document.wSLCNewSubregProductLabelContent.zOpenFile.value = "";
   ...
   var varTimeout = document.wSLCNewSubregProductLabelContent.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function GenerateNewSLC_FromMLC( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "GenerateNewSLC_FromMLC";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function CancelNewProductLabelContent( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "CancelNewProductLabelContent";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}

function InitProductLabelContentForInsert( )
{
...
function smGenerateNewSLC_FromMLC( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "smGenerateNewSLC_FromMLC";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function smCancelNewProductLabelContent( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "smCancelNewProductLabelContent";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mProductManagement";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mSubregistrants";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mTrackingNotificationCompliance";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mStateRegistrations";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mMarketingFulfillment";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mWebDevelopment";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mAdministration";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mLogin";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewSubregProductLabelContent.zAction.value = "mTemplate";
      document.wSLCNewSubregProductLabelContent.submit( );
   }
}
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smGenerateNewSLC_FromMLC( )">Save and Return</a></li>
<%
   }
%>
...
<form name="wSLCNewSubregProductLabelContent" id="wSLCNewSubregProductLabelContent" method="post">
...
<%
   ...
   //strFocusCtrl = task.GetFocusCtrl("wSLC", "NewSubregProductLabelContent" );
...
<div id="SubregistrantProduct" name="SubregistrantProduct" style="float:left;width:730px;"  class="withborder">
...
<td valign="top"  class="text14bold" style="width:530px;">
<% /* TXName:Text */ %>
<% strTextDisplayValue = "";
   mSubProd = task.getViewByName( "mSubProd" );
...
<div id="ProductLabelContent" name="ProductLabelContent" style="float:left;width:730px;"  class="withborder">
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCNewSubregProductLabelContent" );
