...
<%-- wSystemSystemMenu   Generate Timestamp: 20160406142159543 --%>
...
if ( strLastWindow.equals("wSystemSystemMenu") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemSystemMenu strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemSystemMenu LastWindow *** " + strLastWindow );
task.log().info("*** wSystemSystemMenu LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ShowFeedback" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemSystemMenu", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "System" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemSystemMenu", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSystemSystemMenu" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemSystemMenu.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemSystemMenu.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<%
   ...
   {
%>
       <li id="Login" name="Login"><a href="#"  onclick="Login()">Login</a></li>
<%
   }
%>
...
<form name="wSystemSystemMenu" id="wSystemSystemMenu" method="post">
