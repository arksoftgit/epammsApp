...
<%-- wStartUpChangeSubregUserPassword --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangeSubregUserPassword.jsp", "wStartUp.Template" );
      try
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ChangeSubregUserPassword" );
   }
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelChangeSubregUserPass( )">Cancel Password and Return</a></li>
<%
   }
%>
