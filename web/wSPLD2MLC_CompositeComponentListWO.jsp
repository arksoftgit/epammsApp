...
<%-- wSPLD2MLC_CompositeComponentListWO --%>
...
if ( strLastWindow.equals("wSPLD2MLC_CompositeComponentListWO") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2MLC_CompositeComponentListWO strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2MLC_CompositeComponentListWO LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2MLC_CompositeComponentListWO LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2MLC_CompositeComponentListWO", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wSPLD2.CancelMasterLabelContent" );
      try
      {
         nOptRC = wSPLD2.CancelMasterLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "COMMIT_MC_ToFile" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2MLC_CompositeComponentListWO", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wSPLD2.COMMIT_MC_ToFile" );
      try
      {
         nOptRC = wSPLD2.COMMIT_MC_ToFile( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation COMMIT_MC_ToFile: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateComponent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wSPLD2.GOTO_UpdateMLC_Component" );
      try
      {
         nOptRC = wSPLD2.GOTO_UpdateMLC_Component( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_UpdateMLC_Component: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD2", "MLC_CompositeComponentUpdate" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wSPLD2.SaveMasterLabelContent" );
      try
      {
         nOptRC = wSPLD2.SaveMasterLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMasterLabelVersionData" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditMasterLabelVersionData" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "VersionData" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditIngredientsSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditIngredientsSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "Ingredients" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditStorDispSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditStorDispSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "StorageDisposal" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHumanHazardSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditHumanHazardSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "HumanHazard" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditPrecautionarySect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "Precautionary" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditFirstAidSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "FirstAid" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditHazardSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "Hazard" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditClaimsSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "OrganismClaims" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditSurfacesSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "Surfaces" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditAreasOfUseSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "AreasOfUse" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAppTypesSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditAppTypesSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "AppTypes" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditDirectionsUseSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditDirectionsUseSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "DirectionsForUse" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMarketingSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.EditMarketingSect" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "Marketing" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_ListUsageEntries" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wMLC", "UsageList" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_CompositeEntries" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.GOTO_CompositeEntries" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wSPLD2", "MLC_CompositeComponentList" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_CompositeWO_Usage" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wMLC.GOTO_CompositeWO_Usage" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wSPLD2", "MLC_CompositeComponentListWO" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.ProductManagement" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartTopWindow, "wStartUp", "AdminListPrimaryRegistrants" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartTopWindow, "wStartUp", "AdminListSubregistrants" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartTopWindow, "", "" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartTopWindow, "wStartUp", "AdminUpdatePrimaryRegistrant" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentListWO.jsp", "wStartUp.ProcessLogin" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ResetTopWindow, "wStartUp", "UserLogin" );
      }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2MLC_CompositeComponentListWO" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2MLC_CompositeComponentListWO.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "MLC_CompositeComponentListWO" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2MLC_CompositeComponentListWO.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#" class="sideselected"  onclick="smGOTO_CompositeWO_Usage( )">Composites w/o Usage</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="COMMIT_MC_ToFile( )">Write to File</a></li>
<%
   }
%>
...
<form name="wSPLD2MLC_CompositeComponentListWO" id="wSPLD2MLC_CompositeComponentListWO" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "MLC_CompositeComponentListWO" );
...
<span class="groupbox"  id="AddAppTypesList1" name="AddAppTypesList1" style="width:352px;height:16px;">Composite List of All Components without Usage Entries</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2MLC_CompositeComponentListWO" );
