...
if ( strLastWindow.equals("wMLC2DirsForUseSelectByType") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2DirsForUseSelectByType strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2DirsForUseSelectByType LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2DirsForUseSelectByType LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2DirsForUseSelectByType", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseSelectByType.jsp", "wMLC2.CLEAR_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseSelectByType.jsp", "wMLC2.CLEAR_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "RemoveMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseSelectByType.jsp", "wMLC2.RemoveMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseSelectByType.jsp", "wMLC2.SelectMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseSelectByType.jsp", "wMLC2.SETALL_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseSelectByType.jsp", "wMLC2.SETALL_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2DirsForUseSelectByType" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2DirsForUseSelectByType.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2DirsForUseSelectByType.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<title>Directions for Use Usage Select</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2DirsForUseSelectByType.js"></script>
...
<form name="wMLC2DirsForUseSelectByType" id="wMLC2DirsForUseSelectByType" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "DirsForUseSelectByType" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2DirsForUseSelectByType" );
