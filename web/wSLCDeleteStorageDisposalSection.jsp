...
if ( strLastWindow.equals("wSLCDeleteStorageDisposalSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCDeleteStorageDisposalSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCDeleteStorageDisposalSection LastWindow *** " + strLastWindow );
task.log().info("*** wSLCDeleteStorageDisposalSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.CancelDeleteStorDispSect" );
      try
      {
         nOptRC = wSLC.CancelDeleteStorDispSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.ConfirmDeleteStorDispSect" );
      try
      {
         nOptRC = wSLC.ConfirmDeleteStorDispSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.SelectStorDispStmtForDelete" );
      try
      {
         nOptRC = wSLC.SelectStorDispStmtForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "DeleteStorDispStatemen" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveStorDispStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.MoveStorDispStmtDown" );
      try
      {
         nOptRC = wSLC.MoveStorDispStmtDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveStorDispStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.MoveStorDispStmtUp" );
      try
      {
         nOptRC = wSLC.MoveStorDispStmtUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitStorDispStmtForInsert" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.InitStorDispStmtForInsert" );
      try
      {
         nOptRC = wSLC.InitStorDispStmtForInsert( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "StorDispStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.SelectStorDispStmtForUpdate" );
      try
      {
         nOptRC = wSLC.SelectStorDispStmtForUpdate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCDeleteStorageDisposalSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCDeleteStorageDisposalSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCDeleteStorageDisposalSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteStorageDisposalSection.jsp", "wSLC.InitStorDispSectForDelete" );
   nOptRC = wSLC.InitStorDispSectForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCDeleteStorageDisposalSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCDeleteStorageDisposalSection.js"></script>
...
<form name="wSLCDeleteStorageDisposalSection" id="wSLCDeleteStorageDisposalSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "DeleteStorageDisposalSection" );
...
<div id="StorDispSection" name="StorDispSection" class="withborder" style="width:732px;height:126px;float:left;">  <!-- StorDispSection --> 

<div  id="StorDispSection" name="StorDispSection" >Storage and Disposal Section</div>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSubLC.cursor( "S_StorageDisposalSection" ).getStringFromAttribute( "Title", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_StorageDisposalSection.Title: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSubLC.S_StorageDisposalSection" );
      }
   }
%>

<input name="StorDispTitle" id="StorDispTitle"  disabled style="width:474px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* BoldItalic:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="BoldItalic" id="BoldItalic" size="1" style="width:94px;"  disabled onchange="BoldItalicOnChange( )">

<%
   mSubLC = task.getViewByName( "mSubLC" );
   if ( VmlOperation.isValid( mSubLC ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSubLC , "S_StorageDisposalSection", "BoldItalic", "" );

      nRC = mSubLC.cursor( "S_StorageDisposalSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSubLC.cursor( "S_StorageDisposalSection" ).getStringFromAttribute( "BoldItalic", "" );
...
<input name="hBoldItalic" id="hBoldItalic" type="hidden" value="<%=strComboCurrentValue%>" >
</div>  <!-- End of a new line -->
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSubLC.cursor( "S_StorageDisposalSection" ).getStringFromAttribute( "ContainerVolume", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "S_StorageDisposalSection.ContainerVolume: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSubLC.S_StorageDisposalSection" );
      }
...
<% strTextDisplayValue = "";
   ...
   if ( VmlOperation.isValid( wWebXfer ) == false )
      task.log( ).debug( "Invalid View: " + "VolumeUnits" );
   else
   {
      ...
      try
      {
         strTextDisplayValue = wWebXfer.cursor( "Root" ).getStringFromAttribute( "Units", "" );
      }
      catch (Exception e)
      {
         out.println("There is an error on VolumeUnits: " + e.getMessage());
         task.log().info( "*** Error on ctrl VolumeUnits" + e.getMessage() );
      }
...
<span  id="VolumeUnits" name="VolumeUnits" style="width:144px;height:16px;"><%=strTextDisplayValue%></span>
...
<select  name="NoteBoldItalic" id="NoteBoldItalic" size="1" style="width:94px;"  disabled onchange="NoteBoldItalicOnChange( )">

<%
   mSubLC = task.getViewByName( "mSubLC" );
   if ( VmlOperation.isValid( mSubLC ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSubLC , "S_StorageDisposalSection", "NoteBoldItalic", "" );

      nRC = mSubLC.cursor( "S_StorageDisposalSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSubLC.cursor( "S_StorageDisposalSection" ).getStringFromAttribute( "NoteBoldItalic", "" );
         if ( strComboCurrentValue == null )
            strComboCurrentValue = "";
      }
      else
...
<input name="hNoteBoldItalic" id="hNoteBoldItalic" type="hidden" value="<%=strComboCurrentValue%>" >
</div>  <!-- End of a new line -->
...
<div id="StorDispStatements" name="StorDispStatements" class="withborder" style="width:732px;height:422px;float:left;">  <!-- StorDispStatements --> 
...
<div class="tableScroll"  style="height:382px;">

<table name="GridStorageDisposal" id="GridStorageDisposal" cellspacing=0  cols=5  >
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      vGridStorageDisposal = mSubLC.newView( );
      csrRC2 = vGridStorageDisposal.cursor( "S_StorageDisposalStatement" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridStorageDisposal.cursor( "S_StorageDisposalStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strSelect = "";
         nRC = vGridStorageDisposal.cursor( "S_StorageDisposalStatement" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strSelect = vGridStorageDisposal.cursor( "S_StorageDisposalStatement" ).getStringFromAttribute( "Selected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditStorageDisposal = vGridStorageDisposal.cursor( "S_StorageDisposalStatement" ).getStringFromAttribute( "Text", "" );
...
<%
         csrRC2 = vGridStorageDisposal.cursor( "S_StorageDisposalStatement" ).setNextContinue( );
      }
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCDeleteStorageDisposalSection" );
