...
<%
   ...
   {
%>
       <li id="smAreasOfUse" name="smAreasOfUse"><a href="#"  class="sideselected"  onclick="smDisplayAreasOfUseSection()">Areas of Use</a></li>
<%
   }
%>
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSLCAreasOfUse" );
