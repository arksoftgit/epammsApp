...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ChangePrimRegPassword" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wStartUpChangePrimRegPassword.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wStartUpAdminPrimaryRegistrantDetail" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMasterProductForDelete" ) )
   {
      ...
      if ( VmlOperation.isValid( mPrimReg ) )
      {
         ...
         if ( !csrRC.isSet() )
         {
            ...
            csrRCk = mPrimReg.cursor( "MasterProduct" ).setFirst("PrimaryRegistrant" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnFromAdminPrimReg" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wStartUpAdminPrimaryRegistrantDetail.jsp";
