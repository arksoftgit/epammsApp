...
<%-- wStartUpAdminPrimaryRegistrantDetail --%>
                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      csrRC = vGridTmp.cursor( "MasterProduct" ).setFirst( "PrimaryRegistrant" );
      while ( csrRC.isSet() )
      {
...
if ( strLastWindow.equals("wStartUpAdminPrimaryRegistrantDetail") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminPrimaryRegistrantDetail strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminPrimaryRegistrantDetail LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminPrimaryRegistrantDetail LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMasterProductForDelete" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
      ...
      {
         strVMLError = "<br><br>*** Error running Operation SelectSubregProductForDelete: " + e.getMessage();
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wMLC", "DeleteMasterProduct" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewMasterProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
      ...
      {
         strVMLError = "<br><br>*** Error running Operation AddNewMasterProduct: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wMLC", "NewMasterProduct" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMasterProductForUpdate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
      ...
      {
         strVMLError = "<br><br>*** Error running Operation SelectSubregProductForUpdate: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wMLC", "UpdateMasterProduct" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminListPrimRegUsers" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
      ...
      {
         strVMLError = "<br><br>*** Error running Operation SelectListPrimRegUser: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wStartUp", "AdminListPrimRegUsers" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminListSubregistrants" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
      ...
      {
         strVMLError = "<br><br>*** Error running Operation SelectListSubregistrants: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wStartUp", "AdminListSubregistrants" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnFromAdminPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
      ...
      {
         strVMLError = "<br><br>*** Error running Operation ReturnFromAdminPrimaryRegistrant: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminListPrimRegUsers" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminListSubregistrants" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smReturnFromAdminPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminPrimaryRegistrantDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminPrimaryRegistrantDetail.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminPrimaryRegistrantDetail" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminPrimaryRegistrantDetail.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminPrimaryRegistrantDetail.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wStartUpAdminPrimaryRegistrantDetail.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitPrimaryRegistrant";
...
<title>Primary Registrant</title>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ListPrimRegUsers" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smAdminListPrimRegUsers( )">Company Users</a></li>
<%
   }
%>

<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ListSubregistrants" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smAdminListSubregistrants( )">Company Subregistrants</a></li>
<%
   }
%>

<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ChangePrimRegPassword" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnFromAdminPrimReg( )">Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminPrimaryRegistrantDetail" id="wStartUpAdminPrimaryRegistrantDetail" method="post">
...
<div id="PrimaryRegistrant" name="PrimaryRegistrant" class="withborder" style="width:896px;height:574px;float:left;">  <!-- PrimaryRegistrant --> 
...
<span  id="LoginName:" name="LoginName:" style="width:140px;height:16px;">Login Name:</span>
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl LoginName" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<div id="MasterProducts" name="MasterProducts" class="withborder" style="width:866px;height:482px;float:left;">  <!-- MasterProducts --> 
...
<div>  <!-- Beginning of a new line -->
<span style="height:28px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl MoveIncrement" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<table  cols=6 style=""  name="GridPrimaryRegistrant" id="GridPrimaryRegistrant">
...
try
{
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      String strOdd;
      String strTag;
      String strGEProductName;
      String strGridDescription;
      ...
      csrRC2 = vGridPrimaryRegistrant.cursor( "MasterProduct" ).setFirst( "PrimaryRegistrant" );
      while ( csrRC2.isSet() )
      {
         ...
         if ( StringUtils.isBlank( strGEProductName ) )
            strGEProductName = "&nbsp";
         ...
         if ( StringUtils.isBlank( strGridDescription ) )
            strGridDescription = "&nbsp";
...
<%
         csrRC2 = vGridPrimaryRegistrant.cursor( "MasterProduct" ).setNextContinue( );
      }
