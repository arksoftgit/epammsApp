                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      {
         nRC = lTemplLST.cursor( "Template" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            ...
            nRelPos--;    // For Auto Include combos, we need to decrement for the blank entry.
               lTemplLST.cursor( "Template" ).setPosition( nRelPos, "" );
            }
         ...
         {
            nRC = mSPLDef.cursor( "SelectedTemplate" ).checkExistenceOfEntity( ).toInt();
            if ( nRC >= 0 )
            {
               // Only do the automatic include if this is a different entity
               strTemp = mSPLDef.cursor( "SelectedTemplate" ).getStringFromAttribute( "Name" );
               if ( !StringUtils.equals( strTemp, lTemplLST.cursor( "Template" ).getStringFromAttribute( "Name" ))) 
               {
                  mSPLDef.cursor( "SelectedTemplate" ).excludeEntity( CursorPosition.NONE );
                  mSPLDef.cursor( "SelectedTemplate" ).includeSubobject( lTemplLST.cursor( "Template" ), CursorPosition.NEXT );
               }
            }
            else
                  mSPLDef.cursor( "SelectedTemplate" ).includeSubobject( lTemplLST.cursor( "Template" ), CursorPosition.NEXT );
...
if ( strLastWindow.equals("wSPLDReselectTemplate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDReselectTemplate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDReselectTemplate LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDReselectTemplate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CreateSPLD" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDReselectTemplate", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wSPLD.CreateSPLD" );
      try
      {
         nOptRC = wSPLD.CreateSPLD( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation CreateSPLD: " + e.getMessage();
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDReselectTemplate" );
         }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelReselectTemplate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDReselectTemplate", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wSPLD.CancelReselectTemplate" );
      try
      {
         nOptRC = wSPLD.CancelReselectTemplate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation CancelReselectTemplate: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDReselectTemplate.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReselectTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wSPLD.ReselectTemplate" );
      try
      {
         nOptRC = wSPLD.ReselectTemplate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ReselectTemplate: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelReselectTemplate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDReselectTemplate", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDReselectTemplate" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDReselectTemplate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDReselectTemplate.jsp", "wSPLD.InitReselectTemplate" );
   nOptRC = wSPLD.InitReselectTemplate( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLDReselectTemplate.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD" +
                         "&OperationName=" + "InitReselectTemplate";
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDReselectTemplate.js"></script>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "Regenerate" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smReselectTemplate( )">Regenerate</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelReselectTemplate( )">Return</a></li>
<%
   }
%>
...
<form name="wSPLDReselectTemplate" id="wSPLDReselectTemplate" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "ReselectTemplate" );
...
<span  id="Text3" name="Text3" style="width:114px;height:16px;">Select Template:</span>

<span style="height:276px;">&nbsp&nbsp</span>
<% /* ComboBox2:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="ComboBox2" id="ComboBox2" size="1"style="width:370px;" onchange="ComboBox2OnChange( )">
...
<%
   ...
   if ( VmlOperation.isValid( lTemplLST ) )
   {
      ...
      if ( VmlOperation.isValid( mSPLDef ) )
      {
         ...
         if ( nRC >= 0 )
         {
            strComboCurrentValue = mSPLDef.cursor( "SelectedTemplate" ).getStringFromAttribute( "Name", "" );
            if ( strComboCurrentValue == null )
               strComboCurrentValue = "";
         }
      }
      vComboBox2 = lTemplLST.newView( );
      ComboCount = 0;
      strComboSelectedValue = "0";

      // For Auto Include, process null entry.
      ComboCount++;
...
<%
      ...
      csrRC = vComboBox2.cursor( "Template" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         strErrorMapValue = vComboBox2.cursor( "Template" ).getStringFromAttribute( "Name", "" );
...
<%
         ...
         ComboCount++;
         csrRC =  vComboBox2.cursor( "Template" ).setNextContinue( );
      }
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDReselectTemplate" );
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDReselectTemplate" );
