      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "MasterLabelContent" ).setAttribute( "wSelected", strMapValue );
               else
                  vGridTmp.cursor( "MasterLabelContent" ).setAttribute( "wSelected", "" );
         }
...
if ( strLastWindow.equals("wSPLD2NewSLC_SelectMLC") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2NewSLC_SelectMLC strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2NewSLC_SelectMLC LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2NewSLC_SelectMLC LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2NewSLC_SelectMLC", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2NewSLC_SelectMLC.jsp", "wSPLD2.SELECT_MLC_ForNewSLC" );
      try
      {
         nOptRC = wSPLD2.SELECT_MLC_ForNewSLC( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SELECT_MLC_ForNewSLC: " + e.getMessage();
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_ReplaceWindowWithModalWindow, "wSPLD2", "SLC_ComponentsUpdate" );
      }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2NewSLC_SelectMLC" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2NewSLC_SelectMLC.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2NewSLC_SelectMLC.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewSLC_SelectMLC" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2NewSLC_SelectMLC.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="SELECT_MLC_ForNewSLC( )">Select</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CANCEL_SelectMLC( )">Cancel</a></li>
<%
   }
%>
...
<form name="wSPLD2NewSLC_SelectMLC" id="wSPLD2NewSLC_SelectMLC" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "NewSLC_SelectMLC" );
...
try
{
   ...
   if ( VmlOperation.isValid( lMLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridCheckCtl3 = vGrid2.cursor( "MasterLabelContent" ).getStringFromAttribute( "wSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl3 = vGrid2.cursor( "MasterProduct" ).getStringFromAttribute( "Name", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGrid2.cursor( "MasterLabelContent" ).getStringFromAttribute( "Version", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2NewSLC_SelectMLC" );
