...
if ( strLastWindow.equals("wSLC2MarketingStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLC2MarketingStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLC2MarketingStatement LastWindow *** " + strLastWindow );
task.log().info("*** wSLC2MarketingStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLC2MarketingStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_SelectRemoveMktgEntries" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSLC2.SetWebRedirection( vKZXMLPGO, wSLC2.zWAB_StartModalSubwindow, "wSLC2", "MarketingUsageSelect" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLC2MarketingStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLC2MarketingStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLC2MarketingStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLC2MarketingStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptMarketingStatement( )">Accept & Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelMarketingStatement( )">Cancel & Return</a></li>
<%
   }
%>
...
<form name="wSLC2MarketingStatement" id="wSLC2MarketingStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC2", "MarketingStatement" );
...
<span class="listheader"  id="Text5" name="Text5" style="width:434px;height:16px;">Marketing Statement</span>
...
<% /* PushBtn3:PushBtn */ %>
<button type="button" class="newbutton" name="PushBtn3" id="PushBtn3" value="" onclick="GOTO_SelectRemoveMktgEntries( )" style="width:118px;height:26px;position:absolute;left:560px;top:4px;">Select/Remove</button>
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl4 = vGrid4.cursor( "S_MarketingUsage" ).getStringFromAttribute( "UsageType", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSLC2MarketingStatement" );
