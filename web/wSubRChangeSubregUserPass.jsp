...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass.jsp", "wStartUp.Template" );
      try
      {
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass.jsp", "wSubR.InitChangeSubregUserPassword" );
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ChangeSubregUserPass" );
   }
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmChangeSubregUserPass( )">Change Password and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelChangeSubregUserPass( )">Cancel Change and Return</a></li>
<%
   }
%>
