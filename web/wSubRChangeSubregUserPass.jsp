...
<%-- wSubRChangeSubregUserPass   Generate Timestamp: 20160427103758227 --%>
...
if ( strLastWindow.equals("wSubRChangeSubregUserPass") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSubRChangeSubregUserPass strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSubRChangeSubregUserPass LastWindow *** " + strLastWindow );
task.log().info("*** wSubRChangeSubregUserPass LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSubRChangeSubregUserPass", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wSubR.CancelChangeSubregUserPassword" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmChangeSubregUserPass" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wSubR.ConfirmChangeSubregUserPassword" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wStartUp.GOTO_UserList" );
      ...
      {
         // Next Window
         strNextJSP_Name = wSubR.SetWebRedirection( vKZXMLPGO, wSubR.zWAB_StayOnWindowWithRefresh, "", "" );
      }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSubRChangeSubregUserPass.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSubRChangeSubregUserPass.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRChangeSubregUserPass", "wSubR.InitChangeSubregUserPassword" );
   nOptRC = wSubR.InitChangeSubregUserPassword( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSubRChangeSubregUserPass.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSubR" +
                         "&OperationName=" + "InitChangeSubregUserPassword";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ChangeSubregUserPass", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSubRChangeSubregUserPass.js"></script>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ChangeAndReturn" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li id="smChangeAndReturn" name="smChangeAndReturn"><a href="#"  onclick="smConfirmChangeSubregUserPass()">Change Password and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelChangeSubregUserPass()">Cancel Change and Return</a></li>
<%
   }
%>
...
<form name="wSubRChangeSubregUserPass" id="wSubRChangeSubregUserPass" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSubR", "ChangeSubregUserPass" );
...
<% /* HTChangePassword:Text */ %>

<a href="#" id="HTChangePassword" name="HTChangePassword"  onclick="ConfirmChangeSubregUserPass( );" class="mylegend" style="width:602px;height:16px;">Subregistrant >> User >></a>
...
<div id="GroupBox" name="GroupBox" style="width:598px;height:226px;float:left;">  <!-- GroupBox --> 
...
<span class="text10bold"  id="RegistrantName:" name="RegistrantName:" style="width:142px;height:16px;">Registrant Name:</span>
...
<% strTextDisplayValue = "";
   ...
   if ( VmlOperation.isValid( mSubreg ) == false )
      task.log( ).debug( "Invalid View: " + "RegistrantName" );
   else
   {
      ...
      {
         out.println("There is an error on RegistrantName: " + e.getMessage());
         task.log().info( "*** Error on ctrl RegistrantName" + e.getMessage() );
      }
...
<span class="text10"  id="RegistrantName" name="RegistrantName" style="width:418px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="UserName" name="UserName" style="width:418px;height:16px;"><%=strTextDisplayValue%></span>
...
<input class="text10" name="Password" id="Password" maxlength="254" style="width:418px;<%=strErrorColor%>" type="password" value="<%=strErrorMapValue%>" onKeyPress="return _OnEnter( event )" >
...
<input class="text10" name="NewPassword" id="NewPassword" maxlength="254" style="width:418px;<%=strErrorColor%>" type="password" value="<%=strErrorMapValue%>" onKeyPress="return _OnEnter( event )" >
...
<input class="text10" name="ConfirmPassword" id="ConfirmPassword" maxlength="254" style="width:418px;<%=strErrorColor%>" type="password" value="<%=strErrorMapValue%>" onKeyPress="return _OnEnter( event )" >
