...
if ( strLastWindow.equals("wSystemSysDefaultDetail") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemSysDefaultDetail strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemSysDefaultDetail LastWindow *** " + strLastWindow );
task.log().info("*** wSystemSysDefaultDetail LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "SysDefaultDetail", strFeedback );
      }
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemSysDefaultDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "IncludeEmployee" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemSysDefaultDetail", strActionToProcess );
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation IncludeSysEmployee: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveSysDflt" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemSysDefaultDetail", strActionToProcess );
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SaveSysDflt: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemSysDefaultDetail" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemSysDefaultDetail.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemSysDefaultDetail.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSystemSysDefaultDetail.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitSysDefaultDetail";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SysDefaultDetail" );
   }
...
<title>Sys Default Detail</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSystemSysDefaultDetail.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnAction( )">Return</a></li>
<%
   }
%>
...
<form name="wSystemSysDefaultDetail" id="wSystemSysDefaultDetail" method="post">
...
<span class="text14"  id="Text9" name="Text9" style="width:356px;height:16px;">System > Sys Defaults > Detail</span>
...
<div id="GroupBox1" name="GroupBox1" class="noborder" style="width:306px;height:228px;float:left;">  <!-- GroupBox1 --> 
...
<span class="mylegend"  id="Text26" name="Text26" style="width:294px;height:16px;">Details</span>
...
<span class="text10"  id="Text2" name="Text2" style="width:218px;height:16px;">Name not updatable once saved</span>
...
<span class="text10"  id="Text3" name="Text3" style="width:94px;height:16px;">Account:</span>
...
<span class="text10"  id="Text5" name="Text5" style="width:94px;height:16px;">Budget Entity:</span>
...
<span class="text10"  id="Text6" name="Text6" style="width:94px;height:16px;">Employee:</span>

<% /* ComboBox3:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select class="text10" name="ComboBox3" id="ComboBox3" size="1"style="width:198px;" onblur="ComboBox3OnBlur( )">
...
<%
   ...
   if ( VmlOperation.isValid( mUser ) )
   {
      ...
      if ( VmlOperation.isValid( mUser ) )
      {
         ...
         if ( nRC >= 0 )
         {
            strComboCurrentValue = mUser.cursor( "User" ).getStringFromAttribute( "UserName", "" );
      ...
      while ( csrRC.isSet() )
      {
         strErrorMapValue = vComboBox3.cursor( "User" ).getStringFromAttribute( "SMTPServer", "" );
...
<%
         ...
         ComboCount++;
         csrRC =  vComboBox3.cursor( "User" ).setNextContinue( );
      }
...
<input name="hComboBox3" id="hComboBox3" type="hidden" value="<%=strComboSelectedValue%>" >
...
<span class="text10"  id="Text7" name="Text7" style="width:94px;height:16px;">Fund Type</span>
...
<div id="GroupBox4" name="GroupBox4" class="noborder" style="width:102px;height:228px;float:left;">  <!-- GroupBox4 --> 
...
<span class="mylegend"  id="Text15" name="Text15" style="width:94px;height:16px;">Actions</span>
...
<% /* PushBtn1:PushBtn */ %>
<button type="button" class="formStylebutton" name="PushBtn1" id="PushBtn1" value="" onclick="SaveSysDflt( )" style="width:82px;height:28px;">Save</button>
...
<span style="height:28px;">&nbsp</span>
<% /* PushBtn2:PushBtn */ %>
<button type="button" class="formStylebutton" name="PushBtn2" id="PushBtn2" value="" onclick="ESC( )" style="width:82px;height:28px;">Cancel</button>
