...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "RemoveMarketingUsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2MarketingUsageSelect", "wSLC2.RemoveMarketingUsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMarketingUsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2MarketingUsageSelect", "wSLC2.SelectMarketingUsageEntries" );
      try
      {
