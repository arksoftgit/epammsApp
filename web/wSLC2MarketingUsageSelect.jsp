      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "S_MarketingUsageOrdering" ).setAttribute( "wSelected", strMapValue );
               else
                  vGridTmp.cursor( "S_MarketingUsageOrdering" ).setAttribute( "wSelected", "" );
         }
      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "S_SelectableMarketingUsage" ).setAttribute( "wSelected", strMapValue );
               else
                  vGridTmp.cursor( "S_SelectableMarketingUsage" ).setAttribute( "wSelected", "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wSLC2MarketingUsageSelect") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLC2MarketingUsageSelect strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLC2MarketingUsageSelect LastWindow *** " + strLastWindow );
task.log().info("*** wSLC2MarketingUsageSelect LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLC2MarketingUsageSelect", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2MarketingUsageSelect.jsp", "wSLC2.RemoveMarketingUsageEntries" );
      try
      {
         nOptRC = wSLC2.RemoveMarketingUsageEntries( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation RemoveMarketingUsageEntries: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMarketingUsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2MarketingUsageSelect.jsp", "wSLC2.SelectMarketingUsageEntries" );
      try
      {
         nOptRC = wSLC2.SelectMarketingUsageEntries( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SelectMarketingUsageEntries: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLC2MarketingUsageSelect" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLC2MarketingUsageSelect.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLC2MarketingUsageSelect.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "MarketingUsageSelect" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLC2MarketingUsageSelect.js"></script>
...
<form name="wSLC2MarketingUsageSelect" id="wSLC2MarketingUsageSelect" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC2", "MarketingUsageSelect" );
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridCheckCtl2 = vGrid1.cursor( "S_MarketingUsageOrdering" ).getStringFromAttribute( "wSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl2 = vGrid1.cursor( "S_MarketingUsage" ).getStringFromAttribute( "dDisplayUsageName", "" );
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridCheckCtl1 = vGrid2.cursor( "S_SelectableMarketingUsage" ).getStringFromAttribute( "wSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGrid2.cursor( "S_SelectableMarketingUsage" ).getStringFromAttribute( "dDisplayUsageName", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSLC2MarketingUsageSelect" );
