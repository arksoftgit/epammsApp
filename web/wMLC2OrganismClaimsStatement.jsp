...
if ( strLastWindow.equals("wMLC2OrganismClaimsStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2OrganismClaimsStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2OrganismClaimsStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2OrganismClaimsStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2OrganismClaimsStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAddNewUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2OrganismClaimsStatement.jsp", "wMLC2.SaveAddNewUsage" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2OrganismClaimsStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2OrganismClaimsStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2OrganismClaimsStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2OrganismClaimsStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptAndReturnClaimsStatement( )">Accept & Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelClaimsStmt( )">Cancel & Return</a></li>
<%
   }
%>
...
<form name="wMLC2OrganismClaimsStatement" id="wMLC2OrganismClaimsStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "OrganismClaimsStatement" );
...
<div id="GBPrecautionarySection1" name="GBPrecautionarySection1" class="withborder" style="width:480px;height:62px;float:left;">  <!-- GBPrecautionarySection1 --> 
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2OrganismClaimsStatement" );
