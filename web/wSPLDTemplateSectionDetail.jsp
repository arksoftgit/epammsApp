...
if ( strLastWindow.equals("wSPLDTemplateSectionDetail") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDTemplateSectionDetail strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDTemplateSectionDetail LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDTemplateSectionDetail LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDTemplateSectionDetail", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wSPLD.AcceptTemplateSection" );
      try
      {
         nOptRC = wSPLD.AcceptTemplateSection( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelTemplateSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wSPLD.CancelTemplateSection" );
      try
      {
         nOptRC = wSPLD.CancelTemplateSection( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAcceptTemplateSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDTemplateSectionDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelTemplateSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDTemplateSectionDetail", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateSectionDetail.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDTemplateSectionDetail" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDTemplateSectionDetail.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDTemplateSectionDetail.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<title>Template Section Detail</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDTemplateSectionDetail.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAcceptTemplateSection( )">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelTemplateSection( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSPLDTemplateSectionDetail" id="wSPLDTemplateSectionDetail" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "TemplateSectionDetail" );
...
<% /* GroupBox1:GroupBox */ %>
<div id="GroupBox1" name="GroupBox1" style="float:left;width:586px;" >

<table cols=2 style="width:586px;"  class="grouptable">
...
<% /* ComboBoxSectionType:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="ComboBoxSectionType" id="ComboBoxSectionType" size="1" style="width:298px;" onchange="ComboBoxSectionTypeOnChange( )">
...
<input name="hComboBoxSectionType" id="hComboBoxSectionType" type="hidden" value="<%=strComboCurrentValue%>" >
</td>
</tr>
<tr>
<td valign="top" style="width:250px;">
...
<td valign="top" style="width:298px;">
<% /* ComboBoxTitlePosition:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="ComboBoxTitlePosition" id="ComboBoxTitlePosition" size="1" style="width:298px;" onchange="ComboBoxTitlePositionOnChange( )">
...
<input name="hComboBoxTitlePosition" id="hComboBoxTitlePosition" type="hidden" value="<%=strComboCurrentValue%>" >
</td>
</tr>
<tr>
<td valign="top" style="width:250px;">
...
<select  name="TitleBoldItalic" id="TitleBoldItalic" size="1" style="width:130px;" onchange="TitleBoldItalicOnChange( )">
...
<td valign="top" style="width:130px;">
<% /* TitleClass:EditBox */ %>
<input name="TitleClass" id="TitleClass" style="width:130px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<select  name="SubtitlePosition" id="SubtitlePosition" size="1" style="width:298px;" onchange="SubtitlePositionOnChange( )">
...
<select  name="SubtitleBoldItalic" id="SubtitleBoldItalic" size="1" style="width:130px;" onchange="SubtitleBoldItalicOnChange( )">
...
<input name="SubtitleClass" id="SubtitleClass" style="width:130px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="StatementClass" id="StatementClass" style="width:130px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<td valign="top" style="width:298px;">
<% /* ComboBoxStatementFormat:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="ComboBoxStatementFormat" id="ComboBoxStatementFormat" size="1" style="width:298px;" onchange="ComboBoxStatementFormatOnChange( )">
...
<input name="hComboBoxStatementFormat" id="hComboBoxStatementFormat" type="hidden" value="<%=strComboCurrentValue%>" >
</td>
</tr>
<tr>
<td valign="top" style="width:250px;">
