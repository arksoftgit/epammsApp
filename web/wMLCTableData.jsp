...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptTableUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableData", "wMLC.SaveTableColumns" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ADD_TableRow" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableData", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "ADD_TableRow", e.getMessage( ), "" );
         break;
      }
      // Next Window
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddBlankTableRow" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableData", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "AddBlankTableRow", e.getMessage( ), "" );
         break;
      }
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StayOnWindowWithRefresh, "", "" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelTableUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableData", "wMLC.CancelTableUpdate" );
...
<div id="GroupBox4" name="GroupBox4"   style="float:left;position:relative; width:722px; height:234px;">  <!-- GroupBox4 --> 
...
<label class="text12"  id="TableName" name="TableName" style="width:574px;height:24px;position:absolute;left:130px;top:26px;"><%=strTextDisplayValue%></label>
...
<label class="text12"  id="Description" name="Description" style="width:574px;height:24px;position:absolute;left:130px;top:52px;"><%=strTextDisplayValue%></label>
...
<% /* AddBlank:PushBtn */ %>
<button type="button" class="newbutton" name="AddBlank" id="AddBlank" value="" onclick="AddBlankTableRow( )" style="width:120px;height:26px;position:absolute;left:458px;top:78px;">Add Blank Entry</button>
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="AddBtn" onclick="ADD_TableRow( this.id )" id="AddBtn::<%=strEntityKey%>"><img src="./images/ePammsNew.png" alt="Add"></a></td>
