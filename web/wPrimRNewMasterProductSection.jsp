      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               wWebXfer.cursor( "Root" ).getAttribute( "AttemptContentVersion" ).setValue( strMapValue, "" );
         }
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "NewMasterProductSection", "" );
   }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = wWebXfer.cursor( "Root" ).getAttribute( "AttemptContentVersion" ).getString( "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on EBSectionName: " + e.getMessage());
               task.log().error( "*** Error on ctrl EBSectionName", e );
            }
