...
<%-- wPrimRNewMasterProductSection   Generate Timestamp: 20160427103739976 --%>
...
<input name="EBSectionName" id="EBSectionName" maxlength="254" style="width:366px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
