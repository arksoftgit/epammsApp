                           ...
                           boolean webMapping )
{
   ...
   {
      // EditBox: EBSectionName
      nRC = wWebXfer.cursor( "Root" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         strMapValue = request.getParameter( "EBSectionName" );
         try
         {
            if ( webMapping )
               VmlOperation.CreateMessage( task, "EBSectionName", "", strMapValue );
            else
         ...
         {
            nMapError = -16;
            VmlOperation.CreateMessage( task, "EBSectionName", e.getReason( ), strMapValue );
         }
      }
...
if ( strLastWindow.equals("wPrimRNewMasterProductSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wPrimRNewMasterProductSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wPrimRNewMasterProductSection LastWindow *** " + strLastWindow );
task.log().info("*** wPrimRNewMasterProductSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewMasterProductSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRNewMasterProductSection", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wPrimR.AcceptNewMasterProductSection" );
      try
      {
         nOptRC = wPrimR.AcceptNewMasterProductSection( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation AcceptNewMasterProductSection: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wPrimRNewMasterProductSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wPrimRNewMasterProductSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wPrimRNewMasterProductSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRNewMasterProductSection.jsp", "wPrimR.InitMasterProdSectionForInsert" );
   nOptRC = wPrimR.InitMasterProdSectionForInsert( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wPrimRNewMasterProductSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wPrimR" +
                         "&OperationName=" + "InitMasterProdSectionForInsert";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewMasterProductSection" );
   }
...
<title>New Master Product Section</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wPrimRNewMasterProductSection.js"></script>
...
<form name="wPrimRNewMasterProductSection" id="wPrimRNewMasterProductSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wPrimR", "NewMasterProductSection" );
...
<div id="Section" name="Section" style="width:504px;height:468px;float:left;">  <!-- Section --> 
...
<span style="height:16px;">&nbsp</span>
<% /* EBSectionName:EditBox */ %>
<%
   strErrorMapValue = VmlOperation.CheckError( "EBSectionName", strError );
   ...
   else
   {
      ...
      if ( VmlOperation.isValid( wWebXfer ) == false )
         task.log( ).debug( "Invalid View: " + "EBSectionName" );
      else
      {
         nRC = wWebXfer.cursor( "Root" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            ...
            {
               out.println("There is an error on EBSectionName: " + e.getMessage());
               task.log().info( "*** Error on ctrl EBSectionName" + e.getMessage() );
            }
...
<input name="EBSectionName" id="EBSectionName" style="width:366px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<% /* Text:EditBox */ %>
<input class="withborder" name="Text" id="Text" style="width:802px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="EPA_Title:" name="EPA_Title:" style="width:106px;height:16px;">EPA Title:</span>

<span style="height:16px;">&nbsp</span>
<% /* EPA_Title:EditBox */ %>
<input name="EPA_Title" id="EPA_Title" style="width:366px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="Graphic:" name="Graphic:" style="width:106px;height:16px;">Graphic:</span>

<span style="height:16px;">&nbsp</span>
<% /* Graphic:EditBox */ %>
<input name="Graphic" id="Graphic" style="width:366px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="Text:" name="Text:" style="width:106px;height:16px;">Text:</span>
