...
<%-- wMLCDeleteMasterLabelContent   Generate Timestamp: 20160913084219236 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteMasterLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterLabelContent", "wMLC.ConfirmDeleteMasterLabelContent" );
...
<input class="text12" name="Revision Date" id="Revision Date" maxlength="20"  disabled style="width:214px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mMasProd.cursor( "MasterLabelContent" ).getAttribute( "Finalized" ).getString( "" );
      }
      catch (Exception e)
      {
