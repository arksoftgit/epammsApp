   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewMasterLabelContent" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCNewMasterLabelContent" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCNewMasterLabelContent.jsp";
...
<div id="GBMasterLabelContent" name="GBMasterLabelContent" class="withborder" style="width:718px;height:126px;float:left;">  <!-- GBMasterLabelContent --> 

<div  id="GBMasterLabelContent" name="GBMasterLabelContent" >Master Label Content</div>
...
<span  id="Version:" name="Version:" style="width:110px;height:16px;">Version:</span>
...
<input class="text12" name="MasterLabelContentVersion" id="MasterLabelContentVersion" style="width:568px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="Revision Date:" name="Revision Date:" style="width:110px;height:16px;">Revision Date:</span>
...
<span  id="Revision Date" name="Revision Date" style="width:130px;height:16px;"><%=strTextDisplayValue%></span>
...
<span  id="Finalized:" name="Finalized:" style="width:110px;height:16px;">Finalized:</span>
