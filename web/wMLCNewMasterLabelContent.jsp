...
if ( strLastWindow.equals("wMLCNewMasterLabelContent") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCNewMasterLabelContent strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCNewMasterLabelContent LastWindow *** " + strLastWindow );
task.log().info("*** wMLCNewMasterLabelContent LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewMasterLabelContent" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCNewMasterLabelContent", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wMLC.AcceptNewMasterLabelContent" );
      try
      {
         nOptRC = wMLC.AcceptNewMasterLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation AcceptNewMasterLabelContent: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewMasterLabelContent" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCNewMasterLabelContent", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wMLC.CancelNewMasterLabelContent" );
      try
      {
         nOptRC = wMLC.CancelNewMasterLabelContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelNewMasterLabelContent: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAcceptNewMasterLabelContent" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCNewMasterLabelContent", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelNewMasterLabelContent" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCNewMasterLabelContent", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLCNewMasterLabelContent" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCNewMasterLabelContent.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCNewMasterLabelContent.jsp", "wMLC.InitMasterLabelContentForInsert" );
   nOptRC = wMLC.InitMasterLabelContentForInsert( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wMLCNewMasterLabelContent.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wMLC" +
                         "&OperationName=" + "InitMasterLabelContentForInsert";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewMasterLabelContent" );
   }
...
<title>New Master Label Content</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCNewMasterLabelContent.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAcceptNewMasterLabelContent( )">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelNewMasterLabelContent( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wMLCNewMasterLabelContent" id="wMLCNewMasterLabelContent" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "NewMasterLabelContent" );
...
<fieldset id="GBMasterLabelContent" name="GBMasterLabelContent"   style="size:absolute; width:718px; height:106px;">
<legend>Master Label Content</legend>
<% /* Version::Text */ %>

<label  id="Version:" name="Version:" style="width:110px;height:16px;position:absolute;left:18px;top:36px;">Version:</label>
...
<input class="text12" name="MasterLabelContentVersion" id="MasterLabelContentVersion" style="width:568px;position:absolute;left:136px;top:36px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* Revision Date::Text */ %>

<label  id="Revision Date:" name="Revision Date:" style="width:110px;height:16px;position:absolute;left:18px;top:62px;">Revision Date:</label>
...
<label  id="Revision Date" name="Revision Date" style="width:130px;height:16px;position:absolute;left:136px;top:62px;"><%=strTextDisplayValue%></label>

<% /* Finalized::Text */ %>

<label  id="Finalized:" name="Finalized:" style="width:110px;height:16px;position:absolute;left:18px;top:90px;">Finalized:</label>

<% /* Finalized: */ %>
</fieldset>  <!-- GBMasterLabelContent --> 
<div id='clear'></div>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCNewMasterLabelContent" );
