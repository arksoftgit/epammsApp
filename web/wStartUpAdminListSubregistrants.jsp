      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "Subregistrant" ).setAttribute( "wkSelected", "Y" );
               else
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregistrants.jsp", "wStartUp.Template" );
      try
      {
