...
<%-- wSLCVersionData   Generate Timestamp: 20161019144229718 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_TableMaintenance" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCVersionData", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.SaveSLC_Return" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.SaveSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.CancelAndReturnSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayFirstAidSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplaySurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplaySurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplayLocationsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplayApplicationTypesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCVersionData", "wSLC.DisplayClaimsSection" );
...
<%
   ...
   {
%>
       <li id="smVersionData" name="smVersionData"><a href="#"  class="sideselected"  onclick="smDisplayVersionData()">Version Data</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smDisplayTables" name="smDisplayTables"><a href="#"  onclick="GOTO_TableMaintenance()">Tables</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smSyncMLC" name="smSyncMLC"><a href="#"  onclick="Sync()">Sync MLC</a></li>
<%
   }
%>
...
<input name="SubregProductName" id="SubregProductName" maxlength="254" style="width:356px;position:absolute;left:166px;top:50px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EditBox2" id="EditBox2" maxlength="2048" style="width:338px;position:absolute;left:166px;top:4px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EditBox3" id="EditBox3" maxlength="254" style="width:338px;position:absolute;left:166px;top:22px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
