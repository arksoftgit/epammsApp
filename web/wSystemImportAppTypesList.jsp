...
if ( strLastWindow.equals("wSystemImportAppTypesList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemImportAppTypesList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemImportAppTypesList LastWindow *** " + strLastWindow );
task.log().info("*** wSystemImportAppTypesList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "ImportAppTypesList", strFeedback );
      }

   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelImportAppTypesAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAppTypesList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportAppTypesAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAppTypesList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAppTypesList.jsp", "wSystem.ConfirmImportAppTypesList" );
      try
      {
         nOptRC = wSystem.ConfirmImportAppTypesList( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportAppTypesFromFile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAppTypesList.jsp", "wSystem.ImportAppTypesFromFile" );
      try
      {
         nOptRC = wSystem.ImportAppTypesFromFile( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmImportAppTypesAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAppTypesList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelImportAppTypesAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAppTypesList", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemImportAppTypesList" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemImportAppTypesList.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemImportAppTypesList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSystemImportAppTypesList.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitImportAppTypesList";
...
<title>Import Application Types List</title>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmImportAppTypesAndReturn( )">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelImportAppTypesAndReturn( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSystemImportAppTypesList" id="wSystemImportAppTypesList" method="post">
...
<%
   session.setAttribute( "ZeidonWindow", "wSystemImportAppTypesList" );
