...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportAppTypesAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAppTypesList", "wSystem.ConfirmImportAppTypesList" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportAppTypesFromFile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAppTypesList", "wSystem.ImportAppTypesFromFile" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAppTypesList", "wSystem.InitImportAppTypesList" );
...
<%
   ...
   {
%>
       <li id="smConfirmImportAndReturn" name="smConfirmImportAndReturn"><a href="#"  onclick="smConfirmImportAppTypesAndReturn()">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smImportListFromFile" name="smImportListFromFile"><a href="#"  onclick="smImportAppTypesFromFile()">Import List from File</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelImportAppTypesAndReturn()">Cancel and Return</a></li>
<%
   }
%>
