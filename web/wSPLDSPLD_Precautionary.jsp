...
<%-- wSPLDSPLD_Precautionary   Generate Timestamp: 20170427124609124 --%>
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "Combined" ).setValue( strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "BoldTitle" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "BoldText" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wSPLDSPLD_Precautionary") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSPLD_Precautionary strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSPLD_Precautionary LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSPLD_Precautionary LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSPLD_Precautionary", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.SaveSPLD_AndReturn" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.CancelSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.SaveSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGraphicalView" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.SetSPLD_Resume" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGENERATE_SPLD_Label" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.GENERATE_SPLD_Label" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGenerateLabelDottedBorders" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.GENERATE_SPLD_LabelDottedBorders" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHumanHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smFirstAid" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smStorageDisposal" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.ExecuteJOE_Test1" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smPrecautionary" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.DisplayPhysicalChemicalHazards" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCLEAN_SPLD_Data" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_Precautionary", "wSPLD.CLEAN_SPLD_Data" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSPLD_Precautionary" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSPLD_Precautionary.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSPLD_Precautionary.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SPLD_Precautionary", "" );
   }
...
<title>SPLD Precautionary Statements</title>
...
<%
   ...
   {
%>
       <li id="smPrecautionary" name="smPrecautionary"><a href="#"  class="sideselected"  onclick="smPrecautionary()">Precautionary</a></li>
<%
   }
%>
...
<form name="wSPLDSPLD_Precautionary" id="wSPLDSPLD_Precautionary" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "SPLD_Precautionary" );
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "Subtitle" ).getString( "" );
      }
      catch (Exception e)
      {
...
<%
   ...
   else
   {
      nRC = mSPLDef.cursor( "SPLD_GeneralSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
         strRadioGroupValue = mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "Combined" ).getString( );
   }
...
<%
   ...
   else
   {
      nRC = mSPLDef.cursor( "SPLD_GeneralSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
         strRadioGroupValue = mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "BoldTitle" ).getString( );
   }
...
<%
   ...
   else
   {
      nRC = mSPLDef.cursor( "SPLD_GeneralSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
         strRadioGroupValue = mSPLDef.cursor( "SPLD_GeneralSection" ).getAttribute( "BoldText" ).getString( );
   }
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGridPrecautionary.cursor( "SPLD_GeneralStatement" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridPrecautionary.cursor( "SPLD_GeneralStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGridEditPrecautionary = "";
         nRC = vGridPrecautionary.cursor( "SPLD_GeneralStatement" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditPrecautionary = vGridPrecautionary.cursor( "SPLD_GeneralStatement" ).getAttribute( "dGenStmtCombinedTitleText" ).getString( "" );
...
<%
         csrRC2 = vGridPrecautionary.cursor( "SPLD_GeneralStatement" ).setNextContinue( );
      }
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSPLD_Precautionary" );
