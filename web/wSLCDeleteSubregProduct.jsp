...
<%-- wSLCDeleteSubregProduct   Generate Timestamp: 20160620105928089 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteSubregProduct", "wSLC.CancelDeleteSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteSubregProduct", "wSLC.ConfirmDeleteSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteSubregProduct", "wSLC.GOTO_UpdateSubregProduct" );
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSPLD", "SubregProductUpdate" );
      }
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteSubregProduct", "wSLC.InitSPLD_ForDelete" );
   nOptRC = wSLC.InitSPLD_ForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
...
<%
   ...
   {
%>
       <li id="ConfirmDeleteAndReturn" name="ConfirmDeleteAndReturn"><a href="#"  onclick="ConfirmDeleteSubregProduct()">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="CancelDeleteAndReturn" name="CancelDeleteAndReturn"><a href="#"  onclick="CancelDeleteSubregProduct()">Cancel Delete and Return</a></li>
<%
   }
%>
