...
<%-- wSystemUpdateLocations   Generate Timestamp: 20160406142159614 --%>
...
<input name="Locations" id="Locations" style="width:580px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
