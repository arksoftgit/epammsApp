...
if ( strLastWindow.equals("wSPLDListSubregProducts") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDListSubregProducts strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDListSubregProducts LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDListSubregProducts LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDListSubregProducts", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wSPLD.DeleteSubregProduct" );
      try
      {
         nOptRC = wSPLD.DeleteSubregProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDListSubregProducts" );
         }
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDDeleteSubregProduct.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDListSubregProducts" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveSubregProductDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wSPLD.MoveSubregProductDown" );
      try
      {
         nOptRC = wSPLD.MoveSubregProductDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      strURL = response.encodeRedirectURL( "wSPLDListSubregProducts.jsp" );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveSubregProductUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wSPLD.MoveSubregProductUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wSPLD.NewSubregProduct" );
      try
      {
         nOptRC = wSPLD.NewSubregProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDNewSubregProduct.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDListSubregProducts" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnSubregUserDetail" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDListSubregProducts.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdatePhysicalLabelDef" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDListSubregProducts", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wSPLD.UpdatePhysicalLabelDefX" );
      try
      {
         nOptRC = wSPLD.UpdatePhysicalLabelDefX( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation UpdatePhysicalLabelDefX: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDUpdateSubregProduct.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDListSubregProducts" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDListSubregProducts" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDListSubregProducts.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDListSubregProducts.jsp", "wSPLD.InitListSubregProducts" );
   nOptRC = wSPLD.InitListSubregProducts( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLDListSubregProducts.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDListSubregProducts.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnSubregUserDetail( )">Return to Subregistrant</a></li>
<%
   }
%>
...
<form name="wSPLDListSubregProducts" id="wSPLDListSubregProducts" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "ListSubregProducts" );
...
<div id="SubregProducts" name="SubregProducts" style="width:866px;height:40px;float:left;">  <!-- SubregProducts --> 

<div  id="SubregProducts" name="SubregProducts" >Subregistrant Products</div>

 <!-- This is added as a line spacer -->
<div style="height:14px;width:100px;"></div>

<div>  <!-- Beginning of a new line -->
<span style="height:28px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
...
<table  cols=7 style=""  name="GridSubregProducts" id="GridSubregProducts">
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="UpdatePhysicalLabelDef( this.id )" id="GESubregProductName::<%=strEntityKey%>"><%=strGESubregProductName%></a></td>
   <td><a href="#" onclick="UpdatePhysicalLabelDef( this.id )" id="GEPrimRegProductName::<%=strEntityKey%>"><%=strGEPrimRegProductName%></a></td>
   <td><a href="#" onclick="UpdatePhysicalLabelDef( this.id )" id="GridESL_Date::<%=strEntityKey%>"><%=strGridESL_Date%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateSubregProduct" onclick="UpdatePhysicalLabelDef( this.id )" id="BMBUpdateSubregProduct::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDListSubregProducts" );
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDListSubregProducts" );
