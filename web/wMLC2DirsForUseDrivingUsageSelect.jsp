...
<%-- wMLC2DirsForUseDrivingUsageSelect --%>
      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "M_DrivingUsage" ).setAttribute( "wSelected", strMapValue );
               else
                  vGridTmp.cursor( "M_DrivingUsage" ).setAttribute( "wSelected", "" );
         }
...
if ( strLastWindow.equals("wMLC2DirsForUseDrivingUsageSelect") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2DirsForUseDrivingUsageSelect strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2DirsForUseDrivingUsageSelect LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2DirsForUseDrivingUsageSelect LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2DirsForUseDrivingUsageSelect", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseDrivingUsageSelect.jsp", "wMLC2.CLEAR_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseDrivingUsageSelect.jsp", "wMLC2.CLEAR_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "RemoveMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseDrivingUsageSelect.jsp", "wMLC2.RemoveMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseDrivingUsageSelect.jsp", "wMLC2.SelectMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseDrivingUsageSelect.jsp", "wMLC2.SETALL_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirsForUseDrivingUsageSelect.jsp", "wMLC2.SETALL_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2DirsForUseDrivingUsageSelect" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2DirsForUseDrivingUsageSelect.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2DirsForUseDrivingUsageSelect.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DirsForUseDrivingUsageSelect" );
   }
...
<title>Directions for Use Driving Usage Select</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2DirsForUseDrivingUsageSelect.js"></script>
...
<form name="wMLC2DirsForUseDrivingUsageSelect" id="wMLC2DirsForUseDrivingUsageSelect" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "DirsForUseDrivingUsageSelect" );
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridCheckCtl2 = vGrid1.cursor( "M_DrivingUsage" ).getStringFromAttribute( "wSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl2 = vGrid1.cursor( "M_DrivingUsage" ).getStringFromAttribute( "ClaimsClassification", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl3 = vGrid1.cursor( "M_DrivingUsage" ).getStringFromAttribute( "Name", "" );
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGrid2.cursor( "M_Usage" ).getStringFromAttribute( "ClaimsClassification", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl4 = vGrid2.cursor( "M_Usage" ).getStringFromAttribute( "Name", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2DirsForUseDrivingUsageSelect" );
