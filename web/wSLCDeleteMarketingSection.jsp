...
if ( strLastWindow.equals("wSLCDeleteMarketingSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCDeleteMarketingSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCDeleteMarketingSection LastWindow *** " + strLastWindow );
task.log().info("*** wSLCDeleteMarketingSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteMarketSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteMarketingSection", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.CancelDeleteMarketingSect" );
      try
      {
         nOptRC = wSLC.CancelDeleteMarketingSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelDeleteMarketingSect: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteMarketSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteMarketingSection", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.ConfirmDeleteMarketingSect" );
      try
      {
         nOptRC = wSLC.ConfirmDeleteMarketingSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMarketingStatement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.SelectMarketingStmtForDelete" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMarketingStatementDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.MoveMarketingStmtDown" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMarketingStatementUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.MoveMarketingStmtUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewMarketingStatement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.InitMarketingStmtForInsert" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateMarketingStatement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.SelectMarketingStmtForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmDeleteMarketSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteMarketingSection", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelDeleteMarketSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteMarketingSection", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCDeleteMarketingSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCDeleteMarketingSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCDeleteMarketingSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteMarketingSection.jsp", "wSLC.SelectMarketingSectForUpdate" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSLCDeleteMarketingSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
                         "&OperationName=" + "SelectMarketingSectForUpdate";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DeleteMarketingSection" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCDeleteMarketingSection.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmDeleteMarketSection( )">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelDeleteMarketSection( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wSLCDeleteMarketingSection" id="wSLCDeleteMarketingSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "DeleteMarketingSection" );
...
<div id="MarketingStatements" name="MarketingStatements" class="withborder" style="width:732px;height:452px;float:left;">  <!-- MarketingStatements --> 
...
<% /* GridMarketing:Grid */ %>
<div class="tableScroll"  style="height:410px;">
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="UpdateMarketingStatement( this.id )" id="GridEditMarketing::<%=strEntityKey%>"><%=strGridEditMarketing%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateMarketingStatement" onclick="UpdateMarketingStatement( this.id )" id="BMBUpdateMarketingStatement::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveMarketingStatementUp" onclick="MoveMarketingStatementUp( this.id )" id="BMBMoveMarketingStatementUp::<%=strEntityKey%>"><img src="./images/ePammsUp.jpg" alt="Move Up"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveMarketingStatementDown" onclick="MoveMarketingStatementDown( this.id )" id="BMBMoveMarketingStatementDown::<%=strEntityKey%>"><img src="./images/ePammsDown.jpg" alt="Move Down"></a></td>
...
<div id="MarketingSection" name="MarketingSection" class="withborder" style="width:732px;height:96px;float:left;">  <!-- MarketingSection --> 
...
<input name="MarketingTitle" id="MarketingTitle"  disabled style="width:474px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* TitleBoldItalic:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="TitleBoldItalic" id="TitleBoldItalic" size="1" style="width:94px;"  disabled onchange="TitleBoldItalicOnChange( )">

<%
   mSubLC = task.getViewByName( "mSubLC" );
   if ( VmlOperation.isValid( mSubLC ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSubLC , "S_MarketingSection", "BoldItalic", "" );

      nRC = mSubLC.cursor( "S_MarketingSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSubLC.cursor( "S_MarketingSection" ).getStringFromAttribute( "BoldItalic", "" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).info( "S_MarketingSection.ReviewerNote: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mSubLC.S_MarketingSection" );
      }
   }
%>
...
<%
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSubLC , "S_MarketingSection", "NoteBoldItalic", "" );

      nRC = mSubLC.cursor( "S_MarketingSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSubLC.cursor( "S_MarketingSection" ).getStringFromAttribute( "NoteBoldItalic", "" );
         if ( strComboCurrentValue == null )
            strComboCurrentValue = "";
      }
      else
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCDeleteMarketingSection" );
