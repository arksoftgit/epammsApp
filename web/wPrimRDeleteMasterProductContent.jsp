...
<%-- wPrimRDeleteMasterProductContent --%>
...
if ( strLastWindow.equals("wPrimRDeleteMasterProductContent") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wPrimRDeleteMasterProductContent strActionToProcess *** " + strActionToProcess );
task.log().info("*** wPrimRDeleteMasterProductContent LastWindow *** " + strLastWindow );
task.log().info("*** wPrimRDeleteMasterProductContent LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteMasterProductConten" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRDeleteMasterProductContent", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wPrimR.ConfirmDeleteMasterProdContent" );
      try
      {
         nOptRC = wPrimR.ConfirmDeleteMasterProdContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation ConfirmDeleteMasterProdContent: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteMasterProductContent" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRDeleteMasterProductContent", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wPrimR.CancelDeleteMasterProductContent" );
      try
      {
         nOptRC = wPrimR.CancelDeleteMasterProductContent( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelDeleteMasterProductContent: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wPrimRDeleteMasterProductContent" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wPrimRDeleteMasterProductContent.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wPrimRDeleteMasterProductContent.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProductContent.jsp", "wPrimR.InitMasterProdContentForDelete" );
   nOptRC = wPrimR.InitMasterProdContentForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wPrimRDeleteMasterProductContent.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wPrimR" +
                         "&OperationName=" + "InitMasterProdContentForDelete";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DeleteMasterProductContent" );
   }
...
<title>Delete Master Product Content</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wPrimRDeleteMasterProductContent.js"></script>
...
<form name="wPrimRDeleteMasterProductContent" id="wPrimRDeleteMasterProductContent" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wPrimR", "DeleteMasterProductContent" );
...
<div id="PrimaryRegistrant" name="PrimaryRegistrant" class="withborder" style="width:702px;height:110px;float:left;">  <!-- PrimaryRegistrant --> 
...
<span  id="TXName" name="TXName" style="width:570px;height:16px;"><%=strTextDisplayValue%></span>
...
<span  id="Login:" name="Login:" style="width:78px;height:16px;">Login:</span>
...
<% strTextDisplayValue = "";
   mPrimReg = task.getViewByName( "mPrimReg" );
   if ( VmlOperation.isValid( mPrimReg ) == false )
      task.log( ).debug( "Invalid View: " + "TXLoginName" );
   else
   {
      ...
      try
      {
         strTextDisplayValue = mPrimReg.cursor( "Organization" ).getStringFromAttribute( "LoginName", "" );
      }
      catch (Exception e)
      {
         out.println("There is an error on TXLoginName: " + e.getMessage());
         task.log().info( "*** Error on ctrl TXLoginName" + e.getMessage() );
      }
         if ( strTextDisplayValue == null )
            strTextDisplayValue = "";
      }
...
<span  id="TXLoginName" name="TXLoginName" style="width:274px;height:16px;"><%=strTextDisplayValue%></span>

<span style="height:16px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
<% /* Password::Text */ %>

<span  id="Password:" name="Password:" style="width:90px;height:16px;">Password:</span>
...
<div>  <!-- Beginning of a new line -->
<div style="height:1px;width:14px;float:left;"></div>   <!-- Width Spacer -->
<% /* MasterProductContent:GroupBox */ %>

<div id="MasterProductContent" name="MasterProductContent" class="noborder" style="width:702px;height:172px;float:left;">  <!-- MasterProductContent --> 

<div  id="MasterProductContent" name="MasterProductContent" >Master Product Content</div>
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mPrimReg.cursor( "MasterProduct" ).getStringFromAttribute( "Name", "" );
      }
      catch (Exception e)
      {
...
<span  id="ContentDescription" name="ContentDescription" style="width:300px;height:16px;"></span>
...
<span class="text10"  id="Confirm" name="Confirm" style="width:422px;height:16px;">Are you sure you want to delete this Master Product Content?</span>

</div>  <!-- End of a new line -->


</div>  <!--  MasterProductContent --> 
</div>  <!-- End of a new line -->
