                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSubreg ) )
   {
      ...
      csrRC = vGridTmp.cursor( "ListMasterProduct" ).setFirst( "Subregistrant" );
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "ListMasterProduct" ).setAttribute( "wkSelected", "Y" );
               else
...
if ( strLastWindow.equals("wSLCNewSubregProduct") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCNewSubregProduct strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCNewSubregProduct LastWindow *** " + strLastWindow );
task.log().info("*** wSLCNewSubregProduct LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCNewSubregProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wSLC.AcceptNewSubregProduct" );
      try
      {
         nOptRC = wSLC.AcceptNewSubregProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation AcceptNewSubregProduct: " + e.getMessage();
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_ReturnToParent, "wSLC", "ListSubregProducts" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitSubregLabelContentForDelete" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCNewSubregProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wSLC.InitSubregLabelContentForDelete" );
      try
      {
         nOptRC = wSLC.InitSubregLabelContentForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation InitSubregLabelContentForDelete: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSubR", "NewProdLabelContent" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSubregLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wSLC.UpdateSubregLabelContent" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSubR", "UpdateProdLabelContent" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wSLC.CancelNewSubregProduct" );
      try
      {
         nOptRC = wSLC.CancelNewSubregProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelNewSubregProduct: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCNewSubregProduct" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCNewSubregProduct.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCNewSubregProduct.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewSubregProduct.jsp", "wSLC.InitSubregProductForInsert" );
   nOptRC = wSLC.InitSubregProductForInsert( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCNewSubregProduct.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCNewSubregProduct.js"></script>
...
<form name="wSLCNewSubregProduct" id="wSLCNewSubregProduct" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "NewSubregProduct" );
...
<span class="groupbox"  id="SubregistrantProduct" name="SubregistrantProduct" style="width:186px;height:28px;">Subregistrant Product</span>
...
<div id="GBSubregistrantProduct" name="GBSubregistrantProduct" class="withborder" style="width:824px;height:268px;float:left;">  <!-- GBSubregistrantProduct --> 
...
<% /* GroupBox1:GroupBox */ %>
<div id="GroupBox1" name="GroupBox1" style="float:left;width:804px;" >

<table cols=2 style="width:804px;"  class="grouptable">

<tr>
<td valign="top" style="width:184px;">
<% /* ProductName::Text */ %>

<span  id="ProductName:" name="ProductName:" style="width:174px;height:16px;">Name:</span>
...
<input name="ProductName" id="ProductName" style="width:620px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="EPARegistrationNumber:" name="EPARegistrationNumber:" style="width:174px;height:16px;">EPA Registration Number:</span>
...
<input name="EPARegistrationNumber" id="EPARegistrationNumber" style="width:620px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<div id="MasterProducts" name="MasterProducts" class="withborder" style="width:824px;height:388px;float:left;">  <!-- MasterProducts --> 
...
<table  cols=5 style=""  name="GridMasterProducts" id="GridMasterProducts">
...
try
{
   ...
   if ( VmlOperation.isValid( mSubreg ) )
   {
      ...
      csrRC2 = vGridMasterProducts.cursor( "ListMasterProduct" ).setFirst( "Subregistrant" );
      while ( csrRC2.isSet() )
      {
         ...
         nRC = vGridMasterProducts.cursor( "PrimaryRegistrant" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridPrimaryRegistrant = vGridMasterProducts.cursor( "PrimaryRegistrant" ).getStringFromAttribute( "dNameEPA_Number", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><%=strGridPrimaryRegistrant%></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCNewSubregProduct" );
