...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.SaveSLC_Return" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.SaveSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.CancelAndReturnSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayFirstAidSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplaySurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplaySurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplayLocationsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplayApplicationTypesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCIngredients", "wSLC.DisplayClaimsSection" );
...
<script language="JavaScript" type="text/javascript" src="./js/common.js?v=20170810174447333"></script>
<script language="JavaScript" type="text/javascript" src="./js/scw.js?v=20170810174447333"></script>
<script language="JavaScript" type="text/javascript" src="./js/animatedcollapse.js?v=20170810174447333"></script>
<script language="JavaScript" type="text/javascript" src="./js/jquery.blockUI.js?v=20170810174447333"></script>
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCIngredients.js?v=20170810174447333"></script>
...
<%
   ...
   {
%>
       <li id="smIngredients" name="smIngredients"><a href="#"  class="sideselected"  onclick="smDisplayIngredientsSect()">Ingredients</a></li>
<%
   }
%>
...
<div id="GroupBox1" name="GroupBox1" class="listgroup"   style="float:left;position:relative; width:786px; height:110px;">  <!-- GroupBox1 --> 
...
<label  id="Active Title:" name="Active Title:" style="width:118px;height:18px;position:absolute;left:18px;top:40px;">ActiveTitle:</label>
...
<label  id="Text1" name="Text1" style="width:510px;height:18px;position:absolute;left:268px;top:40px;"><%=strTextDisplayValue%></label>

<% /* InertTitle::Text */ %>

<label  id="InertTitle:" name="InertTitle:" style="width:118px;height:18px;position:absolute;left:18px;top:64px;">Inert Title:</label>
...
<label  id="Text2" name="Text2" style="width:510px;height:18px;position:absolute;left:268px;top:64px;"><%=strTextDisplayValue%></label>

<% /* UnspecifiedInertPercentage::Text */ %>

<label  id="UnspecifiedInertPercentage:" name="UnspecifiedInertPercentage:" style="width:248px;height:16px;position:absolute;left:20px;top:88px;">Unspecified Inert Percentage:</label>
...
<label  id="Text3" name="Text3" style="width:50px;height:16px;position:absolute;left:268px;top:88px;"><%=strTextDisplayValue%></label>
...
<div id="GBIngredients" name="GBIngredients" class="listgroup"   style="float:left;position:relative; width:486px; height:36px;">  <!-- GBIngredients --> 
