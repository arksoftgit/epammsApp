...
<%-- wMLCClaimsFootnoteStatement   Generate Timestamp: 20160425132215611 --%>
...
<input name="Footnote" id="Footnote" style="width:594px;position:absolute;left:70px;top:6px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
