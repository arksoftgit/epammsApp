      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "M_UsageFootnote" ).setAttribute( "Text", strMapValue, "" );
         }
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ClaimsFootnoteStatement" );
   }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mMasLC.cursor( "M_UsageFootnote" ).getStringFromAttribute( "Text", "" );
            }
            catch (Exception e)
            {
...
<input name="EditBox1" id="EditBox1" style="width:594px;position:absolute;left:62px;top:6px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
