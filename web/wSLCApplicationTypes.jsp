...
<%-- wSLCApplicationTypes   Generate Timestamp: 20160406142152784 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes", "wSLC.DisplayLocationsSection" );
