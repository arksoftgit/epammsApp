...
if ( strLastWindow.equals("wSLCApplicationTypes") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCApplicationTypes strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCApplicationTypes LastWindow *** " + strLastWindow );
task.log().info("*** wSLCApplicationTypes LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptAppTypesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.AcceptAppTypesSect" );
      try
      {
         nOptRC = wSLC.AcceptAppTypesSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAppTypesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.CancelAppTypesSect" );
      try
      {
         nOptRC = wSLC.CancelAppTypesSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectAppTypesStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.SelectAppTypesStmtForDelete" );
      try
      {
         nOptRC = wSLC.SelectAppTypesStmtForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveAppTypesStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.MoveAppTypesStmtDown" );
      try
      {
         nOptRC = wSLC.MoveAppTypesStmtDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveAppTypesStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.MoveAppTypesStmtUp" );
      try
      {
         nOptRC = wSLC.MoveAppTypesStmtUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAppTypesStmtForInsert" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCApplicationTypes", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.InitAppTypesStmtForInsert" );
      try
      {
         nOptRC = wSLC.InitAppTypesStmtForInsert( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation InitAppTypesStmtForInsert: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wMLC", "AppTypesStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAppTypesStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.InitAppTypesStmtForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSubregLabelVersionData" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditSubregLabelVersionData" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smIngredients" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditIngredientsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smStorageDisposal" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHumanHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditHumanHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smPrecautionary" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditPrecautionarySect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smFirstAid" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditFirstAidSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smClaims" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditClaimsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSurfaces" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditSurfacesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditAreasOfUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smApplicationTypes" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditAppTypesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDirectionsForUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditDirectionsUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smMarketing" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.EditMarketingSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCApplicationTypes" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCApplicationTypes.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCApplicationTypes.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCApplicationTypes.jsp", "wSLC.InitAppTypesSect" );
   nOptRC = wSLC.InitAppTypesSect( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCApplicationTypes.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ApplicationTypes" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCApplicationTypes.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#" class="sideselected"  onclick="smApplicationTypes( )">Application Types</a></li>
<%
   }
%>
...
<form name="wSLCApplicationTypes" id="wSLCApplicationTypes" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "ApplicationTypes" );
...
<div id="GBAppTypesStatements" name="GBAppTypesStatements" style="width:730px;height:42px;float:left;">  <!-- GBAppTypesStatements --> 
...
<% /* AppTypesStatements:Text */ %>

<span  id="AppTypesStatements" name="AppTypesStatements" style="width:222px;height:16px;">Application Types Statements</span>
...
<div style="height:1px;width:14px;float:left;"></div>   <!-- Width Spacer -->
<% /* AppTypeClaims:Grid */ %>
<table  cols=4 style=""  name="AppTypeClaims" id="AppTypeClaims">
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      View vAppTypeClaims;
      vAppTypeClaims = mSubLC.newView( );
      csrRC2 = vAppTypeClaims.cursor( "SI_UsageList" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vAppTypeClaims.cursor( "SI_UsageList" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strGridEditAppTypes = "";
         nRC = vAppTypeClaims.cursor( "SI_UsageList" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditAppTypes = vAppTypeClaims.cursor( "SI_UsageList" ).getStringFromAttribute( "Name", "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="InitAppTypesStmtForUpdate( this.id )" id="GridEditAppTypes::<%=strEntityKey%>"><%=strGridEditAppTypes%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateAppTypesStatement" onclick="InitAppTypesStmtForUpdate( this.id )" id="BMBUpdateAppTypesStatement::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Display"></a></td>
...
<%
         csrRC2 = vAppTypeClaims.cursor( "SI_UsageList" ).setNextContinue( );
      }
      vAppTypeClaims.drop( );
   }
}
