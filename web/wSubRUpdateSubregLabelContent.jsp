...
<%-- wSubRUpdateSubregLabelContent   Generate Timestamp: 20160328163928184 --%>
...
if ( strLastWindow.equals("wSubRUpdateSubregLabelContent") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSubRUpdateSubregLabelContent strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSubRUpdateSubregLabelContent LastWindow *** " + strLastWindow );
task.log().info("*** wSubRUpdateSubregLabelContent LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSubRUpdateSubregLabelContent" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSubRUpdateSubregLabelContent.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSubRUpdateSubregLabelContent.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "MaintainSLC" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li id="smMaintainSLC" name="smMaintainSLC"><a href="#"  onclick="smMaintainSLC()">Maintain SLC</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smSaveAndReturn" name="smSaveAndReturn"><a href="#"  onclick="smAcceptUpdateProdLabelContent()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelUpdateProdLabelContent()">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSubRUpdateSubregLabelContent" id="wSubRUpdateSubregLabelContent" method="post">
