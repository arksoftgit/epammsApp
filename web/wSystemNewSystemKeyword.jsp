                           ...
                           boolean webMapping )
{
   ...
   {
      // EditBox: Name
      nRC = mEPA.cursor( "Keyword" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mEPA.cursor( "Keyword" ).setAttribute( "Name", strMapValue, "" );
         }
...
if ( strLastWindow.equals("wSystemNewSystemKeyword") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemNewSystemKeyword strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemNewSystemKeyword LastWindow *** " + strLastWindow );
task.log().info("*** wSystemNewSystemKeyword LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "NewSystemKeyword", strFeedback );
      }

   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmAddSysKeywordAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemNewSystemKeyword", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemKeyword.jsp", "wSystem.AcceptNewSystemKeyword" );
      try
      {
         nOptRC = wSystem.AcceptNewSystemKeyword( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation AcceptNewSystemKeyword: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddKeywordAndAddNew" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemNewSystemKeyword", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemKeyword.jsp", "wSystem.AddKeywordAndAddNew" );
      try
      {
         nOptRC = wSystem.AddKeywordAndAddNew( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation AddKeywordAndAddNew: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAddSysKeywordAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemNewSystemKeyword", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemKeyword.jsp", "wSystem.CancelNewSystemKeyword" );
      try
      {
         nOptRC = wSystem.CancelNewSystemKeyword( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation CancelNewSystemKeyword: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmAddSysKeywordAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemNewSystemKeyword", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAddKeywordAndAddNew" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemNewSystemKeyword", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAddSysKeywordAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemNewSystemKeyword", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemNewSystemKeyword" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemNewSystemKeyword.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemNewSystemKeyword.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemKeyword.jsp", "wSystem.InitSystemKeywordForInsert" );
   nOptRC = wSystem.InitSystemKeywordForInsert( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSystemNewSystemKeyword.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitSystemKeywordForInsert";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewSystemKeyword" );
   }
...
<title>New System Keyword</title>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "AddKeywordAndAddNew" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "CancelAddKeyword" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<form name="wSystemNewSystemKeyword" id="wSystemNewSystemKeyword" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSystem", "NewSystemKeyword" );
...
<span  id="Keyword:" name="Keyword:" style="width:72px;height:16px;">Keyword:</span>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mEPA.cursor( "Keyword" ).getStringFromAttribute( "Name", "" );
            }
            catch (Exception e)
            {
...
<input name="Name" id="Name" style="width:302px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
