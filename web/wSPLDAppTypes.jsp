...
if ( strLastWindow.equals("wSPLDAppTypes") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDAppTypes strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDAppTypes LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDAppTypes LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptAppTypesSect" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDAppTypes", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.AcceptAppTypesSect" );
      try
      {
         nOptRC = wSPLD.AcceptAppTypesSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDAppTypes" );
         }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAppTypesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.CancelAppTypesSect" );
      try
      {
         nOptRC = wSPLD.CancelAppTypesSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteAppTypesStmt" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDAppTypes", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.SelectAppTypesStmtForDelete" );
      try
      {
         nOptRC = wSPLD.SelectAppTypesStmtForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDDeleteAppTypesStatement.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDAppTypes" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveApplTypesStmtDown" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDAppTypes", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.MoveAppTypesStmtDown" );
      try
      {
         nOptRC = wSPLD.MoveAppTypesStmtDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveApplTypesStmtUp" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDAppTypes", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.MoveAppTypesStmtUp" );
      try
      {
         nOptRC = wSPLD.MoveAppTypesStmtUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAppTypesStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.InitAppTypesStmtForUpdate" );
      try
      {
         nOptRC = wSPLD.InitAppTypesStmtForUpdate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDAppTypesStatement.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDAppTypes" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPhysicalLabelVersionData" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.InitPhysicalLabelDefForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditIngredientsSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditIngredientsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHumanHazardSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditHumanHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditPrecautionarySect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditFirstAidSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditClaimsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditSurfacesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditAreasOfUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAppTypesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditAppTypesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditDirectionsUseSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditDirectionsUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMarketingSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.EditMarketingSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDAppTypes" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDAppTypes.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDAppTypes.jsp", "wSPLD.InitAppTypesSect" );
   nOptRC = wSPLD.InitAppTypesSect( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLDAppTypes.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD" +
...
<title>SPLD Application Types Content</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDAppTypes.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptAppTypesSect( )">Save and Return</a></li>
<%
   }
%>
...
<form name="wSPLDAppTypes" id="wSPLDAppTypes" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "AppTypes" );
...
<% /* AppTypesStatements:GroupBox */ %>

<div id="AppTypesStatements" name="AppTypesStatements" style="width:732px;height:32px;float:left;">  <!-- AppTypesStatements --> 

<div  id="AppTypesStatements" name="AppTypesStatements" >Application Types Statements</div>

</div>  <!--  AppTypesStatements --> 
</div>  <!-- End of a new line -->
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      String strBMBUpdateApplTypesStatement;
      String strBMBDeleteApplTypesStatement;
      String strBMBMoveApplTypesStatementUp;
      String strBMBMoveApplTypesStatemenDown;
      
      View vAppTypesClaims;
      vAppTypesClaims = mSPLDef.newView( );
      csrRC2 = vAppTypesClaims.cursor( "SPLDI_UsageList" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vAppTypesClaims.cursor( "SPLDI_UsageList" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strSelect = "";
         nRC = vAppTypesClaims.cursor( "SPLDI_UsageList" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strSelect = vAppTypesClaims.cursor( "SPLDI_UsageList" ).getStringFromAttribute( "Selected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditAreasOfUse = vAppTypesClaims.cursor( "SPLDI_UsageList" ).getStringFromAttribute( "Name", "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="InitAppTypesStmtForUpdate( this.id )" id="GridEditAreasOfUse::<%=strEntityKey%>"><%=strGridEditAreasOfUse%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateApplTypesStatement" onclick="InitAppTypesStmtForUpdate( this.id )" id="BMBUpdateApplTypesStatement::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Display"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteApplTypesStatement" onclick="DeleteAppTypesStmt( this.id )" id="BMBDeleteApplTypesStatement::<%=strEntityKey%>"><img src="./images/ePammsDelete.jpg" alt="Delete"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveApplTypesStatementUp" onclick="MoveApplTypesStmtUp( this.id )" id="BMBMoveApplTypesStatementUp::<%=strEntityKey%>"><img src="./images/ePammsUp.jpg" alt="Move Up"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveApplTypesStatemenDown" onclick="MoveApplTypesStmtDown( this.id )" id="BMBMoveApplTypesStatemenDown::<%=strEntityKey%>"><img src="./images/ePammsDown.jpg" alt="Move Down"></a></td>

</tr>

<%
         csrRC2 = vAppTypesClaims.cursor( "SPLDI_UsageList" ).setNextContinue( );
      }
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDAppTypes" );
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDAppTypes" );
