...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteAppTypesStmt" ) )
   {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "DeleteAppTypesStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAppTypesStmtForUpdate" ) )
   {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "AppTypesStatement" );
      }
