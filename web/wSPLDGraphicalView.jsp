            ...
            <div id="zmenu" class="toggler" style="background-color:#ccc;top:0px;width:3.5in;height:8.5in;float:right;position:absolute;">   <!-- without position:relative, clone position is off -->
               <div id="zaccordion" style="margin-left:0;padding-left:0">
                ...
                <!-- <fieldset class="border" style="position:absolute;top:80px;left:15px;width:260px;height:200px;"><legend>Drag left onto page to create a new</legend> -->
                  ...
                  <!--
                  // Make sure that the appropriate Keyword entries are set up for a given Block Type.
                  ...
                  <div>
                     ...
                     -->
                        ...
                        <div class="ui-widget">
                           <label>Type: </label>
                           <select id="zBlockType" class="zeidon" data-zmap="block.z_^l^l^d_^block^type" style="float:right">
                        ...
                        &nbsp;
                        <div style="overflow:hidden; white-space:nowrap;">
                           <label for="zBlockTitle">Title:</label>
                        ...
                        &nbsp;
                        &nbsp;
                        <div id="zBlockStatementTitleToggle" style="overflow:hidden; white-space:nowrap;display:hidden;">
                           <div style="overflow:hidden; white-space:nowrap;">
                              <label for="zStatementFormat">Statement Format:</label>
                              <select id="zStatementFormat" class="zeidon" data-zmap="block.z_^statement^format" style="float:right" />
                                 <option value="">Select Statement Format...</option>
                                 <option value="SP">Separate Paragraph</option>
                                 <option value="SPN">Separate Numbered Paragraph</option>
                                 <option value="SPB">Separate Bulleted Paragraph</option>
                                 <option value="SPU">Paragraph with Usage Statements</option>
                                 <option value="L2">2 Column Usage List</option>
                                 <option value="L3">3 Column Usage List</option>
                              </select>
                           </div>
                           <div style="overflow:hidden; white-space:nowrap;">
...
-->
                     ...
                     <div id="zmbp">
                        ...
                        <div id="zFormatting">
                           <div id="zFormattingToggle" style="overflow:hidden; white-space:nowrap;">
                              ...
                              <select id="zTitlePosition" class="zeidon-special" data-zmap="block.z_^title^position" style="float:right" />
                                 <option value="">Select Title Position...</option>
                                 <option value="SL">Separate Line</option>
                                 <option value="CF">Combined w/First Paragraph</option>
                                 <option value="SK">Skip Title</option>
                              </select>
                           </div>
                           <div style="overflow:hidden; white-space:nowrap;">
                             <label for="zTextAlign">Alignment:</label>
                             <select id="zTextAlign" class="zeidon-special" data-zmap="block.z_^text^align" style="float:right" />
                                 <option value="">Select Textual Alignment...</option>
                           ...
                           <div style="overflow:hidden; white-space:nowrap;">
                             <label for="zTextLineHeight">Line Height:</label>
                             ...
                             <label for="zTextLetterSpace">Character Spacing:</label>
