...
<%-- wSystemUpdateViruses   Generate Timestamp: 20160620105934511 --%>
...
<%
   ...
   {
%>
       <li id="smImportVirusesList" name="smImportVirusesList"><a href="#"  onclick="smImportVirusesList()">Import Viruses List</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smAcceptUpdateViruses" name="smAcceptUpdateViruses"><a href="#"  onclick="smAcceptUpdateViruses()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelUpdateViruses" name="smCancelUpdateViruses"><a href="#"  onclick="smCancelUpdateViruses()">Cancel and Return</a></li>
<%
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for Virus: " + "wWebXfer.Root" );
      }
   }
%>

<input name="Virus" id="Virus" maxlength="254" style="width:530px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
try
{
   ...
   if ( VmlOperation.isValid( mEPA ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGEVirus = vGridViruses.cursor( "EPA_Claim" ).getAttribute( "Name" ).getString( "" );
