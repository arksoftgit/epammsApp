...
<%-- wPrimRUpdateMasterProduct   Generate Timestamp: 20160328163917693 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdateMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.AcceptUpdateMasterProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.CancelNewMasterProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelUpdateMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.CancelUpdateMasterProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMasterProductContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.DeleteMasterProductContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductContentDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.MoveMasterProductContentDown" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductContentUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.MoveMasterProductContentUp" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewMasterProductContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.NewMasterProductContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateMasterProductContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.UpdateMasterProductContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wStartUp.GOTO_UserList" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProduct", "wPrimR.InitMasterProductForUpdate" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for ProductName: " + "wWebXfer.Root" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for ProductDescription: " + "mPrimReg.MasterProduct" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for EPARegistrationNumber: " + "mPrimReg.MasterProduct" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for ESL_Date: " + "mPrimReg.MasterProduct" );
      }
   }
%>
...
<%
   boolean inListEPA_ToxicityCategory = false;
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      {
         inListEPA_ToxicityCategory = true;
%>
...
<%
      mPrimReg = task.getViewByName( "mPrimReg" );
      if ( VmlOperation.isValid( mPrimReg ) == false )
         task.log( ).debug( "Invalid View: " + "PBUpdateProductContentVersion" );
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mPrimReg.cursor( "MasterLabelContent" ).getAttribute( "ID" ).getString( "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on PBUpdateProductContentVersion: " + e.getMessage());
               task.log().error( "*** Error on ctrl PBUpdateProductContentVersion", e );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).debug( "MasterLabelContent.ID: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist for PBUpdateProductContentVersion: " + "mPrimReg.MasterLabelContent" );
      }
...
%>
   ...
   <td nowrap><button type="button" class="formStylebutton" name="PBUpdateProductContentVersion::<%=strEntityKey%>"  onclick="UpdateMasterProductContent( this.id )" id="PBUpdateProductContentVersion::<%=strEntityKey%>"  style="width:80px;" ><%=strErrorMapValue%></button></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteMasterProductContent" onclick="DeleteMasterProductContent( this.id )" id="BMBDeleteMasterProductContent::<%=strEntityKey%>"><img src="./images/ePammsDelete.png" alt="Delete"></a></td>
