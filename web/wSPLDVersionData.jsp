...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdatePhysicalLabelDef" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDVersionData" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDVersionData.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSPLD" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDUpdatePhysicalLabelDef.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDVersionData" );
      nRC = 1;  // do the redirection
      break;
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDVersionData" );
