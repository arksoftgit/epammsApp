...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "UpdateSurfaces", strFeedback );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSurface" ) )
   {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation UpdateSurfaceFromCurrent: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewSurfaceLast" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation NewSurface: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteSurface" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation DeleteSurface: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportSurfacesList" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ImportSurfacesList: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveSurfaceDown" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation MoveSurfaceDown: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveSurfaceUp" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation MoveSurfaceUp: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "UpdateSurfaces" );
   }
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl Surface" + e.getMessage() );
            }
...
try
{
   ...
   if ( VmlOperation.isValid( mEPA ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGESurface = vGridSurfaces.cursor( "EPA_Surface" ).getStringFromAttribute( "Name", "" );
