...
<%-- wSystemUpdateSurfaces   Generate Timestamp: 20160427103804491 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSurface" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateSurfaces", "wSystem.UpdateSurfaceFromCurrent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewSurfaceLast" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateSurfaces", "wSystem.NewSurface" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteSurface" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateSurfaces", "wSystem.DeleteSurface" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportSurfacesList" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateSurfaces", "wSystem.ImportSurfacesList" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateSurfaces", "wSystem.InitSurfacesForUpdate" );
...
<%
   ...
   {
%>
       <li id="smImportSurfacesList" name="smImportSurfacesList"><a href="#"  onclick="smImportSurfacesList()">Import Surfaces List</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smAcceptUpdateChemical" name="smAcceptUpdateChemical"><a href="#"  onclick="smAcceptUpdateSurface()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelUpdateChemical" name="smCancelUpdateChemical"><a href="#"  onclick="smCancelUpdateSurface()">Cancel and Return</a></li>
<%
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist for Surface: " + "wWebXfer.Root" );
      }
   }
%>

<input name="Surface" id="Surface" maxlength="254" style="width:538px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
