...
if ( strLastWindow.equals("wSPLDSLC_ComponentsUpdate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSLC_ComponentsUpdate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSLC_ComponentsUpdate LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSLC_ComponentsUpdate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSLC_ComponentsUpdate", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate.jsp", "wSPLD.CancelSubregistrantLabelContent" );
         nOptRC = wSPLD.CancelSubregistrantLabelContent( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAN_ClaimEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate.jsp", "wSPLD.CLEAN_ClaimEntries" );
         nOptRC = wSPLD.CLEAN_ClaimEntries( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_ComponentsDisplay" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_ReplaceWindowWithModalWindow, "wSPLD", "SLC_Components" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMLC_ComponentsForSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate.jsp", "wSPLD.DeleteMLC_ComponentsForSLC" );
         nOptRC = wSPLD.DeleteMLC_ComponentsForSLC( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate.jsp", "wSPLD.SaveSubregistrantLabelContent" );
         nOptRC = wSPLD.SaveSubregistrantLabelContent( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "REFRESH_SLC_FromMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate.jsp", "wSPLD.REFRESH_SLC_FromMLC" );
         nOptRC = wSPLD.REFRESH_SLC_FromMLC( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_ComponentsForSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate.jsp", "wSPLD.SelectMLC_ComponentsForSLC" );
         nOptRC = wSPLD.SelectMLC_ComponentsForSLC( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSLC_ComponentsUpdate" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSLC_ComponentsUpdate.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSLC_ComponentsUpdate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<form name="wSPLDSLC_ComponentsUpdate" id="wSPLDSLC_ComponentsUpdate" method="post">
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSLC_ComponentsUpdate" );
