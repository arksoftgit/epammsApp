...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.CancelSubregistrantLabelContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAN_ClaimEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.CLEAN_ClaimEntries" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMLC_ComponentsForSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.DeleteMLC_ComponentsForSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.SaveSubregistrantLabelContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "REFRESH_SLC_FromMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.REFRESH_SLC_FromMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_ComponentsForSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.SelectMLC_ComponentsForSLC" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSLC_ComponentsUpdate", "wSPLD.PostbuildSLC_Update" );
