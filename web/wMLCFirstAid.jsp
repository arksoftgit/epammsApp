                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      // EditBox: FirstAidSubtitle
      nRC = mMasLC.cursor( "M_GeneralSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         strMapValue = request.getParameter( "FirstAidSubtitle" );
         try
         {
            if ( webMapping )
               VmlOperation.CreateMessage( task, "FirstAidSubtitle", "", strMapValue );
            else
               mMasLC.cursor( "M_GeneralSection" ).setAttribute( "Title", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
            VmlOperation.CreateMessage( task, "FirstAidSubtitle", e.getReason( ), strMapValue );
         }
      }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "M_GeneralSection" ).setAttribute( "ReviewerNote", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      // MLEdit: MLEditContactNote
      nRC = mMasLC.cursor( "M_GeneralSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         strMapValue = request.getParameter( "MLEditContactNote" );
         try
         {
            if ( webMapping )
               VmlOperation.CreateMessage( task, "MLEditContactNote", "", strMapValue );
            else
               mMasLC.cursor( "M_GeneralSection" ).setAttribute( "ContactNote", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
            VmlOperation.CreateMessage( task, "MLEditContactNote", e.getReason( ), strMapValue );
         }
      }

      // MLEdit: MLEditPhysicianNote
      nRC = mMasLC.cursor( "M_GeneralSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         strMapValue = request.getParameter( "MLEditPhysicianNote" );
         try
         {
            if ( webMapping )
               VmlOperation.CreateMessage( task, "MLEditPhysicianNote", "", strMapValue );
            else
               mMasLC.cursor( "M_GeneralSection" ).setAttribute( "NoteToPhysician", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
            VmlOperation.CreateMessage( task, "MLEditPhysicianNote", e.getReason( ), strMapValue );
         }
      }
...
if ( strLastWindow.equals("wMLCFirstAid") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCFirstAid strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCFirstAid LastWindow *** " + strLastWindow );
task.log().info("*** wMLCFirstAid LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCFirstAid", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.AcceptFirstAidSect" );
      try
      {
         nOptRC = wMLC.AcceptFirstAidSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewFirstAidStmt" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCFirstAid", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.AddNewFirstAidStmt" );
      try
      {
         nOptRC = wMLC.AddNewFirstAidStmt( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation AddNewFirstAidStmt: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.CancelFirstAidSect" );
      try
      {
         nOptRC = wMLC.CancelFirstAidSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveFirstAidStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.MoveFirstAidStmtDown" );
      try
      {
         nOptRC = wMLC.MoveFirstAidStmtDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveFirstAidStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.MoveFirstAidStmtUp" );
      try
      {
         nOptRC = wMLC.MoveFirstAidStmtUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectFirstAidStmtForDelete" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCFirstAid", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.SelectFirstAidStmtForDelete" );
      try
      {
         nOptRC = wMLC.SelectFirstAidStmtForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "DeleteFirstAidStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectFirstAidStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.SelectFirstAidStmtForUpdate" );
      try
      {
         nOptRC = wMLC.SelectFirstAidStmtForUpdate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ShowHideEditorContactNote" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCFirstAid", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ShowHideEditorPhysicianNote" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCFirstAid", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMasterLabelVersionData" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditMasterLabelVersionData" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditIngredientsSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditIngredientsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHumanHazardSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditHumanHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditPrecautionarySect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditFirstAidSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditClaimsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditSurfacesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditAreasOfUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAppTypesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditAppTypesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditDirectionsUseSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditDirectionsUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMarketingSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.EditMarketingSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLCFirstAid" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCFirstAid.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCFirstAid.jsp", "wMLC.InitFirstAidSect" );
   nOptRC = wMLC.InitFirstAidSect( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wMLCFirstAid.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wMLC" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCFirstAid.js"></script>
...
<form name="wMLCFirstAid" id="wMLCFirstAid" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "FirstAid" );
...
<fieldset id="GBFirstAidSection" name="GBFirstAidSection"   style="size:absolute; width:750px; height:400px;">
<legend>First Aid Section</legend>
<% /* FirstAidTitle::Text */ %>

<label  id="FirstAidTitle:" name="FirstAidTitle:" style="width:130px;height:16px;position:absolute;left:12px;top:28px;">Title:</label>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).debug( "Entity does not exist: " + "mMasLC.M_GeneralSection" );
      }
   }
%>

<input class="text12" name="FirstAidTitle" id="FirstAidTitle" style="width:584px;position:absolute;left:152px;top:28px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* FirstAidSubtitle::Text */ %>

<label  id="FirstAidSubtitle:" name="FirstAidSubtitle:" style="width:130px;height:16px;position:absolute;left:12px;top:58px;">Subtitle:</label>

<% /* FirstAidSubtitle:EditBox */ %>
<%
   strErrorMapValue = VmlOperation.CheckError( "FirstAidSubtitle", strError );
   if ( !StringUtils.isBlank( strErrorMapValue ) )
   {
      if ( StringUtils.equals( strErrorFlag, "Y" ) )
         strErrorColor = "color:red;";
   ...
   else
   {
      ...
      mMasLC = task.getViewByName( "mMasLC" );
      if ( VmlOperation.isValid( mMasLC ) == false )
         task.log( ).debug( "Invalid View: " + "FirstAidSubtitle" );
      else
      {
         nRC = mMasLC.cursor( "M_GeneralSection" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            ...
            {
               out.println("There is an error on FirstAidSubtitle: " + e.getMessage());
               task.log().info( "*** Error on ctrl FirstAidSubtitle" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<input class="text12" name="FirstAidSubtitle" id="FirstAidSubtitle" style="width:584px;position:absolute;left:152px;top:58px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* NoteToReviewer::Text */ %>

<label  id="NoteToReviewer:" name="NoteToReviewer:" style="width:122px;height:16px;position:absolute;left:12px;top:92px;">Note to Reviewer:</label>

<% /* GroupBox4:GroupBox */ %>

<div id="GroupBox4" name="GroupBox4" style="width:584px;height:86px;position:absolute;left:152px;top:92px;">  <!-- GroupBox4 --> 
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mMasLC.cursor( "M_GeneralSection" ).getStringFromAttribute( "ReviewerNote", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "M_GeneralSection.ReviewerNote: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mMasLC.M_GeneralSection" );
      }
   }
%>
...
<% /* BtnNoteToReviewer:BitmapBtn */ %>
<img src=".\images\tinymce.png" name="BtnNoteToReviewer" id="BtnNoteToReviewer" onclick="ShowHideEditorNoteToReviewer( )" style="width:22px;height:22px;position:absolute;left:738px;top:124px;" title="Note to Reviewer Show/Hide Editor"  alt="Note to Reviewer Show/Hide Editor" >

<% /* ContactNote::Text */ %>

<label  id="ContactNote:" name="ContactNote:" style="width:122px;height:16px;position:absolute;left:12px;top:204px;">Contact Note:</label>

<% /* GroupBox3:GroupBox */ %>

<div id="GroupBox3" name="GroupBox3" style="width:584px;height:86px;position:absolute;left:152px;top:204px;">  <!-- GroupBox3 --> 

<% /* MLEditContactNote:MLEdit */ %>
<%
   // MLEdit: MLEditContactNote
   strErrorMapValue = VmlOperation.CheckError( "MLEditContactNote", strError );
   if ( !StringUtils.isBlank( strErrorMapValue ) )
   {
      if ( StringUtils.equals( strErrorFlag, "Y" ) )
         strErrorColor = "color:red;";
   ...
   else
   {
      ...
      mMasLC = task.getViewByName( "mMasLC" );
      if ( VmlOperation.isValid( mMasLC ) == false )
         task.log( ).info( "Invalid View: " + "MLEditContactNote" );
      else
      {
         nRC = mMasLC.cursor( "M_GeneralSection" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strErrorMapValue = mMasLC.cursor( "M_GeneralSection" ).getStringFromAttribute( "ContactNote", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "M_GeneralSection.ContactNote: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mMasLC.M_GeneralSection" );
      }
...
<textarea name="MLEditContactNote" id="MLEditContactNote" class="mceSimple" style="width:576px;height:86px;position:absolute;left:0px;top:0px;border:solid;border-width:4px;border-style:groove;"><%=strErrorMapValue%></textarea>


</div>  <!--  GroupBox3 --> 
<% /* BtnContactNote:BitmapBtn */ %>
<img src=".\images\tinymce.png" name="BtnContactNote" id="BtnContactNote" onclick="ShowHideEditorContactNote( )" style="width:22px;height:22px;position:absolute;left:738px;top:230px;" title="Contact Note Show/Hide Editor"  alt="Contact Note Show/Hide Editor" >

<% /* NoteToPhysician::Text */ %>

<label  id="NoteToPhysician:" name="NoteToPhysician:" style="width:122px;height:16px;position:absolute;left:12px;top:310px;">Note to Physician:</label>

<% /* GroupBox1:GroupBox */ %>

<div id="GroupBox1" name="GroupBox1" style="width:584px;height:86px;position:absolute;left:152px;top:310px;">  <!-- GroupBox1 --> 

<% /* MLEditPhysicianNote:MLEdit */ %>
<%
   // MLEdit: MLEditPhysicianNote
   strErrorMapValue = VmlOperation.CheckError( "MLEditPhysicianNote", strError );
   if ( !StringUtils.isBlank( strErrorMapValue ) )
   {
      if ( StringUtils.equals( strErrorFlag, "Y" ) )
         strErrorColor = "color:red;";
   ...
   else
   {
      ...
      mMasLC = task.getViewByName( "mMasLC" );
      if ( VmlOperation.isValid( mMasLC ) == false )
         task.log( ).info( "Invalid View: " + "MLEditPhysicianNote" );
      else
      {
         nRC = mMasLC.cursor( "M_GeneralSection" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strErrorMapValue = mMasLC.cursor( "M_GeneralSection" ).getStringFromAttribute( "NoteToPhysician", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).info( "M_GeneralSection.NoteToPhysician: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mMasLC.M_GeneralSection" );
      }
...
<textarea name="MLEditPhysicianNote" id="MLEditPhysicianNote" class="mceSimple" style="width:576px;height:86px;position:absolute;left:0px;top:0px;border:solid;border-width:4px;border-style:groove;"><%=strErrorMapValue%></textarea>


</div>  <!--  GroupBox1 --> 
<% /* BtnPhysicianNote:BitmapBtn */ %>
<img src=".\images\tinymce.png" name="BtnPhysicianNote" id="BtnPhysicianNote" onclick="ShowHideEditorPhysicianNote( )" style="width:22px;height:22px;position:absolute;left:738px;top:334px;" title="Physician Note Show/Hide Editor"  alt="Physician Note Show/Hide Editor" >

</fieldset>  <!-- GBFirstAidSection --> 
<div id='clear'></div>
...
<div id="GBFirstAidStatements" name="GBFirstAidStatements" style="float:left;width:486px;"  class="listgroup">
...
<span class="listheader"  id="FirstAidStatements" name="FirstAidStatements" style="width:154px;height:16px;">First Aid Statements</span>

</td>
<td valign="top"  class="newbutton" style="width:78px;">
<% /* New:PushBtn */ %>
<button type="button" class="newbutton"  id="New" name="New" value="New" onclick="AddNewFirstAidStmt( )"  style="width:78px;height:26px;">New</button>
...
<% /* GridFirstAid:Grid */ %>
<table  cols=5 style=""  name="GridFirstAid" id="GridFirstAid">
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditFirstAid = vGridFirstAid.cursor( "M_GeneralStatement" ).getStringFromAttribute( "Text", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateFirstAidStatement" onclick="SelectFirstAidStmtForUpdate( this.id )" id="BMBUpdateFirstAidStatement::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteFirstAidStatement" onclick="SelectFirstAidStmtForDelete( this.id )" id="BMBDeleteFirstAidStatement::<%=strEntityKey%>"><img src="./images/ePammsDelete.jpg" alt="Delete"></a></td>
...
<div id="GroupBox2" name="GroupBox2" style="width:40px;height:24px;float:left;">  <!-- GroupBox2 --> 
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCFirstAid" );
