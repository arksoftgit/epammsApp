...
<%-- wStartUpAdminNewSubregUser   Generate Timestamp: 20160427103755471 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminAcceptNewSubregUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewSubregUser", "wStartUp.AcceptNewSubregUser" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelNewSubregUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewSubregUser", "wStartUp.CancelNewSubregUser" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewSubregUser", "wStartUp.AddNewSubregUser" );
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "AdminNewSubregUser", "" );
   }
...
<%
   ...
   {
%>
       <li id="smSaveAndReturn" name="smSaveAndReturn"><a href="#"  onclick="smAdminAcceptNewSubregUser()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smAdminCancelNewSubregUser()">Cancel and Return</a></li>
<%
   }
%>
