      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "M_MarketingUsageOrdering" ).setAttribute( "wSelected", strMapValue );
               else
                  vGridTmp.cursor( "M_MarketingUsageOrdering" ).setAttribute( "wSelected", "" );
         }
...
if ( strLastWindow.equals("wMLC2MarketingSelectByType") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2MarketingSelectByType strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2MarketingSelectByType LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2MarketingSelectByType LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2MarketingSelectByType", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2MarketingSelectByType.jsp", "wMLC2.CLEAR_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CLEAR_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2MarketingSelectByType.jsp", "wMLC2.CLEAR_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "RemoveMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2MarketingSelectByType.jsp", "wMLC2.RemoveMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMLC_UsageEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2MarketingSelectByType.jsp", "wMLC2.SelectMLC_UsageEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageSource" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2MarketingSelectByType.jsp", "wMLC2.SETALL_MLC_UsageSource" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SETALL_MLC_UsageTarget" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2MarketingSelectByType.jsp", "wMLC2.SETALL_MLC_UsageTarget" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2MarketingSelectByType" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2MarketingSelectByType.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2MarketingSelectByType.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "MarketingSelectByType" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2MarketingSelectByType.js"></script>
...
<form name="wMLC2MarketingSelectByType" id="wMLC2MarketingSelectByType" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "MarketingSelectByType" );
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridCheckCtl2 = vGrid1.cursor( "M_MarketingUsageOrdering" ).getStringFromAttribute( "wSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl2 = vGrid1.cursor( "M_MarketingUsage" ).getStringFromAttribute( "UsageType", "FullUsageType" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl3 = vGrid1.cursor( "M_MarketingUsage" ).getStringFromAttribute( "dDisplayUsageName", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2MarketingSelectByType" );
