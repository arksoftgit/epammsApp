                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      nRC = mSubLC.cursor( "SI_FirstAidSection" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "SI_FirstAidSection" ).setAttribute( "Title", strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "SI_FirstAidSection" ).setAttribute( "ReviewerNote", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      csrRC = vGridTmp.cursor( "S_FirstAidStatement" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "S_FirstAidStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "S_FirstAidStatement" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSLCFirstAid") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCFirstAid strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCFirstAid LastWindow *** " + strLastWindow );
task.log().info("*** wSLCFirstAid LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCFirstAid", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.AcceptFirstAidSect" );
      try
      {
         nOptRC = wSLC.AcceptFirstAidSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.CancelFirstAidSect" );
      try
      {
         nOptRC = wSLC.CancelFirstAidSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectFirstAidStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.SelectFirstAidStmtForDelete" );
      try
      {
         nOptRC = wSLC.SelectFirstAidStmtForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "DeleteFirstAidStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveFirstAidStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.MoveFirstAidStmtDown" );
      try
      {
         nOptRC = wSLC.MoveFirstAidStmtDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StayOnWindowWithRefresh, "wSLC", "FirstAid" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveFirstAidStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.MoveFirstAidStmtUp" );
      try
      {
         nOptRC = wSLC.MoveFirstAidStmtUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitFirstAidStmtForInsert" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCFirstAid", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.InitFirstAidStmtForInsert" );
      try
      {
         nOptRC = wSLC.InitFirstAidStmtForInsert( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation InitFirstAidStmtForInsert: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "FirstAidStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectFirstAidStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.SelectFirstAidStmtForUpdate" );
      try
      {
         nOptRC = wSLC.SelectFirstAidStmtForUpdate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSubregLabelVersionData" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditSubregLabelVersionData" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smIngredients" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditIngredientsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smStorageDisposal" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHumanHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditHumanHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smPrecautionary" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditPrecautionarySect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smFirstAid" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditFirstAidSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smClaims" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditClaimsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSurfaces" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditSurfacesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditAreasOfUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smApplicationTypes" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditAppTypesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDirectionsForUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditDirectionsUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smMarketing" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.EditMarketingSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCFirstAid" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCFirstAid.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCFirstAid.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCFirstAid.jsp", "wSLC.InitFirstAidSect" );
   nOptRC = wSLC.InitFirstAidSect( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCFirstAid.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCFirstAid.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#" class="sideselected"  onclick="smFirstAid( )">First Aid</a></li>
<%
   }
%>
...
<form name="wSLCFirstAid" id="wSLCFirstAid" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "FirstAid" );
...
<div id="FirstAidSection" name="FirstAidSection" class="withborder" style="width:734px;height:96px;float:left;">  <!-- FirstAidSection --> 
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSubLC.cursor( "SI_FirstAidSection" ).getStringFromAttribute( "Title", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "SI_FirstAidSection.Title: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSubLC.SI_FirstAidSection" );
      }
   }
%>

<input name="FirstAidTitle" id="FirstAidTitle" style="width:560px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mSubLC.cursor( "SI_FirstAidSection" ).getStringFromAttribute( "ReviewerNote", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).debug( "SI_FirstAidSection.ReviewerNote: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSubLC.SI_FirstAidSection" );
      }
...
<textarea id="NoteToReviewer" name="NoteToReviewer" class="" style="width:560px;height:16px;border:solid;border-width:2px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
...
<div id="GBFirstAidStatements" name="GBFirstAidStatements" style="width:730px;height:42px;float:left;">  <!-- GBFirstAidStatements --> 
...
<span  id="FirstAidStatements" name="FirstAidStatements" style="width:222px;height:16px;">First Aid Statements</span>
...
<div style="height:1px;width:14px;float:left;"></div>   <!-- Width Spacer -->
<% /* GridFirstAid:Grid */ %>
<table  cols=1 style=""  name="GridFirstAid" id="GridFirstAid">

<thead><tr>

   <th>First Aid Statement</th>
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      View vGridFirstAid;
      vGridFirstAid = mSubLC.newView( );
      csrRC2 = vGridFirstAid.cursor( "S_FirstAidStatement" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridFirstAid.cursor( "S_FirstAidStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strGridEditFirstAid = "";
         nRC = vGridFirstAid.cursor( "S_FirstAidStatement" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditFirstAid = vGridFirstAid.cursor( "S_FirstAidStatement" ).getStringFromAttribute( "Text", "" );
...
<tr<%=strOdd%>>
   ...
   <td><%=strGridEditFirstAid%></td>

</tr>

<%
         csrRC2 = vGridFirstAid.cursor( "S_FirstAidStatement" ).setNextContinue( );
      }
      vGridFirstAid.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCFirstAid" );
