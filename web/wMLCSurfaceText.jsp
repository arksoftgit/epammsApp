...
<%-- wMLCSurfaceText   Generate Timestamp: 20160328163909847 --%>
...
if ( strLastWindow.equals("wMLCSurfaceText") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCSurfaceText strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCSurfaceText LastWindow *** " + strLastWindow );
task.log().info("*** wMLCSurfaceText LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DisplayGeneratedTextUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCSurfaceText", "wMLC.GOTO_DisplayGeneratedTextUsage" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCSurfaceText" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCSurfaceText.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCSurfaceText.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SurfaceText", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCSurfaceText.js"></script>
...
<form name="wMLCSurfaceText" id="wMLCSurfaceText" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "SurfaceText" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCSurfaceText" );
