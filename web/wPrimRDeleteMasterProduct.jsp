...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mPrimReg.cursor( "Organization" ).getAttribute( "LoginName" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mPrimReg.cursor( "MasterProduct" ).getAttribute( "Name" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mPrimReg.cursor( "MasterLabelContent" ).getAttribute( "Version" ).getString( "" );
      }
      catch (Exception e)
      {
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wPrimRDeleteMasterProduct" );
