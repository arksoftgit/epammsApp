...
if ( strLastWindow.equals("wPrimRDeleteMasterProduct") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wPrimRDeleteMasterProduct strActionToProcess *** " + strActionToProcess );
task.log().info("*** wPrimRDeleteMasterProduct LastWindow *** " + strLastWindow );
task.log().info("*** wPrimRDeleteMasterProduct LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRDeleteMasterProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wPrimR.ConfirmDeleteMasterProduct" );
      try
      {
         nOptRC = wPrimR.ConfirmDeleteMasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wPrimR.CancelDeleteMasterProduct" );
      try
      {
         nOptRC = wPrimR.CancelDeleteMasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wPrimRDeleteMasterProduct" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wPrimRDeleteMasterProduct.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wPrimRDeleteMasterProduct.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDeleteMasterProduct.jsp", "wPrimR.InitMasterProductForDelete" );
   nOptRC = wPrimR.InitMasterProductForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wPrimRDeleteMasterProduct.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wPrimR" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wPrimRDeleteMasterProduct.js"></script>
...
<form name="wPrimRDeleteMasterProduct" id="wPrimRDeleteMasterProduct" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wPrimR", "DeleteMasterProduct" );
...
<div id="MasterProduct" name="MasterProduct" class="noborder" style="width:702px;height:134px;float:left;">  <!-- MasterProduct --> 

<div  id="MasterProduct" name="MasterProduct" >Master Product</div>
...
<span  id="ProductVersion:" name="ProductVersion:" style="width:172px;height:16px;">Product Version:</span>
...
<% strTextDisplayValue = "";
   mPrimReg = task.getViewByName( "mPrimReg" );
   if ( VmlOperation.isValid( mPrimReg ) == false )
      task.log( ).debug( "Invalid View: " + "ProductVersion" );
   else
   {
      nRC = mPrimReg.cursor( "MasterLabelContent" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mPrimReg.cursor( "MasterLabelContent" ).getStringFromAttribute( "Version", "" );
      }
      catch (Exception e)
      {
         out.println("There is an error on ProductVersion: " + e.getMessage());
         task.log().info( "*** Error on ctrl ProductVersion" + e.getMessage() );
      }
         if ( strTextDisplayValue == null )
            strTextDisplayValue = "";
      }
...
<span  id="ProductVersion" name="ProductVersion" style="width:300px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="Confirm" name="Confirm" style="width:452px;height:16px;">Are you sure you want to delete this Master Product Version?</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wPrimRDeleteMasterProduct" );
