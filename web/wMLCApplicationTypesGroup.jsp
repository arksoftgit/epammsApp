...
<%-- wMLCApplicationTypesGroup   Generate Timestamp: 20160427124120989 --%>
...
if ( strLastWindow.equals("wMLCApplicationTypesGroup") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCApplicationTypesGroup strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCApplicationTypesGroup LastWindow *** " + strLastWindow );
task.log().info("*** wMLCApplicationTypesGroup LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_AddGroupUsageStatements" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCApplicationTypesGroup", "wMLC.GOTO_AddGroupUsageStatements" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateGroupUsageStatement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCApplicationTypesGroup", "wMLC.GOTO_UpdateGroupUsageStatement" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCApplicationTypesGroup" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCApplicationTypesGroup.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCApplicationTypesGroup.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ApplicationTypesGroup", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCApplicationTypesGroup.js"></script>
...
<form name="wMLCApplicationTypesGroup" id="wMLCApplicationTypesGroup" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "ApplicationTypesGroup" );
...
<label class="groupbox"  id="OrganismClaimsStatements1" name="OrganismClaimsStatements1" style="width:158px;height:16px;position:absolute;left:6px;top:12px;">Application Types Group Seq. No:</label>
...
<% /* PushBtn3:PushBtn */ %>
<button type="button" name="PushBtn3" id="PushBtn3" value="" onclick="GOTO_SelectUsagesForGroup( )" style="width:336px;height:26px;position:absolute;left:270px;top:98px;">Go to Select Existing Application Types for Group</button>
...
<thead><tr>
   ...
   <th>Select</th>
   <th>Application Types within Group</th>
   <th>Update</th>
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strApplicationTypes = vGridClaims1.cursor( "M_UsageGroupUsage" ).getAttribute( "Name" ).getString( "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="GOTO_UpdateGroupUsageStatement( this.id )" id="ApplicationTypes::<%=strEntityKey%>"><%=strApplicationTypes%></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCApplicationTypesGroup" );
