...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wStart.SaveFeedback( "mOrganiz", "wStart", "SecurityQuestionsUpdate", strFeedback );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SET_Question1" ) )
   {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SET_Question1: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SET_Question2" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SET_Question2: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SET_Question3" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SET_Question3: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UPDATE_SecurityQuestions" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation UPDATE_SecurityQuestions: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SecurityQuestionsUpdate" );
   }
...
<% /* EditBox5:EditBox */ %>
<input class="text10" name="EditBox5" id="EditBox5" style="width:320px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<td valign="top"  class="text10" style="width:320px;">
<% /* EditBox6:EditBox */ %>
<input class="text10" name="EditBox6" id="EditBox6" style="width:320px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<td valign="top"  class="text10" style="width:320px;">
<% /* EditBox9:EditBox */ %>
<input class="text10" name="EditBox9" id="EditBox9" style="width:320px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
