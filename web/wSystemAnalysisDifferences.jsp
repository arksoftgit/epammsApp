...
<div id="GroupBox1" name="GroupBox1" style="width:854px;height:552px;float:left;">  <!-- GroupBox1 --> 
...
<table  cols=3 style="width:826px;"  name="GridAnalysisResults" id="GridAnalysisResults">
