...
<%-- wSubRNewSubregUser   Generate Timestamp: 20160427103801247 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewSubregUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRNewSubregUser", "wSubR.AcceptNewSubregUser" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewSubregUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRNewSubregUser", "wSubR.CancelNewSubregUser" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRNewSubregUser", "wSubR.InitSubregUserForInsert" );
...
<%
   ...
   {
%>
       <li id="smSaveAndReturn" name="smSaveAndReturn"><a href="#"  onclick="smAcceptNewSubregUser()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelNewSubregUser()">Cancel and Return</a></li>
<%
   }
%>
...
<div id="GroupBox6" name="GroupBox6" style="width:506px;height:250px;float:left;">  <!-- GroupBox6 --> 

<div  id="GroupBox6" name="GroupBox6" >GroupBox6</div>
...
<select  name="CBPState" id="CBPState" size="1" style="width:180px;" onchange="CBPStateOnChange( )">
