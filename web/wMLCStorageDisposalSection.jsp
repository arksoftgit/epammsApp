...
<input class="text12" name="StorateDisposalSubTitle" id="StorateDisposalSubTitle" maxlength="1024" style="width:592px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
