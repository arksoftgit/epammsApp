...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCMarketingStatement.jsp", "wStartUp.Template" );
      try
      {
...
<fieldset id="GBMarketingStatement" name="GBMarketingStatement"   style="size:absolute; width:732px; height:50px;">
<% /* MarketingTitle::Text */ %>

<label  id="MarketingTitle:" name="MarketingTitle:" style="width:124px;height:16px;position:absolute;left:12px;top:12px;">Marketing Title:</label>
...
<label class="text14bold"  id="Marketing Title" name="Marketing Title" style="width:562px;height:16px;position:absolute;left:150px;top:12px;"><%=strTextDisplayValue%></label>

<% /* PBCleanHTML:PushBtn */ %>
<button type="button" name="PBCleanHTML" id="PBCleanHTML" value="" onclick="CleanMarketingStmtHTML( )" style="width:102px;height:24px;position:absolute;left:612px;top:38px;">Clean HTML</button>

</fieldset>  <!-- GBMarketingStatement --> 
<div id='clear'></div>
...
<fieldset id="MarketingStatement" name="MarketingStatement"   style="size:absolute; width:732px; height:324px;">
<legend>Marketing Statement</legend>
...
<textarea name="StatementText" id="StatementText" class="mceSimple" style="width:680px;height:316px;position:absolute;left:18px;top:24px;border:solid;border-width:4px;border-style:groove;"><%=strErrorMapValue%></textarea>

<% /* BtnStatementText:BitmapBtn */ %>
<img src=".\images\tinymce.png" name="BtnStatementText" id="BtnStatementText" onclick="ShowHideEditorStatementText( )" style="width:22px;height:22px;position:absolute;left:704px;top:134px;" title="Note to Reviewer Show/Hide Editor"  alt="Statement Text Show/Hide Editor" >

</fieldset>  <!-- MarketingStatement --> 
<div id='clear'></div>
