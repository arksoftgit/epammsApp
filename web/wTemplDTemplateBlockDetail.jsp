...
if ( strLastWindow.equals("wTemplDTemplateBlockDetail") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wTemplDTemplateBlockDetail strActionToProcess *** " + strActionToProcess );
task.log().info("*** wTemplDTemplateBlockDetail LastWindow *** " + strLastWindow );
task.log().info("*** wTemplDTemplateBlockDetail LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelTemplateBlock" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wTemplD.CancelTemplateBlock" );
      try
      {
         nOptRC = wTemplD.CancelTemplateBlock( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteTemplateSection" ) )
   {
      ...
      try
      {
         nOptRC = wTemplD.DeleteTemplateSection( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewTemplateSection" ) )
   {
      ...
      try
      {
         nOptRC = wTemplD.NewTemplateSection( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wTemplD.SetWebRedirection( vKZXMLPGO, wTemplD.zWAB_StartModalSubwindow, "wTemplD", "TemplateSectionDetail" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptTemplateBlock" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wTemplD.AcceptTemplateBlock" );
      try
      {
         nOptRC = wTemplD.AcceptTemplateBlock( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateTemplateSection" ) )
   {
      ...
      try
      {
         nOptRC = wTemplD.UpdateTemplateSection( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wTemplDTemplateBlockDetail.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wTemplDTemplateBlockDetail" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wTemplDTemplateBlockDetail.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wTemplDTemplateBlockDetail.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<title>TemplateBlockDetail</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wTemplDTemplateBlockDetail.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptTemplateBlock( )">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelTemplateBlock( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wTemplDTemplateBlockDetail" id="wTemplDTemplateBlockDetail" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wTemplD", "TemplateBlockDetail" );
...
<% /* BlockAndSections:Text */ %>

<span class="PageTitle"  id="BlockAndSections" name="BlockAndSections" style="width:382px;height:16px;">Block and Sections</span>
...
<% /* GroupBox:GroupBox */ %>
<div id="GroupBox" name="GroupBox" style="float:left;width:488px;" >
...
<span  id="BlockName:" name="BlockName:" style="width:134px;height:16px;">Block Name:</span>
...
<span style="width:134px;height:16px;">&nbsp Show Box</span>

</td>
<td valign="top" style="width:346px;">
<% /* GroupBox1:GroupBox */ %>
<div id="GroupBox1" name="GroupBox1" style="width:346px;height:16px;float:left;">
</div>  <!-- GroupBox1 --> 
</td>
</tr>
<tr>
...
<input name="BlockTitleClass" id="BlockTitleClass" style="width:144px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<a href="#" id="ShowHideMCE" name="ShowHideMCE"  onclick="ShowHideBlockTitle( );" style="width:154px;height:18px;">Show/Hide Editor</a>
...
<% /* GridTemplateSections:Grid */ %>
<table  cols=4 style=""  name="GridTemplateSections" id="GridTemplateSections">
...
<%
   session.setAttribute( "ZeidonWindow", "wTemplDTemplateBlockDetail" );
