...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wStart.SaveFeedback( "mOrganiz", "wStart", "SecurityValidations", strFeedback );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "VERIFY_SSNandDOB" ) )
   {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation VERIFY_SSNandDOB: " + e.getMessage();
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SecurityValidations" );
   }
