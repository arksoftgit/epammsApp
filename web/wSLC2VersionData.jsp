...
if ( strLastWindow.equals("wSLC2VersionData") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLC2VersionData strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLC2VersionData LastWindow *** " + strLastWindow );
task.log().info("*** wSLC2VersionData LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLC2VersionData", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.SaveSLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.CancelAndReturnSLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplayPrecautionarySection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayFirstAidSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplayFirstAidSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplayHazardsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplayClaimsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplaySurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplaySurfacesSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplayAreasOfUseSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smDisplayApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLC2VersionData.jsp", "wSLC2.DisplayApplicationTypesSection" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLC2VersionData" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLC2VersionData.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLC2VersionData.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLC2VersionData.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#" class="sideselected"  onclick="smDisplayVersionData( )">Version Data</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smDisplayClaimsSection( )">Organism Claims</a></li>
<%
   }
%>
...
<form name="wSLC2VersionData" id="wSLC2VersionData" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC2", "VersionData" );
...
<div id="GBStorDispSections1" name="GBStorDispSections1" class="listgroup"   style="float:left;position:relative; width:534px; height:36px;">  <!-- GBStorDispSections1 --> 

<% /* OrganismClaimsStatements2:Text */ %>

<label class="groupbox"  id="OrganismClaimsStatements2" name="OrganismClaimsStatements2" style="width:238px;height:16px;position:absolute;left:2px;top:12px;">Registrant Product</label>
...
<div id="GroupBox1" name="GroupBox1" class="listgroup"   style="float:left;position:relative; width:534px; height:26px;">  <!-- GroupBox1 --> 

<% /* Text1:Text */ %>

<label class="groupbox"  id="Text1" name="Text1" style="width:238px;height:16px;position:absolute;left:2px;top:10px;">Subreg Label Content</label>
...
<div id="GroupBox8" name="GroupBox8"   style="float:left;position:relative; width:534px; height:52px;">  <!-- GroupBox8 --> 

<% /* Text8:Text */ %>

<label  id="Text8" name="Text8" style="width:130px;height:18px;position:absolute;left:16px;top:4px;">SLC Name:</label>
...
<input name="EditBox2" id="EditBox2" style="width:338px;position:absolute;left:166px;top:4px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >

<% /* Text9:Text */ %>

<label  id="Text9" name="Text9" style="width:130px;height:18px;position:absolute;left:16px;top:22px;">SLC Version:</label>
...
<input name="EditBox3" id="EditBox3" style="width:338px;position:absolute;left:166px;top:22px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<%
   session.setAttribute( "ZeidonWindow", "wSLC2VersionData" );
