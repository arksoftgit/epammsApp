      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mUser.cursor( "User" ).setAttribute( "UserName", strMapValue, "" );
         }
...
if ( strLastWindow.equals("wSystemPersonDetailDelete") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemPersonDetailDelete strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemPersonDetailDelete LastWindow *** " + strLastWindow );
task.log().info("*** wSystemPersonDetailDelete LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "PersonDetailDelete", strFeedback );
      }
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemPersonDetailDelete", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemPersonDetailDelete.jsp", "wSystem.DeletePerson" );
      try
      {
         nOptRC = wSystem.DeletePerson( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation DeletePerson: " + e.getMessage();
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemPersonDetailDelete" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemPersonDetailDelete.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemPersonDetailDelete.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "PersonDetailDelete" );
   }
...
<title>Person Detail Delete</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSystemPersonDetailDelete.js"></script>
...
<form name="wSystemPersonDetailDelete" id="wSystemPersonDetailDelete" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSystem", "PersonDetailDelete" );
...
<span class="text14"  id="Text6" name="Text6" style="width:356px;height:16px;">System > Person Delete</span>
...
<div id="GroupBox2" name="GroupBox2" class="noborder" style="width:308px;height:114px;float:left;">  <!-- GroupBox2 --> 
...
<span class="mylegend"  id="Text29" name="Text29" style="width:300px;height:16px;">Details</span>
...
<span class="text10"  id="Text2" name="Text2" style="width:50px;height:16px;">Name:</span>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mUser.cursor( "User" ).getStringFromAttribute( "UserName", "" );
            }
            catch (Exception e)
            {
...
<span class="text10"  id="Text7" name="Text7" style="width:290px;height:16px;">Are you sure you want to delete this Person?</span>
...
<div>  <!-- Beginning of a new line -->
<span style="height:28px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
<% /* PushBtn2:PushBtn */ %>
<button type="button" class="formStylebutton" name="PushBtn2" id="PushBtn2" value="" onclick="DeletePerson( )" style="width:82px;height:28px;">Delete</button>

<span style="height:28px;">&nbsp&nbsp&nbsp&nbsp</span>
<% /* PushBtn3:PushBtn */ %>
<button type="button" class="formStylebutton" name="PushBtn3" id="PushBtn3" value="" onclick="ESC( )" style="width:82px;height:28px;">Cancel</button>
