...
<%-- wSystemPersonDetailDelete   Generate Timestamp: 20160620105933853 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeletePerson" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemPersonDetailDelete", "wSystem.DeletePerson" );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "PersonDetailDelete", "" );
   }
...
<input class="text10" name="EditBox2" id="EditBox2" maxlength="128" style="width:194px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
