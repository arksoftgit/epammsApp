...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteMarketingSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wMLC.CancelDeleteMarketingSect" );
      try
      {
         nOptRC = wMLC.CancelDeleteMarketingSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMarketingStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wMLC.SelectMarketingStmtForDelete" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMarketingStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wMLC.MoveMarketingStmtDown" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMarketingStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wMLC.MoveMarketingStmtUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMarketingStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wMLC.SelectMarketingStmtForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wStartUp.Template" );
      try
      {
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMarketingSection.jsp", "wMLC.InitMarketingSectForDelete" );
   nOptRC = wMLC.InitMarketingSectForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wMLCDeleteMarketingSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wMLC" +
...
<div id="MarketingStatements" name="MarketingStatements" class="listgroup" style="width:736px;height:258px;float:left;">  <!-- MarketingStatements --> 
...
<% /* GridMarketing:Grid */ %>
<table class="listheader" cols=5 style=""  name="GridMarketing" id="GridMarketing">
