...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewSubregProduct" ) )
   {
      ...
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wStartUpAdminListSubregProducts" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnFromSubregProductList" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wStartUpAdminListSubregProducts.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectSubregProductForDelete" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSubRDeleteSubregProduct.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wStartUpAdminListSubregProducts" );
      nRC = 1;  // do the redirection
      break;
