...
<%-- wStartUpAdminListSubregProducts --%>
...
if ( strLastWindow.equals("wStartUpAdminListSubregProducts") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminListSubregProducts strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminListSubregProducts LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminListSubregProducts LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewSubregProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListSubregProducts", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wSubR", "NewSubregProduct" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnFromSubregProductList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListSubregProducts", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectSubregProductForDelete" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListSubregProducts", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.SelectSubregProductForDelete" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wSubR", "DeleteSubregProduct" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectSubregProductForUpdate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListSubregProducts", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.SelectSubregProductForUpdate" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wSubR", "UpdateSubregProduct" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smReturnFromSubregProductList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListSubregProducts", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListSubregProducts.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminListSubregProducts" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminListSubregProducts.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminListSubregProducts" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminListSubregProducts.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnFromSubregProductList( )">Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminListSubregProducts" id="wStartUpAdminListSubregProducts" method="post">
...
<span  id="Subregistrant:" name="Subregistrant:" style="width:134px;height:16px;">Subregistrant:</span>
...
<span  id="Subregistrant" name="Subregistrant" style="width:586px;height:16px;"><%=strTextDisplayValue%></span>
...
<% /* SubregistrantProducts:GroupBox */ %>
<div id="SubregistrantProducts" name="SubregistrantProducts" style="float:left;width:486px;"  class="listgroup">

<table cols=0 style="width:486px;"  class="grouptable">

<tr>
<td valign="top"  class="newbutton" style="width:78px;">
<% /* PBAdminNewSubregProduct:PushBtn */ %>
<button type="button" class="newbutton"  id="PBAdminNewSubregProduct" name="PBAdminNewSubregProduct" value="New" onclick="AddNewSubregProduct( )"  style="width:78px;height:26px;">New</button>

</td>
</tr>
</table>

</div>  <!-- SubregistrantProducts --> 
...
<table class="listheader" cols=5 style=""  name="GridSubregProducts" id="GridSubregProducts">
...
try
{
   ...
   if ( VmlOperation.isValid( mSubreg ) )
   {
      ...
      String strOdd;
      String strTag;
      String strGEProducttName;
      String strGEProductNumber;
      String strGEProductDescription;
      ...
      csrRC2 = vGridSubregProducts.cursor( "SubregProduct" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGEProducttName = vGridSubregProducts.cursor( "SubregProduct" ).getStringFromAttribute( "Name", "" );

            if ( strGEProducttName == null )
               strGEProducttName = "";
         }

         if ( StringUtils.isBlank( strGEProducttName ) )
            strGEProducttName = "&nbsp";

         strGEProductNumber = "";
         nRC = vGridSubregProducts.cursor( "SubregProduct" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGEProductNumber = vGridSubregProducts.cursor( "SubregProduct" ).getStringFromAttribute( "Number", "" );

            if ( strGEProductNumber == null )
               strGEProductNumber = "";
         }

         if ( StringUtils.isBlank( strGEProductNumber ) )
            strGEProductNumber = "&nbsp";

         strGEProductDescription = "";
         nRC = vGridSubregProducts.cursor( "SubregProduct" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGEProductDescription = vGridSubregProducts.cursor( "SubregProduct" ).getStringFromAttribute( "Description", "" );

            if ( strGEProductDescription == null )
               strGEProductDescription = "";
         }

         if ( StringUtils.isBlank( strGEProductDescription ) )
            strGEProductDescription = "&nbsp";
...
<%
   session.setAttribute( "ZeidonWindow", "wStartUpAdminListSubregProducts" );
