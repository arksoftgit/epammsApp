...
if ( strLastWindow.equals("wMLC2ApplicationTypes") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2ApplicationTypes strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2ApplicationTypes LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2ApplicationTypes LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2ApplicationTypes", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "ApplicationTypesStatement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.SaveAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.SaveMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.CancelAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditPrecautionarySection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditFirstAidSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditHazardsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditClaimsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditSurfacesSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditAreasOfUseSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2ApplicationTypes.jsp", "wMLC2.EditApplicationTypesSection" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2ApplicationTypes" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2ApplicationTypes.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2ApplicationTypes.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2ApplicationTypes.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#" class="sideselected"  onclick="smEditApplicationTypesSection( )">Application Types</a></li>
<%
   }
%>
...
<form name="wMLC2ApplicationTypes" id="wMLC2ApplicationTypes" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "ApplicationTypes" );
...
<span class="groupbox"  id="OrganismClaimsStatements" name="OrganismClaimsStatements" style="width:238px;height:16px;">Application Types Statements</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2ApplicationTypes" );
