      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "M_IngredientsSection" ).getAttribute( "ActiveTitle" ).setValue( strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "M_IngredientsSection" ).getAttribute( "InertTitle" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_IngredientsStatementAdd" ) )
   {
      bDone = true;
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "GOTO_IngredientsStatementAdd", e.getMessage( ), "" );
         break;
      }
      // Next Window
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_IngredientsStatementDelete" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCIngredients", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.GOTO_IngredientsStatementDelete" );
      nOptRC = wMLC.GOTO_IngredientsStatementDelete( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_IngredientsStatementUpdate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCIngredients", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "GOTO_IngredientsStatementUpdate", e.getMessage( ), "" );
         break;
      }
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "IngredientsStatement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.SaveMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.CancelAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazards" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditEnvironmentalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditChemicalHazardsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditChemicalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditClaimsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditSurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditAreasOfUseSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.EditApplicationTypesSection" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCIngredients", "wMLC.InitIngredientsSect" );
...
<%
   ...
   {
%>
       <li id="smIngredients" name="smIngredients"><a href="#"  class="sideselected"  onclick="smEditIngredientsSect()">Ingredients</a></li>
<%
   }
%>
...
<label class="groupbox"  id="IngredientsText" name="IngredientsText" style="width:238px;height:16px;position:absolute;left:6px;top:12px;">Ingredients</label>
...
<div id="GroupBox1" name="GroupBox1" style="width:780px;height:80px;float:left;">  <!-- GroupBox1 --> 
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mMasLC.cursor( "M_IngredientsSection" ).getAttribute( "ActiveTitle" ).getString( "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on ActiveTitle: " + e.getMessage());
               task.log().error( "*** Error on ctrl ActiveTitle", e );
            }
...
<input class="text12" name="ActiveTitle" id="ActiveTitle" style="width:620px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mMasLC.cursor( "M_IngredientsSection" ).getAttribute( "InertTitle" ).getString( "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on InertTitle: " + e.getMessage());
               task.log().error( "*** Error on ctrl InertTitle", e );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<input class="text12" name="InertTitle" id="InertTitle" style="width:620px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().error( "*** Error on ctrl GeneralInertPercentage", e );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<input class="text12" name="GeneralInertPercentage" id="GeneralInertPercentage" style="width:50px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<div id="GBIngredients" name="GBIngredients" class="listgroup"   style="float:left;position:relative; width:780px; height:40px;">  <!-- GBIngredients --> 
...
<% /* New:PushBtn */ %>
<button type="button" class="newbutton" name="New" id="New" value="" onclick="GOTO_IngredientsStatementAdd( )" style="width:78px;height:26px;position:absolute;left:342px;top:12px;">New</button>
...
<table  cols=5 style="width:780px;"  name="GridIngredients" id="GridIngredients">
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditIngredients = vGridIngredients.cursor( "M_IngredientsStatement" ).getAttribute( "dIngredientName" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditActiveInert = vGridIngredients.cursor( "M_IngredientsStatement" ).getAttribute( "Active" ).getString( "ActiveInert" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditPercent = vGridIngredients.cursor( "M_IngredientsStatement" ).getAttribute( "Percent" ).getString( "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="GOTO_IngredientsStatementUpdate( this.id )" id="GridEditIngredients::<%=strEntityKey%>"><%=strGridEditIngredients%></a></td>
   <td><a href="#" onclick="GOTO_IngredientsStatementUpdate( this.id )" id="GridEditActiveInert::<%=strEntityKey%>"><%=strGridEditActiveInert%></a></td>
   <td><a href="#" onclick="GOTO_IngredientsStatementUpdate( this.id )" id="GridEditPercent::<%=strEntityKey%>"><%=strGridEditPercent%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateIngredientsStatement" onclick="GOTO_IngredientsStatementUpdate( this.id )" id="BMBUpdateIngredientsStatement::<%=strEntityKey%>"><img src="./images/ePammsUpdate.png" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteIngredientsStatement" onclick="GOTO_IngredientsStatementDelete( this.id )" id="BMBDeleteIngredientsStatement::<%=strEntityKey%>"><img src="./images/ePammsDelete.png" alt="Delete"></a></td>
