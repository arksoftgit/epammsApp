...
<%-- wSPLD2SPLD_BlockDefinitionUpdateSub --%>
                           ...
                           boolean webMapping )
{
   ...
   {
      // ComboBox: ComboBox1
      nRC = mSPLDef.cursor( "LLD_SubBlock" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "LLD_SectionType", strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "Left", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "Top", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "Height", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "Width", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "ImageName", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "ContinuationBlockFlag", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_SubBlock" ).setAttribute( "LLD_ColumnListType", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      csrRC = vGridTmp.cursor( "LLD_SpecialSectionAttributeSub" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "LLD_SpecialSectionAttributeSub" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "LLD_SpecialSectionAttributeSub" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLD2SPLD_BlockDefinitionUpdateSub") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2SPLD_BlockDefinitionUpdateSub strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2SPLD_BlockDefinitionUpdateSub LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2SPLD_BlockDefinitionUpdateSub LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2SPLD_BlockDefinitionUpdateSub", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdateSub.jsp", "wSPLD2.ACCEPT_BlockSubBlockDefinition" );
      try
      {
         nOptRC = wSPLD2.ACCEPT_BlockSubBlockDefinition( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ACCEPT_BlockSubBlockDefinition: " + e.getMessage();
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLD2SPLD_BlockDefinitionUpdateSub" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLD2SPLD_BlockDefinitionUpdateSub.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CANCEL_BlockSubBlockDefinition" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdateSub.jsp", "wSPLD2.CANCEL_BlockSubBlockDefinition" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DELETE_SpecialFormatDef" ) )
   {
      ...
      if ( VmlOperation.isValid( mSPLDef ) )
      {
         ...
         csrRC = mSPLDef.cursor( "LLD_SpecialSectionAttributeSub" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mSPLDef.cursor( "LLD_SpecialSectionAttributeSub" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mSPLDef.cursor( "LLD_SpecialSectionAttributeSub" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mSPLDef.cursor( "LLD_SpecialSectionAttributeSub" ).setNextContinue( );
            } // Grid
         }
      }

      // Stay on Window with Refresh
      strURL = response.encodeRedirectURL( "wSPLD2SPLD_BlockDefinitionUpdateSub.jsp" );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_NewSpecialFormatDefinition" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdateSub.jsp", "wSPLD2.GOTO_NewSpecialFormatDefinition" );
      try
      {
         nOptRC = wSPLD2.GOTO_NewSpecialFormatDefinition( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_NewSpecialFormatDefinition: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_SelectMarketingSection" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLD2SPLD_BlockMarketingSectionSelect.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLD2SPLD_BlockDefinitionUpdateSub" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSpecialFormatDef" ) )
   {
      ...
      nRC = 0;
      EntityCursor cursor = mSPLDef.cursor( "LLD_SpecialSectionAttributeSub" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2SPLD_BlockDefinitionUpdateSub" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2SPLD_BlockDefinitionUpdateSub.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdateSub.jsp", "wSPLD2.PostbuildBlockDefinitionUpdate" );
   nOptRC = wSPLD2.PostbuildBlockDefinitionUpdate( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLD2SPLD_BlockDefinitionUpdateSub.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD2" +
...
<title>SPLD_BlockDefinitionUpdateSub</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2SPLD_BlockDefinitionUpdateSub.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="ACCEPT_BlockSubBlockDefinition( )">Accept and Return</a></li>
<%
   }
%>
...
<form name="wSPLD2SPLD_BlockDefinitionUpdateSub" id="wSPLD2SPLD_BlockDefinitionUpdateSub" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "SPLD_BlockDefinitionUpdateSub" );
...
<%
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSPLDef , "LLD_SubBlock", "LLD_SectionType", "" );

      nRC = mSPLDef.cursor( "LLD_SubBlock" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "LLD_SectionType", "" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "Left", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "LLD_SubBlock.Left: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.LLD_SubBlock" );
      }
   }
%>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "Top", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "LLD_SubBlock.Top: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.LLD_SubBlock" );
      }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "Height", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "LLD_SubBlock.Height: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.LLD_SubBlock" );
      }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "Width", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on EditBox5: " + e.getMessage());
               task.log().info( "*** Error on ctrl EditBox5" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).debug( "LLD_SubBlock.Width: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.LLD_SubBlock" );
      }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "ImageName", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "LLD_SubBlock.ImageName: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.LLD_SubBlock" );
      }
...
<%
   ...
   else
   {
      nRC = mSPLDef.cursor( "LLD_SubBlock" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
         strRadioGroupValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "ContinuationBlockFlag" );
   }
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "BlockSubBlockComponent" ).getStringFromAttribute( "Name", "" );
      }
      catch (Exception e)
      {
...
<div id="GroupBox1" name="GroupBox1" style="width:114px;height:36px;float:left;">  <!-- GroupBox1 --> 
...
<span  id="Text10" name="Text10" style="width:106px;height:14px;">Claim List Type:</span>
...
<div id="GroupBox12" name="GroupBox12" style="width:222px;height:36px;float:left;">  <!-- GroupBox12 --> 
...
<select  name="ComboBox2" id="ComboBox2" size="1" style="width:186px;" onchange="ComboBox2OnChange( )">

<%
   mSPLDef = task.getViewByName( "mSPLDef" );
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSPLDef , "LLD_SubBlock", "LLD_ColumnListType", "" );

      nRC = mSPLDef.cursor( "LLD_SubBlock" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSPLDef.cursor( "LLD_SubBlock" ).getStringFromAttribute( "LLD_ColumnListType", "" );
         if ( strComboCurrentValue == null )
            strComboCurrentValue = "";
      }
      else
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGrid2.cursor( "LLD_SpecialSectionAttributeSub" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid2.cursor( "LLD_SpecialSectionAttributeSub" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strGridEditCtl2 = "";
         nRC = vGrid2.cursor( "LLD_SpecialSectionAttributeSub" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditCtl2 = vGrid2.cursor( "LLD_SpecialSectionAttributeSub" ).getStringFromAttribute( "Name", "" );
         ...
         strGridEditCtl1 = "";
         nRC = vGrid2.cursor( "LLD_SpecialSectionAttrSubBlock" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditCtl1 = vGrid2.cursor( "LLD_SpecialSectionAttrSubBlock" ).getStringFromAttribute( "FontSize", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl5 = vGrid2.cursor( "LLD_SpecialSectionAttrSubBlock" ).getStringFromAttribute( "MarginBottom", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl3 = vGrid2.cursor( "LLD_SpecialSectionAttrSubBlock" ).getStringFromAttribute( "FontWeight", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl4 = vGrid2.cursor( "LLD_SpecialSectionAttrSubBlock" ).getStringFromAttribute( "Color", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BitmapBtn1" onclick="GOTO_UpdateSpecialFormatDef( this.id )" id="BitmapBtn1::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BitmapBtn4" onclick="DELETE_SpecialFormatDef( this.id )" id="BitmapBtn4::<%=strEntityKey%>"><img src="./images/ePammsDelete.jpg" alt="Delete"></a></td>

</tr>

<%
         csrRC2 = vGrid2.cursor( "LLD_SpecialSectionAttributeSub" ).setNextContinue( );
      }
      vGrid2.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2SPLD_BlockDefinitionUpdateSub" );
