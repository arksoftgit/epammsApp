                           ...
                           boolean webMapping )
{
   ...
   {
      // MLEdit: wysiwygEditor
      nRC = wWebXfer.cursor( "Root" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         strMapValue = request.getParameter( "wysiwygEditor" );
         try
         {
            if ( webMapping )
               VmlOperation.CreateMessage( task, "wysiwygEditor", "", strMapValue );
            else
               wWebXfer.cursor( "Root" ).setAttribute( "HTML", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
            VmlOperation.CreateMessage( task, "wysiwygEditor", e.getReason( ), strMapValue );
         }
      }
...
if ( strLastWindow.equals("wPrimRDesignMasterProduct") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wPrimRDesignMasterProduct strActionToProcess *** " + strActionToProcess );
task.log().info("*** wPrimRDesignMasterProduct LastWindow *** " + strLastWindow );
task.log().info("*** wPrimRDesignMasterProduct LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptDesignMasterProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRDesignMasterProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wPrimR.AcceptDesignMasterProduct" );
      try
      {
         nOptRC = wPrimR.AcceptDesignMasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation AcceptDesignMasterProduct: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnToProductList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRDesignMasterProduct", strActionToProcess );

      // Next Window
      strNextJSP_Name = wPrimR.SetWebRedirection( vKZXMLPGO, wPrimR.zWAB_ReturnToParent, "", "" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRDesignMasterProduct.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wPrimRDesignMasterProduct" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wPrimRDesignMasterProduct.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wPrimRDesignMasterProduct.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wPrimRDesignMasterProduct.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wPrimR" +
                         "&OperationName=" + "InitDesignMasterProduct";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DesignMasterProduct" );
   }
...
<title>Design Master Product</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wPrimRDesignMasterProduct.js"></script>
...
<form name="wPrimRDesignMasterProduct" id="wPrimRDesignMasterProduct" method="post">
...
<span  id="MasterProductName" name="MasterProductName" style="width:350px;height:16px;font-weight:bold;">Master Product Name</span>

<span style="height:16px;">&nbsp&nbsp</span>
<% /* MasterProductDescription:Text */ %>

<span  id="MasterProductDescription" name="MasterProductDescription" style="width:534px;height:16px;font-weight:bold;">Master Product Description</span>

<span style="height:24px;">&nbsp&nbsp&nbsp</span>
<% /* PBAcceptDesignMasterProduct:PushBtn */ %>
<button type="button" class="formStylebutton" name="PBAcceptDesignMasterProduct" id="PBAcceptDesignMasterProduct" value="" onclick="AcceptDesignMasterProduct( )" style="width:80px;height:24px;">Update</button>
...
<%
   // MLEdit: wysiwygEditor
   strErrorMapValue = VmlOperation.CheckError( "wysiwygEditor", strError );
   ...
   else
   {
      ...
      if ( VmlOperation.isValid( wWebXfer ) == false )
         task.log( ).info( "Invalid View: " + "wysiwygEditor" );
      else
      {
         nRC = wWebXfer.cursor( "Root" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strErrorMapValue = wWebXfer.cursor( "Root" ).getStringFromAttribute( "HTML", "" );
...
<textarea name="wysiwygEditor" id="wysiwygEditor" class="mceSimple mceAdvancedFull" style="width:910px;height:824px;border:solid;border-width:4px;border-style:groove;"><%=strErrorMapValue%></textarea>
