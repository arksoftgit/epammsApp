...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdateSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wSubR.AcceptUpdateSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelUpdateSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wSubR.CancelUpdateSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewProdLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wSubR.NewSubregLabelContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateProdLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wSubR.UpdateSubregLabelContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wStartUp.ProcessLogin" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregProduct", "wSubR.InitSubregProductForUpdate" );
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "UpdateSubregProduct", "" );
   }
...
<%
   ...
   {
%>
       <li id="smSaveAndReturn" name="smSaveAndReturn"><a href="#"  onclick="smAcceptUpdateSubregProduct()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelUpdateSubregProduct()">Cancel and Return</a></li>
<%
   }
%>
...
<div id="GBRegistrant" name="GBRegistrant" style="width:624px;height:82px;float:left;">  <!-- GBRegistrant --> 

<div  id="GBRegistrant" name="GBRegistrant" >Registrant</div>
...
<div id="GBProduct" name="GBProduct" style="width:624px;height:194px;float:left;">  <!-- GBProduct --> 

<div  id="GBProduct" name="GBProduct" >Product</div>
...
<span  id="escription:" name="escription:" style="width:172px;height:16px;">Description:</span>
...
<div id="GBLabelContent" name="GBLabelContent" class="listgroup" style="width:624px;height:178px;float:left;">  <!-- GBLabelContent --> 

<div  id="GBLabelContent" name="GBLabelContent" >Label Content</div>
...
<button type="button" class="newbutton" name="PBNewProdLabelContent" id="PBNewProdLabelContent" value="" onclick="NewProdLabelContent( )" style="width:78px;height:26px;">New</button>
...
<% /* GridLabels:Grid */ %>
<div class="tableScroll"  style="width:606px;height:124px;">
...
try
{
   ...
   if ( VmlOperation.isValid( mSubreg ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridLabelName = vGridLabels.cursor( "SubregLabelContent" ).getAttribute( "Version" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGridContentDescription = vGridLabels.cursor( "SubregLabelContent" ).getAttribute( "Description" ).getString( "" );
