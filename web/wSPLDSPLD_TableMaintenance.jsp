...
<%-- wSPLDSPLD_TableMaintenance   Generate Timestamp: 20170427141139624 --%>
                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC = vGridTmp.cursor( "SPLD_MetaTable" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SPLD_MetaTable" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "SPLD_MetaTable" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLDSPLD_TableMaintenance") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSPLD_TableMaintenance strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSPLD_TableMaintenance LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSPLD_TableMaintenance LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSPLD_TableMaintenance", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DISPLAY_TableData" ) )
   {
      ...
      if ( VmlOperation.isValid( mSPLDef ) )
      {
         ...
         csrRC = mSPLDef.cursor( "SPLD_MetaTable" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mSPLDef.cursor( "SPLD_MetaTable" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mSPLDef.cursor( "SPLD_MetaTable" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mSPLDef.cursor( "SPLD_MetaTable" ).setNextContinue( );
            } // Grid
         }
      }
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.SetListItemPosition" );
      nOptRC = wSPLD.SetListItemPosition( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "SPLD_TableData" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.SaveSPLD_AndReturn" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.CancelSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.SaveSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGraphicalView" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.SetSPLD_Resume" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGENERATE_SPLD_Label" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.GENERATE_SPLD_Label" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGenerateLabelDottedBorders" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.GENERATE_SPLD_LabelDottedBorders" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smHumanHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smFirstAid" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smStorageDisposal" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.ExecuteJOE_Test1" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smPrecautionary" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazard" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.DisplayPhysicalChemicalHazards" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCLEAN_SPLD_Data" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_TableMaintenance", "wSPLD.CLEAN_SPLD_Data" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSPLD_TableMaintenance" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSPLD_TableMaintenance.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSPLD_TableMaintenance.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SPLD_TableMaintenance", "" );
   }
...
<title>SPLD Table Maintenance</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDSPLD_TableMaintenance.js"></script>
...
<%
   ...
   {
%>
       <li id="smTables" name="smTables"><a href="#"  class="sideselected"  onclick="smTables()">Tables</a></li>
<%
   }
%>
...
<form name="wSPLDSPLD_TableMaintenance" id="wSPLDSPLD_TableMaintenance" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "SPLD_TableMaintenance" );
...
<% strTextDisplayValue = "";
   ...
   {
      nRC = mSPLDef.cursor( "Organization" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "Organization" ).getAttribute( "Name" ).getString( "" );
      }
      catch (Exception e)
      {
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      View vGridTables;
      vGridTables = mSPLDef.newView( );
      csrRC2 = vGridTables.cursor( "SPLD_MetaTable" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridTables.cursor( "SPLD_MetaTable" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGE_TableName = "";
         nRC = vGridTables.cursor( "SPLD_MetaTable" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGE_TableName = vGridTables.cursor( "SPLD_MetaTable" ).getAttribute( "Name" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGE_TableDescription = vGridTables.cursor( "SPLD_MetaTable" ).getAttribute( "Description" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGE_ColumnCnt = vGridTables.cursor( "SPLD_MetaTable" ).getAttribute( "Columns" ).getString( "" );
...
<%
         csrRC2 = vGridTables.cursor( "SPLD_MetaTable" ).setNextContinue( );
      }
      vGridTables.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSPLD_TableMaintenance" );
