...
<%
   ...
   {
%>
       <li id="smDeleteAndReturn" name="smDeleteAndReturn"><a href="#"  onclick="smConfirmDeleteSubregProduct()">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelDeleteSubregProduct()">Cancel Delete and Return</a></li>
<%
   }
%>
