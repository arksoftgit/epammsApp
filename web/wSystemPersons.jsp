...
if ( strLastWindow.equals("wSystemPersons") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemPersons strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemPersons LastWindow *** " + strLastWindow );
task.log().info("*** wSystemPersons LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "Persons", strFeedback );
      }

   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddPerson" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemPersons", strActionToProcess );
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation AddPerson: " + e.getMessage();
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_ReplaceWindowWithModalWindow, "wSystem", "PersonDetail" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeletePerson" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemPersons", strActionToProcess );
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation DeletePrePerson: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_ReplaceWindowWithModalWindow, "wSystem", "PersonDetailDelete" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdatePerson" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemPersons", strActionToProcess );
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation UpdatePerson: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemPersons" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemPersons.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemPersons.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSystemPersons.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitPersons";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "Persons" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSystemPersons.js"></script>
...
<form name="wSystemPersons" id="wSystemPersons" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSystem", "Persons" );
...
<span class="text14"  id="Text3" name="Text3" style="width:222px;height:16px;">System > People > Persons</span>
...
<div id="GroupBox4" name="GroupBox4" style="width:610px;height:28px;float:left;">  <!-- GroupBox4 --> 
...
<% /* PushBtn10:PushBtn */ %>
<button type="button" class="formStylebutton" name="PushBtn10" id="PushBtn10" value="" onclick="AddPerson( )" style="width:82px;height:28px;">Add</button>
...
<div id="GroupBox8" name="GroupBox8" class="content" style="width:610px;height:446px;overflow:auto;float:left;">  <!-- GroupBox8 --> 
...
<div style="height:1px;width:2px;float:left;"></div>   <!-- Width Spacer -->
<% /* GridPerson:Grid */ %>
<table class="sortable"  cols=4 style=""  name="GridPerson" id="GridPerson">
...
try
{
   ...
   if ( VmlOperation.isValid( lPersonLST ) )
   {
      ...
      String strOdd;
      String strTag;
      String strSS_EditCtl8;
      String strGridEditCtl1;
      
      View vGridPerson;
      vGridPerson = lPersonLST.newView( );
      csrRC2 = vGridPerson.cursor( "Person" ).setFirstWithinOi( );
      while ( csrRC2.isSet() )
      {
...
<%
         csrRC2 = vGridPerson.cursor( "Person" ).setNextContinue( );
      }
      vGridPerson.drop( );
   }
}
