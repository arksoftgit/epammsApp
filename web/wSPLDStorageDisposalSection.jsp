                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC = vGridTmp.cursor( "SPLD_StorageDisposalStatement" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SPLD_StorageDisposalStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "SPLD_StorageDisposalStatement" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLDStorageDisposalSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDStorageDisposalSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDStorageDisposalSection LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDStorageDisposalSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDStorageDisposalSection", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.AcceptStorDispSect" );
      try
      {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDStorageDisposalSection" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDStorageDisposalSection.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.CancelStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.SelectStorDispStmtForDelete" );
      try
      {
         nOptRC = wSPLD.SelectStorDispStmtForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDDeleteStorageDisposalStatement.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDStorageDisposalSection" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveStorDispStmtDown" ) )
   {
      ...
      if ( VmlOperation.isValid( mSPLDef ) )
      {
         ...
         csrRC = mSPLDef.cursor( "SPLD_StorageDisposalStatement" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mSPLDef.cursor( "SPLD_StorageDisposalStatement" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mSPLDef.cursor( "SPLD_StorageDisposalStatement" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mSPLDef.cursor( "SPLD_StorageDisposalStatement" ).setNextContinue( );
            } // Grid
         }
      }
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.MoveStorDispStmtDown" );
      try
      {
         nOptRC = wSPLD.MoveStorDispStmtDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveStorDispStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.MoveStorDispStmtUp" );
      try
      {
         nOptRC = wSPLD.MoveStorDispStmtUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAddNewStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.SaveAddNewStorDispSect" );
      try
      {
         nOptRC = wSPLD.SaveAddNewStorDispSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.SelectStorDispStmtForUpdate" );
      try
      {
         nOptRC = wSPLD.SelectStorDispStmtForUpdate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDStorageDisposalSection" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDStorageDisposalSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDStorageDisposalSection.jsp", "wSPLD.InitStorDispSectForDelete" );
   nOptRC = wSPLD.InitStorDispSectForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLDStorageDisposalSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDStorageDisposalSection.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAcceptStorDispSect( )">Return</a></li>
<%
   }
%>
...
<form name="wSPLDStorageDisposalSection" id="wSPLDStorageDisposalSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "StorageDisposalSection" );
...
<span  id="StorDispTitle:" name="StorDispTitle:" style="width:130px;height:16px;">Storage/Disposal Title:</span>

</td>
<td valign="top" style="width:558px;">
<% /* StorDispTitle:EditBox */ %>
<%
   strErrorMapValue = VmlOperation.CheckError( "StorDispTitle", strError );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "SPLD_StorageDisposalSection" ).getStringFromAttribute( "Title", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "SPLD_StorageDisposalSection.Title: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.SPLD_StorageDisposalSection" );
      }
   }
%>

<input name="StorDispTitle" id="StorDispTitle"  disabled style="width:558px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="ContainerVolume:" name="ContainerVolume:" style="width:130px;height:16px;">Container Volume:</span>

</td>
<td valign="top" style="width:66px;">
<% /* ContainerVolume:EditBox */ %>
<%
   strErrorMapValue = VmlOperation.CheckError( "ContainerVolume", strError );
   if ( !StringUtils.isBlank( strErrorMapValue ) )
   {
      if ( StringUtils.equals( strErrorFlag, "Y" ) )
         strErrorColor = "color:red;";
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "SPLD_StorageDisposalSection" ).getStringFromAttribute( "ContainerVolume", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "SPLD_StorageDisposalSection.ContainerVolume: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.SPLD_StorageDisposalSection" );
      }
...
<input name="ContainerVolume" id="ContainerVolume"  disabled style="width:66px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<span  id="SectionType:" name="SectionType:" style="width:130px;height:16px;">Section Type:</span>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "SPLD_StorageDisposalSection" ).getStringFromAttribute( "SDSectionType", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "SPLD_StorageDisposalSection.SDSectionType: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.SPLD_StorageDisposalSection" );
      }
...
<input name="SectionType" id="SectionType"  disabled style="width:160px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mSPLDef.cursor( "SPLD_StorageDisposalSection" ).getStringFromAttribute( "ReviewerNote", "" );
            if ( strErrorMapValue == null )
               strErrorMapValue = "";

            task.log( ).debug( "SPLD_StorageDisposalSection.ReviewerNote: " + strErrorMapValue );
         }
         else
            task.log( ).debug( "Entity does not exist: " + "mSPLDef.SPLD_StorageDisposalSection" );
      }
...
<textarea id="NoteToReviewer" name="NoteToReviewer" class="" style="width:558px;height:28px;border:solid;border-width:4px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
...
<div id="StorDispStatements" name="StorDispStatements" style="width:732px;height:36px;float:left;">  <!-- StorDispStatements --> 
...
<% /* GridStorDisp:Grid */ %>
<table  cols=4 style=""  name="GridStorDisp" id="GridStorDisp">
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGridStorDisp.cursor( "SPLD_StorageDisposalStatement" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridStorDisp.cursor( "SPLD_StorageDisposalStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strGridEditStorDisp = "";
         nRC = vGridStorDisp.cursor( "SPLD_StorageDisposalStatement" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditStorDisp = vGridStorDisp.cursor( "SPLD_StorageDisposalStatement" ).getStringFromAttribute( "Text", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateStorDispStmt" onclick="SelectStorDispStmtForUpdate( this.id )" id="BMBUpdateStorDispStmt::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Display"></a></td>
...
<%
         csrRC2 = vGridStorDisp.cursor( "SPLD_StorageDisposalStatement" ).setNextContinue( );
      }
      vGridStorDisp.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDStorageDisposalSection" );
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDStorageDisposalSection" );
