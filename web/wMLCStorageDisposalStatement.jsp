...
<%-- wMLCStorageDisposalStatement   Generate Timestamp: 20160525203754653 --%>
...
<input class="text12" name="ReviewerNote" id="ReviewerNote" maxlength="254" style="width:592px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
