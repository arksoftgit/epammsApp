...
<textarea id="MLEdit3" name="MLEdit3" class="" style="width:738px;height:46px;border:solid;border-width:4px;border-style:groove;style="width:738px;heig wrap="wrap"><%=strErrorMapValue%></textarea>
...
<textarea id="MLEdit2" name="MLEdit2" class="" style="width:754px;height:302px;border:solid;border-width:4px;border-style:groove;style="width:754px;hei wrap="wrap"><%=strErrorMapValue%></textarea>
