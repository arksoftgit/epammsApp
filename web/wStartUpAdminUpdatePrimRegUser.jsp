      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               wWebXfer.cursor( "Root" ).setAttribute( "TracePassword", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminAcceptUpdatePrimRegUser" ) )
   {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation AcceptUpdatePrimRegUser: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelUpdatePrimRegUser" ) )
   {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation CancelUpdatePrimRegUser: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser.jsp", "wStartUp.Template" );
      try
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminUpdatePrimRegUser" );
   }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = wWebXfer.cursor( "Root" ).getStringFromAttribute( "TracePassword", "" );
            }
            catch (Exception e)
            {
