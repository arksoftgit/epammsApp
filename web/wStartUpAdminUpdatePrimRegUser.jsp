...
<%-- wStartUpAdminUpdatePrimRegUser   Generate Timestamp: 20160531205251021 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminAcceptUpdatePrimRegUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.AcceptUpdatePrimRegUser" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelUpdatePrimRegUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.CancelUpdatePrimRegUser" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.GOTO_UserList" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminUpdatePrimRegUser", "wStartUp.InitPrimRegUserForUpdate" );
...
<%
   ...
   {
%>
       <li id="smSaveAndReturn" name="smSaveAndReturn"><a href="#"  onclick="smAdminAcceptUpdatePrimRegUser()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smAdminCancelUpdatePrimRegUser()">Cancel and Return</a></li>
<%
   }
%>
...
<% strTextDisplayValue = "";
   ...
   {
      nRC = mCurrentUser.cursor( "Organization" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mCurrentUser.cursor( "Organization" ).getAttribute( "Name" ).getString( "" );
      }
      catch (Exception e)
      {
...
<span  id="UserName:" name="UserName:" style="width:146px;height:16px;">UserName:</span>
...
<span  id="VerificationPassword:" name="VerificationPassword:" style="width:146px;height:16px;">Verification Password:</span>
...
<input name="EBConfirmPassword" id="EBConfirmPassword" maxlength="128" style="width:318px;<%=strErrorColor%>" type="password" value="<%=strErrorMapValue%>" onKeyPress="return _OnEnter( event )" >
...
<% /* GroupBox1:GroupBox */ %>
<div id="GroupBox1" name="GroupBox1" style="float:left;width:474px;" >
...
<span  id="PStreet:" name="PStreet:" style="width:146px;height:16px;">Street:</span>
...
<td valign="top" style="width:154px;">
<% /* GroupBox4:GroupBox */ %>
<div id="GroupBox4" name="GroupBox4" style="width:150px;height:16px;float:left;">
...
<span  id="PCity:" name="PCity:" style="width:146px;height:16px;">City:</span>
...
<span  id="PState:" name="PState:" style="width:146px;height:16px;">State:</span>
