      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "SPLD_MarketingSection" ).setAttribute( "Selected", strMapValue );
               else
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptMarketingSect" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDMarketing" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDMarketing.jsp";
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDMarketing" );
