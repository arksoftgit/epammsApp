...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "SysDefault", strFeedback );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddSysDflt" ) )
   {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation AddSysDef: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteSysDflt" ) )
   {
      ...
      if ( VmlOperation.isValid( wWebXfer ) )
      {
         ...
         if ( !csrRC.isSet() )
         {
            ...
            csrRCk = wWebXfer.cursor( "EmailListEntry" ).setFirst( );
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation DeletePreSysDef: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSysDflt" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation UpdateSysDflt: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SysDefault" );
   }
