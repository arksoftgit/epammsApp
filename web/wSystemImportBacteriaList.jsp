...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ImportBacteriaList", "" );
   }
...
<%
   ...
   {
%>
       <li id="smImportListAndReturn" name="smImportListAndReturn"><a href="#"  onclick="smConfirmImportBacteriaAndReturn()">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smImportListFromFile" name="smImportListFromFile"><a href="#"  onclick="smImportBacteriaFromFile()">Import List From File</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelImportBacteriaAndReturn()">Cancel and Return</a></li>
<%
   }
%>
...
<div id="ImportClaimsList" name="ImportClaimsList" class="withborder"   style="float:left;position:relative; width:822px; height:430px;">  <!-- ImportClaimsList --> 

<% /* ClaimsFileName::Text */ %>

<label  id="ClaimsFileName:" name="ClaimsFileName:" style="width:78px;height:16px;position:absolute;left:12px;top:28px;">File Name:</label>
...
<a href="#" id="TXSortClaimsList" name="TXSortClaimsList"  onclick="SortImportList( );" style="width:72px;height:16px;position:absolute;left:552px;top:60px;">Sort</a>
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSystemImportBacteriaList" );
