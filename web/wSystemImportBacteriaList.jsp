...
<%-- wSystemImportBacteriaList   Generate Timestamp: 20160328163928856 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportBacteriaAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportBacteriaList", "wSystem.ConfirmImportBacteriaList" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportBacteriaFromFile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportBacteriaList", "wSystem.ImportBacteriaFromFile" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportBacteriaList", "wSystem.InitImportBacteriaList" );
