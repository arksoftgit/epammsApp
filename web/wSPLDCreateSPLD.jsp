                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      if ( VmlOperation.isValid( lTemplLST ) )
      {
         ...
         if ( nRC >= 0 )
         {
            strMapValue = request.getParameter( "hSPLD_Template" );
            if ( strMapValue != null )
            {
...
if ( strLastWindow.equals("wSPLDCreateSPLD") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDCreateSPLD strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDCreateSPLD LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDCreateSPLD LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDCreateSPLD", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wSPLD.CreateSPLD" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wSPLD.CancelNewSPLD" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdateSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wSPLD.AcceptUpdateSPLD" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCreateSPLD" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDCreateSPLD", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDCreateSPLD.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDCreateSPLD" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDCreateSPLD.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "CreateSPLD" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDCreateSPLD.js"></script>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "GenerateSPLD" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smCreateSPLD( )">Generate SPLD</a></li>
<%
   }
%>
...
<form name="wSPLDCreateSPLD" id="wSPLDCreateSPLD" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "CreateSPLD" );
...
<% /* GroupBox1:GroupBox */ %>
<div id="GroupBox1" name="GroupBox1" style="float:left;width:462px;" >

<table cols=2 style="width:462px;"  class="grouptable">

<tr>
<td valign="top" style="width:116px;">
<% /* Text1:Text */ %>

<span  id="Text1" name="Text1" style="width:114px;height:16px;">SPLD Name:</span>
...
<input name="SPLD_Name" id="SPLD_Name" style="width:346px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<td valign="top" style="width:346px;">
<% /* SPLD_Template:ComboBox */ %>
<% strErrorMapValue = "";  %>

<select  name="SPLD_Template" id="SPLD_Template" size="1"style="width:346px;" onchange="SPLD_TemplateOnChange( )">
...
<%
   ...
   if ( VmlOperation.isValid( lTemplLST ) )
   {
      ...
      vSPLD_Template = lTemplLST.newView( );
      ComboCount = 0;
...
<%
      ...
      csrRC = vSPLD_Template.cursor( "Template" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         strErrorMapValue = vSPLD_Template.cursor( "Template" ).getStringFromAttribute( "Name", "" );
         if ( strErrorMapValue == null )
            strErrorMapValue = "";
...
<%
         ...
         ComboCount++;
         csrRC =  vSPLD_Template.cursor( "Template" ).setNextContinue( );
      }
...
<input name="hSPLD_Template" id="hSPLD_Template" type="hidden" value="<%=strComboSelectedValue%>" >
