...
<%-- wSPLDSPLD_DirectionsForUseCategory   Generate Timestamp: 20170510095822516 --%>
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridTitle = vGridDFU_Sections.cursor( "SPLD_DirectionsForUseSection" ).getAttribute( "Title" ).getString( "" );
