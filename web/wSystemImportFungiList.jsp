...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ImportFungiList", "" );
   }
...
<%
   ...
   {
%>
       <li id="smImportListAndReturn" name="smImportListAndReturn"><a href="#"  onclick="smConfirmImportFungiAndReturn()">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smImportListFromFile" name="smImportListFromFile"><a href="#"  onclick="smImportFungiFromFile()">Import List From File</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelImportFungiAndReturn()">Cancel and Return</a></li>
<%
   }
%>
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSystemImportFungiList" );
