...
<%-- wSystemImportFungiList   Generate Timestamp: 20160427103802659 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportFungiAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportFungiList", "wSystem.ConfirmImportFungiList" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportFungiFromFile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportFungiList", "wSystem.ImportFungiFromFile" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportFungiList", "wSystem.InitImportFungiList" );
