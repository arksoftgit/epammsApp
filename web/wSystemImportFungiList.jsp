...
if ( strLastWindow.equals("wSystemImportFungiList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemImportFungiList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemImportFungiList LastWindow *** " + strLastWindow );
task.log().info("*** wSystemImportFungiList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "ImportFungiList", strFeedback );
      }

   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelImportFungiAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportFungiList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportFungiAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportFungiList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportFungiList.jsp", "wSystem.ConfirmImportFungiList" );
      try
      {
         nOptRC = wSystem.ConfirmImportFungiList( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ConfirmImportFungiList: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportFungiFromFile" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportFungiList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportFungiList.jsp", "wSystem.ImportFungiFromFile" );
      try
      {
         nOptRC = wSystem.ImportFungiFromFile( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ImportFungiFromFile: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmImportFungiAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportFungiList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smImportFungiFromFile" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportFungiList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelImportFungiAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportFungiList", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemImportFungiList" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemImportFungiList.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemImportFungiList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportFungiList.jsp", "wSystem.InitImportFungiList" );
   nOptRC = wSystem.InitImportFungiList( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSystemImportFungiList.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitImportFungiList";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ImportFungiList" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSystemImportFungiList.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmImportFungiAndReturn( )">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smImportFungiFromFile( )">Import List From File</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelImportFungiAndReturn( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSystemImportFungiList" id="wSystemImportFungiList" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSystem", "ImportFungiList" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSystemImportFungiList" );
