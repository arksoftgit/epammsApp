...
<%-- wStartUpAdminNewPrimRegUser   Generate Timestamp: 20160427103755213 --%>
...
if ( strLastWindow.equals("wStartUpAdminNewPrimRegUser") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminNewPrimRegUser strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminNewPrimRegUser LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminNewPrimRegUser LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminAcceptNewPrimRegUser" ) )
   {
      bDone = true;
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.AcceptNewPrimRegUser" );
      nOptRC = wStartUp.AcceptNewPrimRegUser( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelNewPrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimRegUser", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.CancelNewPrimRegUser" );
      nOptRC = wStartUp.CancelNewPrimRegUser( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminAcceptNewPrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimRegUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminCancelNewPrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewPrimRegUser", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wStartUpAdminNewPrimRegUser" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminNewPrimRegUser.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewPrimRegUser", "wStartUp.AddNewPrimRegUser" );
   nOptRC = wStartUp.AddNewPrimRegUser( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wStartUpAdminNewPrimRegUser.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "AddNewPrimRegUser";
...
<title>New Primary Registrant User</title>
...
<form name="wStartUpAdminNewPrimRegUser" id="wStartUpAdminNewPrimRegUser" method="post">
...
<span  id="RegistrantName:" name="RegistrantName:" style="width:150px;height:16px;">Primary Registrant:</span>
...
<input name="EBFirstName" id="EBFirstName" maxlength="64" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBLastName" id="EBLastName" maxlength="64" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBTitle" id="EBTitle" maxlength="254" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBCPhone" id="EBCPhone" maxlength="11" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBFax" id="EBFax" maxlength="11" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBEmail" id="EBEmail" maxlength="128" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBPStreetAddress" id="EBPStreetAddress" maxlength="128" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBPAddress" id="EBPAddress" maxlength="128" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBPCity" id="EBPCity" maxlength="128" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBUserName" id="EBUserName" maxlength="128" style="width:318px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBPassword" id="EBPassword" maxlength="254" style="width:318px;<%=strErrorColor%>" type="password" value="<%=strErrorMapValue%>" >
...
<input name="EBConfirmPassword" id="EBConfirmPassword" maxlength="254" style="width:318px;<%=strErrorColor%>" type="password" value="<%=strErrorMapValue%>" >
...
<%
   session.setAttribute( "ZeidonWindow", "wStartUpAdminNewPrimRegUser" );
