...
if ( strLastWindow.equals("wMLCDeleteUsageStatements") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCDeleteUsageStatements strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCDeleteUsageStatements LastWindow *** " + strLastWindow );
task.log().info("*** wMLCDeleteUsageStatements LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCDeleteUsageStatements", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCDeleteUsageStatements" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCDeleteUsageStatements.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCDeleteUsageStatements.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<form name="wMLCDeleteUsageStatements" id="wMLCDeleteUsageStatements" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "DeleteUsageStatements" );
