...
<%-- wSLCSubregProductUpdate   Generate Timestamp: 20161010115316857 --%>
...
if ( strLastWindow.equals("wSLCSubregProductUpdate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCSubregProductUpdate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCSubregProductUpdate LastWindow *** " + strLastWindow );
task.log().info("*** wSLCSubregProductUpdate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "BACKUP_Objects" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSubregProductUpdate", "wSLC.BACKUP_Objects" );
      nOptRC = wSLC.BACKUP_Objects( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSubregProductUpdate", "wSLC.CancelSubregProduct" );
      nOptRC = wSLC.CancelSubregProduct( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteSubregProductSLC" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "DeleteSubregProductSLC" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DeleteSPLD" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSPLD", "DeleteSubregProductSPLD" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_NewSubregProductSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSubregProductUpdate", "wSLC.GOTO_NewSubregProductSLC" );
      nOptRC = wSLC.GOTO_NewSubregProductSLC( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "NewSLC_SelectMLC" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_NewSubregProductSPLD" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSPLD", "NewSPLD_SelectSLC" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProductSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSubregProductUpdate", "wSLC.GOTO_UpdateSubregProductSLC" );
      nOptRC = wSLC.GOTO_UpdateSubregProductSLC( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProductSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSubregProductUpdate", "wSLC.GOTO_UpdateSubregProductSPLD" );
      nOptRC = wSLC.GOTO_UpdateSubregProductSPLD( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSPLD", "SPLD_UpdateLLD" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSubregProductUpdate", "wSLC.SaveSubregProduct" );
      nOptRC = wSLC.SaveSubregProduct( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSLCSubregProductUpdate" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCSubregProductUpdate.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCSubregProductUpdate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCSubregProductUpdate.js"></script>
...
<form name="wSLCSubregProductUpdate" id="wSLCSubregProductUpdate" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "SubregProductUpdate" );
...
<div id="GroupBox7" name="GroupBox7"   style="float:left;position:relative; width:730px; height:28px;">  <!-- GroupBox7 --> 

<% /* SLC_ProductText:Text */ %>

<label class="groupbox"  id="SLC_ProductText" name="SLC_ProductText" style="width:338px;height:16px;position:absolute;left:0px;top:12px;">SLC Product</label>
...
<div id="GroupBox1" name="GroupBox1"   style="float:left;position:relative; width:532px; height:34px;">  <!-- GroupBox1 --> 

<% /* Text6:Text */ %>

<label class="groupbox"  id="Text6" name="Text6" style="width:250px;height:20px;position:absolute;left:16px;top:20px;">Subregistrant Product SLC Entries</label>
...
<div id="GroupBox5" name="GroupBox5"   style="float:left;position:relative; width:532px; height:34px;">  <!-- GroupBox5 --> 

<% /* Text7:Text */ %>

<label class="groupbox"  id="Text7" name="Text7" style="width:250px;height:20px;position:absolute;left:16px;top:18px;">Subregistrant Product SPLD Entries</label>
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCSubregProductUpdate" );
