...
<%-- wSLCGeneratedTextDisplay   Generate Timestamp: 20160317151020047 --%>
...
if ( strLastWindow.equals("wSLCGeneratedTextDisplay") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCGeneratedTextDisplay strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCGeneratedTextDisplay LastWindow *** " + strLastWindow );
task.log().info("*** wSLCGeneratedTextDisplay LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCGeneratedTextDisplay", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSLCGeneratedTextDisplay" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCGeneratedTextDisplay.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCGeneratedTextDisplay.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "GeneratedTextDisplay", "" );
   }
...
<title>GeneratedTextDisplay</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCGeneratedTextDisplay.js"></script>
...
<form name="wSLCGeneratedTextDisplay" id="wSLCGeneratedTextDisplay" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "GeneratedTextDisplay" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCGeneratedTextDisplay" );
