...
if ( strLastWindow.equals("wMLC2HazardsStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2HazardsStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2HazardsStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2HazardsStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptHazardsStmt" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2HazardsStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelHazardsStmt" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2HazardsStatement", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2HazardsStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2HazardsStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2HazardsStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "HazardsStatement" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2HazardsStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptHazardsStmt( )">Accept & Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelHazardsStmt( )">Cancel & Return</a></li>
<%
   }
%>
...
<form name="wMLC2HazardsStatement" id="wMLC2HazardsStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "HazardsStatement" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2HazardsStatement" );
