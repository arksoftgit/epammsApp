                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC = vGridTmp.cursor( "SelectableMarketingSection" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SelectableMarketingSection" ).getEntityKey( );
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "SelectableMarketingSection" ).setAttribute( "Selected", strMapValue );
               else
                  vGridTmp.cursor( "SelectableMarketingSection" ).setAttribute( "Selected", "" );
         }
         ...
         csrRC = vGridTmp.cursor( "SelectableMarketingSection" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLDSelectMarketingSections") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSelectMarketingSections strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSelectMarketingSections LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSelectMarketingSections LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSelectMarketingSections", strActionToProcess );
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDSelectMarketingSections.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmSelectMarketingSections" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSelectMarketingSections", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wSPLD.ConfirmSelectMarketingSections" );
      try
      {
         nOptRC = wSPLD.ConfirmSelectMarketingSections( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ConfirmSelectMarketingSections: " + e.getMessage();
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDSelectMarketingSections" );
         }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmSelectMarketingSections" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSelectMarketingSections", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSelectMarketingSections.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDSelectMarketingSections" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSelectMarketingSections.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<title>Select Marketing Sections</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDSelectMarketingSections.js"></script>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "SelectMarketingSection" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smConfirmSelectMarketingSections( )">Select Marketing Section</a></li>
<%
   }
%>
...
<form name="wSPLDSelectMarketingSections" id="wSPLDSelectMarketingSections" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "SelectMarketingSections" );
...
<% /* Grid:Grid */ %>
<div class="tableScroll"  style="width:622px;height:568px;">
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGrid.cursor( "SelectableMarketingSection" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid.cursor( "SelectableMarketingSection" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strSelect = "";
         nRC = vGrid.cursor( "SelectableMarketingSection" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strSelect = vGrid.cursor( "SelectableMarketingSection" ).getStringFromAttribute( "Selected", "" );
         ...
         if ( nRC >= 0 )
         {
            strSectionTitle = vGrid.cursor( "SelectableMarketingSection" ).getStringFromAttribute( "Title", "" );

            if ( strSectionTitle == null )
               strSectionTitle = "";
         }

         if ( StringUtils.isBlank( strSectionTitle ) )
            strSectionTitle = "&nbsp";
...
<tr<%=strOdd%>>
   ...
   <td nowrap><%=strSectionTitle%></td>

</tr>

<%
         csrRC2 = vGrid.cursor( "SelectableMarketingSection" ).setNextContinue( );
      }
      vGrid.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSelectMarketingSections" );
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDSelectMarketingSections" );
