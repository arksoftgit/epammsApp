...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteMasterProduct" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCDeleteMasterProduct" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCDeleteMasterProduct.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditMasterLabelVersionData" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wMLCUpdateMasterLabel.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCDeleteMasterProduct" );
      nRC = 1;  // do the redirection
      break;
