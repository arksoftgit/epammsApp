...
if ( strLastWindow.equals("wMLCDeleteMasterProduct") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCDeleteMasterProduct strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCDeleteMasterProduct LastWindow *** " + strLastWindow );
task.log().info("*** wMLCDeleteMasterProduct LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteMasterProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCDeleteMasterProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wMLC.CancelDeleteMasterProduct" );
      try
      {
         nOptRC = wMLC.CancelDeleteMasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation CancelDeleteMasterProduct: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelUpdateMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wMLC.CancelUpdateMasterProduct" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteMasterProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCDeleteMasterProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wMLC.ConfirmDeleteMasterProduct" );
      try
      {
         nOptRC = wMLC.ConfirmDeleteMasterProduct( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation ConfirmDeleteMasterProduct: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditMasterLabelVersionData" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCDeleteMasterProduct", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wMLC.EditMasterLabelVersionData" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "UpdateMasterLabel" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmDeleteMasterProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCDeleteMasterProduct", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelDeleteMasterProduct" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCDeleteMasterProduct", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLCDeleteMasterProduct" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCDeleteMasterProduct.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCDeleteMasterProduct.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteMasterProduct.jsp", "wMLC.InitMasterProductForDelete" );
   nOptRC = wMLC.InitMasterProductForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wMLCDeleteMasterProduct.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wMLC" +
                         "&OperationName=" + "InitMasterProductForDelete";
...
<title>Delete Master Product</title>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ConfirmDeleteAndReturn" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smConfirmDeleteMasterProduct( )">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelDeleteMasterProduct( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wMLCDeleteMasterProduct" id="wMLCDeleteMasterProduct" method="post">
...
<% /* MasterProduct:GroupBox */ %>
<div id="MasterProduct" name="MasterProduct" style="float:left;width:734px;"  class="withborder">

<table cols=2 style="width:734px;"  class="grouptable">
...
<td valign="top"  class="text14bold" style="width:570px;">
<% /* TXName:Text */ %>
<% strTextDisplayValue = "";
   mPrimReg = task.getViewByName( "mPrimReg" );
...
<span class="text14bold"  id="TXName" name="TXName" style="width:570px;height:16px;"><%=strTextDisplayValue%></span>
...
<span  id="MLC_Name:" name="MLC_Name:" style="width:130px;height:16px;">Name:</span>
...
<% strTextDisplayValue = "";
   ...
   if ( VmlOperation.isValid( mMasProd ) == false )
      task.log( ).debug( "Invalid View: " + "MLC_Name" );
   else
   {
      ...
      {
         out.println("There is an error on MLC_Name: " + e.getMessage());
         task.log().info( "*** Error on ctrl MLC_Name" + e.getMessage() );
      }
         if ( strTextDisplayValue == null )
            strTextDisplayValue = "";
      }
...
<span  id="MLC_Name" name="MLC_Name" style="width:570px;height:16px;"><%=strTextDisplayValue%></span>
...
<span  id="ProductDescription:" name="ProductDescription:" style="width:130px;height:16px;">Description:</span>

</td>
<td valign="top" style="width:568px;">
<% /* MasterProductDescription:Text */ %>
<% strTextDisplayValue = "";
   mMasProd = task.getViewByName( "mMasProd" );
   if ( VmlOperation.isValid( mMasProd ) == false )
   ...
   else
   {
      ...
      {
         out.println("There is an error on MasterProductDescription: " + e.getMessage());
         task.log().info( "*** Error on ctrl MasterProductDescription" + e.getMessage() );
      }
         if ( strTextDisplayValue == null )
            strTextDisplayValue = "";
      }
...
<span  id="MasterProductDescription" name="MasterProductDescription" style="width:568px;height:16px;"><%=strTextDisplayValue%></span>
...
<div>  <!-- Beginning of a new line -->
<div style="height:1px;width:14px;float:left;"></div>   <!-- Width Spacer -->
<% /* MasterLabelContentList:GroupBox */ %>

<div id="MasterLabelContentList" name="MasterLabelContentList" class="withborder" style="width:732px;height:340px;float:left;">  <!-- MasterLabelContentList --> 

<div  id="MasterLabelContentList" name="MasterLabelContentList" >Master Label Content</div>
...
<table  cols=3 style=""  name="GridMasterLabelContent" id="GridMasterLabelContent">
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" onclick="EditMasterLabelVersionData( this.id )" id="GridEditVersion::<%=strEntityKey%>"><%=strGridEditVersion%></a></td>
   <td nowrap><a href="#" onclick="EditMasterLabelVersionData( this.id )" id="GridEditRevisionDate::<%=strEntityKey%>"><%=strGridEditRevisionDate%></a></td>
