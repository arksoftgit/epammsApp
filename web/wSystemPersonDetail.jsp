...
<% /* EditBox1:EditBox */ %>
<input class="text10" name="EditBox1" id="EditBox1" maxlength="20" style="width:88px;<%=strErrorColor%>" tabindex=1  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox5:EditBox */ %>
<input class="text10" name="EditBox5" id="EditBox5" maxlength="20" style="width:88px;<%=strErrorColor%>" tabindex=2  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox2:EditBox */ %>
<input class="text10" name="EditBox2" id="EditBox2" maxlength="20" style="width:88px;<%=strErrorColor%>" tabindex=3  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox3:EditBox */ %>
<input class="text10" name="EditBox3" id="EditBox3" maxlength="20" style="width:88px;<%=strErrorColor%>" tabindex=4  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox4:EditBox */ %>
<input class="text10" name="EditBox4" id="EditBox4" maxlength="20" style="width:182px;<%=strErrorColor%>" tabindex=5  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox7:EditBox */ %>
<input class="text10" name="EditBox7" id="EditBox7" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=7  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox10:EditBox */ %>
<input class="text10" name="EditBox10" id="EditBox10" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=10  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox8:EditBox */ %>
<input class="text10" name="EditBox8" id="EditBox8" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=8  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox11:EditBox */ %>
<input class="text10" name="EditBox11" id="EditBox11" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=13  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox9:EditBox */ %>
<input class="text10" name="EditBox9" id="EditBox9" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=9  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox12:EditBox */ %>
<input class="text10" name="EditBox12" id="EditBox12" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=14  type="text" value="<%=strErrorMapValue%>" >
...
<% /* EditBox13:EditBox */ %>
<input class="text10" name="EditBox13" id="EditBox13" maxlength="20" style="width:136px;<%=strErrorColor%>" tabindex=15  type="text" value="<%=strErrorMapValue%>" >
