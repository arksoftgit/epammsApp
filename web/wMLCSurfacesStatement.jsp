...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptAndReturnSurfacesStatement" ) )
   {
      bDone = true;
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "AcceptAndReturnSurfacesStatement", e.getMessage( ), "" );
         break;
      }
      // Next Window
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelSurfacesStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCSurfacesStatement", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "CancelSurfacesStatement", e.getMessage( ), "" );
         break;
      }
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_ReturnToParent, "", "" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_KeywordUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCSurfacesStatement", "wMLC.DummyOperationForPositioning" );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SurfacesStatement", "" );
   }
...
<%
   ...
   {
%>
       <li id="AcceptAndReturn" name="AcceptAndReturn"><a href="#"  onclick="AcceptAndReturnSurfacesStatement()">Accept & Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="CancelAndReturn" name="CancelAndReturn"><a href="#"  onclick="CancelSurfacesStatement()">Cancel & Return</a></li>
<%
   }
%>
...
<div id="GBSurfacesStatement" name="GBSurfacesStatement" class="withborder" style="width:824px;height:28px;float:left;">  <!-- GBSurfacesStatement --> 
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mMasLC.cursor( "M_Usage" ).getAttribute( "dDisplayAtomicNames" ).getString( "" );
      }
      catch (Exception e)
      {
...
<span class="text12"  id="SurfacesName" name="SurfacesName" style="width:730px;height:16px;"><%=strTextDisplayValue%></span>
...
<label class="listheader"  id="Text1" name="Text1" style="width:398px;height:16px;position:absolute;left:10px;top:8px;">Sub-Surfaces</label>

<% /* UpdateSurface:PushBtn */ %>
<button type="button" name="UpdateSurface" id="UpdateSurface" value="" onclick="SurfaceStatementMaintenance( )" style="width:134px;height:26px;position:absolute;left:566px;top:8px;">Update Surface</button>
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="GOTO_UsageUpdate( this.id )" id="SurfaceText::<%=strEntityKey%>"><%=strSurfaceText%></a></td>
