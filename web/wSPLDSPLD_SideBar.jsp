...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditAreasOfUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditAppTypesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditAppTypesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditClaimsSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditClaimsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditDirectionsUseSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditDirectionsUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditFirstAidSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditHazardSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditHumanHazardSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditHumanHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditIngredientsSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditIngredientsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditMarketingSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditMarketingSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditPhysicalLabelVersionData" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.InitPhysicalLabelDefForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditPrecautionarySect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditPrecautionarySect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "EditSurfacesSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSPLD_SideBar.jsp", "wSPLD.EditSurfacesSect" );
      try
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "SPLD_SideBar" );
   }
