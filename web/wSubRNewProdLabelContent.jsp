...
<%-- wSubRNewProdLabelContent   Generate Timestamp: 20160328163927372 --%>
...
<%
   ...
   {
%>
       <li id="Login" name="Login"><a href="#"  onclick="AcceptNewProdLabelContent()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="Login" name="Login"><a href="#"  onclick="CancelNewProdLabelContent()">Cancel and Return</a></li>
<%
   }
%>
