      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSubLC.cursor( "SubregProduct" ).setAttribute( "Name", strMapValue, "" );
         }
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewProdLabelContent" );
   }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSubLC.cursor( "SubregProduct" ).getStringFromAttribute( "Name", "" );
            }
            catch (Exception e)
            {
