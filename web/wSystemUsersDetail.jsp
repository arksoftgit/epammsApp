...
<%-- wSystemUsersDetail   Generate Timestamp: 20160317151027214 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ESC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUsersDetail", "wSystem.CancelUser" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "IncludeUserPerson" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUsersDetail", "wSystem.IncludeUserPerson" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUsersDetail", "wSystem.SaveUser" );
