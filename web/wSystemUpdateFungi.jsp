...
<%-- wSystemUpdateFungi   Generate Timestamp: 20160427103804386 --%>
...
<input name="Fungi" id="Fungi" maxlength="254" style="width:514px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
