...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "UpdateFungi", strFeedback );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewFungiLast" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.NewFungi" );
      try
      {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation NewFungi: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteFungi" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.DeleteClaim" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportFungiList" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.ImportFungiList" );
      try
      {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ImportFungiList: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateFungi" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.UpdateFungiFromCurrent" );
      try
      {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation UpdateFungiFromCurrent: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveFungiDown" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateFungi", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.MoveFungiDown" );
      try
      {
         nOptRC = wSystem.MoveFungiDown( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation MoveFungiDown: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveFungiUp" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateFungi", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.MoveFungiUp" );
      try
      {
         nOptRC = wSystem.MoveFungiUp( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation MoveFungiUp: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateFungi.jsp", "wSystem.InitFungiForUpdate" );
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "UpdateFungi" );
   }
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smImportFungiList( )">Import Fungi List</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAcceptUpdateFungi( )">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelUpdateFungi( )">Cancel and Return</a></li>
<%
   }
%>
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl Fungi" + e.getMessage() );
            }
...
<input name="Fungi" id="Fungi" style="width:580px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<% /* GridFungi:Grid */ %>
<table  cols=6 style=""  name="GridFungi" id="GridFungi">
...
try
{
   ...
   if ( VmlOperation.isValid( mEPA ) )
   {
      ...
      String strBMBMoveFungiUp;
      String strBMBMoveFungiDown;
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGEFungi = vGridFungi.cursor( "EPA_Claim" ).getStringFromAttribute( "Name", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveFungiUp" onclick="MoveFungiUp( this.id )" id="BMBMoveFungiUp::<%=strEntityKey%>"><img src="./images/ePammsUp.jpg" alt="Up"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBMoveFungiDown" onclick="MoveFungiDown( this.id )" id="BMBMoveFungiDown::<%=strEntityKey%>"><img src="./images/ePammsDown.jpg" alt="Down"></a></td>
