...
if ( strLastWindow.equals("wMLC2DirectionsForUse") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2DirectionsForUse strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2DirectionsForUse LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2DirectionsForUse LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DirectionsForUseSectionAdd" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2DirectionsForUse", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "DirectionsForUseSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DirsForUseSectionDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.GOTO_DirsForUseSectionDelete" );
      try
      {
         nOptRC = wMLC2.GOTO_DirsForUseSectionDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_DirsForUseSectionDelete: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.SaveAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.SaveMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.CancelAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditPrecautionarySection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditFirstAidSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditHazardsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditClaimsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditSurfacesSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditAreasOfUseSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUse.jsp", "wMLC2.EditApplicationTypesSection" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2DirectionsForUse" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2DirectionsForUse.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2DirectionsForUse.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2DirectionsForUse.js"></script>
...
<form name="wMLC2DirectionsForUse" id="wMLC2DirectionsForUse" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "DirectionsForUse" );
...
<% /* New:PushBtn */ %>
<button type="button" class="newbutton" name="New" id="New" value="" onclick="GOTO_DirectionsForUseSectionAdd( )" style="width:78px;height:24px;position:absolute;left:586px;top:12px;">New</button>
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      csrRC2 = vGridStorDisp.cursor( "M_DirectionsForUseSection" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridStorDisp.cursor( "M_DirectionsForUseSection" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strName = "";
         nRC = vGridStorDisp.cursor( "M_DirectionsForUseSection" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strName = vGridStorDisp.cursor( "M_DirectionsForUseSection" ).getStringFromAttribute( "Name", "" );
         ...
         if ( nRC >= 0 )
         {
            strTitle = vGridStorDisp.cursor( "M_DirectionsForUseSection" ).getStringFromAttribute( "Title", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateStorDispSect" onclick="GOTO_DirsForUseSectionUpdate( this.id )" id="BMBUpdateStorDispSect::<%=strEntityKey%>"><img src="./images/ePammsUpdate.jpg" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteStorDispSect" onclick="GOTO_DirsForUseSectionDelete( this.id )" id="BMBDeleteStorDispSect::<%=strEntityKey%>"><img src="./images/ePammsDelete.jpg" alt="Delete"></a></td>

</tr>

<%
         csrRC2 = vGridStorDisp.cursor( "M_DirectionsForUseSection" ).setNextContinue( );
      }
      vGridStorDisp.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2DirectionsForUse" );
