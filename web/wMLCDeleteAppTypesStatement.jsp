...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CanceDeletelAppTypesStmt" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteAppTypesStatement", "wMLC.CancelDeleteAppTypesStmt" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteAppTypesStmt" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDeleteAppTypesStatement", "wMLC.ConfirmDeleteAppTypesStmt" );
      try
      {
