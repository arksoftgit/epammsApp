...
<%-- wMLCApplicationTypesStatement   Generate Timestamp: 20170406143228133 --%>
...
if ( strLastWindow.equals("wMLCApplicationTypesStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCApplicationTypesStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCApplicationTypesStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLCApplicationTypesStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ADD_UsageKeyword" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCApplicationTypesStatement", "wMLC.AddNewUsageKeyword" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DisplayGeneratedTextUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCApplicationTypesStatement", "wMLC.GOTO_DisplayGeneratedTextUsage" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAppTypesStmtsForInsert" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCApplicationTypesStatement", "wMLC.InitAppTypesStmtsForInsert" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAddNewUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCApplicationTypesStatement", "wMLC.SaveAddNewUsage" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCApplicationTypesStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCApplicationTypesStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCApplicationTypesStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ApplicationTypesStatement", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCApplicationTypesStatement.js"></script>
...
<%
   ...
   {
%>
       <li id="AddAppTypesList" name="AddAppTypesList"><a href="#"  onclick="InitAppTypesStmtsForInsert()">Add From Application Types List</a></li>
<%
   }
%>
...
<form name="wMLCApplicationTypesStatement" id="wMLCApplicationTypesStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "ApplicationTypesStatement" );
...
<span class="groupbox"  id="PrecautionarySection1" name="PrecautionarySection1" style="width:338px;height:16px;">Application Types Statement</span>
...
<input class="text12"  name="PrecautionarySubtitle1" id="PrecautionarySubtitle1" maxlength="4096" style="width:312px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<div id="GroupBox11" name="GroupBox11" style="width:832px;float:left;">  <!-- GroupBox11 --> 
...
<% /* PushBtn7:PushBtn */ %>
<button type="button" class="newbutton" name="PushBtn7" id="PushBtn7" value="" onclick="GOTO_DisplayGeneratedTextUsage( )" style="width:158px;height:26px;position:absolute;left:438px;top:4px;">Show Generated Text</button>

<% /* PushBtn6:PushBtn */ %>
<button type="button" class="newbutton" name="PushBtn6" id="PushBtn6" value="" onclick="ADD_UsageKeyword( )" style="width:66px;height:26px;position:absolute;left:618px;top:4px;">New</button>

<% /* Text8:Text */ %>

<label class="listheader"  id="Text8" name="Text8" style="width:398px;height:16px;position:absolute;left:10px;top:8px;">Keyword text for Embedding in Statement Text</label>
...
<% /* Grid7:Grid */ %>
<table  cols=4 style=""  name="Grid7" id="Grid7">
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      String strBMBDeleteDirectionsUseStatement5;
      String strBitmapBtn5;
      
      View vGrid7;
      vGrid7 = mMasLC.newView( );
      csrRC2 = vGrid7.cursor( "M_InsertTextKeywordUsage" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid7.cursor( "M_InsertTextKeywordUsage" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGridEditCtl7 = "";
         nRC = vGrid7.cursor( "M_InsertTextKeywordUsage" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditCtl7 = vGrid7.cursor( "M_InsertTextKeywordUsage" ).getAttribute( "Name" ).getString( "" );
         ...
         strGridEditCtl8 = "";
         nRC = vGrid7.cursor( "M_Usage" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGridEditCtl8 = vGrid7.cursor( "M_Usage" ).getAttribute( "dUsageKeywordText" ).getString( "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="GOTO_UsageUpdate( this.id )" id="GridEditCtl7::<%=strEntityKey%>"><%=strGridEditCtl7%></a></td>
   <td><%=strGridEditCtl8%></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteDirectionsUseStatement5" onclick="GOTO_UsageUpdate( this.id )" id="BMBDeleteDirectionsUseStatement5::<%=strEntityKey%>"><img src="./images/ePammsUpdate.png" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BitmapBtn5" onclick="DELETE_UsageKeyword( this.id )" id="BitmapBtn5::<%=strEntityKey%>"><img src="./images/ePammsDelete.png" alt="Delete"></a></td>

</tr>

<%
         csrRC2 = vGrid7.cursor( "M_InsertTextKeywordUsage" ).setNextContinue( );
      }
      vGrid7.drop( );
   }
}
