...
<%-- wMLC2DirectionsForUseStatement --%>
...
if ( strLastWindow.equals("wMLC2DirectionsForUseStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2DirectionsForUseStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2DirectionsForUseStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2DirectionsForUseStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2DirectionsForUseStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_SelectRemoveDUEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2DirectionsForUseStatement.jsp", "wMLC2.GOTO_SelectRemoveDUEntries" );
      try
      {
         nOptRC = wMLC2.GOTO_SelectRemoveDUEntries( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "DirsForUseSelectByType" );
      }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2DirectionsForUseStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2DirectionsForUseStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2DirectionsForUseStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2DirectionsForUseStatement.js"></script>
...
<form name="wMLC2DirectionsForUseStatement" id="wMLC2DirectionsForUseStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "DirectionsForUseStatement" );
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl5 = vGrid4.cursor( "M_DirectionsUsage" ).getStringFromAttribute( "dDisplayUsageName", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2DirectionsForUseStatement" );
