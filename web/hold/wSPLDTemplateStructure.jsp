...
<% /* Grid:Grid */ %>
<div class="tableScroll"  style="position:absolute;top:60px;left:18px;width:386px;height:720px;">
...
<div id="GroupBox3" name="GroupBox3" style="width:386px;height:720px;position:absolute;left:444px;top:68px;">  <!-- GroupBox3 --> 
...
<%
   ...
   String strHTML_FileName = "C:\\Program Files\\Apache Group\\Tomcat 7.0\\webapps\\ROOT\\ePamms\\Oldsi.html";
