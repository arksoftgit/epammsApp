                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC = vGridTmp.cursor( "SPLD_Rows" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SPLD_Rows" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "SPLD_Rows" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLDSPLD_TableData") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSPLD_TableData strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSPLD_TableData LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSPLD_TableData LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSPLD_TableData", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSPLD_TableData" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSPLD_TableData.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSPLD_TableData.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   // Hand coded
   View mSPLDefTable = task.getViewByName( "mSPLDef" );
   EntityCursor cursor = mSPLDefTable.cursor( "SPLD_MetaTable" );
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SPLD_TableData", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDSPLD_TableData.js"></script>
...
<form name="wSPLDSPLD_TableData" id="wSPLDSPLD_TableData" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "SPLD_TableData" );
...
<% strTextDisplayValue = "";
   ...
   {
      nRC = mSPLDef.cursor( "SPLD_MetaTable" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_MetaTable" ).getAttribute( "Name" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_MetaTable" ).getAttribute( "Description" ).getString( "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSPLDef.cursor( "SPLD_MetaTable" ).getAttribute( "Columns" ).getString( "" );
      }
      catch (Exception e)
      {
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      View vGridTable;
      vGridTable = mSPLDef.newView( );
      csrRC2 = vGridTable.cursor( "SPLD_Rows" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridTable.cursor( "SPLD_Rows" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strx1 = "";
         nRC = vGridTable.cursor( "SPLD_Rows" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strx1 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text1" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx2 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text2" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx3 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text3" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx4 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text4" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx5 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text5" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx6 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text6" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx7 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text7" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx8 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text8" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx9 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text9" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strx10 = vGridTable.cursor( "SPLD_Rows" ).getAttribute( "Text10" ).getString( "" );
...
<%
         csrRC2 = vGridTable.cursor( "SPLD_Rows" ).setNextContinue( );
      }
      vGridTable.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDSPLD_TableData" );
