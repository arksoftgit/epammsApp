...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "AddAppTypesList", "" );
   }
...
<%
   ...
   {
%>
       <li id="AddSelectedAppTypes" name="AddSelectedAppTypes"><a href="#"  onclick="ConfirmAddAppTypesStmts()">Add Selected Application Types</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="AddAndReturn" name="AddAndReturn"><a href="#"  onclick="ConfirmAddAppTypesStmtsAndReturn()">Add and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="CancelAndReturn" name="CancelAndReturn"><a href="#"  onclick="CancelAddAppTypesStmts()">Cancel and Return</a></li>
<%
   }
%>
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wMLCAddAppTypesList" );
