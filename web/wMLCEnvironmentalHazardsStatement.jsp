...
<%-- wMLCEnvironmentalHazardsStatement   Generate Timestamp: 20160824153940486 --%>
...
if ( strLastWindow.equals("wMLCEnvironmentalHazardsStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCEnvironmentalHazardsStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCEnvironmentalHazardsStatement LastWindow *** " + strLastWindow );
task.log().info("*** wMLCEnvironmentalHazardsStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCEnvironmentalHazardsStatement", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCEnvironmentalHazardsStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCEnvironmentalHazardsStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCEnvironmentalHazardsStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "EnvironmentalHazardsStatement", "" );
   }
...
<title>Environmental Hazards Statement</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCEnvironmentalHazardsStatement.js"></script>
...
<%
   ...
   {
%>
       <li id="AcceptAndReturn" name="AcceptAndReturn"><a href="#"  onclick="AcceptHazardsStmt()">Accept & Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="CancelAndReturn" name="CancelAndReturn"><a href="#"  onclick="CancelHazardsStmt()">Cancel & Return</a></li>
<%
   }
%>
...
<form name="wMLCEnvironmentalHazardsStatement" id="wMLCEnvironmentalHazardsStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "EnvironmentalHazardsStatement" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCEnvironmentalHazardsStatement" );
