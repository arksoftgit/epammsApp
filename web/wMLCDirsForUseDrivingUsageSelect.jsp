...
<%-- wMLCDirsForUseDrivingUsageSelect   Generate Timestamp: 20160623085855180 --%>
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "DirsForUseDrivingUsageSelect", "" );
   }
...
<%
   ...
   {
%>
       <li id="Return" name="Return"><a href="#"  onclick="AcceptMLC_UsageEntries()">Return</a></li>
<%
   }
%>
