...
if ( strLastWindow.equals("wMLCDirsForUseDrivingUsageSelect") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCDirsForUseDrivingUsageSelect strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCDirsForUseDrivingUsageSelect LastWindow *** " + strLastWindow );
task.log().info("*** wMLCDirsForUseDrivingUsageSelect LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCDirsForUseDrivingUsageSelect" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCDirsForUseDrivingUsageSelect.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCDirsForUseDrivingUsageSelect.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<form name="wMLCDirsForUseDrivingUsageSelect" id="wMLCDirsForUseDrivingUsageSelect" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "DirsForUseDrivingUsageSelect" );
