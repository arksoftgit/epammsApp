...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminAcceptUpdatePrimReg" ) )
   {
      ...
      catch (Exception e)
      {
         ...
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation AcceptUpdatePrimaryRegistrant: " + e.getMessage();
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wStartUpAdminUpdatePrimaryRegistrant" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wStartUpAdminUpdatePrimaryRegistrant.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelUpdatePrimReg" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation CancelUpdatePrimaryRegistrant: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ChangePrimRegPassword" ) )
   {
      ...
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ValidatePrimaryRegistrant: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
