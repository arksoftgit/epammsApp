...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "BACKUP_Objects" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.BACKUP_Objects" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.CancelSubregProduct" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DuplicateSubregProductSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.DuplicateSubregProductSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DuplicateSubregProductSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.DuplicateSubregProductSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_NewSubregProductSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.GOTO_NewSubregProductSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProductSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.GOTO_UpdateSubregProductSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSubregProductSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.GOTO_UpdateSubregProductSPLD" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveSubregProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDSubregProductUpdate", "wSPLD.SaveSubregProduct" );
