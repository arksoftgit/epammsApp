...
<%
   ...
   {
%>
       <li id="smOrganismClaims" name="smOrganismClaims"><a href="#"  class="sideselected"  onclick="smDisplayClaimsSection()">Organism Claims</a></li>
<%
   }
%>
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSLCOrganismClaims" );
