...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCCreateNewProductSLC", "wMLC.CancelSLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GenerateNewSLC_FromMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCCreateNewProductSLC", "wMLC.GenerateNewSLC_FromMLC" );
      try
      {
