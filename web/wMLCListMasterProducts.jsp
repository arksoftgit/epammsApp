...
<%-- wMLCListMasterProducts   Generate Timestamp: 20160407171236655 --%>
...
try
{
   ...
   if ( VmlOperation.isValid( mMasProdLST ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGEDescription = vGridPrimaryRegistrant.cursor( "MasterProduct" ).getAttribute( "Description" ).getString( "" );
