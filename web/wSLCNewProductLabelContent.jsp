...
if ( strLastWindow.equals("wSLCNewProductLabelContent") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSLC.SaveFeedback( "mOrganiz", "wSLC", "NewProductLabelContent", strFeedback );
      }
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCNewProductLabelContent", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wSLC.GenerateNewSLC_FromMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewProductLabelContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wSLC.CancelNewProductLabelContent" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.ProcessLogin" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wStartUp.Template" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().debug( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCNewProductLabelContent" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCNewProductLabelContent.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCNewProductLabelContent.jsp", "wSLC.InitSubregLabelContentForInsert" );
   nOptRC = wSLC.InitSubregLabelContentForInsert( new zVIEW ( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCNewProductLabelContent.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
                         "&OperationName=" + "InitSubregLabelContentForInsert";
...
if ( VmlOperation.isValid( wWebXA ) )
{
   ...
   wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "NewProductLabelContent" );
}
...
<title>New Product Label Content</title>
...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSLCNewProductLabelContent.zAction.value = "_OnResubmitPage";
         document.wSLCNewProductLabelContent.submit( );
      }
      else
      {
         _OnTimeout( );
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewProductLabelContent.zAction.value = "_OnTimeout";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSLCNewProductLabelContent.zAction.value = "_OnUnload";
         document.wSLCNewProductLabelContent.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSLCNewProductLabelContent.zFocusCtrl.value;
   if ( szFocusCtrl != "" )
      eval( 'document.wSLCNewProductLabelContent.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSLCNewProductLabelContent.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSLCNewProductLabelContent.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var keyRole = document.wSLCNewProductLabelContent.zKeyRole.value;
...
// if ( keyRole == "S" ) // If we are here, we have to be a Subregistrant.
   ...
   document.wSLCNewProductLabelContent.zError.value = "";
   document.wSLCNewProductLabelContent.zOpenFile.value = "";
   ...
   var varTimeout = document.wSLCNewProductLabelContent.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function AcceptNewProductLabelContent( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewProductLabelContent.zAction.value = "AcceptNewProductLabelContent";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function CancelNewProductLabelContent( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewProductLabelContent.zAction.value = "CancelNewProductLabelContent";
      document.wSLCNewProductLabelContent.submit( );
   }
}

function InitSubregLabelContentForInsert( )
{
...
function smAcceptNewProductLabelContent( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewProductLabelContent.zAction.value = "smAcceptNewProductLabelContent";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function smCancelNewProductLabelContent( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCNewProductLabelContent.zAction.value = "smCancelNewProductLabelContent";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mProductManagement";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mSubregistrants";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mTrackingNotificationCompliance";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mStateRegistrations";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mMarketingFulfillment";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mWebDevelopment";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mAdministration";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mLogin";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCNewProductLabelContent.zAction.value = "mTemplate";
      document.wSLCNewProductLabelContent.submit( );
   }
}
...
<form name="wSLCNewProductLabelContent" id="wSLCNewProductLabelContent" method="post">
...
<%
   ...
   //strFocusCtrl = task.GetFocusCtrl("wSLC", "NewProductLabelContent" );
...
<%
   ...
   if ( StringUtils.equals( strErrorFlag, "Y" ) && !StringUtils.isBlank( strErrorMapValue ) )
   {
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCNewProductLabelContent" );
