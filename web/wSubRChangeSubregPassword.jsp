...
<%-- wSubRChangeSubregPassword   Generate Timestamp: 20160620105931719 --%>
...
if ( strLastWindow.equals("wSubRChangeSubregPassword") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSubRChangeSubregPassword strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSubRChangeSubregPassword LastWindow *** " + strLastWindow );
task.log().info("*** wSubRChangeSubregPassword LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSubRChangeSubregPassword", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSubRChangeSubregPassword.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSubRChangeSubregPassword.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSubRChangeSubregPassword.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSubR" +
                         "&OperationName=" + "InitChangeSubregPassword";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ChangeSubregPassword", "" );
   }
...
<%
   ...
   {
%>
       <li id="smChangeAndReturn" name="smChangeAndReturn"><a href="#"  onclick="smConfirmChangeSubregPassword()">Change Password and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelChangeSubregPassword()">Cancel Change and Return</a></li>
<%
   }
%>
...
<form name="wSubRChangeSubregPassword" id="wSubRChangeSubregPassword" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSubR", "ChangeSubregPassword" );
...
<a href="#" id="HTChangePassword" name="HTChangePassword"  onclick="ConfirmChangeSubregPassword( );" class="mylegend" style="width:602px;height:16px;">Subregistrant >></a>
...
<div id="GroupBox" name="GroupBox" style="width:598px;height:196px;float:left;">  <!-- GroupBox --> 
