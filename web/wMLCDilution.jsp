...
<%-- wMLCDilution   Generate Timestamp: 20170407175313472 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCDilution", "wMLC.EditLocationsSection" );
...
<title>MLC Dilution Entries</title>
