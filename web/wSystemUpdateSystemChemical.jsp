...
<%-- wSystemUpdateSystemChemical   Generate Timestamp: 20160317151027058 --%>
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mEPA.cursor( "EPA_ChemicalFamily" ).getAttribute( "Name" ).setValue( strMapValue, "" );
         }
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mEPA.cursor( "EPA_ChemicalFamily" ).getAttribute( "Description" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mEPA.cursor( "EPA_ChemicalFamily" ).getAttribute( "ChemicalFamily" ).setValue( strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wSystemUpdateSystemChemical") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemUpdateSystemChemical strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemUpdateSystemChemical LastWindow *** " + strLastWindow );
task.log().info("*** wSystemUpdateSystemChemical LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdateSystemChemical" ) )
   {
      bDone = true;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateAppTypesList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_StartModalSubwindow, "wSystem", "UpdateAppTypes" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelUpdateSystemChemical" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateBacteriaList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_StartModalSubwindow, "wSystem", "UpdateBacteria" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateFungiList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_StartModalSubwindow, "wSystem", "UpdateFungi" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateVirusesList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_StartModalSubwindow, "wSystem", "UpdateViruses" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateSurfacesList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
      ...
      {
         // Next Window
         strNextJSP_Name = wSystem.SetWebRedirection( vKZXMLPGO, wSystem.zWAB_StartModalSubwindow, "wSystem", "UpdateSurfaces" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smUpdateAppTypesList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smUpdateSurfacesList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smUpdateBacteriaList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smUpdateFungiList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smUpdateVirusesList" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAcceptUpdateSystemChemical" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelUpdateSystemChemical" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemUpdateSystemChemical", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSystemUpdateSystemChemical" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemUpdateSystemChemical.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemUpdateSystemChemical.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSystemUpdateSystemChemical.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitSystemChemicalForUpdate";
...
<title>Update System Chemical</title>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "UpdateAppTypesList" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "UpdateSurfacesList" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "UpdateBacteriaList" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "UpdateFungiList" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "UpdateVirusesList" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
...
<form name="wSystemUpdateSystemChemical" id="wSystemUpdateSystemChemical" method="post">
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).info( "Entity does not exist for Name: " + "mEPA.EPA_ChemicalFamily" );
      }
   }
%>

<textarea name="Name" id="Name" style="width:402px;height:84px;position:absolute;left:130px;top:24px;border:solid;border-width:2px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).info( "Entity does not exist for Description: " + "mEPA.EPA_ChemicalFamily" );
      }
   }
%>

<textarea name="Description" id="Description" style="width:402px;height:84px;position:absolute;left:132px;top:130px;border:solid;border-width:2px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
