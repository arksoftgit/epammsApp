...
<%-- wSPLD2DirectionsForUseStatement --%>
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "M_DirectionsForUseStatement" ).setAttribute( "Title", strMapValue, "" );
         }
...
if ( strLastWindow.equals("wSPLD2DirectionsForUseStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2DirectionsForUseStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2DirectionsForUseStatement LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2DirectionsForUseStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2DirectionsForUseStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_SelectRemoveDUEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2DirectionsForUseStatement.jsp", "wSPLD2.GOTO_SelectRemoveDUEntries" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2DirectionsForUseStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2DirectionsForUseStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2DirectionsForUseStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2DirectionsForUseStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptDirectionsStatement( )">Accept and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelDirectionsStatement( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSPLD2DirectionsForUseStatement" id="wSPLD2DirectionsForUseStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "DirectionsForUseStatement" );
...
<div id="DirectionsForUseStatementGroup" name="DirectionsForUseStatementGroup" class="withborder" style="width:830px;height:418px;float:left;">  <!-- DirectionsForUseStatementGroup --> 

<div  id="DirectionsForUseStatementGroup" name="DirectionsForUseStatementGroup" >Directions for Use Statement</div>
...
<%
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            strErrorMapValue = mMasLC.cursor( "M_DirectionsForUseStatement" ).getStringFromAttribute( "Title", "" );
...
<textarea id="MLEdit1" name="MLEdit1" class="" style="width:738px;height:46px;border:solid;border-width:4px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
...
<textarea id="MLEdit2" name="MLEdit2" class="" style="width:738px;height:306px;border:solid;border-width:4px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
...
<div id="GroupBox9" name="GroupBox9" style="width:624px;height:30px;float:left;">  <!-- GroupBox9 --> 
...
<span  id="Text6" name="Text6" style="width:364px;height:22px;">Usage Entries</span>
...
<div id="GroupBox10" name="GroupBox10" style="width:146px;height:30px;float:left;">  <!-- GroupBox10 --> 


<div>  <!-- Beginning of a new line -->
<span style="height:26px;">&nbsp&nbsp</span>
<% /* PushBtn4:PushBtn */ %>
<button type="button" class="formStylebutton" name="PushBtn4" id="PushBtn4" value="" onclick="GOTO_SelectRemoveDUEntries( )" style="width:116px;height:26px;">Select/Remove</button>
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl4 = vGrid4.cursor( "M_DirectionsUsage" ).getStringFromAttribute( "UsageType", "FullUsageType" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl5 = vGrid4.cursor( "M_DirectionsUsage" ).getStringFromAttribute( "Name", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2DirectionsForUseStatement" );
