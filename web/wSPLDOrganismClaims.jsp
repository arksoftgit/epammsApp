      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "SPLDI_UsageList" ).setAttribute( "Selected", "Y" );
               else
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteClaimsStmt" ) )
   {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "DeleteClaimsStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitClaimsStmtForUpdate" ) )
   {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "OrganismClaimsStatement" );
      }
