...
<%-- wSubRUpdateSubregUser   Generate Timestamp: 20160531205256178 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdateSubregUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregUser", "wSubR.AcceptUpdateSubregUser" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelUpdateSubregUser" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregUser", "wSubR.CancelUpdateSubregUser" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSubRUpdateSubregUser", "wSubR.InitSubregUserForUpdate" );
...
<input name="EBPAddress" id="EBPAddress" maxlength="128" style="width:300px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="EBUserName" id="EBUserName" maxlength="128" style="width:300px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
