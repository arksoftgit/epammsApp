...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForDelete" ) )
   {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "DeleteStorDispStatemen" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForUpdate" ) )
   {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD.SetWebRedirection( vKZXMLPGO, wSPLD.zWAB_StartModalSubwindow, "wSPLD", "StorDispStatement" );
      }
