...
<%-- wSPLDDeleteStorageDisposalSection --%>
...
if ( strLastWindow.equals("wSPLDDeleteStorageDisposalSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDDeleteStorageDisposalSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDDeleteStorageDisposalSection LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDDeleteStorageDisposalSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDDeleteStorageDisposalSection", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.CancelDeleteStorDispSect" );
      try
      {
         nOptRC = wSPLD.CancelDeleteStorDispSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDDeleteStorageDisposalSection" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDDeleteStorageDisposalSection.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteStorDispSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.ConfirmDeleteStorDispSect" );
      try
      {
         nOptRC = wSPLD.ConfirmDeleteStorDispSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.SelectStorDispStmtForDelete" );
      try
      {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDDeleteStorDispStatemen.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDDeleteStorageDisposalSection" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveStorDispStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.MoveStorDispStmtDown" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveStorDispStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.MoveStorDispStmtUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectStorDispStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.SelectStorDispStmtForUpdate" );
      try
      {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wSPLDStorDispStatement.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDDeleteStorageDisposalSection" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDDeleteStorageDisposalSection" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDDeleteStorageDisposalSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDDeleteStorageDisposalSection.jsp", "wSPLD.InitStorDispSectForDelete" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSPLDDeleteStorageDisposalSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDDeleteStorageDisposalSection.js"></script>
...
<form name="wSPLDDeleteStorageDisposalSection" id="wSPLDDeleteStorageDisposalSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "DeleteStorageDisposalSection" );
...
<div id="StorDispSection" name="StorDispSection" class="withborder" style="width:732px;height:96px;float:left;">  <!-- StorDispSection --> 
...
<input name="StorDispTitle" id="StorDispTitle"  disabled style="width:560px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).info( "SPLD_StorageDisposalSection.ReviewerNote: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mSPLDef.SPLD_StorageDisposalSection" );
      }
   }
%>

<textarea name="NoteToReviewer" id="NoteToReviewer"style="width:560px;height:16px;border:solid;border-width:2px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
...
<div id="StorDispStatements" name="StorDispStatements" style="width:732px;height:256px;float:left;">  <!-- StorDispStatements --> 
...
<div class="tableScroll"  style="height:222px;">

<table name="GridStorageDisposal" id="GridStorageDisposal" cellspacing=0  cols=7  >
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      vGridStorageDisposal = mSPLDef.newView( );
      csrRC2 = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strSelect = "";
         nRC = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strSelect = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).getStringFromAttribute( "Selected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditStorageDisposal = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).getStringFromAttribute( "Text", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridBoldItalic = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).getStringFromAttribute( "BoldItalic", "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" onclick="SelectStorDispStmtForUpdate( this.id )" id="GridBoldItalic::<%=strEntityKey%>"><%=strGridBoldItalic%></a></td>
...
<%
         csrRC2 = vGridStorageDisposal.cursor( "SPLD_StorageDisposalStatement" ).setNextContinue( );
      }
