...
<%-- wSPLDNewSPLD_SelectSLC   Generate Timestamp: 20160328163922836 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SELECT_SLC_ForNewSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDNewSPLD_SelectSLC", "wSPLD.SELECT_SLC_ForNewSPLD" );
