...
if ( strLastWindow.equals("wSPLDNewSPLD_SelectSLC") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDNewSPLD_SelectSLC strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDNewSPLD_SelectSLC LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDNewSPLD_SelectSLC LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDNewSPLD_SelectSLC", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SELECT_SLC_ForNewSPLD" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDNewSPLD_SelectSLC.jsp", "wSPLD.SELECT_SLC_ForNewSPLD" );
         nOptRC = wSPLD.SELECT_SLC_ForNewSPLD( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDNewSPLD_SelectSLC" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDNewSPLD_SelectSLC.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDNewSPLD_SelectSLC.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<title>Select SLC for New SPLD</title>
...
<%
   ...
   {
%>
       <li id="AcceptAndReturn" name="AcceptAndReturn"><a href="#"  onclick="SELECT_SLC_ForNewSPLD()">Select</a></li>
<%
   }
%>
...
<form name="wSPLDNewSPLD_SelectSLC" id="wSPLDNewSPLD_SelectSLC" method="post">
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDNewSPLD_SelectSLC" );
