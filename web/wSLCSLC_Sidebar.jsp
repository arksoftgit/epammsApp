...
<%-- wSLCSLC_Sidebar   Generate Timestamp: 20160317151020655 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAndReturnSLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.CancelAndReturnSLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayPhysicalChemicalHazards" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCSLC_Sidebar", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayPhysicalChemicalHazards" );
      nOptRC = wSLC.DisplayPhysicalChemicalHazards( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StayOnWindowWithRefresh, "wSLC", "HazardsSection" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayApplicationTypesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayAreasOfUseSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayClaimsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayFirstAidSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplayPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplayPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DisplaySurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.DisplaySurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCSLC_Sidebar", "wSLC.SaveSLC" );
...
<%
   ...
   {
%>
       <li id="Ingredients" name="Ingredients"><a href="#"  onclick="DisplayIngredientsSect()">Ingredients</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="FirstAid" name="FirstAid"><a href="#"  onclick="DisplayFirstAidSection()">First Aid</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="EnvironmentalHazards" name="EnvironmentalHazards"><a href="#"  onclick="DisplayHazardSection()">Environmental Hazards</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="AreasOfUse" name="AreasOfUse"><a href="#"  onclick="DisplayAreasOfUseSection()">Areas of Use</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="AppTypes" name="AppTypes"><a href="#"  onclick="DisplayApplicationTypesSection()">Application Types</a></li>
<%
   }
%>
