      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "EPA_AreaOfUse" ).setAttribute( "wkSelected", "Y" );
               else
                  vGridTmp.cursor( "EPA_AreaOfUse" ).setAttribute( "wkSelected", "" );
         }
...
if ( strLastWindow.equals("wMLCAddAreasOfUseList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCAddAreasOfUseList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCAddAreasOfUseList LastWindow *** " + strLastWindow );
task.log().info("*** wMLCAddAreasOfUseList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCAddAreasOfUseList", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wMLC.CancelAddAreasOfUseStmts" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmAddAreasOfUseStmtsReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCAddAreasOfUseList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wMLC.ConfirmAddAreasOfUseStmts" );
      try
      {
         nOptRC = wMLC.ConfirmAddAreasOfUseStmts( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation ConfirmAddAreasOfUseStmts: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmAddSelectedAreasOfUse" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCAddAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmAddSelectedAreasOfUse" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCAddAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmAddAreasOfUseStmtsReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCAddAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAddAreasOfUseStmts" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCAddAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLCAddAreasOfUseList" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCAddAreasOfUseList.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCAddAreasOfUseList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAddAreasOfUseList.jsp", "wMLC.InitAreasOfUseStmtsForInsert" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wMLCAddAreasOfUseList.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wMLC" +
                         "&OperationName=" + "InitAreasOfUseStmtsForInsert";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AddAreasOfUseList" );
   }
...
<title>Add Areas of Use List</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCAddAreasOfUseList.js"></script>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "AddSelectedAreasOfUse" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smConfirmAddSelectedAreasOfUse( )">Add Selected Areas of Use</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmAddAreasOfUseStmtsReturn( )">Add and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelAddAreasOfUseStmts( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wMLCAddAreasOfUseList" id="wMLCAddAreasOfUseList" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "AddAreasOfUseList" );
...
<% /* GBAddAreasOfUseList:GroupBox */ %>

<div id="GBAddAreasOfUseList" name="GBAddAreasOfUseList" style="width:730px;height:42px;float:left;">  <!-- GBAddAreasOfUseList --> 
...
<% /* AddAreasOfUseList:Text */ %>

<span class="groupbox"  id="AddAreasOfUseList" name="AddAreasOfUseList" style="width:176px;height:16px;">Add Areas of Use List</span>
...
try
{
   ...
   if ( VmlOperation.isValid( mEPA ) )
   {
      ...
      String strGE_AreasOfUse;
      
      View vGrid;
      vGrid = mEPA.newView( );
      csrRC2 = vGrid.cursor( "EPA_AreaOfUse" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid.cursor( "EPA_AreaOfUse" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         ...
         if ( nRC >= 0 )
         {
            strGS_Select = vGrid.cursor( "EPA_AreaOfUse" ).getStringFromAttribute( "wkSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGE_AreasOfUse = vGrid.cursor( "EPA_AreaOfUse" ).getStringFromAttribute( "Name", "" );

            if ( strGE_AreasOfUse == null )
               strGE_AreasOfUse = "";
         }

         if ( StringUtils.isBlank( strGE_AreasOfUse ) )
            strGE_AreasOfUse = "&nbsp";
...
<tr<%=strOdd%>>
   ...
   <td nowrap><%=strGE_AreasOfUse%></td>

</tr>

<%
         csrRC2 = vGrid.cursor( "EPA_AreaOfUse" ).setNextContinue( );
      }
      vGrid.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCAddAreasOfUseList" );
