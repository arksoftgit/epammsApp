      ...
      while ( csrRC.isSet() )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "EPA_AreaOfUse" ).setAttribute( "wkSelected", strMapValue );
               else
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelAddAreasOfUseStmts" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCAddAreasOfUseList" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCAddAreasOfUseList.jsp";
