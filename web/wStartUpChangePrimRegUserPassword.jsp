...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelChangePrimRegUserPass" ) )
   {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation CancelChangePrimRegUserPassword: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmChangePrimRegUserPass" ) )
   {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation ConfirmChangePrimRegUserPassword: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword.jsp", "wStartUp.Template" );
      try
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ChangePrimRegUserPassword" );
   }
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmChangePrimRegUserPass( )">Change Password and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelChangePrimRegUserPass( )">Cancel Password and Return</a></li>
<%
   }
%>
