...
<%-- wStartUpChangePrimRegUserPassword   Generate Timestamp: 20160328163925620 --%>
...
if ( strLastWindow.equals("wStartUpChangePrimRegUserPassword") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpChangePrimRegUserPassword strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpChangePrimRegUserPassword LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpChangePrimRegUserPassword LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelChangePrimRegUserPass" ) )
   {
      bDone = true;
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.CancelChangePrimRegUserPassword" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmChangePrimRegUserPass" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegUserPassword", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.ConfirmChangePrimRegUserPassword" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmChangePrimRegUserPass" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegUserPassword", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelChangePrimRegUserPass" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpChangePrimRegUserPassword", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.GOTO_UserList" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wStartUpChangePrimRegUserPassword" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpChangePrimRegUserPassword.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpChangePrimRegUserPassword.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpChangePrimRegUserPassword", "wStartUp.InitChangePrimRegUserPassword" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wStartUpChangePrimRegUserPassword.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitChangePrimRegUserPassword";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ChangePrimRegUserPassword", "" );
   }
...
<title>Change Primary Registrant User Password</title>
...
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ConfirmChangePrimRegUserPassword" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li id="smConfirmChangePrimRegUserPassword" name="smConfirmChangePrimRegUserPassword"><a href="#"  onclick="smConfirmChangePrimRegUserPass()">Change Password and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelChangePassword" name="smCancelChangePassword"><a href="#"  onclick="smCancelChangePrimRegUserPass()">Cancel Password and Return</a></li>
<%
   }
%>
...
<form name="wStartUpChangePrimRegUserPassword" id="wStartUpChangePrimRegUserPassword" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "ChangePrimRegUserPassword" );
...
<span  id="PrimaryRegistrantName:" name="PrimaryRegistrantName:" style="width:140px;height:16px;">Primary Registrant:</span>
...
<span  id="PrimaryRegistrantName" name="PrimaryRegistrantName" style="width:302px;height:16px;"><%=strTextDisplayValue%></span>
...
<% /* GroupBox:GroupBox */ %>
<div id="GroupBox" name="GroupBox" style="float:left;width:638px;"  class="withborder">

<table cols=2 style="width:638px;"  class="grouptable">

<tr>
<td valign="top" style="width:154px;">
<% /* UserName::Text */ %>

<span  id="UserName:" name="UserName:" style="width:142px;height:16px;">User Name:</span>
...
<span  id="UserName" name="UserName" style="width:458px;height:16px;"><%=strTextDisplayValue%></span>
