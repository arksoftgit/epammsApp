...
if ( strLastWindow.equals("wSLCImportAreasOfUseList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCImportAreasOfUseList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCImportAreasOfUseList LastWindow *** " + strLastWindow );
task.log().info("*** wSLCImportAreasOfUseList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelImportAreasOfUseStatements" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCImportAreasOfUseList", strActionToProcess );

      // Next Window
      strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_ReturnToParent, "wSLC", "AreasOfUseStatement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectAreasOfUseStmtForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.SelectAreasOfUseStmtForDelete" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportAreasOfUseStatements" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCImportAreasOfUseList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.ImportAreasOfUseStatements" );
      try
      {
         nOptRC = wSLC.ImportAreasOfUseStatements( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation ImportAreasOfUseStatements: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSLC.SetWebRedirection( vKZXMLPGO, wSLC.zWAB_StartModalSubwindow, "wSLC", "Claims" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveAreasOfUseStmtDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.MoveAreasOfUseStmtDown" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveAreasOfUseStmtUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.MoveAreasOfUseStmtUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAreasOfUseStmtForInsert" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.InitAreasOfUseStmtForInsert" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "InitAreasOfUseStmtForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.InitAreasOfUseStmtForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smImportAreasOfUseStatements" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCImportAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelImportAreasOfUseStatements" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCImportAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCImportAreasOfUseList" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCImportAreasOfUseList.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCImportAreasOfUseList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCImportAreasOfUseList.jsp", "wSLC.InitImportAreasOfUseStatements" );
   nOptRC = wSLC.InitImportAreasOfUseStatements( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSLCImportAreasOfUseList.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSLC" +
                         "&OperationName=" + "InitImportAreasOfUseStatements";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "ImportAreasOfUseList" );
   }
...
<title>Import Areas of Use List</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCImportAreasOfUseList.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smImportAreasOfUseStatements( )">Import and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelImportAreasOfUseStatements( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSLCImportAreasOfUseList" id="wSLCImportAreasOfUseList" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "ImportAreasOfUseList" );
...
<div id="ImportAreasOfUseList" name="ImportAreasOfUseList" class="withborder" style="width:730px;height:72px;float:left;">  <!-- ImportAreasOfUseList --> 

<div  id="ImportAreasOfUseList" name="ImportAreasOfUseList" >Import Areas of Use List</div>
...
<span  id="UseFileName:" name="UseFileName:" style="width:130px;height:16px;">File Name:</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCImportAreasOfUseList" );
