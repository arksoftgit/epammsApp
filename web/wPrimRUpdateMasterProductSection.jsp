...
<%-- wPrimRUpdateMasterProductSection   Generate Timestamp: 20160328163919381 --%>
...
if ( strLastWindow.equals("wPrimRUpdateMasterProductSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wPrimRUpdateMasterProductSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wPrimRUpdateMasterProductSection LastWindow *** " + strLastWindow );
task.log().info("*** wPrimRUpdateMasterProductSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SplitSectionText" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wPrimRUpdateMasterProductSection", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wPrimR.SetWebRedirection( vKZXMLPGO, wPrimR.zWAB_StartModalSubwindow, "wPrimR", "SplitMasterProductSection" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductSection", "wStartUp.GOTO_UserList" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wPrimRUpdateMasterProductSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wPrimRUpdateMasterProductSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wPrimRUpdateMasterProductSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wPrimRUpdateMasterProductSection.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wPrimR" +
                         "&OperationName=" + "InitMasterProdSectionForUpdate";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "UpdateMasterProductSection", "" );
   }
...
<title>Update Master Product Section</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wPrimRUpdateMasterProductSection.js"></script>
...
<form name="wPrimRUpdateMasterProductSection" id="wPrimRUpdateMasterProductSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wPrimR", "UpdateMasterProductSection" );
...
<% /* PBAcceptUpdateMasterSection:PushBtn */ %>
<button type="button" class="formStylebutton" name="PBAcceptUpdateMasterSection" id="PBAcceptUpdateMasterSection" value="" onclick="AcceptUpdateMasterProductParagra( )" style="width:80px;height:24px;">Update</button>
...
<span style="height:24px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
<% /* Split:PushBtn */ %>
<button type="button" class="formStylebutton" name="Split" id="Split" value="" onclick="SplitSectionText( )" style="width:80px;height:24px;">Split</button>
...
<div id="Section" name="Section" style="width:504px;height:464px;float:left;">  <!-- Section --> 
