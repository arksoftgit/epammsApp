      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDefPanel.cursor( "ReusableBlockDefinition" ).getAttribute( "Name" ).setValue( strMapValue, "" );
         }
...
if ( strLastWindow.equals("wSPLDUpdateReusableBlock") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDUpdateReusableBlock strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDUpdateReusableBlock LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDUpdateReusableBlock LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDUpdateReusableBlock", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDUpdateReusableBlock", "wSPLD.SaveReusableBlock" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDUpdateReusableBlock" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDUpdateReusableBlock.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDUpdateReusableBlock.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDUpdateReusableBlock", "wSPLD.InitReusableBlockForUpdate" );
   nOptRC = wSPLD.InitReusableBlockForUpdate( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSPLDUpdateReusableBlock.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD" +
                         "&OperationName=" + "InitReusableBlockForUpdate";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "UpdateReusableBlock", "" );
   }
...
<title>Update Subregistrant Reusable Block</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDUpdateReusableBlock.js"></script>
...
<%
   ...
   {
%>
       <li id="SaveReturn" name="SaveReturn"><a href="#"  onclick="SaveReturn()">Return</a></li>
<%
   }
%>
...
<form name="wSPLDUpdateReusableBlock" id="wSPLDUpdateReusableBlock" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "UpdateReusableBlock" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mSPLDefPanel.cursor( "ReusableBlockDefinition" ).getAttribute( "Name" ).getString( "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "Entity does not exist for ReusableBlockName: " + "mSPLDefPanel.ReusableBlockDefinition" );
      }
   }
%>
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDUpdateReusableBlock" );
