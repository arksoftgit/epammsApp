                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      csrRC = vGridTmp.cursor( "MasterLabelContent" ).setFirst( "PrimaryRegistrant" );
      while ( csrRC.isSet() )
      {
...
if ( strLastWindow.equals("wStartUpListMasterProducts") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpListMasterProducts strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpListMasterProducts LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpListMasterProducts LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMasterProductForDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.SelectSubregProductForDelete" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.MoveMasterProductDown" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.MoveMasterProductUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewMasterProduct" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.AddNewMasterProduct" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectMasterProductForUpdate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.SelectSubregProductForUpdate" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpListMasterProducts.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpListMasterProducts" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpListMasterProducts.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpListMasterProducts.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnPrimaryRegistrants( )">Return to Primary Registrant</a></li>
<%
   }
%>
...
<form name="wStartUpListMasterProducts" id="wStartUpListMasterProducts" method="post">
...
<% /* MasterProductVersions:GroupBox */ %>

<div id="MasterProductVersions" name="MasterProductVersions" class="withborder" style="width:866px;height:436px;float:left;">  <!-- MasterProductVersions --> 

<div  id="MasterProductVersions" name="MasterProductVersions" >Master Product Versions</div>
...
try
{
   ...
   if ( VmlOperation.isValid( mPrimReg ) )
   {
      ...
      csrRC2 = vGridPrimaryRegistrant.cursor( "MasterLabelContent" ).setFirst( "PrimaryRegistrant" );
      while ( csrRC2.isSet() )
      {
...
<%
         csrRC2 = vGridPrimaryRegistrant.cursor( "MasterLabelContent" ).setNextContinue( );
      }
...
<div>  <!-- Beginning of a new line -->
<div style="height:1px;width:48px;float:left;"></div>   <!-- Width Spacer -->
<% /* GroupBox:GroupBox */ %>

<div id="GroupBox" name="GroupBox" style="width:32px;height:76px;float:left;">  <!-- GroupBox --> 
...
<%
   session.setAttribute( "ZeidonWindow", "wStartUpListMasterProducts" );
