...
if ( strLastWindow.equals("wMLCEnvironmentalHazards") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCEnvironmentalHazards strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCEnvironmentalHazards LastWindow *** " + strLastWindow );
task.log().info("*** wMLCEnvironmentalHazards LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DELETE_EnvironmentalSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCEnvironmentalHazards", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "DELETE_EnvironmentalSection", e.getMessage( ), "" );
         break;
      }
      // Next Window
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_EnvironmentalSectionAfter" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCEnvironmentalHazards", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "GOTO_EnvironmentalSectionAfter", e.getMessage( ), "" );
         break;
      }
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "EnvironmentalHazardsSection" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_EnvironmentalSection" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCEnvironmentalHazards", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "GOTO_EnvironmentalSection", e.getMessage( ), "" );
         break;
      }
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "EnvironmentalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_EnvironmentalSectionBefore" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCEnvironmentalHazards", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.GOTO_EnvironmentalSectionBefore" );
      nOptRC = wMLC.GOTO_EnvironmentalSectionBefore( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_EnvironmentalSectionUpdate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCEnvironmentalHazards", strActionToProcess );
      ...
      {
         nRC = 2;
         VmlOperation.CreateMessage( task, "GOTO_EnvironmentalSectionUpdate", e.getMessage( ), "" );
         break;
      }
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "EnvironmentalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.SaveAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.SaveMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.CancelAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazards" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditEnvironmentalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditChemicalHazardsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditChemicalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditClaimsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditSurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditAreasOfUseSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditApplicationTypesSection" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCEnvironmentalHazards" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCEnvironmentalHazards.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCEnvironmentalHazards.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCEnvironmentalHazards.js"></script>
...
<form name="wMLCEnvironmentalHazards" id="wMLCEnvironmentalHazards" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "EnvironmentalHazards" );
...
<div id="GBStorDispSections" name="GBStorDispSections" class="listgroup"   style="float:left;position:relative; width:782px; height:38px;">  <!-- GBStorDispSections --> 

<% /* OrganismClaimsStatements:Text */ %>

<label class="groupbox"  id="OrganismClaimsStatements" name="OrganismClaimsStatements" style="width:238px;height:16px;position:absolute;left:6px;top:12px;">Environmental Hazards Sections</label>

<% /* PushBtn1:PushBtn */ %>
<button type="button" name="PushBtn1" id="PushBtn1" value="" onclick="GOTO_EnvironmentalSection( )" style="width:74px;height:28px;position:absolute;left:616px;top:12px;">New</button>
...
<% /* GridStorDisp:Grid */ %>
<table  cols=6 style="width:778px;"  name="GridStorDisp" id="GridStorDisp">
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="GOTO_EnvironmentalSectionUpdate( this.id )" id="GridEditStorDisp::<%=strEntityKey%>"><%=strGridEditStorDisp%></a></td>
   <td><a href="#" onclick="GOTO_EnvironmentalSectionUpdate( this.id )" id="GridEditVolume::<%=strEntityKey%>"><%=strGridEditVolume%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BitmapBtn2" onclick="GOTO_EnvironmentalSectionBefore( this.id )" id="BitmapBtn2::<%=strEntityKey%>"><img src="./images/ePammsNew.png" alt="New Before"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BitmapBtn1" onclick="GOTO_EnvironmentalSectionAfter( this.id )" id="BitmapBtn1::<%=strEntityKey%>"><img src="./images/ePammsNew.png" alt="New After"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBUpdateStorDispSect" onclick="GOTO_EnvironmentalSectionUpdate( this.id )" id="BMBUpdateStorDispSect::<%=strEntityKey%>"><img src="./images/ePammsUpdate.png" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteStorDispSect" onclick="DELETE_EnvironmentalSection( this.id )" id="BMBDeleteStorDispSect::<%=strEntityKey%>"><img src="./images/ePammsDelete.png" alt="Delete"></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCEnvironmentalHazards" );
