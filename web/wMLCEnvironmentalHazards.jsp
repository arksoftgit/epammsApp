...
<%-- wMLCEnvironmentalHazards   Generate Timestamp: 20160407171236077 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCEnvironmentalHazards", "wMLC.EditLocationsSection" );
