   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptHazardStmt" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCHazardStatement" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCHazardStatement.jsp";
...
<textarea name="StatementText" id="StatementText"style="width:698px;height:316px;border:solid;border-width:2px;border-style:groove;" wrap="wrap"><%=strErrorMapValue%></textarea>
