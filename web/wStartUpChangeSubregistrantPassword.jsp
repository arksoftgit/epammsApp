...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ChangeSubregistrantPassword", "" );
   }
...
<%
   ...
   {
%>
       <li id="smConfirmChangeSubregPassword" name="smConfirmChangeSubregPassword"><a href="#"  onclick="smConfirmChangeSubregPassword()">Change Password and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelChangeSubregPassword" name="smCancelChangeSubregPassword"><a href="#"  onclick="smCancelChangeSubregPassword()">Cancel Password and Return</a></li>
<%
   }
%>
