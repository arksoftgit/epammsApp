                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      csrRC = vGridTmp.cursor( "M_MetaTable" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "M_MetaTable" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "M_MetaTable" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wMLCTableMaintenance") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCTableMaintenance strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCTableMaintenance LastWindow *** " + strLastWindow );
task.log().info("*** wMLCTableMaintenance LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ADD_Table" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableMaintenance", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.AddTable" );
      nOptRC = wMLC.AddTable( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "TableSpecifications" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AltF4" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableMaintenance", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DELETE_Table" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableMaintenance", strActionToProcess );
      ...
      if ( VmlOperation.isValid( mMasLC ) )
      {
         ...
         csrRC = mMasLC.cursor( "M_MetaTable" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mMasLC.cursor( "M_MetaTable" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mMasLC.cursor( "M_MetaTable" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mMasLC.cursor( "M_MetaTable" ).setNextContinue( );
            } // Grid
         }
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "Return" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.SaveMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UPDATE_TableData" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableMaintenance", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wMLC.SetWebRedirection( vKZXMLPGO, wMLC.zWAB_StartModalSubwindow, "wMLC", "TableData" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "UPDATE_TableSpecifications" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCTableMaintenance", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.UpdateTable" );
      nOptRC = wMLC.UpdateTable( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.SaveAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.CancelAndReturnMLC" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditFirstAidSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditPrecautionarySection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEnvironmentalHazards" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditEnvironmentalHazardsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditSurfacesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditLocationsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditLocationsSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditApplicationTypesSection" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCTableMaintenance", "wMLC.EditClaimsSection" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCTableMaintenance" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCTableMaintenance.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCTableMaintenance.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCTableMaintenance.js"></script>
...
<%
   ...
   {
%>
       <li id="smDisplayTables" name="smDisplayTables"><a href="#"  class="sideselected"  onclick="smTables()">Tables</a></li>
<%
   }
%>

<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "TableOfContents" );
   if ( !csrRC.isSet( ) )
   {
%>
       <li id="smTableOfContents" name="smTableOfContents"><a href="#"  onclick="TOC()">Table of Contents</a></li>
<%
   }
%>
...
<form name="wMLCTableMaintenance" id="wMLCTableMaintenance" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "TableMaintenance" );
...
<div id="Tables" name="Tables" class="withborder"   style="float:left;position:relative; width:784px; height:260px;">  <!-- Tables --> 
...
<div id="GBAddTable" name="GBAddTable" style="width:758px;height:42px;position:absolute;left:14px;top:88px;">  <!-- GBAddTable --> 

<% /* AddTable:Text */ %>

<label class="groupbox"  id="AddTable" name="AddTable" style="width:176px;height:16px;position:absolute;left:6px;top:12px;">Add Table</label>

<% /* NewTable:PushBtn */ %>
<button type="button" class="newbutton" name="NewTable" id="NewTable" value="" onclick="ADD_Table( )" style="width:66px;height:26px;position:absolute;left:528px;top:12px;">New</button>

<% /* PBSort:PushBtn */ %>
<button type="button" class="newbutton" name="PBSort" id="PBSort" value="" onclick="Sort( )" style="width:66px;height:26px;position:absolute;left:610px;top:12px;">Sort</button>
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      View vGridTables;
      vGridTables = mMasLC.newView( );
      csrRC2 = vGridTables.cursor( "M_MetaTable" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridTables.cursor( "M_MetaTable" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strGE_TableName = "";
         nRC = vGridTables.cursor( "M_MetaTable" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGE_TableName = vGridTables.cursor( "M_MetaTable" ).getAttribute( "Name" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGE_TableDescription = vGridTables.cursor( "M_MetaTable" ).getAttribute( "Description" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGE_ColumnCnt = vGridTables.cursor( "M_MetaTable" ).getAttribute( "Columns" ).getString( "" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" onclick="UPDATE_TableSpecifications( this.id )" id="GE_TableName::<%=strEntityKey%>"><%=strGE_TableName%></a></td>
   <td nowrap><a href="#" onclick="UPDATE_TableSpecifications( this.id )" id="GE_TableDescription::<%=strEntityKey%>"><%=strGE_TableDescription%></a></td>
   <td nowrap><a href="#" onclick="UPDATE_TableSpecifications( this.id )" id="GE_ColumnCnt::<%=strEntityKey%>"><%=strGE_ColumnCnt%></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="UpdBtn" onclick="UPDATE_TableSpecifications( this.id )" id="UpdBtn::<%=strEntityKey%>"><img src="./images/ePammsUpdate.png" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="DeleteBtn" onclick="DELETE_Table( this.id )" id="DeleteBtn::<%=strEntityKey%>"><img src="./images/ePammsDelete.png" alt="Delete"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="Data" onclick="UPDATE_TableData( this.id )" id="Data::<%=strEntityKey%>"><img src="./images/ePammsUpdate.png" alt="Data"></a></td>

</tr>

<%
         csrRC2 = vGridTables.cursor( "M_MetaTable" ).setNextContinue( );
      }
      vGridTables.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCTableMaintenance" );
