...
if ( strLastWindow.equals("wSystemImportAreasOfUseList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSystemImportAreasOfUseList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSystemImportAreasOfUseList LastWindow *** " + strLastWindow );
task.log().info("*** wSystemImportAreasOfUseList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   if ( task != null )
   {
      ...
      if ( strFeedback != "" )
      {
         ...
         wSystem.SaveFeedback( "mOrganiz", "wSystem", "ImportAreasOfUseList", strFeedback );
      }

   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelImportAreasOfUseAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportAreasOfUseAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAreasOfUseList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAreasOfUseList.jsp", "wSystem.ConfirmImportAreasOfUseList" );
      try
      {
         nOptRC = wSystem.ConfirmImportAreasOfUseList( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportAreasOfUseFromFile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAreasOfUseList.jsp", "wSystem.ImportAreasOfUseFromFile" );
      try
      {
         nOptRC = wSystem.ImportAreasOfUseFromFile( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmImportAreasOfUseAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelImportAreasOfUseAndReturn" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSystemImportAreasOfUseList", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSystemImportAreasOfUseList" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSystemImportAreasOfUseList.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSystemImportAreasOfUseList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAreasOfUseList.jsp", "wSystem.InitImportAreasOfUseList" );
   nOptRC = wSystem.InitImportAreasOfUseList( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wSystemImportAreasOfUseList.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSystem" +
                         "&OperationName=" + "InitImportAreasOfUseList";
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSystemImportAreasOfUseList.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmImportAreasOfUseAndReturn( )">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelImportAreasOfUseAndReturn( )">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wSystemImportAreasOfUseList" id="wSystemImportAreasOfUseList" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSystem", "ImportAreasOfUseList" );
