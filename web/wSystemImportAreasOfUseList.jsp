...
<%-- wSystemImportAreasOfUseList   Generate Timestamp: 20160317151025909 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmImportAreasOfUseAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAreasOfUseList", "wSystem.ConfirmImportAreasOfUseList" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportAreasOfUseFromFile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAreasOfUseList", "wSystem.ImportAreasOfUseFromFile" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemImportAreasOfUseList", "wSystem.InitImportAreasOfUseList" );
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ImportAreasOfUseList", "" );
   }
...
<%
   ...
   {
%>
       <li id="smConfirmImportAndReturn" name="smConfirmImportAndReturn"><a href="#"  onclick="smConfirmImportAreasOfUseAndReturn()">Import List and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smImportListFromFile" name="smImportListFromFile"><a href="#"  onclick="smImportAreasOfUseFromFile()">Import List from File</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelImportAreasOfUseAndReturn()">Cancel and Return</a></li>
<%
   }
%>
...
<a href="#" id="TXSortAreasOfUseList" name="TXSortAreasOfUseList"  onclick="SortAreasOfUseList( );" style="width:72px;height:16px;position:absolute;left:552px;top:60px;">Sort</a>
