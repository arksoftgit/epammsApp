...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptAreasOfUseSect" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCAreasOfUse" );
         }
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wMLCAreasOfUse.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "BulkAreasOfUseListMaintenance" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wMLCMaintainAreasOfUseList.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wMLCAreasOfUse" );
      nRC = 1;  // do the redirection
      break;
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_CompositeEntries" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAreasOfUse.jsp", "wMLC.GOTO_CompositeEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_CompositeWO_Usage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCAreasOfUse.jsp", "wMLC.GOTO_CompositeWO_Usage" );
      try
      {
