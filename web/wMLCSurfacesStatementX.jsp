...
<%-- wMLCSurfacesStatementX   Generate Timestamp: 20160914154446548 --%>
...
if ( strLastWindow.equals("wMLCSurfacesStatementX") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLCSurfacesStatementX strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLCSurfacesStatementX LastWindow *** " + strLastWindow );
task.log().info("*** wMLCSurfacesStatementX LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptAndReturnUsageStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLCSurfacesStatementX", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCSurfacesStatementX", "wMLC.AcceptAndReturnUsageStatement" );
      nOptRC = wMLC.AcceptAndReturnUsageStatement( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DisplayGeneratedTextUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCSurfacesStatementX", "wMLC.GOTO_DisplayGeneratedTextUsage" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAddNewUsage" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCSurfacesStatementX", "wMLC.SaveAddNewUsage" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wMLCSurfacesStatementX" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLCSurfacesStatementX.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLCSurfacesStatementX.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "SurfacesStatementX", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLCSurfacesStatementX.js"></script>
...
<%
   ...
   {
%>
       <li id="AcceptAndReturn" name="AcceptAndReturn"><a href="#"  onclick="AcceptAndReturnUsageStatement()">Accept & Return</a></li>
<%
   }
%>
...
<form name="wMLCSurfacesStatementX" id="wMLCSurfacesStatementX" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC", "SurfacesStatementX" );
...
<% /* GridClaims:Grid */ %>
<div class="tableScroll"  style="position:absolute;top:46px;left:6px;width:742px;height:148px;">
...
<label class="listheader"  id="Text6" name="Text6" style="width:398px;height:16px;position:absolute;left:10px;top:8px;">Keyword text for Embedding in Statement Text</label>
...
<% /* Grid5:Grid */ %>
<table class="sortable"  cols=4 style=""  name="Grid5" id="Grid5">
...
try
{
   ...
   if ( VmlOperation.isValid( mMasLC ) )
   {
      ...
      String strBMBDeleteDirectionsUseStatement3;
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl5 = vGrid5.cursor( "M_InsertTextKeywordUsage" ).getAttribute( "Name" ).getString( "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl6 = vGrid5.cursor( "M_Usage" ).getAttribute( "dUsageKeywordText" ).getString( "" );
...
<tr<%=strOdd%>>
   ...
   <td><a href="#" onclick="GOTO_UsageUpdate( this.id )" id="GridEditCtl5::<%=strEntityKey%>"><%=strGridEditCtl5%></a></td>
   <td><%=strGridEditCtl6%></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BMBDeleteDirectionsUseStatement3" onclick="GOTO_UsageUpdate( this.id )" id="BMBDeleteDirectionsUseStatement3::<%=strEntityKey%>"><img src="./images/ePammsUpdate.png" alt="Update"></a></td>
   <td nowrap><a href="#" style="display:block;width:100%;height:100%;text-decoration:none;" name="BitmapBtn3" onclick="DELETE_UsageKeyword( this.id )" id="BitmapBtn3::<%=strEntityKey%>"><img src="./images/ePammsDelete.png" alt="Delete"></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLCSurfacesStatementX" );
