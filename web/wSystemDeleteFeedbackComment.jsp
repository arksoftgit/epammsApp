...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DeleteFeedbackComment" );
   }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mOrganiz.cursor( "Organization" ).getStringFromAttribute( "LoginName", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on Organization: " + e.getMessage());
               task.log().info( "*** Error on ctrl Organization" + e.getMessage() );
            }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mOrganiz.cursor( "Feedback" ).getStringFromAttribute( "UserId", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on UserId: " + e.getMessage());
               task.log().info( "*** Error on ctrl UserId" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mOrganiz.cursor( "Feedback" ).getStringFromAttribute( "Dialog", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on Dialog: " + e.getMessage());
               task.log().info( "*** Error on ctrl Dialog" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mOrganiz.cursor( "Feedback" ).getStringFromAttribute( "Window", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on Window: " + e.getMessage());
               task.log().info( "*** Error on ctrl Window" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mOrganiz.cursor( "Feedback" ).getStringFromAttribute( "Comment", "" );
            }
            catch (Exception e)
            {
               out.println("There is an error on Comment: " + e.getMessage());
               task.log().info( "*** Error on ctrl Comment" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
