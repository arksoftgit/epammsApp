...
<%-- wPrimRUpdateMasterProductContent --%>
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mMasLC.cursor( "MasterProduct" ).setAttribute( "Description", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptUpdateMasterProductContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.AcceptUpdateMasterProductContent" );
      try
      {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation AcceptUpdateMasterProductContent: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMasterProductContent" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.DeleteMasterProductContent" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteMasterProductSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.DeleteMasterProductSection" );
      try
      {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation DeleteMasterProductSection: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductContentDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.MoveMasterProductContentDown" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductContentUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.MoveMasterProductContentUp" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductSectionDown" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.MoveMasterProductSectionDown" );
      try
      {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation MoveMasterProductSectionDown: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "MoveMasterProductSectionUp" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.MoveMasterProductSectionUp" );
      try
      {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation MoveMasterProductSectionUp: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "NewMasterProductSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.NewMasterProductSection" );
      try
      {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation NewMasterProductSection: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateMasterProductSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wPrimR.UpdateMasterProductSection" );
      try
      {
      ...
      {
         strVMLError = "<br><br>*** Error running Operation UpdateMasterProductSection: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wPrimRUpdateMasterProductContent.jsp", "wStartUp.Template" );
      try
      {
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "UpdateMasterProductContent" );
   }
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mMasLC.cursor( "MasterProduct" ).getStringFromAttribute( "Name", "" );
      }
      catch (Exception e)
      {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl ContentName" + e.getMessage() );
            }
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mMasLC.cursor( "MasterProduct" ).getStringFromAttribute( "Description", "" );
            }
            catch (Exception e)
            {
            ...
            task.log( ).debug( "Entity does not exist: " + "mMasLC.MasterProduct" );
      }
   }
%>
