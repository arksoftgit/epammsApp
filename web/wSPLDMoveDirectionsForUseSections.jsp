...
<%-- wSPLDMoveDirectionsForUseSections --%>
                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC = vGridTmp.cursor( "SelectDirectionsForUse" ).setFirst(  );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "SelectDirectionsForUse" ).getEntityKey( );
         ...
         try
         {
            if ( webMapping )
               ...
               if ( strMapValue != null )
                  vGridTmp.cursor( "SelectDirectionsForUse" ).setAttribute( "wkSelected", strMapValue );
               else
                  vGridTmp.cursor( "SelectDirectionsForUse" ).setAttribute( "wkSelected", "" );
         }
         ...
         csrRC = vGridTmp.cursor( "SelectDirectionsForUse" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wSPLDMoveDirectionsForUseSections") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDMoveDirectionsForUseSections strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDMoveDirectionsForUseSections LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDMoveDirectionsForUseSections LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDMoveDirectionsForUseSections", strActionToProcess );
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wSPLDMoveDirectionsForUseSections.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectDirectionsUseSect" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDMoveDirectionsForUseSections", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wSPLD.SelectDirectionsUseSect" );
      try
      {
         nOptRC = wSPLD.SelectDirectionsUseSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SelectDirectionsUseSect: " + e.getMessage();
      ...
      if ( nRC >= 0 )
      {
         ...
         if ( strFunctionCall != null && StringUtils.equals( strFunctionCall, "StartSubwindow" ) )
         {
            ...
            vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wSPLDMoveDirectionsForUseSections" );
         }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSelectDirectionsUseSect" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDMoveDirectionsForUseSections", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDMoveDirectionsForUseSections.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLDMoveDirectionsForUseSections" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDMoveDirectionsForUseSections.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<title>Move Directions For Use Sections</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLDMoveDirectionsForUseSections.js"></script>
...
<div id="sidenavigation">
   <ul>
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "SelectDirectionsUseSection" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li><a href="#"  onclick="smSelectDirectionsUseSect( )">Select DirectionsForUse Section</a></li>
<%
   }
%>
...
<form name="wSPLDMoveDirectionsForUseSections" id="wSPLDMoveDirectionsForUseSections" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD", "MoveDirectionsForUseSections" );
...
<% /* Grid:Grid */ %>
<div class="tableScroll"  style="width:550px;height:350px;">
...
try
{
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      csrRC2 = vGrid.cursor( "SelectDirectionsForUse" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGrid.cursor( "SelectDirectionsForUse" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         strButtonName = "SelectButton" + strEntityKey;

         strSelect = "";
         nRC = vGrid.cursor( "SelectDirectionsForUse" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strSelect = vGrid.cursor( "SelectDirectionsForUse" ).getStringFromAttribute( "wkSelected", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl = vGrid.cursor( "SelectDirectionsForUse" ).getStringFromAttribute( "DisplayEntry", "" );
...
<%
         csrRC2 = vGrid.cursor( "SelectDirectionsForUse" ).setNextContinue( );
      }
      vGrid.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLDMoveDirectionsForUseSections" );
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDMoveDirectionsForUseSections" );
