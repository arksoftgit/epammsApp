                           ...
                           boolean webMapping )
{
   ...
   if ( VmlOperation.isValid( lPrimReg ) )
   {
      ...
      csrRC = vGridTmp.cursor( "User" ).setFirst( "PrimaryRegistrant" );
      while ( csrRC.isSet() )
      {
         lEntityKey = vGridTmp.cursor( "User" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
         iTableRowCnt++;

         csrRC = vGridTmp.cursor( "User" ).setNextContinue( );
      }
...
if ( strLastWindow.equals("wStartUpAdminListPrimRegUsers") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminListPrimRegUsers strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminListPrimRegUsers LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminListPrimRegUsers LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewPrimRegUser" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListPrimRegUsers", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wStartUp", "AdminNewPrimRegUser" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }

   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnToPrimaryRegistrants" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListPrimRegUsers", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectPrimRegUserForDelete" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListPrimRegUsers", strActionToProcess );
      ...
      if ( VmlOperation.isValid( lPrimReg ) )
      {
         ...
         csrRC = lPrimReg.cursor( "User" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() ) //if ( nRC < 0 )
         {
         // This is temp code because SetCursorEntityKey doesn't work on subobjects.
            csrRCk = lPrimReg.cursor( "User" ).setFirst( );
            while ( csrRCk.isSet() )
            {
               lEKey = lPrimReg.cursor( "User" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = lPrimReg.cursor( "User" ).setNextContinue( );
            }
         }
      }
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.SelectPrimRegUserForDelete" );
      try
      {
         nOptRC = wStartUp.SelectPrimRegUserForDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation SelectPrimRegUserForDelete: " + e.getMessage();
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wStartUp", "AdminDeletePrimRegUser" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectPrimRegUserForUpdate" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListPrimRegUsers", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.SelectPrimRegUserForUpdate" );
      try
      {
         nOptRC = wStartUp.SelectPrimRegUserForUpdate( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation SelectPrimRegUserForUpdate: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_StartModalSubwindow, "wStartUp", "AdminUpdatePrimRegUser" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smReturnToPrimaryRegistrants" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminListPrimRegUsers", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminListPrimRegUsers" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminListPrimRegUsers.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminListPrimRegUsers.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminListPrimRegUsers.jsp", "wStartUp.InitListPrimRegUsers" );
   nOptRC = wStartUp.InitListPrimRegUsers( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wStartUpAdminListPrimRegUsers.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitListPrimRegUsers";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminListPrimRegUsers" );
   }
...
<title>List Primary Registrant Users</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminListPrimRegUsers.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smReturnToPrimaryRegistrants( )">Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminListPrimRegUsers" id="wStartUpAdminListPrimRegUsers" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminListPrimRegUsers" );
...
<span  id="PrimaryRegistrant:" name="PrimaryRegistrant:" style="width:134px;height:16px;">Primary Registrant:</span>
...
<span  id="TXName" name="TXName" style="width:516px;height:16px;"><%=strTextDisplayValue%></span>
...
<% /* PrimRegUsers:GroupBox */ %>
<div id="PrimRegUsers" name="PrimRegUsers" style="float:left;width:486px;"  class="listgroup">

<table cols=0 style="width:486px;"  class="grouptable">

<tr>
<td valign="top"  class="newbutton" style="width:78px;">
<% /* PBAdminNewPrimRegUser:PushBtn */ %>
<button type="button" class="newbutton"  id="PBAdminNewPrimRegUser" name="PBAdminNewPrimRegUser" value="New" onclick="AddNewPrimRegUser( )"  style="width:78px;height:26px;">New</button>
...
<table class="sortable listheader"  cols=5 style=""  name="GridSubregistrant" id="GridSubregistrant">
...
try
{
   ...
   if ( VmlOperation.isValid( lPrimReg ) )
   {
      ...
      String strGEPrimaryRegistrantFirstName;
      String strGEPrimaryRegistrantLastName;
      String strBMBAdminUpdatePrimRegUser;
      String strBMBAdminDeletePrimRegUser;
      
      View vGridSubregistrant;
      vGridSubregistrant = lPrimReg.newView( );
      csrRC2 = vGridSubregistrant.cursor( "User" ).setFirst( "PrimaryRegistrant" );
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGEPrimaryRegistrantName = vGridSubregistrant.cursor( "User" ).getStringFromAttribute( "UserName", "" );
         ...
         strGEPrimaryRegistrantFirstName = "";
         nRC = vGridSubregistrant.cursor( "Employee" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGEPrimaryRegistrantFirstName = vGridSubregistrant.cursor( "Employee" ).getStringFromAttribute( "FirstName", "" );

            if ( strGEPrimaryRegistrantFirstName == null )
               strGEPrimaryRegistrantFirstName = "";
         }

         if ( StringUtils.isBlank( strGEPrimaryRegistrantFirstName ) )
            strGEPrimaryRegistrantFirstName = "&nbsp";

         strGEPrimaryRegistrantLastName = "";
         nRC = vGridSubregistrant.cursor( "Employee" ).checkExistenceOfEntity( ).toInt();
         if ( nRC >= 0 )
         {
            strGEPrimaryRegistrantLastName = vGridSubregistrant.cursor( "Employee" ).getStringFromAttribute( "LastName", "" );

            if ( strGEPrimaryRegistrantLastName == null )
               strGEPrimaryRegistrantLastName = "";
         }

         if ( StringUtils.isBlank( strGEPrimaryRegistrantLastName ) )
            strGEPrimaryRegistrantLastName = "&nbsp";
...
<%
         csrRC2 = vGridSubregistrant.cursor( "User" ).setNextContinue( );
      }
      vGridSubregistrant.drop( );
   }
}
catch (Exception e)
{
