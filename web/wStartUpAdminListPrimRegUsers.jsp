...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewPrimRegUser" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wStartUpAdminNewPrimRegUser.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wStartUpAdminListPrimRegUsers" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ReturnToPrimaryRegistrants" ) )
   {
      ...
      if ( nRC >= 0 )
      {
         ...
         strLastPage = "wStartUpAdminListPrimRegUsers.jsp";
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SelectPrimRegUserForDelete" ) )
   {
      ...
      // Next Window
      strURL = response.encodeRedirectURL( "wStartUpAdminDeletePrimRegUser.jsp" );
      vKZXMLPGO.cursor( "PagePath" ).createEntity( CursorPosition.NEXT );
      vKZXMLPGO.cursor( "PagePath" ).setAttribute( "LastPageName", "wStartUpAdminListPrimRegUsers" );
      nRC = 1;  // do the redirection
      break;
