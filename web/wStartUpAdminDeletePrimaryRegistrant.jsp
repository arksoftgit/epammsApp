...
<%-- wStartUpAdminDeletePrimaryRegistrant --%>
...
if ( strLastWindow.equals("wStartUpAdminDeletePrimaryRegistrant") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminDeletePrimaryRegistrant strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminDeletePrimaryRegistrant LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminDeletePrimaryRegistrant LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminCancelDelPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimaryRegistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminConfirmDeletePrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimaryRegistrant", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.DeletePrimaryRegistrant" );
      try
      {
         nOptRC = wStartUp.DeletePrimaryRegistrant( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         strVMLError = "<br><br>*** Error running Operation DeletePrimaryRegistrant: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminConfirmDeletePrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimaryRegistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAdminCancelDelPrimReg" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminDeletePrimaryRegistrant", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpAdminDeletePrimaryRegistrant" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminDeletePrimaryRegistrant.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminDeletePrimaryRegistrant.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminDeletePrimaryRegistrant.jsp", "wStartUp.InitPrimaryRegistrantForDelete" );
   nOptRC = wStartUp.InitPrimaryRegistrantForDelete( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wStartUpAdminDeletePrimaryRegistrant.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitPrimaryRegistrantForDelete";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "AdminDeletePrimaryRegistrant" );
   }
...
<title>Delete Primary Registrant</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminDeletePrimaryRegistrant.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminConfirmDeletePrimReg( )">Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smAdminCancelDelPrimReg( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminDeletePrimaryRegistrant" id="wStartUpAdminDeletePrimaryRegistrant" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminDeletePrimaryRegistrant" );
...
<div id="PrimaryRegistrant" name="PrimaryRegistrant" class="noborder" style="width:702px;height:140px;float:left;">  <!-- PrimaryRegistrant --> 
...
<span  id="TXName" name="TXName" style="width:228px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="RegistrantName:" name="RegistrantName:" style="width:126px;height:16px;">Registrant Name:</span>

<span style="height:16px;">&nbsp</span>
<% /* PrimaryRegistrantNameID:Text */ %>
<% strTextDisplayValue = "";
   mPrimReg = task.getViewByName( "mPrimReg" );
   if ( VmlOperation.isValid( mPrimReg ) == false )
      task.log( ).debug( "Invalid View: " + "PrimaryRegistrantNameID" );
   else
   {
      ...
      {
         out.println("There is an error on PrimaryRegistrantNameID: " + e.getMessage());
         task.log().info( "*** Error on ctrl PrimaryRegistrantNameID" + e.getMessage() );
      }
         if ( strTextDisplayValue == null )
            strTextDisplayValue = "";
      }
...
<span class="text10"  id="PrimaryRegistrantNameID" name="PrimaryRegistrantNameID" style="width:518px;height:16px;"><%=strTextDisplayValue%></span>
...
<span class="text10"  id="Confirm" name="Confirm" style="width:422px;height:16px;">Are you sure you want to delete this Primary Registrant?</span>
