...
<%-- wSLC2DirectionsForUseStatement --%>
...
if ( strLastWindow.equals("wSLC2DirectionsForUseStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLC2DirectionsForUseStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLC2DirectionsForUseStatement LastWindow *** " + strLastWindow );
task.log().info("*** wSLC2DirectionsForUseStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLC2DirectionsForUseStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_SelectRemoveDUEntries" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSLC2.SetWebRedirection( vKZXMLPGO, wSLC2.zWAB_StartModalSubwindow, "wSLC2", "DirsForUseUsageSelect" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLC2DirectionsForUseStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLC2DirectionsForUseStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLC2DirectionsForUseStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLC2DirectionsForUseStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="AcceptDirectionsStatement( )">Accept & Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="CancelDirectionsStatement( )">Cancel & Return</a></li>
<%
   }
%>
...
<form name="wSLC2DirectionsForUseStatement" id="wSLC2DirectionsForUseStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC2", "DirectionsForUseStatement" );
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSubLC.cursor( "S_DirectionsForUseStatement" ).getStringFromAttribute( "Title", "" );
      }
      catch (Exception e)
      {
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSubLC.cursor( "S_DirectionsForUseStatement" ).getStringFromAttribute( "Text", "" );
      }
      catch (Exception e)
      {
...
try
{
   ...
   if ( VmlOperation.isValid( mSubLC ) )
   {
      ...
      while ( csrRC2.isSet() )
      {
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl4 = vGrid4.cursor( "S_DirectionsUsage" ).getStringFromAttribute( "UsageType", "" );
         ...
         if ( nRC >= 0 )
         {
            strGridEditCtl5 = vGrid4.cursor( "S_DirectionsUsage" ).getStringFromAttribute( "dDisplayUsageName", "" );
...
<%
   session.setAttribute( "ZeidonWindow", "wSLC2DirectionsForUseStatement" );
