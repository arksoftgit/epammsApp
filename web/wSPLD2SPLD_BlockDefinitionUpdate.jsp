      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_Block" ).setAttribute( "LLD_SectionType", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_Block" ).setAttribute( "Height", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_Block" ).setAttribute( "Width", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_Block" ).setAttribute( "ImageName", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_Block" ).setAttribute( "ContinuationBlockFlag", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
      ...
      if ( nRC >= 0 )
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mSPLDef.cursor( "LLD_Block" ).setAttribute( "LLD_ColumnListType", strMapValue, "" );
         }
         catch ( InvalidAttributeValueException e )
         {
            nMapError = -16;
...
if ( strLastWindow.equals("wSPLD2SPLD_BlockDefinitionUpdate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2SPLD_BlockDefinitionUpdate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2SPLD_BlockDefinitionUpdate LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2SPLD_BlockDefinitionUpdate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ACCEPT_BlockSubBlockDefinition" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdate.jsp", "wSPLD2.ACCEPT_BlockSubBlockDefinition" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CANCEL_BlockSubBlockDefinition" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdate.jsp", "wSPLD2.CANCEL_BlockSubBlockDefinition" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DELETE_SpecialFormatDef" ) )
   {
      ...
      if ( VmlOperation.isValid( mSPLDef ) )
      {
         ...
         csrRC = mSPLDef.cursor( "LLD_SpecialSectionAttribute" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() )
         {
            boolean bFound = false;
            csrRCk = mSPLDef.cursor( "LLD_SpecialSectionAttribute" ).setFirst( );
            while ( csrRCk.isSet() && !bFound )
            {
               lEKey = mSPLDef.cursor( "LLD_SpecialSectionAttribute" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = mSPLDef.cursor( "LLD_SpecialSectionAttribute" ).setNextContinue( );
            } // Grid
         }
      }
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdate.jsp", "wSPLD2.DELETE_SpecialFormatDef" );
      try
      {
         nOptRC = wSPLD2.DELETE_SpecialFormatDef( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation DELETE_SpecialFormatDef: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_NewSpecialFormatDefinition" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdate.jsp", "wSPLD2.GOTO_NewSpecialFormatDefinition" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD2", "SPLD_BlockSpecialFormatDef" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_SelectMarketingSection" ) )
   {
      ...
      // Next Window
      strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD2", "SPLD_BlockMarketingSectionSelect" );
      strURL = response.encodeRedirectURL( strNextJSP_Name );
      nRC = 1;  // do the redirection
      break;
   }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateSpecialFormatDef" ) )
   {
      ...
      nRC = 0;
      EntityCursor cursor = mSPLDef.cursor( "LLD_SpecialSectionAttribute" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2SPLD_BlockDefinitionUpdate" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2SPLD_BlockDefinitionUpdate.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2SPLD_BlockDefinitionUpdate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2SPLD_BlockDefinitionUpdate.jsp", "wSPLD2.PostbuildBlockDefinitionUpdate" );
   ...
   if ( nOptRC == 2 )
   {
      ...
      strURLParameters = "?CallingPage=wSPLD2SPLD_BlockDefinitionUpdate.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wSPLD2" +
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2SPLD_BlockDefinitionUpdate.js"></script>
...
<form name="wSPLD2SPLD_BlockDefinitionUpdate" id="wSPLD2SPLD_BlockDefinitionUpdate" method="post">
...
<%
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      ...
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSPLDef.cursor( "LLD_Block" ).getStringFromAttribute( "LLD_SectionType", "" );
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_Block" ).getStringFromAttribute( "Height", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_Block" ).getStringFromAttribute( "Width", "" );
            }
            catch (Exception e)
            {
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
            strErrorMapValue = mSPLDef.cursor( "LLD_Block" ).getStringFromAttribute( "ImageName", "" );
            }
            catch (Exception e)
            {
...
<%
   ...
   else
   {
      nRC = mSPLDef.cursor( "LLD_Block" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
         strRadioGroupValue = mSPLDef.cursor( "LLD_Block" ).getStringFromAttribute( "ContinuationBlockFlag" );
   }
...
<%
   ...
   if ( VmlOperation.isValid( mSPLDef ) )
   {
      List<TableEntry> list = JspWebUtils.getTableDomainValues( mSPLDef , "LLD_Block", "LLD_ColumnListType", "" );

      nRC = mSPLDef.cursor( "LLD_Block" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
         strComboCurrentValue = mSPLDef.cursor( "LLD_Block" ).getStringFromAttribute( "LLD_ColumnListType", "" );
         if ( strComboCurrentValue == null )
            strComboCurrentValue = "";
      }
      else
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2SPLD_BlockDefinitionUpdate" );
