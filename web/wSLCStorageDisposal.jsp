...
<%-- wSLCStorageDisposal   Generate Timestamp: 20160317151020741 --%>
...
<%
   ...
   {
%>
       <li id="smStorDisp" name="smStorDisp"><a href="#"  class="sideselected"  onclick="smDisplayStorDispSect()">Storage and Disposal</a></li>
<%
   }
%>
