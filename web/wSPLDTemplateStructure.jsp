...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddMarketingBlock" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateStructure.jsp", "wSPLD.AddMarketingBlock" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GeneratePDF" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLDTemplateStructure.jsp", "wSPLD.GeneratePDF" );
      try
      {
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSPLDTemplateStructure" );
