...
if ( strLastWindow.equals("wMLC2AreasOfUse") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2AreasOfUse strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2AreasOfUse LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2AreasOfUse LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ADD_AreasOfUseStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2AreasOfUse", strActionToProcess );
      ...
      // Next Window
      strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "AreasOfUseStatement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateAreasOfUseStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2AreasOfUse", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.SaveAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smSaveMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.SaveMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelAndReturnMLC" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.CancelAndReturnMLC" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditPrecautionarySection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditFirstAidSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditHazardsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditClaimsSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditSurfacesSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditAreasOfUseSection" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditApplicationTypesSection" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2AreasOfUse.jsp", "wMLC2.EditApplicationTypesSection" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2AreasOfUse" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2AreasOfUse.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2AreasOfUse.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2AreasOfUse.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#" class="sideselected"  onclick="smEditAreasOfUseSection( )">Areas of Use</a></li>
<%
   }
%>
...
<form name="wMLC2AreasOfUse" id="wMLC2AreasOfUse" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "AreasOfUse" );
...
<span class="groupbox"  id="OrganismClaimsStatements" name="OrganismClaimsStatements" style="width:238px;height:16px;">Areas of Use Statements</span>
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2AreasOfUse" );
