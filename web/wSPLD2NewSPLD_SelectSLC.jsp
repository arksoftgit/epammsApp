...
if ( strLastWindow.equals("wSPLD2NewSPLD_SelectSLC") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2NewSPLD_SelectSLC strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2NewSPLD_SelectSLC LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2NewSPLD_SelectSLC LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2NewSPLD_SelectSLC", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SELECT_SLC_ForNewSPLD" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2NewSPLD_SelectSLC", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2NewSPLD_SelectSLC.jsp", "wSPLD2.SELECT_SLC_ForNewSPLD" );
      try
      {
         nOptRC = wSPLD2.SELECT_SLC_ForNewSPLD( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation SELECT_SLC_ForNewSPLD: " + e.getMessage();
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2NewSPLD_SelectSLC" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLD2NewSPLD_SelectSLC.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2NewSPLD_SelectSLC.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2NewSPLD_SelectSLC.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="SELECT_SLC_ForNewSPLD( )">Select</a></li>
<%
   }
%>
...
<form name="wSPLD2NewSPLD_SelectSLC" id="wSPLD2NewSPLD_SelectSLC" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "NewSPLD_SelectSLC" );
...
<thead><tr>
   ...
   <th style="width:224px;">Description</th>
...
try
{
   ...
   if ( VmlOperation.isValid( mSubProd ) )
   {
      ...
      View vGrid2;
      vGrid2 = mSubProd.newView( );
      csrRC2 = vGrid2.cursor( "SubregLabelContent" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
...
<%
         csrRC2 = vGrid2.cursor( "SubregLabelContent" ).setNextContinue( );
      }
      vGrid2.drop( );
   }
}
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2NewSPLD_SelectSLC" );
