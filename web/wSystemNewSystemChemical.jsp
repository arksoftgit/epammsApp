...
<%-- wSystemNewSystemChemical   Generate Timestamp: 20160406142158981 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewSystemChemicalAndRtn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemChemical", "wSystem.AcceptNewSystemChemical" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewChemicalAndRtn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemChemical", "wSystem.CancelNewSystemChemical" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemNewSystemChemical", "wSystem.InitSystemChemicalForInsert" );
...
<%
   ...
   {
%>
       <li id="smAcceptNewChemical" name="smAcceptNewChemical"><a href="#"  onclick="smAcceptNewSystemChemicalAndRtn()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelNewChemical" name="smCancelNewChemical"><a href="#"  onclick="smCancelNewChemicalAndRtn()">Cancel and Return</a></li>
<%
   }
%>
