...
<%-- wSystemUpdateAreasOfUse   Generate Timestamp: 20160317151026847 --%>
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AddNewAreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateAreasOfUse", "wSystem.NewAreasOfUse" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DeleteAreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateAreasOfUse", "wSystem.DeleteAreasOfUse" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ImportAreasOfUseList" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateAreasOfUse", "wSystem.ImportAreasOfUseList" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "UpdateAreasOfUse" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateAreasOfUse", "wSystem.UpdateAreasOfUseFromCurrent" );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wSystemUpdateAreasOfUse", "wSystem.InitAreasOfUseForUpdate" );
...
<%
   ...
   {
%>
       <li id="smImportAreasOfUseList" name="smImportAreasOfUseList"><a href="#"  onclick="smImportAreasOfUseList()">Import Areas of Use List</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smAcceptUpdateAreasOfUse" name="smAcceptUpdateAreasOfUse"><a href="#"  onclick="smAcceptUpdateAreasOfUse()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelUpdateAreasOfUse" name="smCancelUpdateAreasOfUse"><a href="#"  onclick="smCancelUpdateAreasOfUse()">Cancel and Return</a></li>
<%
   }
%>
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().error( "*** Error on ctrl AreasOfUse", e );
            }
