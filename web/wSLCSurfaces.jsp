...
<%
   ...
   {
%>
       <li id="smTypesOfSurfaces" name="smTypesOfSurfaces"><a href="#"  class="sideselected"  onclick="smDisplaySurfacesSection()">Types of Surfaces</a></li>
<%
   }
%>
...
<%
   ...
   task.log().info( "After building the page setting ZeidonWindow: ------>>> " + "wSLCSurfaces" );
