...
<%-- wSPLD2MLC_CompositeComponentList --%>
...
if ( strLastWindow.equals("wSPLD2MLC_CompositeComponentList") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLD2MLC_CompositeComponentList strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLD2MLC_CompositeComponentList LastWindow *** " + strLastWindow );
task.log().info("*** wSPLD2MLC_CompositeComponentList LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2MLC_CompositeComponentList", strActionToProcess );

      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wSPLD2.CancelMasterLabelContent" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_UpdateMLC_Component" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLD2MLC_CompositeComponentList", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wSPLD2.GOTO_UpdateMLC_Component" );
      try
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wSPLD2.SetWebRedirection( vKZXMLPGO, wSPLD2.zWAB_StartModalSubwindow, "wSPLD2", "MLC_CompositeComponentList" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "SaveAndReturn" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wSPLD2.SaveMasterLabelContent" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMasterLabelVersionData" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditMasterLabelVersionData" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditIngredientsSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditIngredientsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditStorDispSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditStorDispSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHumanHazardSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditHumanHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditPrecautionarySect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditPrecautionarySect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditFirstAidSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditFirstAidSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditHazardSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditHazardSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditClaimsSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditClaimsSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditSurfacesSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditSurfacesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAreasOfUseSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditAreasOfUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditAppTypesSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditAppTypesSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditDirectionsUseSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditDirectionsUseSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smEditMarketingSect" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.EditMarketingSect" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_CompositeEntries" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.GOTO_CompositeEntries" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smGOTO_CompositeWO_Usage" ) )
   {
      ...
      nRC = 0;
      wMLC_Dialog wMLC = new wMLC_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wMLC.GOTO_CompositeWO_Usage" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSPLD2MLC_CompositeComponentList.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSPLD2MLC_CompositeComponentList" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLD2MLC_CompositeComponentList.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "MLC_CompositeComponentList" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSPLD2MLC_CompositeComponentList.js"></script>
...
<form name="wSPLD2MLC_CompositeComponentList" id="wSPLD2MLC_CompositeComponentList" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSPLD2", "MLC_CompositeComponentList" );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><a href="#" onclick="GOTO_UpdateMLC_Component( this.id )" id="GE_AppType1::<%=strEntityKey%>"><%=strGE_AppType1%></a></td>
   <td><a href="#" onclick="GOTO_UpdateMLC_Component( this.id )" id="GridEditCtl2::<%=strEntityKey%>"><%=strGridEditCtl2%></a></td>
...
<%
   session.setAttribute( "ZeidonWindow", "wSPLD2MLC_CompositeComponentList" );
