...
<%-- wStartUpePammsPortal   Generate Timestamp: 20160328163925807 --%>
                           ...
                           boolean webMapping )
{
   ...
   qOrganizLogin = task.getViewByName( "qOrganizLogin" );
   if ( VmlOperation.isValid( qOrganizLogin ) )
   {
   }
...
if ( strLastWindow.equals("wStartUpePammsPortal") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpePammsPortal strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpePammsPortal LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpePammsPortal LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ResumeSPLD" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpePammsPortal", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "LoadCommitForTestPurposes" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpePammsPortal", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.LoadCommitForTestPurposes" );
      nOptRC = wStartUp.LoadCommitForTestPurposes( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smResumeSPLD" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpePammsPortal", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mUsers" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.GOTO_UserList" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wStartUpePammsPortal" );
         task.dropTask();
         task = null;
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpePammsPortal.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpePammsPortal", "wStartUp.InitPortal" );
   nOptRC = wStartUp.InitPortal( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wStartUpePammsPortal.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitPortal";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "ePammsPortal", "" );
   }
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpePammsPortal.js"></script>
...
<div id="sidenavigation">
   <ul id="ShortCut" name="ShortCut">
<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "Login" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li id="smLogin" name="smLogin"><a href="#"  onclick="smReturnToLogin()">Return to Login</a></li>
<%
   }
%>

<%
   csrRC = vKZXMLPGO.cursor( "DisableMenuOption" ).setFirst( "MenuOptionName", "ResumeSPLD" );
   if ( !csrRC.isSet() ) //if ( nRC < 0 )
   {
%>
       <li id="smResumeSPLD" name="smResumeSPLD"><a href="#"  onclick="smResumeSPLD()">Resume SPLD</a></li>
<%
   }
%>
...
<form name="wStartUpePammsPortal" id="wStartUpePammsPortal" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "ePammsPortal" );
...
<% strTextDisplayValue = "";
   qOrganizLogin = task.getViewByName( "qOrganizLogin" );
   if ( VmlOperation.isValid( qOrganizLogin ) == false )
      task.log( ).debug( "Invalid View: " + "WelcomeText" );
   else
   {
      nRC = qOrganizLogin.cursor( "Organization" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 )
      {
      try
      {
         strTextDisplayValue = qOrganizLogin.cursor( "Organization" ).getAttribute( "dLoginUserNameRole" ).getString( "" );
      }
      catch (Exception e)
      {
         out.println("There is an error on WelcomeText: " + e.getMessage());
         task.log().info( "*** Error on ctrl WelcomeText" + e.getMessage() );
      }
