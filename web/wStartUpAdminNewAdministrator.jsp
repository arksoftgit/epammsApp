                           ...
                           boolean webMapping )
{
   ...
   mePamms = task.getViewByName( "mePamms" );
   if ( VmlOperation.isValid( mePamms ) )
   {
      // EditBox: EBName
      nRC = mePamms.cursor( "ePamms" ).checkExistenceOfEntity( ).toInt();
      if ( nRC >= 0 ) // CursorResult.SET
      {
         ...
         try
         {
            if ( webMapping )
               ...
               mePamms.cursor( "ePamms" ).getAttribute( "Name" ).setValue( strMapValue, "" );
         }
...
if ( strLastWindow.equals("wStartUpAdminNewAdministrator") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpAdminNewAdministrator strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpAdminNewAdministrator LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpAdminNewAdministrator LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AcceptNewAdministrator" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewAdministrator", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.AcceptNewAdministrator" );
      nOptRC = wStartUp.AcceptNewAdministrator( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wStartUp.SetWebRedirection( vKZXMLPGO, wStartUp.zWAB_ReplaceWindowWithModalWindow, "wStartUp", "UserLogin" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelNewAdministrator" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewAdministrator", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.CancelNewAdministrator" );
      nOptRC = wStartUp.CancelNewAdministrator( new zVIEW( vKZXMLPGO ) );
      if ( nOptRC == 2 )
      {
         nRC = 2;  // do the "error" redirection
         session.setAttribute( "ZeidonError", "Y" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smAcceptNewAdministrator" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewAdministrator", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelNewAdministrator" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpAdminNewAdministrator", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.ProductManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.SubregistrantManagement" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.TrackingNotificationCompliance" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.StateRegistrations" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.MarketingFulfillment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.WebDevelopment" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mCompanyProfile" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpAdminNewAdministrator.jsp", "wStartUp.ProcessLogin" );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wStartUpAdminNewAdministrator" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpAdminNewAdministrator.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpAdminNewAdministrator.jsp") ) 
         {
            response.sendRedirect( strURL );
...
else
{
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).getAttribute( "CurrentWindow" ).setValue( "AdminNewAdministrator", "" );
   }
...
<title>New Administrator Setup</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpAdminNewAdministrator.js"></script>
...
<%
   ...
   {
%>
       <li id="smSaveAndReturn" name="smSaveAndReturn"><a href="#"  onclick="smAcceptNewAdministrator()">Save and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="smCancelAndReturn" name="smCancelAndReturn"><a href="#"  onclick="smCancelNewAdministrator()">Cancel and Return</a></li>
<%
   }
%>
...
<form name="wStartUpAdminNewAdministrator" id="wStartUpAdminNewAdministrator" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "AdminNewAdministrator" );
...
<% /* NewAdministrator:Text */ %>

<span class="groupbox"  id="NewAdministrator" name="NewAdministrator" style="width:120px;height:28px;">Administrator</span>
...
<% /* GBNewAdministrator:GroupBox */ %>

<div id="GBNewAdministrator" name="GBNewAdministrator" style="width:586px;height:46px;float:left;">  <!-- GBNewAdministrator --> 
...
<table cols=0 style="width:546px;"  class="grouptable">
...
<%
   ...
   else
   {
      strErrorColor = "";
      mePamms = task.getViewByName( "mePamms" );
      if ( VmlOperation.isValid( mePamms ) == false )
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            try
            {
               strErrorMapValue = mePamms.cursor( "ePamms" ).getAttribute( "Name" ).getString( "" );
            }
            catch (Exception e)
            {
...
<div id="GBLogin" name="GBLogin" style="width:586px;height:78px;float:left;">  <!-- GBLogin --> 
...
<div style="clear:both;"></div>  <!-- Moving to a new line, so do a clear -->
 ...
 <!-- This is added as a line spacer -->
<div style="height:62px;width:100px;"></div>
