...
<%
   ...
   {
%>
       <li id="COPY_SPLD_VersionCurrent" name="COPY_SPLD_VersionCurrent"><a href="#"  onclick="COPY_SPLD_VersionCurrent()">Create from Current SPLD</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li id="COPY_SPLD_Next" name="COPY_SPLD_Next"><a href="#"  onclick="COPY_SPLD_VersionNext()">Create from Next SPLD</a></li>
<%
   }
%>
