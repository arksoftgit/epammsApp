...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLCVersionData.jsp", "wStartUp.Template" );
      try
      {
...
<fieldset id="MasterLabelContent" name="MasterLabelContent"   style="size:absolute; width:732px; height:132px;">
