...
function smTemplate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wPrimRUpdateMasterProduct.zAction.value = "smTemplate";
      document.wPrimRUpdateMasterProduct.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wPrimRUpdateMasterProduct.zAction.value = "mAdministration";
      document.wPrimRUpdateMasterProduct.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wPrimRUpdateMasterProduct.zAction.value = "mLogin";
      document.wPrimRUpdateMasterProduct.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wPrimRUpdateMasterProduct.zAction.value = "mTemplate";
      document.wPrimRUpdateMasterProduct.submit( );
   }
}
