...
function smConfirmAddAppTypesStmts( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCAddAppTypesList.zAction.value = "smConfirmAddAppTypesStmts";
      document.wMLCAddAppTypesList.submit( );
   }
}

function smConfirmAddAppTypesStmtsAndReturn( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCAddAppTypesList.zAction.value = "smConfirmAddAppTypesStmtsAndReturn";
      document.wMLCAddAppTypesList.submit( );
   }
}

function smCancelAddAppTypesStmts( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCAddAppTypesList.zAction.value = "smCancelAddAppTypesStmts";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mProductManagement";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mSubregistrants";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mTrackingNotificationCompliance";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mStateRegistrations";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mMarketingFulfillment";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mWebDevelopment";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mAdministration";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mLogin";
      document.wMLCAddAppTypesList.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAppTypesList.zAction.value = "mTemplate";
      document.wMLCAddAppTypesList.submit( );
   }
}
