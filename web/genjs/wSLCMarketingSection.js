...
// _DisableFormElements( false );
   ...
   var varTimeout = document.wSLCMarketingSection.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function AcceptMarketingSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "AcceptMarketingSect";
      document.wSLCMarketingSection.submit( );
   }
}
...
function InitAppTypesStmtForUpdate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "InitAppTypesStmtForUpdate";
      document.wSLCMarketingSection.submit( );
   }
}
...
function CancelMarketingSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "CancelMarketingSect";
      document.wSLCMarketingSection.submit( );
   }
}
...
function SelectMarketingSectForDelete( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "SelectMarketingSectForDelete";
      document.wSLCMarketingSection.submit( );
   }
}
...
function MoveMarketingStmtDown( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "MoveMarketingStmtDown";
      document.wSLCMarketingSection.submit( );
   }
}
...
function MoveMarketingStmtUp( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "MoveMarketingStmtUp";
      document.wSLCMarketingSection.submit( );
   }
}

function InitMarketingStmtForInsert( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "InitMarketingStmtForInsert";
      document.wSLCMarketingSection.submit( );
   }
}
...
function SaveAddNewMarketingSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "SaveAddNewMarketingSect";
      document.wSLCMarketingSection.submit( );
   }
}
...
function InitAreasOfUseStmtForUpdate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "InitAreasOfUseStmtForUpdate";
      document.wSLCMarketingSection.submit( );
   }
}
...
function SelectMarketingStmtForUpdate( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "SelectMarketingStmtForUpdate";
      document.wSLCMarketingSection.submit( );
   }
}
...
function smCancelMarketingSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCMarketingSection.zAction.value = "smCancelMarketingSect";
      document.wSLCMarketingSection.submit( );
   }
}
