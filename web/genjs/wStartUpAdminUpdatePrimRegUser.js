...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminUpdatePrimRegUser.zAction.value = "mAdministration";
      document.wStartUpAdminUpdatePrimRegUser.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminUpdatePrimRegUser.zAction.value = "mLogin";
      document.wStartUpAdminUpdatePrimRegUser.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminUpdatePrimRegUser.zAction.value = "mTemplate";
      document.wStartUpAdminUpdatePrimRegUser.submit( );
   }
}
