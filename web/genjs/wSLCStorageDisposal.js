...
// _DisableFormElements( false );
   ...
   var LoginName = document.wSLCStorageDisposal.zLoginName.value;
...
function smDilution( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposal.zAction.value = "smDilution";
      document.wSLCStorageDisposal.submit( );
   }
}
...
function smDisplayLocationsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposal.zAction.value = "smDisplayLocationsSection";
      document.wSLCStorageDisposal.submit( );
   }
}
...
function smGOTO_Footnotes( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposal.zAction.value = "smGOTO_Footnotes";
      document.wSLCStorageDisposal.submit( );
   }
}
...
function smDisplayTables( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposal.zAction.value = "smDisplayTables";
      document.wSLCStorageDisposal.submit( );
   }
}
