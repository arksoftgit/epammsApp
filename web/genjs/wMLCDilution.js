...
function smEditEnvironmentalHazardSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDilution.zAction.value = "smEditEnvironmentalHazardSection";
      document.wMLCDilution.submit( );
   }
}
...
function smEditChemicalHazardsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDilution.zAction.value = "smEditChemicalHazardsSection";
      document.wMLCDilution.submit( );
   }
}
...
function smEditAreasOfUseSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDilution.zAction.value = "smEditAreasOfUseSection";
      document.wMLCDilution.submit( );
   }
}
