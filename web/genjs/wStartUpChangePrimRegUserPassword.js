...
// _DisableFormElements( false );
   ...
   var LoginName = document.wStartUpChangePrimRegUserPassword.zLoginName.value;
...
function InitChangePrimRegUserPass( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      document.wStartUpChangePrimRegUserPassword.zAction.value = "InitChangePrimRegUserPass";
      document.wStartUpChangePrimRegUserPassword.submit( );
   }
}
...
function mUsers( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpChangePrimRegUserPassword.zAction.value = "mUsers";
      document.wStartUpChangePrimRegUserPassword.submit( );
   }
}
