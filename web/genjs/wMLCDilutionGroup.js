...
function GOTO_DilutionGroupItem( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDilutionGroup.zAction.value = "GOTO_DilutionGroupItem";
      document.wMLCDilutionGroup.submit( );
   }
}
...
function AcceptChartEntryItem( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDilutionGroup.zAction.value = "AcceptChartEntryItem";
      document.wMLCDilutionGroup.submit( );
   }
}
...
function CancelChartEntryItem( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDilutionGroup.zAction.value = "CancelChartEntryItem";
      document.wMLCDilutionGroup.submit( );
   }
}
