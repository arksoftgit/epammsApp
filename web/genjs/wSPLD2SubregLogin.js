...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSPLD2SubregLogin.zAction.value = "_OnResubmitPage";
         document.wSPLD2SubregLogin.submit( );
      }
      else
      {
         _OnTimeout( );
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2SubregLogin.zAction.value = "_OnTimeout";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSPLD2SubregLogin.zAction.value = "_OnUnload";
         document.wSPLD2SubregLogin.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSPLD2SubregLogin.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSPLD2SubregLogin.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSPLD2SubregLogin.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSPLD2SubregLogin.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   document.wSPLD2SubregLogin.zError.value = "";
   document.wSPLD2SubregLogin.zOpenFile.value = "";
   ...
   var varTimeout = document.wSPLD2SubregLogin.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function FORGOT_Password( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2SubregLogin.zAction.value = "FORGOT_Password";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function ExecuteJOE_Test1( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2SubregLogin.zAction.value = "ExecuteJOE_Test1";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function ExecuteJOE_Test2( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2SubregLogin.zAction.value = "ExecuteJOE_Test2";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function ProcessUserLogin( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2SubregLogin.zAction.value = "ProcessUserLogin";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mProductManagement";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mSubregistrants";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mTrackingNotificationCompliance";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mStateRegistrations";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mMarketingFulfillment";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mWebDevelopment";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mAdministration";
      document.wSPLD2SubregLogin.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLD2SubregLogin.zAction.value = "mLogin";
      document.wSPLD2SubregLogin.submit( );
   }
}
