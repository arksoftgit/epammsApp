// wMLCVersionData   Generate Timestamp: 20160914154446944
...
// _DisableFormElements( false );
   ...
   var LoginName = document.wMLCVersionData.zLoginName.value;
...
function smEditLocationsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCVersionData.zAction.value = "smEditLocationsSection";
      document.wMLCVersionData.submit( );
   }
}
