...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wStartUpChangePrimRegPassword.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "_OnTimeout";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wStartUpChangePrimRegPassword.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wStartUpChangePrimRegPassword.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wStartUpChangePrimRegPassword.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wStartUpChangePrimRegPassword.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wStartUpChangePrimRegPassword.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function CancelChangePrimRegPassword( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "CancelChangePrimRegPassword";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}

function ConfirmChangePrimRegPassword( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      var strPassword =  document.wStartUpChangePrimRegPassword.Password.value;
      var strNew =  document.wStartUpChangePrimRegPassword.NewPassword.value;
      var strConfirm =  document.wStartUpChangePrimRegPassword.ConfirmPassword.value;

      if ( strPassword == "" )
      {
         alert( "Password must be specified." );
         document.wStartUpChangePrimRegPassword.Password.focus();
         return;
      }
      ...
      if ( strNew == "" || strConfirm == "" )
      {
         ...
         if ( strNew == "" )
            document.wStartUpChangePrimRegPassword.NewPassword.focus();
         else
            document.wStartUpChangePrimRegPassword.ConfirmPassword.focus();
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "ConfirmChangePrimRegPassword";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}

function InitChangePrimRegPassword( )
{
...
function smConfirmChangePrimRegPassword( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "smConfirmChangePrimRegPassword";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}

function smCancelChangePrimRegPassword( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "smCancelChangePrimRegPassword";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mProductManagement";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mSubregistrants";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mTrackingNotificationCompliance";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mStateRegistrations";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mMarketingFulfillment";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mWebDevelopment";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpChangePrimRegPassword.zAction.value = "mTemplate";
      document.wStartUpChangePrimRegPassword.submit( );
   }
}
