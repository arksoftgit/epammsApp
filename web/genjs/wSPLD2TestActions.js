...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSPLD2TestActions.zAction.value = "_OnResubmitPage";
         document.wSPLD2TestActions.submit( );
      }
      else
      {
         _OnTimeout( );
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2TestActions.zAction.value = "_OnTimeout";
      document.wSPLD2TestActions.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSPLD2TestActions.zAction.value = "_OnUnload";
         document.wSPLD2TestActions.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSPLD2TestActions.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSPLD2TestActions.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSPLD2TestActions.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSPLD2TestActions.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   document.wSPLD2TestActions.zError.value = "";
   document.wSPLD2TestActions.zOpenFile.value = "";
   ...
   var varTimeout = document.wSPLD2TestActions.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function FORGOT_Password( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2TestActions.zAction.value = "FORGOT_Password";
      document.wSPLD2TestActions.submit( );
   }
}
...
function ProcessUserLogin( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLD2TestActions.zAction.value = "ProcessUserLogin";
      document.wSPLD2TestActions.submit( );
   }
}
