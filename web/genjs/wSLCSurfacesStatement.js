...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSLCSurfacesStatement.zAction.value = "_OnResubmitPage";
         document.wSLCSurfacesStatement.submit( );
      }
      else
      {
         _OnTimeout( );
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCSurfacesStatement.zAction.value = "_OnTimeout";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSLCSurfacesStatement.zAction.value = "_OnUnload";
         document.wSLCSurfacesStatement.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSLCSurfacesStatement.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSLCSurfacesStatement.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSLCSurfacesStatement.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSLCSurfacesStatement.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var keyRole = document.wSLCSurfacesStatement.zKeyRole.value;
   document.wSLCSurfacesStatement.zError.value = "";
   document.wSLCSurfacesStatement.zOpenFile.value = "";
   ...
   var varTimeout = document.wSLCSurfacesStatement.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function AcceptSurfacesStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCSurfacesStatement.zAction.value = "AcceptSurfacesStmt";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function CancelSurfacesStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCSurfacesStatement.zAction.value = "CancelSurfacesStmt";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function InitImportSurfacesStatements( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCSurfacesStatement.zAction.value = "InitImportSurfacesStatements";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function SaveAddNewSurface( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCSurfacesStatement.zAction.value = "SaveAddNewSurface";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function smCancelSurfacesStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCSurfacesStatement.zAction.value = "smCancelSurfacesStmt";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mProductManagement";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mSubregistrants";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mTrackingNotificationCompliance";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mStateRegistrations";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mMarketingFulfillment";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mWebDevelopment";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mAdministration";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mLogin";
      document.wSLCSurfacesStatement.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCSurfacesStatement.zAction.value = "mTemplate";
      document.wSLCSurfacesStatement.submit( );
   }
}
