// wSLCIngredients   Generate Timestamp: 20170810174447287
...
// _DisableFormElements( false );
   ...
   var LoginName = document.wSLCIngredients.zLoginName.value;
...
var $wai = $("#wai"); if ( $wai ) { $wai.text( document.title ); }
   var storageName = "epamms.wSLCIngredients.position";
...
function smDilution( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCIngredients.zAction.value = "smDilution";
      document.wSLCIngredients.submit( );
   }
}
...
function smDisplayLocationsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCIngredients.zAction.value = "smDisplayLocationsSection";
      document.wSLCIngredients.submit( );
   }
}
...
function smGOTO_Footnotes( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCIngredients.zAction.value = "smGOTO_Footnotes";
      document.wSLCIngredients.submit( );
   }
}
...
function smDisplayTables( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCIngredients.zAction.value = "smDisplayTables";
      document.wSLCIngredients.submit( );
   }
}
