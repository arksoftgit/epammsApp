...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wStartUpePammsPortal.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpePammsPortal.zAction.value = "_OnTimeout";
      document.wStartUpePammsPortal.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wStartUpePammsPortal.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wStartUpePammsPortal.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wStartUpePammsPortal.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wStartUpePammsPortal.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wStartUpePammsPortal.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mProductManagement";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mSubregistrants";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mTrackingNotificationCompliance";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mStateRegistrations";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mMarketingFulfillment";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mWebDevelopment";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mAdministration";
      document.wStartUpePammsPortal.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpePammsPortal.zAction.value = "mTemplate";
      document.wStartUpePammsPortal.submit( );
   }
}
