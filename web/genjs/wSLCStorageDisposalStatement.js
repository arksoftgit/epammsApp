...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSLCStorageDisposalStatement.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "_OnTimeout";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSLCStorageDisposalStatement.zAction.value = "_OnUnload";
         document.wSLCStorageDisposalStatement.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSLCStorageDisposalStatement.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSLCStorageDisposalStatement.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSLCStorageDisposalStatement.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSLCStorageDisposalStatement.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var keyRole = document.wSLCStorageDisposalStatement.zKeyRole.value;
   document.wSLCStorageDisposalStatement.zError.value = "";
   document.wSLCStorageDisposalStatement.zOpenFile.value = "";
...
function AcceptStorDispStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "AcceptStorDispStmt";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function CancelStorDispStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "CancelStorDispStmt";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function SaveAddNewStorDispStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "SaveAddNewStorDispStmt";
      document.wSLCStorageDisposalStatement.submit( );
   }
}

function smCancelStorDispStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "smCancelStorDispStmt";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mProductManagement";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mSubregistrants";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mTrackingNotificationCompliance";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mStateRegistrations";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mMarketingFulfillment";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mWebDevelopment";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mAdministration";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mLogin";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCStorageDisposalStatement.zAction.value = "mTemplate";
      document.wSLCStorageDisposalStatement.submit( );
   }
}
