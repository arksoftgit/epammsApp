...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "_OnTimeout";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wStartUpDEPRECATED_SelectPrimaryReg.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wStartUpDEPRECATED_SelectPrimaryReg.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wStartUpDEPRECATED_SelectPrimaryReg.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wStartUpDEPRECATED_SelectPrimaryReg.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wStartUpDEPRECATED_SelectPrimaryReg.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function InitSelectPrimaryRegistrant( )
{
...
function smSystem( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "smSystem";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function smShowFeedback( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "smShowFeedback";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mProductManagement";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mSubregistrants";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mTrackingNotificationCompliance";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mStateRegistrations";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mMarketingFulfillment";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mWebDevelopment";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpDEPRECATED_SelectPrimaryReg.zAction.value = "mTemplate";
      document.wStartUpDEPRECATED_SelectPrimaryReg.submit( );
   }
}
