...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wStartUpAdminSelectSubregistrant.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "_OnTimeout";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wStartUpAdminSelectSubregistrant.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wStartUpAdminSelectSubregistrant.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wStartUpAdminSelectSubregistrant.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wStartUpAdminSelectSubregistrant.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wStartUpAdminSelectSubregistrant.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function InitSelectSubregistrant( )
{
...
function smSystem( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "smSystem";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function smShowFeedback( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "smShowFeedback";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "mProductManagement";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "mSubregistrants";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "mTrackingNotificationCompliance";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "mStateRegistrations";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "mMarketingFulfillment";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminSelectSubregistrant.zAction.value = "mWebDevelopment";
      document.wStartUpAdminSelectSubregistrant.submit( );
   }
}
