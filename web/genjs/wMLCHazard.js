...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wMLCHazard.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "_OnTimeout";
      document.wMLCHazard.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wMLCHazard.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wMLCHazard.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wMLCHazard.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wMLCHazard.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wMLCHazard.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function AcceptHazardSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "AcceptHazardSect";
      document.wMLCHazard.submit( );
   }
}
...
function CancelHazardSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "CancelHazardSect";
      document.wMLCHazard.submit( );
   }
}

function SelectHazardSectForDelete( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zTableRowSelect.value = strEntityKey;
      _DisableFormElements( true );

      document.wMLCHazard.zAction.value = "SelectHazardSectForDelete";
      document.wMLCHazard.submit( );
   }
}
...
function MoveHazardSectDown( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "MoveHazardSectDown";
      document.wMLCHazard.submit( );
   }
}
...
function MoveHazardSectUp( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "MoveHazardSectUp";
      document.wMLCHazard.submit( );
   }
}
...
function InitHazardSectForInsert( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "InitHazardSectForInsert";
      document.wMLCHazard.submit( );
   }
}
...
function SelectHazardSectForUpdate( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "SelectHazardSectForUpdate";
      document.wMLCHazard.submit( );
   }
}
...
function smEditMasterLabelVersionData( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditMasterLabelVersionData";
      document.wMLCHazard.submit( );
   }
}
...
function smEditIngredientsSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditIngredientsSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditStorDispSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditStorDispSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditHumanHazardSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditHumanHazardSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditPrecautionarySect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditPrecautionarySect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditFirstAidSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditFirstAidSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditHazardSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditHazardSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditClaimsSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditClaimsSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditSurfacesSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditSurfacesSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditAreasOfUseSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditAreasOfUseSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditAppTypesSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditAppTypesSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditDirectionsUseSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditDirectionsUseSect";
      document.wMLCHazard.submit( );
   }
}
...
function smEditMarketingSect( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCHazard.zAction.value = "smEditMarketingSect";
      document.wMLCHazard.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mProductManagement";
      document.wMLCHazard.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mSubregistrants";
      document.wMLCHazard.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mTrackingNotificationCompliance";
      document.wMLCHazard.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mStateRegistrations";
      document.wMLCHazard.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mMarketingFulfillment";
      document.wMLCHazard.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mWebDevelopment";
      document.wMLCHazard.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mAdministration";
      document.wMLCHazard.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCHazard.zAction.value = "mLogin";
      document.wMLCHazard.submit( );
   }
}
