...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wMLCDeleteMarketingStatement.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "_OnTimeout";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wMLCDeleteMarketingStatement.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wMLCDeleteMarketingStatement.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wMLCDeleteMarketingStatement.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wMLCDeleteMarketingStatement.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wMLCDeleteMarketingStatement.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function smConfirmDeleteMarketingStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "smConfirmDeleteMarketingStmt";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function smCancelDeleteMarketingStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "smCancelDeleteMarketingStmt";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mProductManagement";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mSubregistrants";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mTrackingNotificationCompliance";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mStateRegistrations";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mMarketingFulfillment";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mWebDevelopment";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mAdministration";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCDeleteMarketingStatement.zAction.value = "mLogin";
      document.wMLCDeleteMarketingStatement.submit( );
   }
}
