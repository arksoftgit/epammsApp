...
function smTemplate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wPrimRNewMasterProductContent.zAction.value = "smTemplate";
      document.wPrimRNewMasterProductContent.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wPrimRNewMasterProductContent.zAction.value = "mAdministration";
      document.wPrimRNewMasterProductContent.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wPrimRNewMasterProductContent.zAction.value = "mLogin";
      document.wPrimRNewMasterProductContent.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wPrimRNewMasterProductContent.zAction.value = "mTemplate";
      document.wPrimRNewMasterProductContent.submit( );
   }
}
