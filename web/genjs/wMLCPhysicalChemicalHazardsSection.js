// wMLCPhysicalChemicalHazardsSection   Generate Timestamp: 20160824153943121
...
function smEnvironmentalHazards( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCPhysicalChemicalHazardsSection.zAction.value = "smEnvironmentalHazards";
      document.wMLCPhysicalChemicalHazardsSection.submit( );
   }
}
...
function smEditLocationsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCPhysicalChemicalHazardsSection.zAction.value = "smEditLocationsSection";
      document.wMLCPhysicalChemicalHazardsSection.submit( );
   }
}
