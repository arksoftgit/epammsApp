...
// _DisableFormElements( false );
   ...
   var LoginName = document.wStartUpAdminDeleteSubregistrant.zLoginName.value;
...
function mCompanyProfile( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wStartUpAdminDeleteSubregistrant.zAction.value = "mCompanyProfile";
      document.wStartUpAdminDeleteSubregistrant.submit( );
   }
}
...
function mUsers( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wStartUpAdminDeleteSubregistrant.zAction.value = "mUsers";
      document.wStartUpAdminDeleteSubregistrant.submit( );
   }
}
