...
// _DisableFormElements( false );
   ...
   var LoginName = document.wSPLDDirectionsForUseSection.zLoginName.value;
   var keyRole = document.wSPLDDirectionsForUseSection.zKeyRole.value;
...
function GOTO_DirectionsForUseStatement( strTagEntityKey )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDDirectionsForUseSection.zAction.value = "GOTO_DirectionsForUseStatement";
      document.wSPLDDirectionsForUseSection.submit( );
   }
}
