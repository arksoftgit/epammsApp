...
function smConfirmAddSelectedAreasOfUse( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "smConfirmAddSelectedAreasOfUse";
      document.wMLCAddAreasOfUseList.submit( );
   }
}

function smConfirmAddAreasOfUseStmtsReturn( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "smConfirmAddAreasOfUseStmtsReturn";
      document.wMLCAddAreasOfUseList.submit( );
   }
}

function smCancelAddAreasOfUseStmts( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "smCancelAddAreasOfUseStmts";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mProductManagement";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mSubregistrants";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mTrackingNotificationCompliance";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mStateRegistrations";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mMarketingFulfillment";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mWebDevelopment";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mAdministration";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mLogin";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wMLCAddAreasOfUseList.zAction.value = "mTemplate";
      document.wMLCAddAreasOfUseList.submit( );
   }
}
