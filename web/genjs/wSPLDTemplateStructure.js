...
function AddMarketingBlock( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateStructure.zAction.value = "AddMarketingBlock";
      document.wSPLDTemplateStructure.submit( );
   }
}

function ShowGeneratedPDF( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      var PDF_FileName = document.wSPLDTemplateStructure.zPDF.value;
      var NewWin = window.open( PDF_FileName, "ePamms", "status=1,scrollbars=1,resizable=1" );
      if ( NewWin )
         NewWin.focus( );
      else
      {
...
// GeneratePDF Script Here
      ...
      document.wSPLDTemplateStructure.zAction.value = "smGeneratePDF";
      document.wSPLDTemplateStructure.submit( );
   }
}
...
function smAddMarketingBlock( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateStructure.zAction.value = "smAddMarketingBlock";
      document.wSPLDTemplateStructure.submit( );
   }
}
...
function smShowGeneratedPDF( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateStructure.zAction.value = "smShowGeneratedPDF";
      document.wSPLDTemplateStructure.submit( );
   }
}
