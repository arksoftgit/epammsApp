// wMLCStorageDisposal   Generate Timestamp: 20170419093443556
...
// _DisableFormElements( false );
   ...
   var LoginName = document.wMLCStorageDisposal.zLoginName.value;
...
function smEditLocationsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCStorageDisposal.zAction.value = "smEditLocationsSection";
      document.wMLCStorageDisposal.submit( );
   }
}
...
function smTables( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCStorageDisposal.zAction.value = "smTables";
      document.wMLCStorageDisposal.submit( );
   }
}
