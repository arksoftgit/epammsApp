...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSPLDSubregLogin.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDSubregLogin.zAction.value = "_OnTimeout";
      document.wSPLDSubregLogin.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSPLDSubregLogin.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSPLDSubregLogin.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSPLDSubregLogin.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSPLDSubregLogin.zOpenFile.value;
   if ( szMsg != "" )
   {
...
function ProcessUserLogin( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDSubregLogin.zAction.value = "ProcessUserLogin";
      document.wSPLDSubregLogin.submit( );
   }
}
