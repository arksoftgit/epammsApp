...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mProductManagement";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mSubregistrants";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mTrackingNotificationCompliance";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mStateRegistrations";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mMarketingFulfillment";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mWebDevelopment";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mAdministration";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mLogin";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRUpdateSubregProduct.zAction.value = "mTemplate";
      document.wSubRUpdateSubregProduct.submit( );
   }
}
