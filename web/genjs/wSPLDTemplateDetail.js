...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSPLDTemplateDetail.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateDetail.zAction.value = "_OnTimeout";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSPLDTemplateDetail.zAction.value = "_OnUnload";
         document.wSPLDTemplateDetail.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSPLDTemplateDetail.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSPLDTemplateDetail.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSPLDTemplateDetail.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSPLDTemplateDetail.zOpenFile.value;
   if ( szMsg != "" )
   {
...
function AcceptTemplate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateDetail.zAction.value = "AcceptTemplate";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function CancelTemplate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateDetail.zAction.value = "CancelTemplate";
      document.wSPLDTemplateDetail.submit( );
   }
}

function DeleteTemplatePanel( )
{
...
if (!answer)
{
   return;
      ...
      document.wSPLDTemplateDetail.zAction.value = "DeleteTemplatePanel";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function NewTemplatePanel( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateDetail.zAction.value = "NewTemplatePanel";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function smAcceptTemplate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateDetail.zAction.value = "smAcceptTemplate";
      document.wSPLDTemplateDetail.submit( );
   }
}

function smCancelTemplate( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSPLDTemplateDetail.zAction.value = "smCancelTemplate";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mProductManagement";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mSubregistrants";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mTrackingNotificationCompliance";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mStateRegistrations";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mMarketingFulfillment";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mWebDevelopment";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mAdministration";
      document.wSPLDTemplateDetail.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSPLDTemplateDetail.zAction.value = "mLogin";
      document.wSPLDTemplateDetail.submit( );
   }
}
