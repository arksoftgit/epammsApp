...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSLCHazardStatement.zAction.value = "_OnResubmitPage";
         document.wSLCHazardStatement.submit( );
      }
      else
      {
         _OnTimeout( );
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCHazardStatement.zAction.value = "_OnTimeout";
      document.wSLCHazardStatement.submit( );
   }
}
...
function _BeforePageUnload( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (isWindowClosing)
      {
         document.wSLCHazardStatement.zAction.value = "_OnUnload";
         document.wSLCHazardStatement.submit( );
      }
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSLCHazardStatement.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSLCHazardStatement.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSLCHazardStatement.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSLCHazardStatement.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var keyRole = document.wSLCHazardStatement.zKeyRole.value;
   document.wSLCHazardStatement.zError.value = "";
   document.wSLCHazardStatement.zOpenFile.value = "";
   ...
   var varTimeout = document.wSLCHazardStatement.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function AcceptHazardStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCHazardStatement.zAction.value = "AcceptHazardStmt";
      document.wSLCHazardStatement.submit( );
   }
}
...
function CancelHazardStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCHazardStatement.zAction.value = "CancelHazardStmt";
      document.wSLCHazardStatement.submit( );
   }
}
...
function smCancelHazardStmt( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSLCHazardStatement.zAction.value = "smCancelHazardStmt";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mProductManagement( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mProductManagement";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mSubregistrants( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mSubregistrants";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mTrackingNotificationCompliance( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mTrackingNotificationCompliance";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mStateRegistrations( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mStateRegistrations";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mMarketingFulfillment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mMarketingFulfillment";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mWebDevelopment( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mWebDevelopment";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mAdministration";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mLogin( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mLogin";
      document.wSLCHazardStatement.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSLCHazardStatement.zAction.value = "mTemplate";
      document.wSLCHazardStatement.submit( );
   }
}
