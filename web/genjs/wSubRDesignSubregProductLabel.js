...
function _OnAlmostTimeout()
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      if (tDiff < 60000)
      {
         document.wSubRDesignSubregProductLabel.zAction.value = "_OnResubmitPage";
...
function _OnTimeout( )
{
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "_OnTimeout";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}
...
// _DisableFormElements( false );
   ...
   var szFocusCtrl = document.wSubRDesignSubregProductLabel.zFocusCtrl.value;
   if ( szFocusCtrl != "" && szFocusCtrl != "null" )
      eval( 'document.wSubRDesignSubregProductLabel.' + szFocusCtrl + '.focus( )' );

   // This is where we put out a message from the previous iteration on this window
   var szMsg = document.wSubRDesignSubregProductLabel.zError.value;
   if ( szMsg != "" )
      alert( szMsg ); // "Houston ... We have a problem"

   szMsg = document.wSubRDesignSubregProductLabel.zOpenFile.value;
   if ( szMsg != "" )
   {
   ...
   var varTimeout = document.wSubRDesignSubregProductLabel.zTimeout.value;
   if ( varTimeout > 0 )
   {
...
function AcceptDesignSubregProductLabel( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "AcceptDesignSubregProductLabel";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}

function CancelDesignSubregProductLabel( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "CancelDesignSubregProductLabel";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}

function InitDesignSubregProductLabel( )
{
...
function smSystem( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "smSystem";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}
...
function smShowFeedback( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "smShowFeedback";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}
...
function mAdministration( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "mAdministration";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}
...
function mTemplate( )
{
   ...
   if ( thisLi.disabled == true )
      ...
      document.wSubRDesignSubregProductLabel.zAction.value = "mTemplate";
      document.wSubRDesignSubregProductLabel.submit( );
   }
}
