...
function smEditEnvironmentalHazardSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCFirstAidSection.zAction.value = "smEditEnvironmentalHazardSection";
      document.wMLCFirstAidSection.submit( );
   }
}
...
function smEditChemicalHazardsSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCFirstAidSection.zAction.value = "smEditChemicalHazardsSection";
      document.wMLCFirstAidSection.submit( );
   }
}
...
function smEditAreasOfUseSection( )
{
   ...
   if ( _IsDocDisabled( ) == false )
   {
      ...
      document.wMLCFirstAidSection.zAction.value = "smEditAreasOfUseSection";
      document.wMLCFirstAidSection.submit( );
   }
}
