...
<%-- wStartUpDEPRECATED_SelectPrimaryReg --%>
                           ...
                           boolean webMapping )
{
   ...
   qPrimReg = task.getViewByName( "qPrimReg" );
   if ( VmlOperation.isValid( qPrimReg ) )
   {
...
if ( strLastWindow.equals("wStartUpDEPRECATED_SelectPrimaryReg") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wStartUpDEPRECATED_SelectPrimaryReg strActionToProcess *** " + strActionToProcess );
task.log().info("*** wStartUpDEPRECATED_SelectPrimaryReg LastWindow *** " + strLastWindow );
task.log().info("*** wStartUpDEPRECATED_SelectPrimaryReg LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "AdminSelectPrimaryRegistrant" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wStartUpDEPRECATED_SelectPrimaryReg", strActionToProcess );
      ...
      if ( VmlOperation.isValid( qPrimReg ) )
      {
         ...
         csrRC = qPrimReg.cursor( "PrimaryRegistrant" ).setByEntityKey( lEKey );
         if ( !csrRC.isSet() ) //if ( nRC < 0 )
         {
         // This is temp code because SetCursorEntityKey doesn't work on subobjects.
            csrRCk = qPrimReg.cursor( "PrimaryRegistrant" ).setFirst( );
            while ( csrRCk.isSet() )
            {
               lEKey = qPrimReg.cursor( "PrimaryRegistrant" ).getEntityKey( );
               ...
               if ( StringUtils.equals( strKey, strEntityKey ) )
               {
                  ...
                  csrRCk = qPrimReg.cursor( "PrimaryRegistrant" ).setNextContinue( );
            }
         }
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wStartUpDEPRECATED_SelectPrimaryReg" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wStartUpDEPRECATED_SelectPrimaryReg.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wStartUpDEPRECATED_SelectPrimaryReg.jsp") ) 
         {
            response.sendRedirect( strURL );
...
{
   VmlOperation.SetZeidonSessionAttribute( null, task, "wStartUpDEPRECATED_SelectPrimaryReg.jsp", "wStartUp.InitSelectPrimaryRegistrant" );
   nOptRC = wStartUp.InitSelectPrimaryRegistrant( new zVIEW( vKZXMLPGO ) );
   if ( nOptRC == 2 )
   {
      View vView;
      String strMessage;
      ...
      strURLParameters = "?CallingPage=wStartUpDEPRECATED_SelectPrimaryReg.jsp" +
                         "&Message=" + strMessage +
                         "&DialogName=" + "wStartUp" +
                         "&OperationName=" + "InitSelectPrimaryRegistrant";
   ...
   if ( VmlOperation.isValid( wWebXA ) )
   {
      ...
      wWebXA.cursor( "Root" ).setAttribute( "CurrentWindow", "DEPRECATED_SelectPrimaryReg" );
   }
...
<title>Select Primary Registrant for New User</title>
...
<script language="JavaScript" type="text/javascript" src="./genjs/wStartUpDEPRECATED_SelectPrimaryReg.js"></script>
...
<form name="wStartUpDEPRECATED_SelectPrimaryReg" id="wStartUpDEPRECATED_SelectPrimaryReg" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wStartUp", "DEPRECATED_SelectPrimaryReg" );
...
<span style="height:30px;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
<% /* TXSelectPrimaryRegistrant:Text */ %>

<span  id="TXSelectPrimaryRegistrant" name="TXSelectPrimaryRegistrant" style="width:314px;height:30px;">Select Primary Registrant</span>
...
<div id="PrimaryRegistrants" name="PrimaryRegistrants" style="width:578px;height:276px;float:left;">  <!-- PrimaryRegistrants --> 

<div  id="PrimaryRegistrants" name="PrimaryRegistrants" >Primary Registrants</div>
...
try
{
   ...
   if ( VmlOperation.isValid( qPrimReg ) )
   {
      ...
      String strOdd;
      String strTag;
      String strGridPrimaryRegistrantName;
      String strGridPrimaryRegistrantDescription;
      
      View vGridPrimaryRegistrantList;
      vGridPrimaryRegistrantList = qPrimReg.newView( );
      csrRC2 = vGridPrimaryRegistrantList.cursor( "PrimaryRegistrant" ).setFirst(  );
      while ( csrRC2.isSet() )
      {
         strOdd = (iTableRowCnt % 2) != 0 ? " class='odd'" : "";
         iTableRowCnt++;

         lEntityKey = vGridPrimaryRegistrantList.cursor( "PrimaryRegistrant" ).getEntityKey( );
         strEntityKey = Long.toString( lEntityKey );
...
<tr<%=strOdd%>>
   ...
   <td nowrap><%=strGridPrimaryRegistrantName%></td>
   <td nowrap><%=strGridPrimaryRegistrantDescription%></td>
   <td nowrap><button type="button" class="formStylebutton" name=<%=strButtonName%> onclick="AdminSelectPrimaryRegistrant( this.id )" id="GridPrimaryRegistrantDescription::<%=strEntityKey%>"  style="width:44px;" >Select</button></td>

</tr>

<%
         csrRC2 = vGridPrimaryRegistrantList.cursor( "PrimaryRegistrant" ).setNextContinue( );
      }
