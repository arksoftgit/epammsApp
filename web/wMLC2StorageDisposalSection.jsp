...
if ( strLastWindow.equals("wMLC2StorageDisposalSection") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wMLC2StorageDisposalSection strActionToProcess *** " + strActionToProcess );
task.log().info("*** wMLC2StorageDisposalSection LastWindow *** " + strLastWindow );
task.log().info("*** wMLC2StorageDisposalSection LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wMLC2StorageDisposalSection", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2StorageDisposalSection.jsp", "wMLC2.AcceptAddNewStorDispSect" );
      try
      {
         nOptRC = wMLC2.AcceptAddNewStorDispSect( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation AcceptAddNewStorDispSect: " + e.getMessage();
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ADD_StorageDisposalContainer" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2StorageDisposalSection.jsp", "wMLC2.ADD_StorageDisposalContainer" );
      try
      {
         nOptRC = wMLC2.ADD_StorageDisposalContainer( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation ADD_StorageDisposalContainer: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   // END of Javascript code entered by user.
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2StorageDisposalSection.jsp", "wMLC2.CleanStorDispStmtHTML" );
      try
      {
         nOptRC = wMLC2.CleanStorDispStmtHTML( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "DELETE_StorageDisposalContainer" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2StorageDisposalSection.jsp", "wMLC2.DELETE_StorageDisposalContainer" );
      try
      {
         nOptRC = wMLC2.DELETE_StorageDisposalContainer( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation DELETE_StorageDisposalContainer: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_StorageDispStatementAdd" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2StorageDisposalSection.jsp", "wMLC2.GOTO_StorageDispStatementAdd" );
      try
      {
         nOptRC = wMLC2.GOTO_StorageDispStatementAdd( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_StorageDispStatementAdd: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
      ...
      {
         // Next Window
         strNextJSP_Name = wMLC2.SetWebRedirection( vKZXMLPGO, wMLC2.zWAB_StartModalSubwindow, "wMLC2", "StorageDisposalStatement" );
      }
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "GOTO_DirsForUseStatementDelete" ) )
   {
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wMLC2StorageDisposalSection.jsp", "wMLC2.GOTO_DirsForUseStatementDelete" );
      try
      {
         nOptRC = wMLC2.GOTO_DirsForUseStatementDelete( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
         // Set the error return code.
         nOptRC = 2;
         strVMLError = "<br><br>*** Error running Operation GOTO_DirsForUseStatementDelete: " + e.getMessage();
         task.log().info( strVMLError );
      }
      if ( nOptRC == 2 )
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wMLC2StorageDisposalSection" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wMLC2StorageDisposalSection.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wMLC2StorageDisposalSection.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wMLC2StorageDisposalSection.js"></script>
...
<form name="wMLC2StorageDisposalSection" id="wMLC2StorageDisposalSection" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wMLC2", "StorageDisposalSection" );
...
<%
   session.setAttribute( "ZeidonWindow", "wMLC2StorageDisposalSection" );
