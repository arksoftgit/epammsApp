...
<%-- wSPLDSPLD_StatementUpdate   Generate Timestamp: 20160620105929670 --%>
...
if ( strLastWindow.equals("wSPLDSPLD_StatementUpdate") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSPLDSPLD_StatementUpdate strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSPLDSPLD_StatementUpdate LastWindow *** " + strLastWindow );
task.log().info("*** wSPLDSPLD_StatementUpdate LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSPLDSPLD_StatementUpdate", strActionToProcess );
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----->>> " + "wSPLDSPLD_StatementUpdate" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSPLDSPLD_StatementUpdate.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSPLDSPLD_StatementUpdate.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<form name="wSPLDSPLD_StatementUpdate" id="wSPLDSPLD_StatementUpdate" method="post">
