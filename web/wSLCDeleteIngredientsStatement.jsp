...
<%-- wSLCDeleteIngredientsStatement --%>
...
if ( strLastWindow.equals("wSLCDeleteIngredientsStatement") && StringUtils.isBlank( strActionToProcess ) && StringUtils.isBlank( strLastAction ) )
{
...
task.log().info("*** wSLCDeleteIngredientsStatement strActionToProcess *** " + strActionToProcess );
task.log().info("*** wSLCDeleteIngredientsStatement LastWindow *** " + strLastWindow );
task.log().info("*** wSLCDeleteIngredientsStatement LastAction *** " + strLastAction );
...
if ( strActionToProcess != null )
{
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "ConfirmDeleteIngrediStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteIngredientsStatement", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wSLC.ConfirmDeleteIngredientStmt" );
      try
      {
         nOptRC = wSLC.ConfirmDeleteIngredientStmt( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "CancelDeleteIngredStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteIngredientsStatement", strActionToProcess );
      ...
      // Action Operation
      nRC = 0;
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wSLC.CancelDeleteIngredientStmt" );
      try
      {
         nOptRC = wSLC.CancelDeleteIngredientStmt( new zVIEW( vKZXMLPGO ) );
      }
      catch (Exception e)
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smConfirmDeleteIngrediStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteIngredientsStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "smCancelDeleteIngredStatement" ) )
   {
      bDone = true;
      VmlOperation.SetZeidonSessionAttribute( session, task, "wSLCDeleteIngredientsStatement", strActionToProcess );
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mProductManagement" ) )
   {
      ...
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.ProductManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mSubregistrants" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.SubregistrantManagement" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTrackingNotificationCompliance" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.TrackingNotificationCompliance" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mStateRegistrations" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.StateRegistrations" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mMarketingFulfillment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.MarketingFulfillment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mWebDevelopment" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.WebDevelopment" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mAdministration" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.PrimaryRegistrantCompanySetup" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mLogin" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.ProcessLogin" );
      try
      {
   ...
   while ( bDone == false && StringUtils.equals( strActionToProcess, "mTemplate" ) )
   {
      ...
      nRC = 0;
      wStartUp_Dialog wStartUp = new wStartUp_Dialog( vKZXMLPGO );
      VmlOperation.SetZeidonSessionAttribute( null, task, "wSLCDeleteIngredientsStatement.jsp", "wStartUp.Template" );
      try
      {
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnUnload" ) )
   {
      ...
      if ( task != null )
      {
         task.log().info( "OnUnload UnregisterZeidonApplication: ----------------------------------->>> " + "wSLCDeleteIngredientsStatement" );
         task.dropTask();
         task = null;
   ...
   while ( bDone == false && strActionToProcess.equals( "_OnResubmitPage" ) )
   {
      ...
      strURL = response.encodeRedirectURL( "wSLCDeleteIngredientsStatement.jsp" );
      nRC = 1;  //do the redirection
      break;
   }
   ...
   if ( nRC != 0 )
   {
      if ( nRC > 0 )
      {
         ...
         if ( ! strURL.equals("wSLCDeleteIngredientsStatement.jsp") ) 
         {
            response.sendRedirect( strURL );
...
<script language="JavaScript" type="text/javascript" src="./genjs/wSLCDeleteIngredientsStatement.js"></script>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smConfirmDeleteIngrediStatement( )">Confirm Delete and Return</a></li>
<%
   }
%>
...
<%
   ...
   {
%>
       <li><a href="#"  onclick="smCancelDeleteIngredStatement( )">Cancel Delete and Return</a></li>
<%
   }
%>
...
<form name="wSLCDeleteIngredientsStatement" id="wSLCDeleteIngredientsStatement" method="post">
...
<%
   ...
   strFocusCtrl = VmlOperation.GetFocusCtrl( task, "wSLC", "DeleteIngredientsStatement" );
...
<div id="IngredientsStatement" name="IngredientsStatement" class="withborder" style="width:732px;height:248px;float:left;">  <!-- IngredientsStatement --> 
...
<% strTextDisplayValue = "";
   ...
   else
   {
      ...
      try
      {
         strTextDisplayValue = mSubLC.cursor( "S_IngredientsStatement" ).getStringFromAttribute( "dIngredientName", "" );
      }
      catch (Exception e)
      {
...
<span  id="Ingredients Title" name="Ingredients Title" style="width:566px;height:16px;"><%=strTextDisplayValue%></span>
   ...
   else
   {
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            task.log( ).info( "S_IngredientsStatement.Prompt: " + strErrorMapValue );
         }
         else
            task.log( ).info( "Entity does not exist: " + "mSubLC.S_IngredientsStatement" );
      }
   }
%>

<textarea name="StatementText" id="StatementText" class="mceSimple" style="width:566px;height:74px;border:solid;border-width:4px;border-style:groove;"><%=strErrorMapValue%></textarea>
...
<input name="CommonName" id="CommonName"  disabled style="width:566px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<input name="ChemicalName" id="ChemicalName"  disabled style="width:566px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
      ...
      else
      {
         ...
         if ( nRC >= 0 )
         {
            ...
            catch (Exception e)
            {
               ...
               task.log().info( "*** Error on ctrl IngredientsActive" + e.getMessage() );
            }
            if ( strErrorMapValue == null )
               strErrorMapValue = "";
...
<input name="IngredientsActive" id="IngredientsActive"  disabled style="width:106px;<%=strErrorColor%>" type="text" value="<%=strErrorMapValue%>" >
...
<%
   session.setAttribute( "ZeidonWindow", "wSLCDeleteIngredientsStatement" );
